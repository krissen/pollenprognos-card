...
export function renderLevelCirclesSection(editor) {
    ...
    <details>
            ...
            <ha-formfield label="${editor._t("levels_empty_color")}">
              <div style="display: flex; align-items: center; gap: 8px;">
                <input
                  ...
                  @input=${(e) =>
                    editor._updateConfig("levels_empty_color", e.target.value)}
                  style="width: 28px; height: 28px; border: none; background: none;"
                />
                ${editor._renderTextField({
      ...
      <ha-formfield label="${editor._t("levels_thickness")}">
        <ha-slider
          ...
          @input=${(e) =>
            editor._updateConfig("levels_thickness", Number(e.target.value))}
          style="width: 120px;"
        ></ha-slider>
      ...
      >
        <ha-slider
          ...
          .disabled=${gapDisabled}
          @input=${(e) =>
            editor._updateConfig("levels_gap", Number(e.target.value))}
          style="width: 120px;"
        ></ha-slider>
        ${editor._renderNumberField({
          value: c.levels_gap,
            ...
            <ha-formfield label="${editor._t("levels_gap_color")}">
              <div style="display: flex; align-items: center; gap: 8px;">
                <input
                  ...
                  @input=${(e) =>
                    editor._updateConfig("levels_gap_color", e.target.value)}
                  style="width: 28px; height: 28px; border: none; background: none;"
                />
                ${editor._renderTextField({
      ...
      <ha-formfield label="${editor._t("levels_text_size")}">
        <ha-slider
          ...
          @input=${(e) =>
            editor._updateConfig("levels_text_size", Number(e.target.value))}
          style="width: 120px;"
        ></ha-slider>
        ${editor._renderNumberField({
          value: c.levels_text_size || 0.3,
      ...
      <ha-formfield label="${editor._t("levels_icon_ratio")}">
        <ha-slider
          ...
          @input=${(e) =>
            editor._updateConfig("levels_icon_ratio", Number(e.target.value))}
          style="width: 120px;"
        ></ha-slider>
        ${editor._renderNumberField({
          value: c.levels_icon_ratio || 1,
        ...
        <div style="display: flex; align-items: center; gap: 8px;">
          <input
            ...
            .value=${/^#([0-9A-F]{3}|[0-9A-F]{6})$/i.test(
              ...
              : "#000000"}
            @input=${(e) =>
              editor._updateConfig("levels_text_color", e.target.value)}
            style="width: 28px; height: 28px; border: none; background: none;"
          />
          ${editor._renderTextField({
