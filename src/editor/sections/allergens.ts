...
export function renderAllergensSection(
  ...
  const selectedAllergens = (c.allergens as string[]) || [];
    ...
    <details>
      ...
      <div class="slider-row">
        ...
        <div class="slider-value">
          ${formatNumberForInput(c.pollen_threshold as number, editor._hass)}
        </div>
        <ha-slider
      ...
      ${
        c.integration === "atmo"
          ? html`
              <ha-formfield label="${editor._t("sort_pollution_block")}">
                <ha-checkbox
