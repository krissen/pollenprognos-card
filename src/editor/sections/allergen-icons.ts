...
export function renderAllergenIconsSection(
  ...
  return html`
    ...
    <details>
      ...
      <ha-formfield
        label="${editor._t("allergen_color_mode") ||
        "Allergen Color Mode"}"
      >
        <ha-selector
          .hass=${editor._hass}
            ...
            select: {
              ...
              options: [
                ...
                },
                {
                  value: "custom",
                  label:
                    editor._t("allergen_color_custom") || "Custom Colors",
                },
              ],
            },
          }}
        ...
        ></ha-selector>
          ...
          ${c.allergen_color_mode === "custom"
            ? html`
                <ha-formfield
                  label="${editor._t("allergen_colors") ||
                ...
                <ha-formfield
                  label="${editor._t("no_allergens_color") ||
                  "No Allergens Color"}"
                >
                  <div
                    style="display: flex; align-items: center; gap: 8px;"
                  >
                    ...
                    ${editor._renderResetButton({
                      title:
                        editor._t("no_allergens_color_reset") || "Reset",
                      style: "margin-left: 8px;",
                      onClick: () =>
                        editor._updateConfig(
                          "no_allergens_color",
            ...
            : ""}
      <ha-formfield
        label="${editor._t("allergen_outline_color")}"
      >
        <div style="display: flex; align-items: center; gap: 8px;">
          ...
          ${editor._renderTextField({
            ...
            width: "100px",
            onInput: (v) =>
              editor._updateConfig("allergen_outline_color", v),
          })}
          ${editor._renderResetButton({
      ...
      <ha-formfield
        label="${editor._t("allergen_stroke_color_synced")}"
      >
        <ha-checkbox
      ...
      <ha-formfield
        label="${editor._t("allergen_stroke_width")}"
      >
        <ha-slider
          min="0"
          max="150"
      ...
      <div class="field-helper">${editor._t("helper_allergen_stroke_width")}</div>
    </details>
  `;
}
