  ...
  return html`
    ...
    <details open>
      ...
      <div class="section-helper">
        ${editor._t("helper_integration_and_place")}
      </div>
                  ...
                  .selector=${{
                    select: {
                      ...
                      options: [
                        ...
                        ...(editor.installedPpLocations || []).map(
                          ([key, label]) => ({
                            value: key,
                            label,
                          }),
                    ...
                    .selector=${{
                      select: {
                        ...
                        options: [
                          ...
                          ...(editor.installedPeuLocations || []).map(
                            ([slug, title]) => ({
                              value: slug,
                              label: title,
                            }),
                  ...
                  <ha-formfield label="${editor._t("location")}">
                    <ha-selector
                      ...
                      .selector=${{
                        select: {
                          ...
                          options: [
                            ...
                            ...(editor.installedSilamLocations || []).map(
                              ([slug, title]) => ({
                                value: slug,
                                label: title,
                              }),
                      ...
                      @value-changed=${(e: CustomEvent) => {
                        const v = e.detail?.value;
                        if (v !== undefined)
                          editor._updateConfig("location", v);
                      }}
                    ></ha-selector>
                  </ha-formfield>
                `
                        ...
                        .selector=${{
                          select: {
                            ...
                            options: [
                              ...
                              ...(editor.installedKleenexLocations || []).map(
                                ([slug, title]) => ({
                                  value: slug,
                                  label: title,
                                }),
                          ...
                          .selector=${{
                            select: {
                              ...
                              options: [
                                ...
                                ...(editor.installedAtmoLocations || []).map(
                                  ([slug, title]) => ({
                                    value: slug,
                                    label: title,
                                  }),
                          ...
                          <ha-formfield label="${editor._t("region_id")}">
                            <ha-selector
                              ...
                              .selector=${{
                                select: {
                                  ...
                                  options: [
                                    ...
                                    ...(editor.installedDwdLocations || []).map(
                                      ([key, label]) => ({
                                        value: key,
                                        label,
                                      }),
                              ...
                              @value-changed=${(e: CustomEvent) => {
                                const v = e.detail?.value;
                                if (v !== undefined)
                                  editor._updateConfig("region_id", v);
                              }}
                            ></ha-selector>
                          </ha-formfield>
                        `
                    ...
                    .selector=${{
                      select: {
                        ...
                        options: [
                          ...
                          {
                            value: "twice_daily",
                            label: editor._t("mode_twice_daily"),
                          },
                      ...
                      .selector=${{
                        select: {
                          ...
                          options: [
                            ...
                            {
                              value: "hourly",
                              label: editor._t("mode_hourly"),
                            },
                            {
                              value: "hourly_second",
                              label: editor._t("mode_hourly_second"),
                            },
                            {
                              value: "hourly_third",
                              label: editor._t("mode_hourly_third"),
                            },
                            {
                              value: "hourly_fourth",
                              label: editor._t("mode_hourly_fourth"),
                            },
                            {
                              value: "hourly_sixth",
                              label: editor._t("mode_hourly_sixth"),
                            },
                            {
                              value: "hourly_eighth",
                              label: editor._t("mode_hourly_eighth"),
                            },
                          ],
                        },
                      }}
                    ...
                    ? html`
                        <ha-formfield label="${editor._t("entity_weather")}">
                          ${editor._renderTextField({
                            ...
                            placeholder: editor._t(
                              "entity_weather_placeholder",
                            ),
                            onInput: (v) =>
