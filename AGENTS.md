...
- **Adapters**: `src/adapters/` (integration-specific data handlers for pp, dwd, peu, silam, kleenex, plu, atmo, gpl, gp, msw)
...
3. **Avoid direct DOM manipulation** - use Lit's reactive rendering
4. **Always handle missing entities gracefully** in adapters
