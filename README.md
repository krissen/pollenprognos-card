...
- [Polleninformation EU](https://github.com/krissen/polleninformation)  
  **Note,** for polleninformation >= v0.4.0, you need >=v2.4.2 of this card.  
  For polleninformation <=v0.3.1, you need v2.2.0–v2.4.1 of this card.
...
- [SILAM Pollen Allergy Sensor](https://github.com/danishru/silam_pollen)  
  **Notes:**
  ...
  - For silam_pollen >=v0.2.7, you need v2.4.1 or higher of this card.
  - For silam_pollen <v0.2.7, you need v2.3.0–v2.4.0 of this card.
...
| `levels_colors` | `array<string>` | `["#ffeb3b", "#ffc107", "#ff9800", "#ff5722", "#e64a19", "#d32f2f"]` | Segment colors for level indicator circle (e.g. `["#ffeecc", "#ffbb00", ...]`). Must be same length as the number of levels. |
| `levels_empty_color`       | `string`           | `rgba(200, 200, 200, 0.15)` | Color for empty/unfilled segments in the level circle. Any valid CSS color.                                                                      |
| `levels_gap_color`         | `string`           | `var(--card-background-color)` | Color for gaps between segments in the level circle. Any valid CSS color.                                                                    |
| `levels_thickness`         | `integer`          | `60`                     | Thickness of the level indicator circle, as percent of diameter (10–90).                                                                         |
| `levels_gap`               | `integer`          | `1`                      | Gap width (in px) between segments in the level indicator circle.                                                                                |
| `levels_text_color`        | `string`           | `var(--primary-text-color)` | Color for the number/text inside the level circle. Any valid CSS color.                                 |
| `levels_text_size`         | `number`           | `0.3`                    | Text size for the value inside the level circle (as a fraction of the icon size; 0.1–0.5).                                                      |
