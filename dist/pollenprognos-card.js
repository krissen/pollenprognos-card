 ...
 */
var xA;
const pA = window, iA = pA.trustedTypes, VA = iA ? iA.createPolicy("lit-html", { createHTML: (t) => t }) : void 0, HA = "$lit$", _ = `lit$${(Math.random() + "").slice(9)}$`, rg = "?" + _, ug = `<${rg}>`, eA = document, hA = () => eA.createComment(""), DA = (t) => t === null || typeof t != "object" && typeof t != "function", og = Array.isArray, fg = (t) => og(t) || typeof (t == null ? void 0 : t[Symbol.iterator]) == "function", wA = `[ 	
\f\r]`, lA = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, zA = /-->/g, NA = />/g, AA = RegExp(`>|${wA}(?:([^\\s"'>=/]+)(${wA}*=${wA}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), XA = /'/g, qA = /"/g, lg = /^(?:script|style|textarea|title)$/i, mg = (t) => (A, ...g) => ({ _$litType$: t, strings: A, values: g }), y = mg(1), aA = Symbol.for("lit-noChange"), W = Symbol.for("lit-nothing"), _A = /* @__PURE__ */ new WeakMap(), gA = eA.createTreeWalker(eA, 129, null, !1);
function sg(t, A) {
        ...
        if (n.hasAttributes()) {
          ...
          for (const r of n.getAttributeNames()) if (r.endsWith(HA) || r.startsWith(_)) {
            ...
            if (s.push(r), l !== void 0) {
              const p = n.getAttribute(l.toLowerCase() + HA).split(_), w = /([.?@])?(.*)/.exec(l);
              i.push({ type: 1, index: C, name: w[2], strings: p, ctor: w[1] === "." ? xg : w[1] === "?" ? yg : w[1] === "@" ? vg : fA });
...
const wg = iA ? iA.emptyScript : "";
class yg extends fA {
  constructor() {
    super(...arguments), this.type = 4;
  }
  j(A) {
    A && A !== W ? this.element.setAttribute(this.name, wg) : this.element.removeAttribute(this.name);
  }
}
class vg extends fA {
  constructor(A, g, e, n, C) {
...
CA.finalized = !0, CA._$litElement$ = !0, (yA = globalThis.litElementHydrateSupport) === null || yA === void 0 || yA.call(globalThis, { LitElement: CA });
...
const bA = (t, A = "_") => {
  ...
  "nettle_and_pellitory_-1_png": wI,
  ...
  __proto__: null,
  default: Fn
}, Symbol.toStringTag, { value: "Module" })), eg = /* @__PURE__ */ Object.assign({ "./locales/cs.json": Bn, "./locales/da.json": xn, "./locales/de.json": yn, "./locales/en.json": Rn, "./locales/fi.json": kn, "./locales/it.json": bn, "./locales/nl.json": Jn, "./locales/no.json": Yn, "./locales/ru.json": Gn, "./locales/sk.json": Wn, "./locales/sv.json": Ln }), oA = {};
for (const t in eg) {
    ...
    try {
      ...
      D.days = [], O.forEach((U, J) => {
        if (U.level !== null && U.level >= 0) {
          ...
          let c;
          a ? w[x] !== void 0 ? c = w[x] : x >= 0 && x <= 2 ? c = b(`card.days.${x}`, n) : c = U.date.toLocaleDateString(C, {
            day: "numeric",
            month: "short"
...
async function $n(t, A) {
  ...
  const l = i.no_information || b("card.no_information", e), p = i.days, w = A.integration === "dwd" ? 3 : A.integration === "peu" ? 4 : 6, H = (u) => {
    const E = Number(u);
    return isNaN(E) || E < 0 ? -1 : E > w ? w : E;
  }, B = /* @__PURE__ */ new Date();
  B.setHours(0, 0, 0, 0);
...
async function nt(t, A) {
  ...
  r.setHours(0, 0, 0, 0);
  const l = A.days_to_show ?? T.days_to_show, p = A.pollen_threshold ?? T.pollen_threshold, w = (A.location || "").toLowerCase(), H = Object.keys(t.states).filter((D) => {
...
async function tt(t, A, g = null) {
  ...
  const n = q(t, A.date_locale), C = A.date_locale || ((w = t.locale) == null ? void 0 : w.language) || t.language || `${n}-${n.toUpperCase()}`, a = A.pollen_threshold ?? T.pollen_threshold;
  if (e) {
...
async function at(t, A) {
  ...
  const I = q(t, A.date_locale), i = A.date_locale || ((Q = t.locale) == null ? void 0 : Q.language) || t.language || `${I}-${I.toUpperCase()}`, o = A.days_relative !== !1, h = !!A.days_abbreviated, s = !!A.days_uppercase, r = {
    ...
    no_information: "",
    ...A.phrases || {}
  }, l = r.full, p = r.short, w = r.levels, H = Array.isArray(w) && w.length === 7 ? w : Array.from({ length: 7 }, (d, S) => b(`card.levels.${S}`, I));
...
class rt extends CA {
  ...
  set hass(g) {
    ...
    if (this._integrationExplicit && Array.isArray(h) && h.length > 0 ? (this.debug && console.debug(
      ...
      const Q = q(g, null), D = ((H = (w = this._hass) == null ? void 0 : w.locale) == null ? void 0 : H.language) || ((B = this._hass) == null ? void 0 : B.language) || `${Q}-${Q.toUpperCase()}`;
  ...
  _renderMinimalHtml() {
    return y`
      ${this.header ? y`<div class="card-header">${this.header}</div>` : ""}
      ...
      return (i = this.config) != null && i.show_text_allergen && (C += (o = this.config) != null && o.allergens_abbreviated ? g.allergenShort ?? "" : g.allergenCapitalized ?? ""), (h = this.config) != null && h.show_value_text && ((s = this.config) != null && s.show_value_numeric) ? (C && (C += ": "), C += `${e} (${n})`) : (r = this.config) != null && r.show_value_text ? (C && (C += ": "), C += e) : (l = this.config) != null && l.show_value_numeric && (C && (C += " "), C += `(${n})`), y`
        ...
        (p = g.day0) == null ? void 0 : p.state
                ...
                />
                ${C ? y`<span class="short-text">${C}</span>` : ""}
              </div>
            `;
    })}
        </div>
  ...
  _renderNormalHtml() {
    ...
    return this.debug && console.debug("Display columns:", e), y`
      ${this.header ? y`<div class="card-header">${this.header}</div>` : ""}
      <div class="card-content">
        <div class="forecast-content">
          <table class="forecast"">
            <colgroup>
              ${[0, ...e].map(
      () => y`<col style="width: ${100 / (e.length + 1)}%;" />`
    )}
            </colgroup>
            <thead>
              <tr>
      ...
      (n) => {
        ...
        return y`
          ...
          (a) => {
            ...
            return y`
              ...
              (I = n.days[a]) == null ? void 0 : I.state
                          ...
                          />
                          ${this.config.show_value_numeric_in_circle ? y`<span class="circle-overlay">
                                ${((i = n.days[a]) == null ? void 0 : i.state) ?? ""}
                              </span>` : ""}
                        </div>
                      </td>
          ...
          let o = "";
          return this.config.show_value_text && this.config.show_value_numeric ? o = `${I} (${i})` : this.config.show_value_text ? o = I : this.config.show_value_numeric && (o = String(i)), y`<td>${o}</td>`;
        })}
                      </tr>
                    ` : ""}
              `;
  ...
  render() {
    ...
    if (this.sensors.length)
      ...
      let s = "";
      this._availableSensorCount === 0 ? s = this._t("card.error_no_sensors") : s = this._t("card.error_filtered_sensors"), g = y`<div class="card-error">${s} (${h})</div>`;
    }
...
class lt extends CA {
  ...
  set hass(A) {
    ...
    this.installedCities = JA.filter(
      ...
      new Map(
        Object.values(A.states).filter((l) => l.entity_id.startsWith("sensor.polleninformation_")).map((l) => {
          var H, B;
          const p = l.attributes.location_slug || l.entity_id.replace("sensor.polleninformation_", "").replace(/_[^_]+$/, ""), w = l.attributes.location_title || ((B = (H = l.attributes.friendly_name) == null ? void 0 : H.match(/\((.*?)\)/)) == null ? void 0 : B[1]) || p;
          return [p, w];
        })
      )
    ...
    if (this.debug) {
      ...
      for (const [p, w] of Object.entries(M.mapping))
    ...
    this.installedSilamLocations = Array.from(
      new Map(
        Object.values(A.states).filter((l) => {
          ...
          const p = l.entity_id.match(
            /^sensor\.silam_pollen_(.*)_([^_]+)$/
          ), w = p ? p[1].replace(/^[-\s]+/, "") : "", H = bA(w);
          let B = l.attributes.location_title || (l.attributes.friendly_name ? l.attributes.friendly_name.replace(/^SILAM Pollen\s*-?\s*/i, "").replace(new RegExp("\\s+\\p{L}+$", "u"), "").trim() : "") || w;
  ...
  render() {
    ...
    return this.debug && (console.debug("Aktuellt språk (lang):", this._lang), console.debug("Sort label test:", this._t("sort_value_ascending"))), y`
      ...
      ([I, i]) => y`<mwc-list-item .value=${I}
                          >${i}</mwc-list-item
                        >`
    )}
                  </ha-select>
                </ha-formfield>
              ` : A.integration === "silam" ? y`
                  <ha-formfield label="${this._t("location")}">
                    <ha-select
                      .value=${A.location || ""}
                      @selected=${(I) => this._updateConfig("location", I.target.value)}
      ...
      i.trim() === "" ? this._updateConfig("title", !0) : this._updateConfig("title", i);
        ...
        <!-- Layout-switchar -->
        ${A.integration === "silam" && this._hasSilamWeatherEntity(A.location) ? y`
      ...
      I.target.checked
        ...
        <ha-formfield label="${this._t("sort")}">
          ...
          >
            ${a.map(
      ({ value: I, label: i }) => y`<mwc-list-item .value=${I}>${i}</mwc-list-item>`
    )}
          </ha-select>
        </ha-formfield>
