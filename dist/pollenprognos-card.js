...
var dg = (n, A, g) => A in n ? hg(n, A, { enumerable: !0, configurable: !0, writable: !0, value: g }) : n[A] = g;
var mA = (n, A, g) => dg(n, typeof A != "symbol" ? A + "" : A, g);
 ...
 */
var BA;
const cA = window, KA = cA.trustedTypes, Eg = KA ? KA.emptyScript : "", VA = cA.reactiveElementPolyfillSupport, jA = { toAttribute(n, A) {
  switch (A) {
    case Boolean:
      n = n ? Eg : null;
      break;
  ...
  return g;
} }, ig = (n, A) => A !== n && (A == A || n == n), UA = { attribute: !0, type: String, converter: jA, reflect: !1, hasChanged: ig }, kA = "finalized";
let nA = class extends HTMLElement {
  ...
  createRenderRoot() {
    ...
    return Sg(g, this.constructor.elementStyles), g;
  }
  connectedCallback() {
    var A;
  ...
  requestUpdate(A, g, I) {
    let C = !0;
    A !== void 0 && (((I = I || this.constructor.getPropertyOptions(A)).hasChanged || ig)(this[A], g) ? (this._$AL.has(A) || this._$AL.set(A, g), I.reflect === !0 && this._$El !== A && (this._$EC === void 0 && (this._$EC = /* @__PURE__ */ new Map()), this._$EC.set(A, I))) : C = !1), !this.isUpdatePending && C && (this._$E_ = this._$Ej());
  }
  async _$Ej() {
...
nA[kA] = !0, nA.elementProperties = /* @__PURE__ */ new Map(), nA.elementStyles = [], nA.shadowRootOptions = { mode: "open" }, VA == null || VA({ ReactiveElement: nA }), ((BA = cA.reactiveElementVersions) !== null && BA !== void 0 ? BA : cA.reactiveElementVersions = []).push("1.6.3");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
var xA;
const pA = window, rA = pA.trustedTypes, TA = rA ? rA.createPolicy("lit-html", { createHTML: (n) => n }) : void 0, HA = "$lit$", _ = `lit$${(Math.random() + "").slice(9)}$`, rg = "?" + _, cg = `<${rg}>`, IA = document, hA = () => IA.createComment(""), dA = (n) => n === null || typeof n != "object" && typeof n != "function", ag = Array.isArray, pg = (n) => ag(n) || typeof (n == null ? void 0 : n[Symbol.iterator]) == "function", yA = `[ 	
\f\r]`, sA = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, zA = /-->/g, NA = />/g, gA = RegExp(`>|${yA}(?:([^\\s"'>=/]+)(${yA}*=${yA}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), XA = /'/g, qA = /"/g, lg = /^(?:script|style|textarea|title)$/i, ug = (n) => (A, ...g) => ({ _$litType$: n, strings: A, values: g }), v = ug(1), aA = Symbol.for("lit-noChange"), W = Symbol.for("lit-nothing"), _A = /* @__PURE__ */ new WeakMap(), eA = IA.createTreeWalker(IA, 129, null, !1);
function og(n, A) {
...
const fg = (n, A) => {
  ...
  for (let a = 0; a < g; a++) {
    const i = n[a];
    let l, d, S = -1, r = 0;
    for (; r < i.length && (t.lastIndex = r, d = t.exec(i), d !== null); ) r = t.lastIndex, t === sA ? d[1] === "!--" ? t = zA : d[1] !== void 0 ? t = NA : d[2] !== void 0 ? (lg.test(d[2]) && (C = RegExp("</" + d[2], "g")), t = gA) : d[3] !== void 0 && (t = gA) : t === gA ? d[0] === ">" ? (t = C ?? sA, S = -1) : d[1] === void 0 ? S = -2 : (S = t.lastIndex - d[2].length, l = d[1], t = d[3] === void 0 ? gA : d[3] === '"' ? qA : XA) : t === qA || t === XA ? t = gA : t === zA || t === NA ? t = sA : (t = gA, C = void 0);
    const o = t === gA && n[a + 1].startsWith("/>") ? " " : "";
    e += t === sA ? i + cg : S >= 0 ? (I.push(l), i.slice(0, S) + HA + i.slice(S) + _ + o) : i + _ + (S === -2 ? (I.push(void 0), a) : o);
  }
  return [og(n, e + (n[g] || "<?>") + (A === 2 ? "</svg>" : "")), I];
};
class QA {
  constructor({ strings: A, _$litType$: g }, I) {
    ...
    this.parts = [];
    let e = 0, t = 0;
    const a = A.length - 1, i = this.parts, [l, d] = fg(A, g);
    ...
    for (; (C = eA.nextNode()) !== null && i.length < a; ) {
        ...
        if (C.hasAttributes()) {
          ...
          for (const r of C.getAttributeNames()) if (r.endsWith(HA) || r.startsWith(_)) {
            ...
            if (S.push(r), o !== void 0) {
              ...
              i.push({ type: 1, index: e, name: x[2], strings: c, ctor: x[1] === "." ? Bg : x[1] === "?" ? xg : x[1] === "@" ? yg : fA });
            } else i.push({ type: 6, index: e });
          }
          for (const r of S) C.removeAttribute(r);
        }
        if (lg.test(C.tagName)) {
      ...
      } else if (C.nodeType === 8) if (C.data === rg) i.push({ type: 2, index: e });
      else {
        let S = -1;
...
class mg {
  ...
  u(A) {
    ...
    for (; l !== void 0; ) {
      if (a === l.index) {
        let d;
        l.type === 2 ? d = new SA(t, t.nextSibling, this, A) : l.type === 1 ? d = new l.ctor(t, l.name, l.strings, this, A) : l.type === 6 && (d = new wg(t, this, A)), this._$AV.push(d), l = C[++i];
      }
...
class SA {
  ...
  _$AI(A, g = this) {
    A = lA(this, A, g), dA(A) ? A === W || A == null || A === "" ? (this._$AH !== W && this._$AR(), this._$AH = W) : A !== this._$AH && A !== aA && this._(A) : A._$litType$ !== void 0 ? this.g(A) : A.nodeType !== void 0 ? this.$(A) : pg(A) ? this.T(A) : this._(A);
  }
  k(A) {
  ...
  g(A) {
    var g;
    const { values: I, _$litType$: C } = A, e = typeof C == "number" ? this._$AC(A) : (C.el === void 0 && (C.el = QA.createElement(og(C.h, C.h[0]), this.options)), C);
    if (((g = this._$AH) === null || g === void 0 ? void 0 : g._$AD) === e) this._$AH.v(I);
    else {
      const t = new mg(e, this), a = t.u(this.options);
...
class iA extends nA {
  ...
  update(A) {
    const g = this.render();
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(A), this._$Do = vg(g, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
    var A;
...
const bA = (n, A = "_") => {
  ...
  mold_spores_0_png: eI,
  mold_spores_1_png: II,
  mold_spores_2_png: CI,
  mold_spores_3_png: nI,
  mold_spores_4_png: tI,
  mold_spores_5_png: iI,
  mold_spores_6_png: rI,
  // mugwort
  "mugwort_-1_png": SI,
  mugwort_0_png: lI,
  mugwort_1_png: oI,
  ...
  nettle_and_pellitory_0_png: EI,
  nettle_and_pellitory_1_png: cI,
  nettle_and_pellitory_2_png: pI,
  nettle_and_pellitory_3_png: uI,
  nettle_and_pellitory_4_png: fI,
  nettle_and_pellitory_5_png: mI,
  nettle_and_pellitory_6_png: BI,
  // oak
  "oak_-1_png": HI,
  oak_0_png: xI,
  oak_1_png: yI,
  ...
  __proto__: null,
  default: GC
}, Symbol.toStringTag, { value: "Module" })), eg = /* @__PURE__ */ Object.assign({ "./locales/cs.json": uC, "./locales/da.json": mC, "./locales/de.json": UC, "./locales/en.json": yC, "./locales/fi.json": vC, "./locales/it.json": jC, "./locales/nl.json": HC, "./locales/no.json": JC, "./locales/ru.json": YC, "./locales/sk.json": MC, "./locales/sv.json": ZC }), oA = {};
for (const n in eg) {
...
const FC = "state_tomorrow", LC = "state_in_2_days", KC = "state_today_desc", VC = "state_tomorrow_desc", TC = "state_in_2_days_desc", V = {
  integration: "dwd",
  region_id: "",
  allergens: [
    "erle",
...
async function zC(n, A) {
  const g = !!A.debug, I = (Q) => Q.charAt(0).toUpperCase() + Q.slice(1), C = q(n, A.date_locale), e = A.date_locale || V.date_locale, t = A.days_relative !== !1, a = !!A.days_abbreviated, i = !!A.days_uppercase, l = A.phrases || {}, d = l.full || {}, S = l.short || {}, r = l.levels, o = Array.isArray(r) && r.length === 7 ? r : Array.from({ length: 7 }, (Q, s) => J(`card.levels.${s}`, C)), c = l.no_information || J("card.no_information", C), x = l.days || {}, b = A.days_to_show ?? V.days_to_show, f = A.pollen_threshold ?? V.pollen_threshold;
  ...
  for (const Q of A.allergens)
    try {
      ...
      const m = n.states[E], y = R(m.state), j = R(m.attributes[FC]), B = R(m.attributes[LC]), O = [
        { date: P, level: y },
      ...
      s.days = [], O.forEach((U, H) => {
        ...
        const w = m.attributes[H === 0 ? KC : H === 1 ? VC : TC] || "", G = U.level * 2, F = Math.min(Math.max(Math.round(G), 0), 6), N = F < 0 ? c : o[F] || w;
        s[`day${H}`] = {
...
async function XC(n, A) {
  ...
  f.setHours(0, 0, 0, 0);
  const R = A.days_to_show ?? T.days_to_show, P = A.pollen_threshold ?? T.pollen_threshold, M = Object.keys(n.states).filter(
...
class tn extends iA {
      ...
      I ? (this._forecastUnsub = this._hass.connection.subscribeMessage(
        (C) => {
          this.debug && console.debug(
            ...
            C
          ), this._forecastEvent = C, this._updateSensorsAfterForecastEvent(), this.requestUpdate();
        },
        {
  ...
  _updateSensorsAfterForecastEvent() {
    if (this.config && this.config.integration === "silam" && this.config.mode === "hourly" && this._forecastEvent) {
      ...
      typeof g.fetchHourlyForecast == "function" && g.fetchHourlyForecast(this._hass, this.config, this._forecastEvent).then((I) => {
        this.sensors = I, this.requestUpdate();
      });
    }
  }
  disconnectedCallback() {
  ...
  setConfig(g) {
    ...
    I === "pp" ? C = L : I === "peu" ? C = T : I === "dwd" ? C = V : I === "silam" ? C = K : C = L;
  ...
  set hass(g) {
    ...
    let l;
    i === "dwd" ? l = V : i === "peu" ? l = T : i === "pp" ? l = L : i === "silam" ? l = K : console.error("Unknown integration:", i);
    ...
    if (c)
      return c.then((Q) => {
        ...
        const s = nn(r, g, this.debug), p = s.length;
        let u = {};
...
const DA = (n, A) => {
  ...
  return g;
}, rn = (n) => n === "dwd" ? V : n === "peu" ? T : n === "silam" ? K : L;
class an extends iA {
  get debug() {
  ...
  setConfig(A) {
    ...
    try {
      ...
      const i = (e.integration === "dwd" ? V : e.integration === "peu" ? T : e.integration === "silam" ? K : L).date_locale;
