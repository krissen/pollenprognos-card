 ...
 */
const SA = window, bA = SA.ShadowRoot && (SA.ShadyCSS === void 0 || SA.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, JA = Symbol(), YA = /* @__PURE__ */ new WeakMap();
let $A = class {
  constructor(A, e, I) {
  ...
  get styleSheet() {
    ...
    if (bA && A === void 0) {
      ...
      I && (A = YA.get(e)), A === void 0 && ((this.o = A = new CSSStyleSheet()).replaceSync(this.cssText), I && YA.set(e, A));
    }
    return A;
  }
  toString() {
...
const ig = (t) => new $A(typeof t == "string" ? t : t + "", void 0, JA), Ag = (t, ...A) => {
  const e = t.length === 1 ? t[0] : A.reduce((I, C, g) => I + ((n) => {
  ...
  bA ? t.adoptedStyleSheets = A.map((e) => e instanceof CSSStyleSheet ? e : e.styleSheet) : A.forEach((e) => {
    const I = document.createElement("style"), C = SA.litNonce;
    C !== void 0 && I.setAttribute("nonce", C), I.textContent = e.cssText, t.appendChild(I);
  });
}, PA = bA ? (t) => t : (t) => t instanceof CSSStyleSheet ? ((A) => {
  let e = "";
 ...
 */
var fA;
const EA = window, MA = EA.trustedTypes, ag = MA ? MA.emptyScript : "", GA = EA.reactiveElementPolyfillSupport, yA = { toAttribute(t, A) {
  switch (A) {
    case Boolean:
      t = t ? ag : null;
      break;
  ...
  return e;
} }, gg = (t, A) => A !== t && (A == A || t == t), mA = { attribute: !0, type: String, converter: yA, reflect: !1, hasChanged: gg }, vA = "finalized";
let nA = class extends HTMLElement {
  ...
  static getPropertyDescriptor(A, e, I) {
    return { get() {
      ...
      const g = this[A];
      this[e] = C, this.requestUpdate(A, g, I);
    }, configurable: !0, enumerable: !0 };
  }
  static getPropertyOptions(A) {
    return this.elementProperties.get(A) || mA;
  }
  static finalize() {
    if (this.hasOwnProperty(vA)) return !1;
    this[vA] = !0;
    ...
    if (A.finalize(), A.h !== void 0 && (this.h = [...A.h]), this.elementProperties = new Map(A.elementProperties), this._$Ev = /* @__PURE__ */ new Map(), this.hasOwnProperty("properties")) {
      ...
      for (const C of I) this.createProperty(C, e[C]);
    }
  ...
  static finalizeStyles(A) {
    ...
    if (Array.isArray(A)) {
      ...
      for (const C of I) e.unshift(PA(C));
    } else A !== void 0 && e.push(PA(A));
    return e;
  }
  static _$Ep(A, e) {
    const I = e.attribute;
  ...
  createRenderRoot() {
    ...
    return rg(e, this.constructor.elementStyles), e;
  }
  connectedCallback() {
    var A;
  ...
  _$EO(A, e, I = mA) {
    var C;
    const g = this.constructor._$Ep(A, I);
    if (g !== void 0 && I.reflect === !0) {
      const n = (((C = I.converter) === null || C === void 0 ? void 0 : C.toAttribute) !== void 0 ? I.converter : yA).toAttribute(e, I.type);
      this._$El = A, n == null ? this.removeAttribute(g) : this.setAttribute(g, n), this._$El = null;
    }
  }
  _$AK(A, e) {
    var I;
    const C = this.constructor, g = C._$Ev.get(A);
    if (g !== void 0 && this._$El !== g) {
      const n = C.getPropertyOptions(g), i = typeof n.converter == "function" ? { fromAttribute: n.converter } : ((I = n.converter) === null || I === void 0 ? void 0 : I.fromAttribute) !== void 0 ? n.converter : yA;
      this._$El = g, this[g] = i.fromAttribute(e, n.type), this._$El = null;
    }
  }
  requestUpdate(A, e, I) {
    let C = !0;
    A !== void 0 && (((I = I || this.constructor.getPropertyOptions(A)).hasChanged || gg)(this[A], e) ? (this._$AL.has(A) || this._$AL.set(A, e), I.reflect === !0 && this._$El !== A && (this._$EC === void 0 && (this._$EC = /* @__PURE__ */ new Map()), this._$EC.set(A, I))) : C = !1), !this.isUpdatePending && C && (this._$E_ = this._$Ej());
  }
  async _$Ej() {
  ...
  performUpdate() {
    ...
    this.hasUpdated, this._$Ei && (this._$Ei.forEach((C, g) => this[g] = C), this._$Ei = void 0);
    let e = !1;
    const I = this._$AL;
    try {
      e = this.shouldUpdate(I), e ? (this.willUpdate(I), (A = this._$ES) === null || A === void 0 || A.forEach((C) => {
        var g;
        return (g = C.hostUpdate) === null || g === void 0 ? void 0 : g.call(C);
      }), this.update(I)) : this._$Ek();
    } catch (C) {
      throw e = !1, this._$Ek(), C;
    }
    e && this._$AE(I);
  }
  willUpdate(A) {
...
nA[vA] = !0, nA.elementProperties = /* @__PURE__ */ new Map(), nA.elementStyles = [], nA.shadowRootOptions = { mode: "open" }, GA == null || GA({ ReactiveElement: nA }), ((fA = EA.reactiveElementVersions) !== null && fA !== void 0 ? fA : EA.reactiveElementVersions = []).push("1.6.3");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
var BA;
const pA = window, iA = pA.trustedTypes, ZA = iA ? iA.createPolicy("lit-html", { createHTML: (t) => t }) : void 0, RA = "$lit$", q = `lit$${(Math.random() + "").slice(9)}$`, eg = "?" + q, lg = `<${eg}>`, IA = document, DA = () => IA.createComment(""), hA = (t) => t === null || typeof t != "object" && typeof t != "function", Ig = Array.isArray, og = (t) => Ig(t) || typeof (t == null ? void 0 : t[Symbol.iterator]) == "function", UA = `[ 	
\f\r]`, oA = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, WA = /-->/g, FA = />/g, gA = RegExp(`>|${UA}(?:([^\\s"'>=/]+)(${UA}*=${UA}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), LA = /'/g, KA = /"/g, Cg = /^(?:script|style|textarea|title)$/i, sg = (t) => (A, ...e) => ({ _$litType$: t, strings: A, values: e }), R = sg(1), rA = Symbol.for("lit-noChange"), Z = Symbol.for("lit-nothing"), VA = /* @__PURE__ */ new WeakMap(), eA = IA.createTreeWalker(IA, 129, null, !1);
function ng(t, A) {
...
const Dg = (t, A) => {
  ...
  let C, g = A === 2 ? "<svg>" : "", n = oA;
  for (let i = 0; i < e; i++) {
    const a = t[i];
    let l, Q, r = -1, E = 0;
    for (; E < a.length && (n.lastIndex = E, Q = n.exec(a), Q !== null); ) E = n.lastIndex, n === oA ? Q[1] === "!--" ? n = WA : Q[1] !== void 0 ? n = FA : Q[2] !== void 0 ? (Cg.test(Q[2]) && (C = RegExp("</" + Q[2], "g")), n = gA) : Q[3] !== void 0 && (n = gA) : n === gA ? Q[0] === ">" ? (n = C ?? oA, r = -1) : Q[1] === void 0 ? r = -2 : (r = n.lastIndex - Q[2].length, l = Q[1], n = Q[3] === void 0 ? gA : Q[3] === '"' ? KA : LA) : n === KA || n === LA ? n = gA : n === WA || n === FA ? n = oA : (n = gA, C = void 0);
    const o = n === gA && t[i + 1].startsWith("/>") ? " " : "";
    g += n === oA ? a + lg : r >= 0 ? (I.push(l), a.slice(0, r) + RA + a.slice(r) + q + o) : a + q + (r === -2 ? (I.push(void 0), i) : o);
  }
  return [ng(t, g + (t[e] || "<?>") + (A === 2 ? "</svg>" : "")), I];
};
class dA {
  constructor({ strings: A, _$litType$: e }, I) {
    ...
    this.parts = [];
    let g = 0, n = 0;
    const i = A.length - 1, a = this.parts, [l, Q] = Dg(A, e);
    if (this.el = dA.createElement(l, I), eA.currentNode = this.el.content, e === 2) {
      const r = this.el.content, E = r.firstChild;
      E.remove(), r.append(...E.childNodes);
    }
    for (; (C = eA.nextNode()) !== null && a.length < i; ) {
      if (C.nodeType === 1) {
        if (C.hasAttributes()) {
          const r = [];
          for (const E of C.getAttributeNames()) if (E.endsWith(RA) || E.startsWith(q)) {
            const o = Q[n++];
            if (r.push(E), o !== void 0) {
              const c = C.getAttribute(o.toLowerCase() + RA).split(q), w = /([.?@])?(.*)/.exec(o);
              a.push({ type: 1, index: g, name: w[2], strings: c, ctor: w[1] === "." ? dg : w[1] === "?" ? Sg : w[1] === "@" ? Eg : uA });
            } else a.push({ type: 6, index: g });
          }
          for (const E of r) C.removeAttribute(E);
        }
        if (Cg.test(C.tagName)) {
          const r = C.textContent.split(q), E = r.length - 1;
          if (E > 0) {
            C.textContent = iA ? iA.emptyScript : "";
            for (let o = 0; o < E; o++) C.append(r[o], DA()), eA.nextNode(), a.push({ type: 2, index: ++g });
            C.append(r[E], DA());
          }
        }
      } else if (C.nodeType === 8) if (C.data === eg) a.push({ type: 2, index: g });
      else {
        let r = -1;
        for (; (r = C.data.indexOf(q, r + 1)) !== -1; ) a.push({ type: 7, index: g }), r += q.length - 1;
      }
      g++;
    }
  }
...
function aA(t, A, e = t, I) {
  var C, g, n, i;
  if (A === rA) return A;
  let a = I !== void 0 ? (C = e._$Co) === null || C === void 0 ? void 0 : C[I] : e._$Cl;
  const l = hA(A) ? void 0 : A._$litDirective$;
  return (a == null ? void 0 : a.constructor) !== l && ((g = a == null ? void 0 : a._$AO) === null || g === void 0 || g.call(a, !1), l === void 0 ? a = void 0 : (a = new l(t), a._$AT(t, e, I)), I !== void 0 ? ((n = (i = e)._$Co) !== null && n !== void 0 ? n : i._$Co = [])[I] = a : e._$Cl = a), a !== void 0 && (A = aA(t, a._$AS(t, A.values), a, I)), A;
}
class hg {
  constructor(A, e) {
  ...
  u(A) {
    var e;
    const { el: { content: I }, parts: C } = this._$AD, g = ((e = A == null ? void 0 : A.creationScope) !== null && e !== void 0 ? e : IA).importNode(I, !0);
    eA.currentNode = g;
    let n = eA.nextNode(), i = 0, a = 0, l = C[0];
    for (; l !== void 0; ) {
      if (i === l.index) {
        let Q;
        l.type === 2 ? Q = new QA(n, n.nextSibling, this, A) : l.type === 1 ? Q = new l.ctor(n, l.name, l.strings, this, A) : l.type === 6 && (Q = new pg(n, this, A)), this._$AV.push(Q), l = C[++a];
      }
      i !== (l == null ? void 0 : l.index) && (n = eA.nextNode(), i++);
    }
    return eA.currentNode = IA, g;
  }
  v(A) {
    let e = 0;
...
class QA {
  constructor(A, e, I, C) {
    var g;
    this.type = 2, this._$AH = Z, this._$AN = void 0, this._$AA = A, this._$AB = e, this._$AM = I, this.options = C, this._$Cp = (g = C == null ? void 0 : C.isConnected) === null || g === void 0 || g;
  }
  get _$AU() {
    var A, e;
  ...
  get parentNode() {
    ...
    const e = this._$AM;
    return e !== void 0 && (A == null ? void 0 : A.nodeType) === 11 && (A = e.parentNode), A;
  }
  get startNode() {
    return this._$AA;
  }
  ...
  _$AI(A, e = this) {
    A = aA(this, A, e), hA(A) ? A === Z || A == null || A === "" ? (this._$AH !== Z && this._$AR(), this._$AH = Z) : A !== this._$AH && A !== rA && this._(A) : A._$litType$ !== void 0 ? this.g(A) : A.nodeType !== void 0 ? this.$(A) : og(A) ? this.T(A) : this._(A);
  }
  k(A) {
  ...
  _(A) {
    this._$AH !== Z && hA(this._$AH) ? this._$AA.nextSibling.data = A : this.$(IA.createTextNode(A)), this._$AH = A;
  }
  g(A) {
    var e;
    const { values: I, _$litType$: C } = A, g = typeof C == "number" ? this._$AC(A) : (C.el === void 0 && (C.el = dA.createElement(ng(C.h, C.h[0]), this.options)), C);
    if (((e = this._$AH) === null || e === void 0 ? void 0 : e._$AD) === g) this._$AH.v(I);
    else {
      const n = new hg(g, this), i = n.u(this.options);
      n.v(I), this.$(i), this._$AH = n;
    }
  }
  _$AC(A) {
    let e = VA.get(A.strings);
    return e === void 0 && VA.set(A.strings, e = new dA(A)), e;
  }
  T(A) {
    Ig(this._$AH) || (this._$AH = [], this._$AR());
    const e = this._$AH;
    let I, C = 0;
    for (const g of A) C === e.length ? e.push(I = new QA(this.k(DA()), this.k(DA()), this, this.options)) : I = e[C], I._$AI(g), C++;
    C < e.length && (this._$AR(I && I._$AB.nextSibling, C), e.length = C);
  }
...
class uA {
  constructor(A, e, I, C, g) {
    this.type = 1, this._$AH = Z, this._$AN = void 0, this.element = A, this.name = e, this._$AM = C, this.options = g, I.length > 2 || I[0] !== "" || I[1] !== "" ? (this._$AH = Array(I.length - 1).fill(new String()), this.strings = I) : this._$AH = Z;
  }
  get tagName() {
  ...
  _$AI(A, e = this, I, C) {
    ...
    let n = !1;
    if (g === void 0) A = aA(this, A, e, 0), n = !hA(A) || A !== this._$AH && A !== rA, n && (this._$AH = A);
    else {
      const i = A;
      let a, l;
      for (A = g[0], a = 0; a < g.length - 1; a++) l = aA(this, i[I + a], e, a), l === rA && (l = this._$AH[a]), n || (n = !hA(l) || l !== this._$AH[a]), l === Z ? A = Z : A !== Z && (A += (l ?? "") + g[a + 1]), this._$AH[a] = l;
    }
    n && !C && this.j(A);
  }
  j(A) {
    A === Z ? this.element.removeAttribute(this.name) : this.element.setAttribute(this.name, A ?? "");
  }
}
class dg extends uA {
  constructor() {
  ...
  j(A) {
    this.element[this.name] = A === Z ? void 0 : A;
  }
}
const Qg = iA ? iA.emptyScript : "";
class Sg extends uA {
  constructor() {
    super(...arguments), this.type = 4;
  }
  j(A) {
    A && A !== Z ? this.element.setAttribute(this.name, Qg) : this.element.removeAttribute(this.name);
  }
}
class Eg extends uA {
  constructor(A, e, I, C, g) {
    super(A, e, I, C, g), this.type = 5;
  }
  _$AI(A, e = this) {
    var I;
    if ((A = (I = aA(this, A, e, 0)) !== null && I !== void 0 ? I : Z) === rA) return;
    const C = this._$AH, g = A === Z && C !== Z || A.capture !== C.capture || A.once !== C.once || A.passive !== C.passive, n = A !== Z && (C === Z || g);
    g && this.element.removeEventListener(this.name, this, C), n && this.element.addEventListener(this.name, this, A), this._$AH = A;
  }
  handleEvent(A) {
    var e, I;
...
const TA = pA.litHtmlPolyfillSupport;
TA == null || TA(dA, QA), ((BA = pA.litHtmlVersions) !== null && BA !== void 0 ? BA : pA.litHtmlVersions = []).push("2.8.0");
const cg = (t, A, e) => {
  var I, C;
  const g = (I = e == null ? void 0 : e.renderBefore) !== null && I !== void 0 ? I : A;
  let n = g._$litPart$;
  if (n === void 0) {
    const i = (C = e == null ? void 0 : e.renderBefore) !== null && C !== void 0 ? C : null;
    g._$litPart$ = n = new QA(A.insertBefore(DA(), i), i, void 0, e ?? {});
  }
  return n._$AI(t), n;
};
/**
...
class tA extends nA {
  ...
  update(A) {
    const e = this.render();
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(A), this._$Do = cg(e, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
    var A;
...
tA.finalized = !0, tA._$litElement$ = !0, (xA = globalThis.litElementHydrateSupport) === null || xA === void 0 || xA.call(globalThis, { LitElement: tA });
const zA = globalThis.litElementPolyfillSupport;
zA == null || zA({ LitElement: tA });
((wA = globalThis.litElementVersions) !== null && wA !== void 0 ? wA : globalThis.litElementVersions = []).push("3.3.3");
const jA = (t, A = "_") => {
  const e = "àáâäæãåāăąабçćčđďдèéêëēėęěеёэфğǵгḧхîïíīįìıİийкłлḿмñńǹňнôöòóœøōõőоṕпŕřрßśšşșсťțтûüùúūǘůűųувẃẍÿýыžźżз·", I = `aaaaaaaaaaabcccdddeeeeeeeeeeefggghhiiiiiiiiijkllmmnnnnnoooooooooopprrrsssssstttuuuuuuuuuuvwxyyyzzzz${A}`, C = new RegExp(e.split("").join("|"), "g"), g = {
    ж: "zh",
    х: "kh",
    ц: "ts",
    ч: "ch",
  ...
  lime_6_png: Ke,
  // mold_spores
  "mold_spores_-1_png": AI,
  mold_spores_0_png: Te,
  mold_spores_1_png: ze,
  mold_spores_2_png: Ne,
  mold_spores_3_png: Xe,
  mold_spores_4_png: qe,
  mold_spores_5_png: _e,
  mold_spores_6_png: $e,
  // mugwort
  "mugwort_-1_png": rI,
  mugwort_0_png: gI,
  ...
  "nettle_and_pellitory_-1_png": QI,
  nettle_and_pellitory_0_png: aI,
  nettle_and_pellitory_1_png: lI,
  nettle_and_pellitory_2_png: oI,
  nettle_and_pellitory_3_png: sI,
  nettle_and_pellitory_4_png: DI,
  nettle_and_pellitory_5_png: hI,
  nettle_and_pellitory_6_png: dI,
  // oak
  "oak_-1_png": BI,
  oak_0_png: SI,
  oak_1_png: EI,
  ...
  __proto__: null,
  default: jC
}, Symbol.toStringTag, { value: "Module" })), XA = /* @__PURE__ */ Object.assign({ "./locales/cs.json": sC, "./locales/da.json": hC, "./locales/de.json": QC, "./locales/en.json": EC, "./locales/fi.json": cC, "./locales/it.json": fC, "./locales/nl.json": BC, "./locales/no.json": xC, "./locales/ru.json": yC, "./locales/sk.json": RC, "./locales/sv.json": kC }), lA = {};
for (const t in XA) {
  const A = t.match(/\.\/locales\/([\w-]+)\.json$/);
  A && (lA[A[1]] = XA[t].default);
}
const kA = "en";
function qA(t, A) {
  return A.split(".").reduce((e, I) => e && typeof e == "object" ? e[I] : void 0, t);
}
function $(t, A) {
  var C;
  let e = A || ((C = t == null ? void 0 : t.locale) == null ? void 0 : C.language) || (t == null ? void 0 : t.language) || kA;
  if (lA[e])
    return e;
  const I = e.slice(0, 2).toLowerCase();
  return lA[I] ? I : kA;
}
const HC = Object.keys(lA);
function J(t, A) {
  const e = lA[A] || {};
  if (e[t] !== void 0)
    return e[t];
...
const bC = "state_tomorrow", JC = "state_in_2_days", OC = "state_today_desc", YC = "state_tomorrow_desc", PC = "state_in_2_days_desc", L = {
  integration: "dwd",
  region_id: "",
  allergens: [
    "erle",
...
async function MC(t, A) {
  const e = !!A.debug, I = (f) => f.charAt(0).toUpperCase() + f.slice(1), C = $(t, A.date_locale), g = A.date_locale || L.date_locale, n = A.days_relative !== !1, i = !!A.days_abbreviated, a = !!A.days_uppercase, l = A.phrases || {}, Q = l.full || {}, r = l.short || {}, E = l.levels, o = Array.isArray(E) && E.length === 7 ? E : Array.from({ length: 7 }, (f, p) => J(`card.levels.${p}`, C)), c = l.no_information || J("card.no_information", C), w = l.days || {}, O = A.days_to_show ?? L.days_to_show, b = A.pollen_threshold ?? L.pollen_threshold;
  e && console.debug("DWD adapter: start fetchForecast", { config: A, lang: C });
  const G = (f) => {
    const p = Number(f);
    return isNaN(p) ? -1 : p;
  }, u = /* @__PURE__ */ new Date();
  u.setHours(0, 0, 0, 0);
  const j = [];
  for (const f of A.allergens)
    try {
      const p = {}, v = cA(f);
      p.allergenReplaced = v;
      const x = CA[v] || v, S = Q[f];
      if (S)
        p.allergenCapitalized = S;
      else {
        const P = `card.allergen.${CA[v] || v}`, y = J(P, C);
        p.allergenCapitalized = y !== P ? y : I(f);
      }
      if (A.allergens_abbreviated) {
        const m = r[f];
        p.allergenShort = m || J(`editor.phrases_short.${x}`, C) || p.allergenCapitalized;
      } else
        p.allergenShort = p.allergenCapitalized;
      let D = A.region_id ? `sensor.pollenflug_${v}_${A.region_id}` : null;
      if (!D || !t.states[D]) {
        const m = Object.keys(t.states).filter(
          (P) => P.startsWith(`sensor.pollenflug_${v}_`)
        );
        if (m.length === 1) D = m[0];
        else continue;
      }
      const h = t.states[D], s = G(h.state), B = G(h.attributes[bC]), k = G(h.attributes[JC]), F = [
        { date: u, level: s },
        { date: new Date(u.getTime() + 864e5), level: B },
        { date: new Date(u.getTime() + 2 * 864e5), level: k }
      ];
      for (; F.length < O; ) {
        const m = F.length;
        F.push({
          date: new Date(u.getTime() + m * 864e5),
          level: -1
        });
      }
      p.days = [], F.forEach((m, P) => {
        const y = Math.round((m.date - u) / 864e5);
        let d;
        n ? w[y] !== void 0 ? d = w[y] : y >= 0 && y <= 2 ? d = J(`card.days.${y}`, C) : d = m.date.toLocaleDateString(g, {
          day: "numeric",
          month: "short"
        }) : (d = m.date.toLocaleDateString(g, {
          weekday: i ? "short" : "long"
        }), d = d.charAt(0).toUpperCase() + d.slice(1)), a && (d = d.toUpperCase());
        const U = h.attributes[P === 0 ? OC : P === 1 ? YC : PC] || "", Y = m.level * 2, H = Math.min(Math.max(Math.round(Y), 0), 6), T = H < 0 ? c : o[H] || U;
        p[`day${P}`] = {
      ...
      }), (F.slice(0, O).some((m) => m.level >= b) || b === 0) && j.push(p);
    } catch (p) {
      console.warn(`DWD adapter error for allergen ${f}:`, p);
    }
  return j.sort(
    {
      value_ascending: (f, p) => f.day0.state - p.day0.state,
      value_descending: (f, p) => p.day0.state - f.day0.state,
      name_descending: (f, p) => p.allergenCapitalized.localeCompare(f.allergenCapitalized)
    }[A.sort] || ((f, p) => p.day0.state - f.day0.state)
  ), e && console.debug("DWD adapter complete sensors:", j), j;
}
...
async function ZC(t, A) {
  var v, x;
  const e = !!A.debug, I = $(t, A.date_locale), C = A.date_locale || ((v = t.locale) == null ? void 0 : v.language) || t.language || `${I}-${I.toUpperCase()}`, g = A.days_relative !== !1, n = !!A.days_abbreviated, i = !!A.days_uppercase, a = {
    full: {},
    short: {},
    levels: [],
    days: {},
    no_information: "",
    ...A.phrases || {}
  }, l = a.full, Q = a.short, r = a.levels, E = 5;
  Array.isArray(r) && r.length === E || Array.from(
    { length: E },
    (S, D) => J(`card.levels.${D}`, I)
  );
  const o = a.no_information || J("card.no_information", I), c = a.days, w = A.integration === "dwd" ? 3 : A.integration === "peu" ? 4 : 6, O = (S) => {
    const D = Number(S);
    return isNaN(D) || D < 0 ? -1 : D > w ? w : D;
  }, b = /* @__PURE__ */ new Date();
  b.setHours(0, 0, 0, 0);
  const G = A.days_to_show ?? K.days_to_show, u = A.pollen_threshold ?? K.pollen_threshold, j = Object.keys(t.states).filter(
    (S) => S.startsWith("sensor.polleninformation_")
  );
  let f = A.location;
  !f && j.length && (f = j[0].slice(25).split("_")[0]);
  const p = [];
  for (const S of A.allergens)
    try {
      ...
      D.days = [];
      const h = S;
      if (D.allergenReplaced = h, l[h])
        D.allergenCapitalized = l[h];
      else {
        const d = CA[h] || h, U = J(`card.allergen.${d}`, I);
        D.allergenCapitalized = U !== `card.allergen.${d}` ? U : h.charAt(0).toUpperCase() + h.slice(1);
      }
      if (A.allergens_abbreviated) {
        const d = Q[h];
        D.allergenShort = d || J(`editor.phrases_short.${h}`, I) || D.allergenCapitalized;
      } else
        D.allergenShort = D.allergenCapitalized;
      let s = f ? `sensor.polleninformation_${f}_${h}` : null;
      if (!s || !t.states[s]) {
        const d = j.filter((U) => {
          const Y = U.match(/^sensor\.polleninformation_(.+)_(.+)$/);
          if (!Y) return !1;
          const H = Y[1], T = Y[2];
          return (!f || H === f) && T === h;
        });
      ...
      const B = t.states[s];
      if (!((x = B == null ? void 0 : B.attributes) != null && x.forecast)) throw "Missing forecast";
      const k = B.attributes.forecast, F = Array.isArray(k) ? k.reduce((d, U) => {
        const Y = U.time || U.datetime;
        return d[Y] = U, d;
      }, {}) : {}, m = Object.keys(F).sort(
        (d, U) => new Date(d) - new Date(U)
      ).filter((d) => new Date(d) >= b);
      let P = [];
      if (m.length >= G)
        P = m.slice(0, G);
      else {
        P = m.slice();
        let d = m.length > 0 ? new Date(m[m.length - 1]) : b;
        for (; P.length < G; ) {
          d = new Date(d.getTime() + 864e5);
          const U = d.getFullYear(), Y = String(d.getMonth() + 1).padStart(2, "0"), H = String(d.getDate()).padStart(2, "0");
          P.push(`${U}-${Y}-${H}T00:00:00`);
        }
      }
      P.forEach((d, U) => {
        const Y = F[d] || {}, H = O(Y.level), T = new Date(d), z = Math.round((T - b) / 864e5);
        let M;
        g ? c[z] != null ? M = c[z] : z >= 0 && z <= 2 ? M = J(`card.days.${z}`, I) : M = T.toLocaleDateString(C, {
          day: "numeric",
          month: "short"
        }) : (M = T.toLocaleDateString(C, {
          weekday: n ? "short" : "long"
        }), M = M.charAt(0).toUpperCase() + M.slice(1)), i && (M = M.toUpperCase());
        let AA;
        H < 2 ? AA = Math.floor(H * 6 / 4) : AA = Math.ceil(H * 6 / 4);
        const OA = {
        ...
        D[`day${U}`] = OA, D.days.push(OA);
      }), (D.days.some((d) => d.state >= u) || u === 0) && p.push(D);
    } catch (D) {
      e && console.warn(`Fel vid allergen ${S}:`, D);
    }
  return p.sort(
    {
...
async function KC(t, A) {
  var x, S, D;
  const e = !!A.debug, I = $(t, A.date_locale), C = A.date_locale || ((x = t.locale) == null ? void 0 : x.language) || t.language || `${I}-${I.toUpperCase()}`, g = A.days_relative !== !1, n = !!A.days_abbreviated, i = !!A.days_uppercase, a = {
  ...
  function l(h, s) {
    const B = a[h];
    return !B || isNaN(s) ? -1 : s <= B[0] ? 0 : s <= B[1] ? 1 : s <= B[2] ? 2 : s <= B[3] ? 3 : s <= B[4] ? 4 : s <= B[5] ? 5 : 6;
  }
  const Q = {
    full: {},
    short: {},
    ...
    no_information: "",
    ...A.phrases || {}
  }, r = Q.full, E = Q.short, o = Q.levels, c = Array.isArray(o) && o.length === 7 ? o : Array.from({ length: 7 }, (h, s) => J(`card.levels.${s}`, I)), w = Q.no_information || J("card.no_information", I), O = Q.days, b = /* @__PURE__ */ new Date();
  b.setHours(0, 0, 0, 0);
  const G = A.days_to_show ?? V.days_to_show, u = A.pollen_threshold ?? V.pollen_threshold, j = (A.location || "").toLowerCase(), f = Object.keys(t.states).filter((h) => {
    const s = h.match(/^sensor\.silam_pollen_(.*)_([^_]+)$/);
    return s && s[1] === j;
  }), p = {};
  for (const h of f) {
    const s = h.match(/^sensor\.silam_pollen_(.*)_([^_]+)$/);
    ...
    const B = s[2];
    let k = !1;
    for (const [F, X] of Object.entries(N.mapping))
      if (X[B]) {
        const m = X[B];
        p[m] = h, k = !0;
        break;
    ...
    !k && e && console.debug(
      `[SILAM][fetchForecast] Hittade ingen master-key för haSlug: '${B}'`
    );
  }
  const v = [];
  for (const h of A.allergens)
    try {
      const s = {};
      if (s.days = [], s.allergenReplaced = h, r[h] ? s.allergenCapitalized = r[h] : N.names && N.names[h] && N.names[h][I] ? s.allergenCapitalized = N.names[h][I] : s.allergenCapitalized = h.charAt(0).toUpperCase() + h.slice(1), A.allergens_abbreviated) {
        const y = E[h];
        s.allergenShort = y || s.allergenCapitalized;
      } else
        s.allergenShort = s.allergenCapitalized;
      const B = p[h];
      if (!B || !t.states[B]) {
        e && console.debug(`[SILAM] Ingen sensor för ${h}:`, B);
        continue;
      }
      const k = t.states[B], F = Number(k.state);
      let X = [];
      k.attributes && k.attributes.forecast && Array.isArray(k.attributes.forecast) && (X = k.attributes.forecast.map((y) => ({
        date: new Date(y.datetime || y.time),
        value: Number(y.value)
      })).filter(
        (y) => !isNaN(y.value) && y.date instanceof Date && !isNaN(y.date)
      ), X.sort((y, d) => y.date - d.date));
      let m = [];
      if (m.push(l(h, F)), k.attributes && Array.isArray(k.attributes.forecast) && k.attributes.forecast.length > 0)
        for (let y = 1; y < G; ++y) {
          const d = new Date(b.getTime() + y * 864e5), U = k.attributes.forecast.find(
            (H) => Math.abs(
              new Date(H.datetime || H.time).getTime() - d.getTime()
            ) < 12 * 3600 * 1e3
          ), Y = U ? l(h, Number(U.value)) : -1;
          m.push(Y);
        }
      else
        for (G > 1 && ((S = k.attributes) == null ? void 0 : S.tomorrow) !== void 0 ? m.push(
          l(h, Number(k.attributes.tomorrow))
        ) : G > 1 && m.push(-1); m.length < G; )
          m.push(-1);
      m.length < G && ((D = k.attributes) == null ? void 0 : D.tomorrow) !== void 0 && (m[1] = l(h, Number(k.attributes.tomorrow)) || -1);
      for (let y = 0; y < G; ++y) {
        const d = m[y], U = new Date(b.getTime() + y * 864e5), Y = y;
        let H;
        g ? O[Y] != null ? H = O[Y] : Y >= 0 && Y <= 2 ? H = J(`card.days.${Y}`, I) : H = U.toLocaleDateString(C, {
          day: "numeric",
          month: "short"
        }) : (H = U.toLocaleDateString(C, {
          weekday: n ? "short" : "long"
        }), H = H.charAt(0).toUpperCase() + H.slice(1)), i && (H = H.toUpperCase());
        const T = d < 0 ? 0 : Math.min(Math.round(d), 6), z = d < 0 ? w : c[T] || String(d);
        s[`day${y}`] = {
      ...
      (s.days.some((y) => y.state >= u) || u === 0) && v.push(s);
    } catch (s) {
      e && console.warn(`[SILAM] Fel vid allergen ${h}:`, s);
    }
  return v.sort(
    {
      value_ascending: (h, s) => h.day0.state - s.day0.state,
      value_descending: (h, s) => s.day0.state - h.day0.state,
      name_ascending: (h, s) => h.allergenCapitalized.localeCompare(s.allergenCapitalized),
      name_descending: (h, s) => s.allergenCapitalized.localeCompare(h.allergenCapitalized)
    }[A.sort] || ((h, s) => s.day0.state - h.day0.state)
  ), e && console.debug("[SILAM] fetchForecast klar:", v), v;
}
...
async function zC(t, A) {
  var p, v;
  const e = [], I = !!A.debug, C = (x) => x.charAt(0).toUpperCase() + x.slice(1), g = (x) => {
    const [S] = x.split("T"), [D, h, s] = S.split("-").map(Number);
    return new Date(D, h - 1, s);
  }, n = /* @__PURE__ */ new Date();
  n.setHours(0, 0, 0, 0);
  const i = $(t, A.date_locale), a = A.date_locale || ((p = t.locale) == null ? void 0 : p.language) || t.language || `${i}-${i.toUpperCase()}`, l = A.days_relative !== !1, Q = !!A.days_abbreviated, r = !!A.days_uppercase, E = {
    full: {},
    short: {},
    levels: [],
    days: {},
    no_information: "",
    ...A.phrases || {}
  }, o = E.full, c = E.short, w = E.levels, O = Array.isArray(w) && w.length === 7 ? w : Array.from({ length: 7 }, (x, S) => J(`card.levels.${S}`, i)), b = E.no_information || J("card.no_information", i), G = E.days;
  I && console.debug("PP.fetchForecast — start", { city: A.city, lang: i });
  const u = (x) => {
    const S = Number(x);
    return isNaN(S) || S < 0 ? -1 : S > 6 ? 6 : S;
  }, j = A.days_to_show ?? W.days_to_show, f = A.pollen_threshold ?? W.pollen_threshold;
  for (const x of A.allergens)
    try {
      const S = {};
      S.days = [];
      const D = _(x);
      if (S.allergenReplaced = D, this.debug && console.log(
        "[PP] allergen",
        x,
        "fullPhrases keys",
        Object.keys(o)
      ), o[x])
        S.allergenCapitalized = o[x];
      else {
        const d = CA[D] || D, U = J(`card.allergen.${d}`, i);
        S.allergenCapitalized = U !== `card.allergen.${d}` ? U : C(x);
      }
      if (A.allergens_abbreviated) {
        const d = CA[D] || D, U = c[x];
        S.allergenShort = U || J(`editor.phrases_short.${d}`, i) || S.allergenCapitalized;
      } else
        S.allergenShort = S.allergenCapitalized;
      const h = _(A.city);
      let s = `sensor.pollen_${h}_${D}`;
      if (!t.states[s]) {
        const d = Object.keys(t.states).filter(
          (U) => U.startsWith(`sensor.pollen_${h}_`) && U.includes(D)
        );
        if (d.length === 1) s = d[0];
        else continue;
      }
      const B = t.states[s];
      if (!((v = B == null ? void 0 : B.attributes) != null && v.forecast)) throw "Missing forecast";
      const k = B.attributes.forecast, F = Array.isArray(k) ? k.reduce((d, U) => {
        const Y = U.time || U.datetime;
        return d[Y] = U, d;
      }, {}) : k, m = Object.keys(F).sort(
        (d, U) => g(d) - g(U)
      ).filter((d) => g(d) >= n);
      let P = [];
      if (m.length >= j)
        ...
        P = m.slice();
        let d = m.length > 0 ? g(m[m.length - 1]) : n;
        for (; P.length < j; ) {
          d = new Date(d.getTime() + 864e5);
          const U = d.getFullYear(), Y = String(d.getMonth() + 1).padStart(2, "0"), H = String(d.getDate()).padStart(2, "0");
          P.push(`${U}-${Y}-${H}T00:00:00`);
      ...
      P.forEach((d, U) => {
        const Y = F[d] || {}, H = u(Y.level), T = g(d), z = Math.round((T - n) / 864e5);
        let M;
        l ? G[z] != null ? M = G[z] : z >= 0 && z <= 2 ? M = J(`card.days.${z}`, i) : M = T.toLocaleDateString(a, {
          day: "numeric",
          month: "short"
        }) : (M = T.toLocaleDateString(a, {
          weekday: Q ? "short" : "long"
        }), M = M.charAt(0).toUpperCase() + M.slice(1)), r && (M = M.toUpperCase());
        const AA = {
          name: S.allergenCapitalized,
          day: M,
          state: H,
          state_text: H < 0 ? b : O[H]
        };
        S[`day${U}`] = AA, S.days.push(AA);
      }), (S.days.some((d) => d.state >= f) || f === 0) && e.push(S);
    } catch (S) {
      console.warn(`[PP] Fel vid allergen ${x}:`, S);
    }
  return e.sort(
    {
      value_ascending: (x, S) => x.day0.state - S.day0.state,
      value_descending: (x, S) => S.day0.state - x.day0.state,
      name_ascending: (x, S) => x.allergenCapitalized.localeCompare(S.allergenCapitalized),
      name_descending: (x, S) => S.allergenCapitalized.localeCompare(x.allergenCapitalized)
    }[A.sort] || ((x, S) => S.day0.state - x.day0.state)
  ), I && console.debug("PP.fetchForecast — done", e), e;
}
function NC(t, A, e = !1) {
  ...
  if (I === "pp") {
    ...
    for (const n of t.allergens || []) {
      const i = _(n), a = `sensor.pollen_${g}_${i}`, l = !!A.states[a];
      e && console.debug(
        `[findAvailableSensors][pp] allergen: '${n}', cityKey: '${g}', rawKey: '${i}', sensorId: '${a}', exists: ${l}`
      ), l && C.push(a);
    }
  } else if (I === "dwd")
    for (const g of t.allergens || []) {
      const n = cA(g);
      let i = t.region_id ? `sensor.pollenflug_${n}_${t.region_id}` : null, a = i && A.states[i];
      if (!a) {
        const l = Object.keys(A.states).filter(
          (Q) => Q.startsWith(`sensor.pollenflug_${n}_`)
        );
        l.length === 1 && (i = l[0], a = !0);
      }
      e && console.debug(
        `[findAvailableSensors][dwd] allergen: '${g}', rawKey: '${n}', region_id: '${t.region_id}', sensorId: '${i}', exists: ${!!a}`
      ), a && C.push(i);
    }
  else if (I === "peu") {
    const g = (t.location || "").toLowerCase();
    for (const n of t.allergens || []) {
      const i = _(n);
      let a = g ? `sensor.polleninformation_${g}_${i}` : null, l = a && A.states[a];
      if (!l) {
        const Q = Object.keys(A.states).filter((r) => {
          const E = r.match(/^sensor\.polleninformation_(.+)_(.+)$/);
          if (!E) return !1;
          const o = E[1], c = E[2];
          return (!g || o === g) && c === i;
        });
        Q.length === 1 && (a = Q[0], l = !0);
      }
      e && console.debug(
        `[findAvailableSensors][peu] allergen: '${n}', locationSlug: '${g}', allergenSlug: '${i}', sensorId: '${a}', exists: ${!!l}`
      ), l && C.push(a);
    }
  } else if (I === "silam") {
    const g = (t.location || "").toLowerCase();
    for (const n of t.allergens || []) {
      let i = null;
      for (const a of Object.values(N.mapping)) {
        const l = Object.entries(a).reduce((Q, [r, E]) => (Q[E] = r, Q), {});
        if (l[n]) {
          const Q = l[n], r = `sensor.silam_pollen_${g}_${Q}`;
          if (A.states[r]) {
            i = Q, e && console.debug(
              `[findAvailableSensors][silam] allergen: '${n}', locationSlug: '${g}', hassSlug: '${i}', sensorId: '${r}', exists: true`,
              A.states[r]
            ), C.push(r);
            break;
          }
      ...
      !i && e && console.debug(
        `[findAvailableSensors][silam] allergen: '${n}', locationSlug: '${g}', ingen sensor hittades!`
      );
    }
  }
  if (e) {
...
class qC extends tA {
  ...
  get _lang() {
    var A;
    return $(this._hass, (A = this.config) == null ? void 0 : A.date_locale);
  }
  _t(A) {
    return J(A, this._lang);
  }
  _hasTapAction() {
    const A = this.tapAction;
  ...
  _getImageSrc(A, e) {
    const I = Number(e);
    let C = I, g = -1, n = 6;
    this.config.integration === "dwd" ? (C = I * 2, n = 6) : this.config.integration === "peu" && (C = Math.round(I * 6 / 4), n = 6, g = 0);
    let i = Math.round(C);
    (isNaN(i) || i < g) && (i = g), i > n && (i = n);
    const a = CA[A] || A;
    return NA[`${a}_${i}_png`] || NA[`${i}_png`];
  }
  constructor() {
    super(), this.days_to_show = 4, this.displayCols = [], this.header = "", this._initDone = !1, this._userConfig = {}, this.sensors = [], this.tapAction = null;
  }
  ...
  // }
  setConfig(A) {
    this._userConfig = { ...A }, this.tapAction = A.tap_action || null, this._integrationExplicit = A.hasOwnProperty("integration");
    let e = this._userConfig.integration, I;
    e === "pp" ? I = W : e === "peu" ? I = K : e === "dwd" ? I = L : e === "silam" ? I = V : I = W;
    const C = Object.keys(I).concat([
      "allergens",
      "city",
      "location",
      "region_id",
    ...
    let g = {};
    for (const n of C)
      n in this._userConfig && (g[n] = this._userConfig[n]);
    this._userConfig = { ...I, ...g, integration: e }, this._initDone = !1, this._hass && (this.hass = this._hass);
  }
  set hass(A) {
    var o, c, w, O, b, G;
    this._hass = A;
    ...
    const I = Object.keys(A.states).filter(
      (u) => u.startsWith("sensor.pollen_") && !u.startsWith("sensor.pollenflug_")
    ), C = Object.keys(A.states).filter(
      (u) => u.startsWith("sensor.pollenflug_")
    ), g = Object.keys(A.states).filter(
      (u) => u.startsWith("sensor.polleninformation_")
    ), n = Object.keys(A.states).filter(
      (u) => u.startsWith("sensor.silam_pollen_")
    );
    this.debug && (console.debug("Sensor states detected:"), console.debug("PP:", I), console.debug("DWD:", C), console.debug("PEU:", g), console.debug("SILAM:", n));
    let i = this._userConfig.integration;
    e || (I.length ? i = "pp" : g.length ? i = "peu" : C.length ? i = "dwd" : n.length && (i = "silam"));
    let a;
    i === "dwd" ? a = L : i === "peu" ? a = K : i === "pp" ? a = W : i === "silam" ? a = V : console.error("Unknown integration:", i);
    const { allergens: l, ...Q } = this._userConfig, r = {
      ...a,
      ...Q,
      integration: i
    };
    if (this._integrationExplicit && Array.isArray(l) && l.length > 0 ? (this.debug && console.debug(
      "[Card] Explicit integration (",
      i,
      "); using user-defined allergens:",
      l
    ), r.allergens = l) : (this.debug && console.debug(
      "[Card] Using stub allergens for integration:",
      i
    ), i === "pp" ? r.allergens = W.allergens : i === "peu" ? r.allergens = K.allergens : i === "dwd" ? r.allergens = L.allergens : i === "silam" && (r.allergens = V.allergens)), !r.hasOwnProperty("date_locale")) {
      const u = $(A, null), j = ((c = (o = this._hass) == null ? void 0 : o.locale) == null ? void 0 : c.language) || ((w = this._hass) == null ? void 0 : w.language) || `${u}-${u.toUpperCase()}`;
      r.date_locale = j, this.debug && console.debug("[Card] auto-filling date_locale:", r.date_locale);
    }
    if (i === "dwd" && !r.region_id && C.length)
      r.region_id = Array.from(
        new Set(C.map((u) => u.split("_").pop()))
      ).sort((u, j) => Number(u) - Number(j))[0], this.debug && console.debug("[Card] Auto-set region_id:", r.region_id);
    else if (i === "pp" && !r.city && I.length)
      r.city = I[0].slice(14).replace(/_[^_]+$/, ""), this.debug && console.debug("[Card] Auto-set city:", r.city);
    else if (i === "peu" && !r.location && g.length) {
      const u = Array.from(
        new Set(
          g.map((j) => {
            var p;
            return (((p = A.states[j]) == null ? void 0 : p.attributes) || {}).location_slug || null;
          }).filter(Boolean)
        )
      );
      r.location = u[0] || null, this.debug && console.debug(
        "[Card][PEU] Auto-set location (location_slug):",
        r.location,
        u
      );
    } else if (i === "silam" && !r.location && n.length) {
      const u = Array.from(
        new Set(
          n.map((j) => {
            const f = j.match(/^sensor\.silam_pollen_(.*)_([^_]+)$/);
            return f ? f[1] : null;
          }).filter(Boolean)
        )
      );
    ...
    if (this.config = r, this.tapAction = r.tap_action || this.tapAction || null, this.debug && (console.debug("[Card][Debug] Aktiv integration:", i), console.debug("[Card][Debug] Allergens i config:", r.allergens)), r.title === "false" || r.title === !1 || typeof r.title == "string" && r.title.trim() === "")
      ...
      let u = "";
      if (i === "dwd")
        u = tg[r.region_id] || r.region_id;
      else if (i === "peu") {
        const f = Object.values(A.states).filter(
          (v) => v.entity_id.startsWith("sensor.polleninformation_")
        ).find((v) => ((v.attributes || {}).location_slug || v.entity_id.replace("sensor.polleninformation_", "").replace(/_[^_]+$/, "")) === r.location);
        let p = "";
        if (f) {
          const v = f.attributes;
          p = v.location_title || ((b = (O = v.friendly_name) == null ? void 0 : O.match(/\((.*?)\)/)) == null ? void 0 : b[1]) || r.location;
        }
        u = p || r.location || "";
      } else if (i === "silam") {
        const j = [
          ...
          Object.values(N.mapping).flatMap(
            (D) => Object.entries(D).filter(
              ([h, s]) => j.includes(s)
            ).map(([h]) => h)
          )
        ), p = Object.values(A.states).filter((D) => {
          if (!D.entity_id.startsWith("sensor.silam_pollen_")) return !1;
          const h = D.entity_id.match(
            /^sensor\.silam_pollen_(.*)_([^_]+)$/
          );
          if (!h) return !1;
          const s = h[2];
          return f.has(s);
        }), v = jA(r.location || ""), x = p.find((D) => {
          const s = D.entity_id.replace("sensor.silam_pollen_", "").replace(/_[^_]+$/, "").replace(/^[-\s]+/, "");
          return jA(s) === v;
        });
        let S = "";
        if (x) {
          const D = x.attributes;
          S = D.location_title || ((G = D.friendly_name) == null ? void 0 : G.replace(/^SILAM Pollen\s*-?\s*/i, "").replace(new RegExp("\\s+\\p{L}+$", "u"), "").trim()) || r.location, S = S.replace(/^[-\s]+/, "");
        }
        u = S || r.location || "";
      } else
        u = HA.find(
          (j) => j.toLowerCase().replace(/[åä]/g, "a").replace(/ö/g, "o").replace(/[-\s]/g, "_") === r.city
        ) || r.city;
      this.header = `${this._t("card.header_prefix")} ${u}`, this.debug && console.debug("[Card] header set to:", this.header);
    }
    (XC[r.integration] || _A).fetchForecast(A, r).then((u) => {
      this.debug && (console.debug("[Card][Debug] Sensors före filtrering:", u), console.debug(
      ...
      const j = NC(r, A, this.debug), f = j.length;
      let p = {};
      if (r.integration === "silam") {
        const D = Object.keys(A.states).filter((h) => {
          const s = h.match(/^sensor\.silam_pollen_(.*)_([^_]+)$/);
          return s && s[1] === (r.location || "");
        });
        for (const h of D) {
          const s = h.match(/^sensor\.silam_pollen_(.*)_([^_]+)$/);
          if (!s) continue;
          ...
          !k && this.debug && console.debug(
            `[Card][SILAM] Hittade ingen mapping för haSlug: '${B}'`
          );
        }
        this.debug && console.debug(
      ...
      let v = u.filter((D) => {
        if (r.integration === "silam" && p) {
          const h = r.location || "", s = p[D.allergenReplaced] || D.allergenReplaced, B = `sensor.silam_pollen_${h}_${s}`;
          return this.debug && console.debug(
            `[Card][Debug][SILAM filter] allergenReplaced: '${D.allergenReplaced}', key: '${s}', id: '${B}', available: ${j.includes(B)}`
          ), j.includes(B);
        }
        return !0;
      });
      if (Array.isArray(r.allergens) && r.allergens.length > 0 && r.integration !== "silam") {
        let D, h;
        i === "dwd" ? (D = new Set(r.allergens.map((s) => cA(s))), h = (s) => cA(s.allergenReplaced || "")) : (this.debug && console.debug(
          "[Card][Debug] Använder normalisering för allergener:",
          r.allergens
        ), D = new Set(r.allergens.map((s) => _(s))), h = (s) => _(s.allergenReplaced || "")), v = v.filter((s) => {
          const B = h(s), k = D.has(B);
          return !k && this.debug && console.debug(
            `[Card][Debug] Sensor '${B}' är EJ tillåten (ej i allowed)`,
            s
          ), k;
        });
      }
      if (this._integrationExplicit && !!r.location && f === 0) {
        this.sensors = [], this._availableSensorCount = 0, this._explicitLocationNoSensors = !0, this.debug && console.warn(
          `[Card] Ingen sensor hittad för explicit vald plats: '${r.location}'`
        ), this.requestUpdate();
        return;
      } else {
        this._explicitLocationNoSensors = !1, this.sensors = v, this._availableSensorCount = j.length;
        let D = 0;
        r.show_empty_days ? D = r.days_to_show : v.length > 0 && v[0].days && (D = v[0].days.length), this.days_to_show = D, this.displayCols = Array.from({ length: D }, (h, s) => s), this.requestUpdate();
      }
    }).catch((u) => {
      console.error("[Card] Error fetching pollen forecast:", u), this.debug && console.debug("[Card] fetchForecast error:", u);
    });
  }
  _renderMinimalHtml() {
    return R`
      ${this.header ? R`<div class="card-header">${this.header}</div>` : ""}
      <div class="card-content">
        <div class="flex-container">
          ${(this.sensors || []).map((A) => {
      var g, n, i, a, l, Q, r, E, o;
      const e = ((g = A.day0) == null ? void 0 : g.state_text) ?? "", I = ((n = A.day0) == null ? void 0 : n.state) ?? "";
      let C = "";
      return (i = this.config) != null && i.show_text_allergen && (C += (a = this.config) != null && a.allergens_abbreviated ? A.allergenShort ?? "" : A.allergenCapitalized ?? ""), (l = this.config) != null && l.show_value_text && ((Q = this.config) != null && Q.show_value_numeric) ? (C && (C += ": "), C += `${e} (${I})`) : (r = this.config) != null && r.show_value_text ? (C && (C += ": "), C += e) : (E = this.config) != null && E.show_value_numeric && (C && (C += " "), C += `(${I})`), R`
              <div class="sensor">
                <img
                  class="box"
                  src="${this._getImageSrc(
        A.allergenReplaced,
        (o = A.day0) == null ? void 0 : o.state
      )}"
                />
                ${C ? R`<span class="short-text">${C}</span>` : ""}
              </div>
            `;
    })}
        </div>
  ...
  _renderNormalHtml() {
    const A = !!this.config.days_boldfaced, e = this.displayCols;
    return R`
      ${this.header ? R`<div class="card-header">${this.header}</div>` : ""}
      <div class="card-content">
            ...
            return R`
                    <td>
                      <div class="icon-wrapper">
                        <img
                          src="${this._getImageSrc("", (n = I.days[g]) == null ? void 0 : n.state)}"
                        />
                        ${this.config.show_value_numeric_in_circle ? R`<span class="circle-overlay">
                              ${((i = I.days[g]) == null ? void 0 : i.state) ?? ""}
                            </span>` : ""}
                      </div>
                    </td>
                  `;
              ...
              ${this.config.show_text_allergen || this.config.show_value_text || this.config.show_value_numeric ? R`
                    <tr class="allergen-text-row" valign="top">
                      <td>
                        ${this.config.show_text_allergen ? this.config.allergens_abbreviated ? I.allergenShort : I.allergenCapitalized : ""}
                      </td>
                      ${e.map((g) => {
          var l, Q;
          const n = ((l = I.days[g]) == null ? void 0 : l.state_text) || "", i = (Q = I.days[g]) == null ? void 0 : Q.state;
          let a = "";
          return this.config.show_value_text && this.config.show_value_numeric ? a = `${n} (${i})` : this.config.show_value_text ? a = n : this.config.show_value_numeric && (a = String(i)), R`<td>${a}</td>`;
        })}
                    </tr>
                  ` : ""}
            `;
  ...
  render() {
    ...
    this.debug && console.debug("[Card] Hela config:", this.config);
    let A;
    if (this.sensors.length)
      A = this.config.minimal ? this._renderMinimalHtml() : this._renderNormalHtml();
    else {
      const a = `card.integration.${this.config.integration}`, l = this._t(a);
      let Q = "";
      this._availableSensorCount === 0 ? Q = this._t("card.error_no_sensors") : Q = this._t("card.error_filtered_sensors"), A = R`<div class="card-error">${Q} (${l})</div>`;
    }
    const e = this.config.tap_action || null, I = (i = (n = this.config.background_color) == null ? void 0 : n.trim) != null && i.call(n) ? `background-color: ${this.config.background_color.trim()};` : "";
    this.debug && console.debug("[Card] Background style:", I);
    const C = e && e.type && e.type !== "none" ? "pointer" : "auto", g = `${I} cursor: ${C};`;
    return R`
      <ha-card
        style="${g}"
  ...
  _handleTapAction(A) {
    ...
    (C = A.preventDefault) == null || C.call(A), (g = A.stopPropagation) == null || g.call(A);
    const e = this.tapAction.type || "more-info";
    let I = this.tapAction.entity || "camera.pollen";
    switch (e) {
      case "more-info":
        this._fire("hass-more-info", { entityId: I });
        break;
      case "navigate":
      ...
      case "call-service":
        if (this.tapAction.service && typeof this.tapAction.service == "string") {
          const [n, i] = this.tapAction.service.split(".");
...
customElements.define("pollenprognos-card", qC);
const sA = (t, A) => {
  const e = { ...t };
  for (const I of Object.keys(A)) {
    const C = A[I];
    C !== null && typeof C == "object" && !Array.isArray(C) && typeof t[I] == "object" && t[I] !== null ? e[I] = sA(t[I], C) : e[I] = C;
  }
  return e;
}, _C = (t) => t === "dwd" ? L : t === "peu" ? K : t === "silam" ? V : W;
class $C extends tA {
  get debug() {
  ...
  _resetPhrases(A) {
    ...
    const e = this._config.integration === "dwd" ? L.allergens : this._config.integration === "peu" ? K.allergens : this._config.integration === "silam" ? V.allergens : W.allergens, I = {}, C = {};
    e.forEach((l) => {
      const Q = _(l), r = CA[Q] || Q;
      I[l] = J(`editor.phrases_full.${r}`, A), C[l] = J(`editor.phrases_short.${r}`, A);
    });
    const g = this._config.integration === "dwd" ? 4 : this._config.integration === "peu" ? 5 : (this._config.integration === "silam", 7), n = Array.from(
      { length: g },
      (l, Q) => J(`editor.phrases_levels.${Q}`, A)
    ), i = {
      0: J("editor.phrases_days.0", A),
      1: J("editor.phrases_days.1", A),
      2: J("editor.phrases_days.2", A)
    }, a = J("editor.no_information", A);
  ...
  get _lang() {
    return $(this._hass, this._config.date_locale);
  }
  _t(A) {
  ...
  setConfig(A) {
    ...
    try {
      ...
      const C = A.integration === "dwd" ? L.allergens.length : A.integration === "peu" ? K.allergens.length : A.integration === "silam" ? V.allergens.length : W.allergens.length, g = { ...A };
      ...
      const n = (g.integration === "dwd" ? L : g.integration === "peu" ? K : g.integration === "silam" ? V : W).pollen_threshold;
      g.hasOwnProperty("pollen_threshold") && !this._thresholdExplicit && g.pollen_threshold === n && (this.debug && console.debug(
        "[Editor] dropping incoming stub-threshold (matches stub):",
        n
      ), delete g.pollen_threshold);
      const i = A.integration;
      this._prevIntegration !== void 0 && i !== this._prevIntegration && (delete this._userConfig.allergens, this._allergensExplicit = !1, this.debug && console.debug("[Editor] integration changed → wipe allergens")), !this._integrationExplicit && g.integration === W.integration && (this.debug && console.debug("[Editor] dropped stub integration"), delete g.integration), !this._daysExplicit && g.days_to_show === W.days_to_show && (this.debug && console.debug("[Editor] dropped stub days_to_show"), delete g.days_to_show);
      const a = (g.integration === "dwd" ? L : g.integration === "peu" ? K : g.integration === "silam" ? V : W).date_locale;
      !this._localeExplicit && g.date_locale === a && (this.debug && console.debug("[Editor] dropped stub date_locale"), delete g.date_locale), this._userConfig = sA(this._userConfig, g), this._thresholdExplicit = this._userConfig.hasOwnProperty("pollen_threshold"), this._allergensExplicit = this._userConfig.hasOwnProperty("allergens"), this._integrationExplicit = this._userConfig.hasOwnProperty("integration"), this._daysExplicit = this._userConfig.hasOwnProperty("days_to_show"), this._localeExplicit = this._userConfig.hasOwnProperty("date_locale");
      ...
      if (!this._integrationExplicit && this._hass) {
        const E = Object.keys(this._hass.states);
        E.some((o) => o.startsWith("sensor.pollen_")) ? l = "pp" : E.some((o) => o.startsWith("sensor.polleninformation_")) ? l = "peu" : E.some((o) => o.startsWith("sensor.pollenflug_")) ? l = "dwd" : E.some((o) => o.startsWith("sensor.silam_pollen_")) && (l = "silam"), this._userConfig.integration = l, this.debug && console.debug("[Editor] auto-detected integration:", l);
      }
      const Q = _C(l);
      let r = sA(Q, this._userConfig);
      if (this._userConfig.hasOwnProperty("pollen_threshold") || (r.pollen_threshold = Q.pollen_threshold, this.debug && console.debug(
        "[Editor] reset pollen_threshold to stub:",
        Q.pollen_threshold
      )), r.allergens = Array.isArray(this._userConfig.allergens) ? this._userConfig.allergens : Q.allergens, r.integration = l, r.type = "custom:pollenprognos-card", this._config = r, this._prevIntegration = l, this.debug && console.debug(
        "[Editor][F] slutgiltigt this._config.allergens:",
        this._config.allergens
      ), this._daysExplicit || (this._config.days_to_show = Q.days_to_show, this.debug && console.debug(
        "[Editor] reset days_to_show to stub:",
        Q.days_to_show
      )), !this._localeExplicit) {
        const E = $(this._hass, null), o = ((I = (e = this._hass) == null ? void 0 : e.locale) == null ? void 0 : I.language) || `${E}-${E.toUpperCase()}`;
      ...
      if (this._initDone = !1, this._hass) {
        ...
        this.installedRegionIds = Array.from(
          new Set(
            E.filter((c) => c.startsWith("sensor.pollenflug_")).map((c) => c.split("_").pop())
          )
        ).sort((c, w) => Number(c) - Number(w));
        const o = new Set(
          E.filter(
        ...
        this.installedCities = HA.filter(
          (c) => o.has(
  ...
  set hass(A) {
    this._hass = A;
    const e = this._integrationExplicit, I = Object.keys(A.states).filter(
    ...
    let i = this._userConfig.integration;
    e || (I.length ? i = "pp" : g.length ? i = "peu" : C.length ? i = "dwd" : n.length && (i = "silam"), this._userConfig.integration = i);
    const a = i === "dwd" ? L : i === "peu" ? K : i === "silam" ? V : W;
    let l = sA(a, this._userConfig);
    this._userConfig.hasOwnProperty("pollen_threshold") || (l.pollen_threshold = a.pollen_threshold, this.debug && console.debug(
    ...
    this.installedCities = HA.filter(
      ...
      new Map(
        Object.values(A.states).filter((o) => o.entity_id.startsWith("sensor.polleninformation_")).map((o) => {
          var O, b;
          const c = o.attributes.location_slug || o.entity_id.replace("sensor.polleninformation_", "").replace(/_[^_]+$/, ""), w = o.attributes.location_title || ((b = (O = o.attributes.friendly_name) == null ? void 0 : O.match(/\((.*?)\)/)) == null ? void 0 : b[1]) || c;
          return [c, w];
        })
      )
    ...
    if (this.debug) {
      console.debug("[SilamAllergenMap.mapping]", N.mapping), console.debug("[pollenAllergens]", r);
      for (const [c, w] of Object.entries(N.mapping))
        for (const [O, b] of Object.entries(w))
          console.debug(`[Mapping] ${c}: ${O} → ${b}`);
      const o = Object.values(N.mapping).flatMap(
    ...
    this.installedSilamLocations = Array.from(
      new Map(
        Object.values(A.states).filter((o) => {
          ...
          const c = o.entity_id.match(
            /^sensor\.silam_pollen_(.*)_([^_]+)$/
          ), w = c ? c[1].replace(/^[-\s]+/, "") : "", O = jA(w);
          let b = o.attributes.location_title || (o.attributes.friendly_name ? o.attributes.friendly_name.replace(/^SILAM Pollen\s*-?\s*/i, "").replace(new RegExp("\\s+\\p{L}+$", "u"), "").trim() : "") || w;
  ...
  _onAllergenToggle(A, e) {
    const I = new Set(this._config.allergens);
    e ? I.add(A) : I.delete(A), this._updateConfig("allergens", [...I]);
  }
  _updateConfig(A, e) {
    this.debug && console.debug("[Editor] _updateConfig – prop:", A, "value:", e);
    const I = { ...this._userConfig };
    let C;
    if (A === "integration") {
      const g = e, n = this._config.integration;
      g !== n && (delete I[g === "dwd" ? "city" : "region_id"], delete I.allergens, delete I.pollen_threshold, this._allergensExplicit = !1), C = sA(g === "dwd" ? L : g === "peu" ? K : g === "silam" ? V : W, I), C.integration = g;
    } else
      C = { ...this._config, [A]: e };
  ...
  render() {
    const A = {
      ...
      ...this._config
    }, e = A.integration === "dwd" ? L.allergens : A.integration === "peu" ? K.allergens : A.integration === "silam" ? V.allergens : W.allergens, I = A.integration === "dwd" ? 4 : A.integration === "peu" ? 5 : 7, C = A.integration === "dwd" ? { min: 0, max: 3, step: 0.5 } : A.integration === "peu" ? { min: 0, max: 4, step: 1 } : { min: 0, max: 6, step: 1 };
    return R`
      <div class="card-config">
        ...
        <ha-formfield label="${this._t("integration")}">
          <ha-select
            .value=${A.integration}
            @selected=${(g) => this._updateConfig("integration", g.target.value)}
        ...
        ${A.integration === "pp" ? R`
              <ha-formfield label="${this._t("city")}">
                <ha-select
                  .value=${A.city || ""}
                  @selected=${(g) => this._updateConfig("city", g.target.value)}
                  @closed=${(g) => g.stopPropagation()}
                >
                  ${this.installedCities.map(
      (g) => R`<mwc-list-item .value=${g}
                        >${g}</mwc-list-item
                      >`
    )}
                </ha-select>
            ...
            ` : A.integration === "peu" ? R`
                <ha-formfield label="${this._t("location")}">
                  <ha-select
                    .value=${A.location || ""}
                    @selected=${(g) => this._updateConfig("location", g.target.value)}
                    @closed=${(g) => g.stopPropagation()}
                  >
                    ${this.installedPeuLocations.map(
      ([g, n]) => R`<mwc-list-item .value=${g}
                          >${n}</mwc-list-item
                        >`
    )}
                  </ha-select>
                </ha-formfield>
              ` : A.integration === "silam" ? R`
                  <ha-formfield label="${this._t("location")}">
                    <ha-select
                      .value=${A.location || ""}
                      @selected=${(g) => this._updateConfig("location", g.target.value)}
      ...
      ([g, n]) => R`<mwc-list-item .value=${g}
                ...
                ` : R`
                  <ha-formfield label="${this._t("region_id")}">
                    <ha-select
                      .value=${A.region_id || ""}
                      @selected=${(g) => this._updateConfig("region_id", g.target.value)}
                      @closed=${(g) => g.stopPropagation()}
                    >
                      ${this.installedRegionIds.map(
      (g) => R`
                          <mwc-list-item .value=${g}>
                            ${g} — ${tg[g] || g}
                          </mwc-list-item>
                        `
    )}
        ...
        <div style="display:flex; gap:8px; align-items:center;">
          ...
          <ha-formfield label="${this._t("title_hide")}">
            <ha-checkbox
              .checked=${A.title === !1}
              @change=${(g) => {
      g.target.checked ? this._updateConfig("title", !1) : this._updateConfig("title", !0);
    }}
            ></ha-checkbox>
          </ha-formfield>
          <!-- Automatic -->
          <ha-formfield label="${this._t("title_automatic")}">
            <ha-checkbox
              ...
              @change=${(g) => {
      g.target.checked ? this._updateConfig("title", !0) : this._updateConfig("title", "");
    }}
            ></ha-checkbox>
          </ha-formfield>
        </div>
      ...
      n.trim() === "" ? this._updateConfig("title", !0) : this._updateConfig("title", n);
    }}
          ></ha-textfield>
        </ha-formfield>
        <!-- Bakgrundsfärg -->
        <ha-formfield label="${this._t("background_color")}">
          <div style="display:flex; gap:8px; align-items:center;">
            <ha-textfield
              ...
              @input=${(g) => this._updateConfig("background_color", g.target.value)}
              style="width: 120px;"
            ></ha-textfield>
            <input
              type="color"
        ...
        <ha-formfield label="${this._t("minimal")}">
          <ha-switch
            .checked=${A.minimal}
            @change=${(g) => this._updateConfig("minimal", g.target.checked)}
          ></ha-switch>
        </ha-formfield>
        <ha-formfield label="${this._t("allergens_abbreviated")}">
          <ha-switch
            .checked=${A.allergens_abbreviated}
            @change=${(g) => this._updateConfig("allergens_abbreviated", g.target.checked)}
          ></ha-switch>
        </ha-formfield>
      ...
      g.target.checked
        ...
        <ha-formfield label="${this._t("show_empty_days")}">
          <ha-switch
            ...
            @change=${(g) => this._updateConfig("show_empty_days", g.target.checked)}
          ></ha-switch>
        </ha-formfield>
        ...
        <ha-formfield label="${this._t("days_relative")}">
          <ha-switch
            ...
            @change=${(g) => this._updateConfig("days_relative", g.target.checked)}
          ></ha-switch>
        </ha-formfield>
        <ha-formfield label="${this._t("days_abbreviated")}">
          <ha-switch
            .checked=${A.days_abbreviated}
            @change=${(g) => this._updateConfig("days_abbreviated", g.target.checked)}
          ></ha-switch>
        </ha-formfield>
        <ha-formfield label="${this._t("days_uppercase")}">
          <ha-switch
            .checked=${A.days_uppercase}
            @change=${(g) => this._updateConfig("days_uppercase", g.target.checked)}
          ></ha-switch>
        </ha-formfield>
        <ha-formfield label="${this._t("days_boldfaced")}">
          <ha-switch
            .checked=${A.days_boldfaced}
            @change=${(g) => this._updateConfig("days_boldfaced", g.target.checked)}
          ></ha-switch>
        </ha-formfield>
        ...
        <ha-formfield label="${this._t("sort")}">
          <ha-select
            .value=${A.sort}
            @selected=${(g) => this._updateConfig("sort", g.target.value)}
            @closed=${(g) => g.stopPropagation()}
          >
            ${[
      "value_ascending",
      ...
      (g) => R`<mwc-list-item .value=${g}
        ...
        <ha-formfield label="${this._t("locale")}">
          <ha-textfield
            .value=${A.date_locale}
            @input=${(g) => this._updateConfig("date_locale", g.target.value)}
          ></ha-textfield>
        </ha-formfield>
      ...
      (g) => R`
                <ha-formfield .label=${g}>
                  <ha-checkbox
                    ...
                    @change=${(n) => this._onAllergenToggle(g, n.target.checked)}
                  ></ha-checkbox>
                </ha-formfield>
              `
    )}
        ...
        <div class="preset-buttons">
          <ha-formfield label="${this._t("phrases_translate_all")}">
            <ha-select
              ...
              @selected=${(g) => this._selectedPhraseLang = g.target.value}
              @closed=${(g) => g.stopPropagation()}
            >
              ${HC.map(
      (g) => R`
      ...
      (g) => R`
        ...
        const i = {
          ...A.phrases,
          full: { ...A.phrases.full, [g]: n.target.value }
        };
      ...
      (g) => R`
        ...
        const i = {
          ...A.phrases,
          short: { ...A.phrases.short, [g]: n.target.value }
        };
        this._updateConfig("phrases", i);
      }}
                ></ha-textfield>
        ...
        <details>
          ...
          ${Array.from({ length: I }, (g, n) => n).map(
      (g) => R`
              <ha-formfield .label=${g}>
                <ha-textfield
                  .value=${A.phrases.levels[g] || ""}
                  @input=${(n) => {
        const i = [...A.phrases.levels];
        i[g] = n.target.value;
        const a = { ...A.phrases, levels: i };
      ...
      (g) => R`
              <ha-formfield .label=${g}>
                <ha-textfield
                  ...
                  @input=${(n) => {
        const i = { ...A.phrases.days, [g]: n.target.value };
        this._updateConfig("phrases", { ...A.phrases, days: i });
      }}
                ></ha-textfield>
              </ha-formfield>
            `
        ...
        <ha-formfield label="${this._t("no_information")}">
          <ha-textfield
            ...
            @input=${(g) => this._updateConfig("phrases", {
      ...A.phrases,
      no_information: g.target.value
    })}
          ></ha-textfield>
        </ha-formfield>
        ...
        <ha-formfield label="Enable tap action">
          <ha-switch
            ...
            @change=${(g) => {
      g.target.checked ? (this._tapType = "more-info", this._updateConfig("tap_action", {
        ...
        ${this._tapType !== "none" ? R`
              <div style="margin-top: 10px;">
                <label>Action type</label>
                <ha-select
                  .value=${this._tapType}
                  @selected=${(g) => {
      this._tapType = g.target.value;
      let n = { type: this._tapType };
      if (this._tapType === "more-info" && (n.entity = this._tapEntity), this._tapType === "navigate" && (n.navigation_path = this._tapNavigation), this._tapType === "call-service") {
        n.service = this._tapService;
        try {
          n.service_data = JSON.parse(
      ...
      this._updateConfig("tap_action", n), this.requestUpdate();
    }}
                  @closed=${(g) => g.stopPropagation()}
                >
              ...
              ${this._tapType === "more-info" ? R`
                    <ha-formfield label="Entity">
                      <ha-textfield
                        .value=${this._tapEntity}
                        @input=${(g) => {
      this._tapEntity = g.target.value, this._updateConfig("tap_action", {
        type: "more-info",
        entity: this._tapEntity
                  ...
                  ` : ""}
              ${this._tapType === "navigate" ? R`
                    <ha-formfield label="Navigation path">
                      <ha-textfield
                        .value=${this._tapNavigation}
                        @input=${(g) => {
      this._tapNavigation = g.target.value, this._updateConfig("tap_action", {
        type: "navigate",
        navigation_path: this._tapNavigation
                  ...
                  ` : ""}
              ${this._tapType === "call-service" ? R`
                    <ha-formfield label="Service (e.g. light.turn_on)">
                      <ha-textfield
                        .value=${this._tapService}
                        @input=${(g) => {
      this._tapService = g.target.value;
      let n = {};
      try {
        n = JSON.parse(this._tapServiceData || "{}");
      } catch {
      }
        ...
        service_data: n
                    ...
                    <ha-formfield label="Service data (JSON)">
                      <ha-textfield
                        ...
                        @input=${(g) => {
      this._tapServiceData = g.target.value;
      let n = {};
      try {
        n = JSON.parse(this._tapServiceData || "{}");
      } catch {
      ...
      this._updateConfig("tap_action", {
        ...
        <ha-formfield label="${this._t("debug")}">
          <ha-switch
            .checked=${A.debug}
            @change=${(g) => this._updateConfig("debug", g.target.checked)}
          ></ha-switch>
        </ha-formfield>
      </div>
    `;
...
customElements.define("pollenprognos-card-editor", $C);
