...
var fA = (n, A, g) => Qg(n, typeof A != "symbol" ? A + "" : A, g);
...
const Sg = (n) => new tg(typeof n == "string" ? n : n + "", void 0, YA), ig = (n, ...A) => {
  const g = n.length === 1 ? n[0] : A.reduce((I, C, e) => I + ((t) => {
    if (t._$cssResult$ === !0) return t.cssText;
    if (typeof t == "number") return t;
    throw Error("Value passed to 'css' function must be a 'css' function result: " + t + ". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.");
  })(C) + n[e + 1], n[0]);
  return new tg(g, n, YA);
}, Eg = (n, A) => {
  PA ? n.adoptedStyleSheets = A.map((g) => g instanceof CSSStyleSheet ? g : g.styleSheet) : A.forEach((g) => {
...
}, LA = PA ? (n) => n : (n) => n instanceof CSSStyleSheet ? ((A) => {
  let g = "";
 ...
 */
var xA;
const pA = window, rA = pA.trustedTypes, VA = rA ? rA.createPolicy("lit-html", { createHTML: (n) => n }) : void 0, HA = "$lit$", _ = `lit$${(Math.random() + "").slice(9)}$`, ag = "?" + _, pg = `<${ag}>`, IA = document, hA = () => IA.createComment(""), dA = (n) => n === null || typeof n != "object" && typeof n != "function", og = Array.isArray, ug = (n) => og(n) || typeof (n == null ? void 0 : n[Symbol.iterator]) == "function", yA = `[ 	
\f\r]`, sA = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, zA = /-->/g, NA = />/g, gA = RegExp(`>|${yA}(?:([^\\s"'>=/]+)(${yA}*=${yA}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), XA = /'/g, qA = /"/g, lg = /^(?:script|style|textarea|title)$/i, mg = (n) => (A, ...g) => ({ _$litType$: n, strings: A, values: g }), w = mg(1), aA = Symbol.for("lit-noChange"), W = Symbol.for("lit-nothing"), _A = /* @__PURE__ */ new WeakMap(), eA = IA.createTreeWalker(IA, 129, null, !1);
function sg(n, A) {
...
const fg = (n, A) => {
  ...
  for (let a = 0; a < g; a++) {
    const i = n[a];
    let o, d, S = -1, r = 0;
    for (; r < i.length && (t.lastIndex = r, d = t.exec(i), d !== null); ) r = t.lastIndex, t === sA ? d[1] === "!--" ? t = zA : d[1] !== void 0 ? t = NA : d[2] !== void 0 ? (lg.test(d[2]) && (C = RegExp("</" + d[2], "g")), t = gA) : d[3] !== void 0 && (t = gA) : t === gA ? d[0] === ">" ? (t = C ?? sA, S = -1) : d[1] === void 0 ? S = -2 : (S = t.lastIndex - d[2].length, o = d[1], t = d[3] === void 0 ? gA : d[3] === '"' ? qA : XA) : t === qA || t === XA ? t = gA : t === zA || t === NA ? t = sA : (t = gA, C = void 0);
    const l = t === gA && n[a + 1].startsWith("/>") ? " " : "";
    e += t === sA ? i + pg : S >= 0 ? (I.push(o), i.slice(0, S) + HA + i.slice(S) + _ + l) : i + _ + (S === -2 ? (I.push(void 0), a) : l);
  }
...
class QA {
  constructor({ strings: A, _$litType$: g }, I) {
    ...
    this.parts = [];
    let e = 0, t = 0;
    const a = A.length - 1, i = this.parts, [o, d] = fg(A, g);
      ...
      if (C.nodeType === 1) {
        if (C.hasAttributes()) {
          ...
          for (const r of C.getAttributeNames()) if (r.endsWith(HA) || r.startsWith(_)) {
            ...
            if (S.push(r), l !== void 0) {
              const c = C.getAttribute(l.toLowerCase() + HA).split(_), x = /([.?@])?(.*)/.exec(l);
              i.push({ type: 1, index: e, name: x[2], strings: c, ctor: x[1] === "." ? Ug : x[1] === "?" ? yg : x[1] === "@" ? wg : mA });
        ...
        if (lg.test(C.tagName)) {
          ...
          if (r > 0) {
            ...
            for (let l = 0; l < r; l++) C.append(S[l], hA()), eA.nextNode(), i.push({ type: 2, index: ++e });
            C.append(S[r], hA());
          }
        }
...
function oA(n, A, g = n, I) {
  var C, e, t, a;
  if (A === aA) return A;
  let i = I !== void 0 ? (C = g._$Co) === null || C === void 0 ? void 0 : C[I] : g._$Cl;
  const o = dA(A) ? void 0 : A._$litDirective$;
  return (i == null ? void 0 : i.constructor) !== o && ((e = i == null ? void 0 : i._$AO) === null || e === void 0 || e.call(i, !1), o === void 0 ? i = void 0 : (i = new o(n), i._$AT(n, g, I)), I !== void 0 ? ((t = (a = g)._$Co) !== null && t !== void 0 ? t : a._$Co = [])[I] = i : g._$Cl = i), i !== void 0 && (A = oA(n, i._$AS(n, A.values), i, I)), A;
}
class Bg {
  constructor(A, g) {
  ...
  u(A) {
    ...
    eA.currentNode = e;
    let t = eA.nextNode(), a = 0, i = 0, o = C[0];
    for (; o !== void 0; ) {
      if (a === o.index) {
        let d;
        o.type === 2 ? d = new SA(t, t.nextSibling, this, A) : o.type === 1 ? d = new o.ctor(t, o.name, o.strings, this, A) : o.type === 6 && (d = new vg(t, this, A)), this._$AV.push(d), o = C[++i];
      }
      a !== (o == null ? void 0 : o.index) && (t = eA.nextNode(), a++);
    }
...
class mA {
  ...
  _$AI(A, g = this, I, C) {
    ...
    let t = !1;
    if (e === void 0) A = oA(this, A, g, 0), t = !dA(A) || A !== this._$AH && A !== aA, t && (this._$AH = A);
    else {
      const a = A;
      let i, o;
      for (A = e[0], i = 0; i < e.length - 1; i++) o = oA(this, a[I + i], g, i), o === aA && (o = this._$AH[i]), t || (t = !dA(o) || o !== this._$AH[i]), o === W ? A = W : A !== W && (A += (o ?? "") + e[i + 1]), this._$AH[i] = o;
    }
    t && !C && this.j(A);
  }
  j(A) {
...
const bA = (n, A = "_") => {
  ...
  __proto__: null,
  default: ZC
}, Symbol.toStringTag, { value: "Module" })), eg = /* @__PURE__ */ Object.assign({ "./locales/cs.json": mC, "./locales/da.json": BC, "./locales/de.json": xC, "./locales/en.json": wC, "./locales/fi.json": RC, "./locales/it.json": kC, "./locales/nl.json": bC, "./locales/no.json": JC, "./locales/ru.json": YC, "./locales/sk.json": GC, "./locales/sv.json": WC }), lA = {};
for (const n in eg) {
  const A = n.match(/\.\/locales\/([\w-]+)\.json$/);
  A && (lA[A[1]] = eg[n].default);
}
const OA = "en";
function Ig(n, A) {
...
function q(n, A) {
  var C;
  let g = A || ((C = n == null ? void 0 : n.locale) == null ? void 0 : C.language) || (n == null ? void 0 : n.language) || OA;
  if (lA[g])
    return g;
  const I = g.slice(0, 2).toLowerCase();
  return lA[I] ? I : OA;
}
const FC = Object.keys(lA);
function O(n, A) {
  const g = lA[A] || {};
  if (g[n] !== void 0)
    return g[n];
...
async function NC(n, A) {
  const g = !!A.debug, I = (Q) => Q.charAt(0).toUpperCase() + Q.slice(1), C = q(n, A.date_locale), e = A.date_locale || T.date_locale, t = A.days_relative !== !1, a = !!A.days_abbreviated, i = !!A.days_uppercase, o = A.phrases || {}, d = o.full || {}, S = o.short || {}, r = o.levels, l = Array.isArray(r) && r.length === 7 ? r : Array.from({ length: 7 }, (Q, s) => O(`card.levels.${s}`, C)), c = o.no_information || O("card.no_information", C), x = o.days || {}, b = A.days_to_show ?? T.days_to_show, m = A.pollen_threshold ?? T.pollen_threshold;
  ...
  for (const Q of A.allergens)
    try {
      ...
      if (D)
        ...
        const H = `card.allergen.${CA[p] || p}`, Z = O(H, C);
        s.allergenCapitalized = Z !== H ? Z : I(Q);
      }
      if (A.allergens_abbreviated) {
        const U = S[Q];
        s.allergenShort = U || O(`editor.phrases_short.${u}`, C) || s.allergenCapitalized;
      } else
      ...
      const f = n.states[E], y = R(f.state), j = R(f.attributes[LC]), B = R(f.attributes[KC]), J = [
        { date: Y, level: y },
      ...
      s.days = [], J.forEach((U, H) => {
        ...
        let h;
        t ? x[Z] !== void 0 ? h = x[Z] : Z >= 0 && Z <= 2 ? h = O(`card.days.${Z}`, C) : h = U.date.toLocaleDateString(e, {
          day: "numeric",
          month: "short"
        }) : (h = U.date.toLocaleDateString(e, {
          weekday: a ? "short" : "long"
        }), h = h.charAt(0).toUpperCase() + h.slice(1)), i && (h = h.toUpperCase());
        const v = f.attributes[H === 0 ? TC : H === 1 ? VC : zC] || "", G = U.level * 2, F = Math.min(Math.max(Math.round(G), 0), 6), N = F < 0 ? c : l[F] || v;
        s[`day${H}`] = {
...
async function qC(n, A) {
  ...
  const g = !!A.debug, I = q(n, A.date_locale), C = A.date_locale || ((p = n.locale) == null ? void 0 : p.language) || n.language || `${I}-${I.toUpperCase()}`, e = A.days_relative !== !1, t = !!A.days_abbreviated, a = !!A.days_uppercase, i = {
    ...
    no_information: "",
    ...A.phrases || {}
  }, o = i.full, d = i.short, S = i.levels, r = 5;
  Array.isArray(S) && S.length === r || Array.from(
    { length: r },
    (D, E) => O(`card.levels.${E}`, I)
  );
  const l = i.no_information || O("card.no_information", I), c = i.days, x = A.integration === "dwd" ? 3 : A.integration === "peu" ? 4 : 6, b = (D) => {
    const E = Number(D);
    return isNaN(E) || E < 0 ? -1 : E > x ? x : E;
  }, m = /* @__PURE__ */ new Date();
  m.setHours(0, 0, 0, 0);
  const R = A.days_to_show ?? V.days_to_show, Y = A.pollen_threshold ?? V.pollen_threshold, M = Object.keys(n.states).filter(
  ...
  for (const D of A.allergens)
    try {
      ...
      if (E.allergenReplaced = f, o[f])
        ...
        const h = CA[f] || f, v = O(`card.allergen.${h}`, I);
        E.allergenCapitalized = v !== `card.allergen.${h}` ? v : f.charAt(0).toUpperCase() + f.slice(1);
      }
      if (A.allergens_abbreviated) {
        const h = d[f];
        E.allergenShort = h || O(`editor.phrases_short.${f}`, I) || E.allergenCapitalized;
      } else
      ...
      const B = j.attributes.forecast, J = Array.isArray(B) ? B.reduce((h, v) => {
        const G = v.time || v.datetime;
        return h[G] = v, h;
      }, {}) : {}, U = Object.keys(J).sort(
        (h, v) => new Date(h) - new Date(v)
      ).filter((h) => new Date(h) >= m);
      let H = [];
      if (U.length >= R)
        H = U.slice(0, R);
      else {
        H = U.slice();
        let h = U.length > 0 ? new Date(U[U.length - 1]) : m;
        for (; H.length < R; ) {
      ...
      H.forEach((h, v) => {
        const G = J[h] || {}, F = b(G.level), N = new Date(h), X = Math.round((N - m) / 864e5);
        let P;
        e ? c[X] != null ? P = c[X] : X >= 0 && X <= 2 ? P = O(`card.days.${X}`, I) : P = N.toLocaleDateString(C, {
          day: "numeric",
          month: "short"
        }) : (P = N.toLocaleDateString(C, {
          weekday: t ? "short" : "long"
        }), P = P.charAt(0).toUpperCase() + P.slice(1)), a && (P = P.toUpperCase());
        let AA;
      ...
      }), (E.days.some((h) => h.state >= Y) || Y === 0) && s.push(E);
    } catch (E) {
...
function GA(n, A) {
  return Array.isArray(n.levels) && n.levels.length === 7 ? n.levels : Array.from({ length: 7 }, (g, I) => O(`card.levels.${I}`, A));
}
function ZA(n, A, g) {
  let I;
...
async function gn(n, A) {
  var Y, M, Q;
  const g = !!A.debug, I = q(n, A.date_locale), C = A.date_locale || ((Y = n.locale) == null ? void 0 : Y.language) || n.language || `${I}-${I.toUpperCase()}`, e = A.days_relative !== !1, t = !!A.days_abbreviated, a = !!A.days_uppercase, i = MA(A, I), o = GA(i, I), d = i.no_information, S = i.days, r = /* @__PURE__ */ new Date();
  r.setHours(0, 0, 0, 0);
  const l = A.days_to_show ?? K.days_to_show, c = A.pollen_threshold ?? K.pollen_threshold, x = (A.location || "").toLowerCase(), b = Object.keys(n.states).filter((s) => {
  ...
  for (const s of b) {
    ...
    const u = p[2];
    let D = !1;
    for (const [E, f] of Object.entries(z.mapping))
      if (f[u]) {
        const y = f[u];
        m[y] = s, D = !0;
        break;
  ...
  for (const s of A.allergens)
    try {
      ...
      const f = n.states[E], y = Number(f.state);
      let j = [];
      ...
      if (B.push(tA(s, y)), f.attributes && Array.isArray(f.attributes.forecast) && f.attributes.forecast.length > 0)
        for (let k = 1; k < l; ++k) {
          const U = new Date(r.getTime() + k * 864e5), H = f.attributes.forecast.find(
            (h) => Math.abs(
      ...
      for (let k = 0; k < l; ++k) {
        ...
        let h;
        e ? S[Z] != null ? h = S[Z] : Z >= 0 && Z <= 2 ? h = O(`card.days.${Z}`, I) : h = H.toLocaleDateString(C, {
          day: "numeric",
          month: "short"
...
async function en(n, A, g = null) {
  ...
  if (I) {
    const m = Object.keys(n.states).filter(
  ...
  for (const m of Object.keys(n.states))
    if (m.startsWith("weather.silam_pollen_") && m.includes(a) && m.endsWith("forecast")) {
      i = m;
      break;
    }
  if (I && console.debug(
  ...
  const d = MA(A, C), S = GA(d, C), r = d.no_information, l = A.allergens || K.allergens;
  I && console.debug(
  ...
  for (const m of l)
    try {
      ...
      for (let s = 0; s < o.length; ++s) {
        const p = o[s], u = `pollen_${m}`, D = Number(p[u]), E = tA(m, D), f = E < 0 ? r : S[E] || String(E);
...
async function nn(n, A) {
  ...
  const g = [], I = !!A.debug, C = (u) => u.charAt(0).toUpperCase() + u.slice(1), e = (u) => {
    const [D] = u.split("T"), [E, f, y] = D.split("-").map(Number);
    return new Date(E, f - 1, y);
  }, t = /* @__PURE__ */ new Date();
  t.setHours(0, 0, 0, 0);
  const a = q(n, A.date_locale), i = A.date_locale || ((s = n.locale) == null ? void 0 : s.language) || n.language || `${a}-${a.toUpperCase()}`, o = A.days_relative !== !1, d = !!A.days_abbreviated, S = !!A.days_uppercase, r = {
    full: {},
    short: {},
    levels: [],
    days: {},
    no_information: "",
    ...A.phrases || {}
  }, l = r.full, c = r.short, x = r.levels, b = Array.isArray(x) && x.length === 7 ? x : Array.from({ length: 7 }, (u, D) => O(`card.levels.${D}`, a)), m = r.no_information || O("card.no_information", a), R = r.days;
  ...
  for (const u of A.allergens)
    try {
      ...
      if (D.allergenReplaced = E, this.debug && console.log(
        ...
        const h = CA[E] || E, v = O(`card.allergen.${h}`, a);
        D.allergenCapitalized = v !== `card.allergen.${h}` ? v : C(u);
      }
      if (A.allergens_abbreviated) {
        const h = CA[E] || E, v = c[u];
        D.allergenShort = v || O(`editor.phrases_short.${h}`, a) || D.allergenCapitalized;
      } else
      ...
      H.forEach((h, v) => {
        const G = J[h] || {}, F = Y(G.level), N = e(h), X = Math.round((N - t) / 864e5);
        let P;
        o ? R[X] != null ? P = R[X] : X >= 0 && X <= 2 ? P = O(`card.days.${X}`, a) : P = N.toLocaleDateString(i, {
          day: "numeric",
          month: "short"
...
function Cg(n, A, g = !1) {
  ...
  if (I === "pp") {
    ...
    for (const t of n.allergens || []) {
      const a = $(t), i = `sensor.pollen_${e}_${a}`, o = !!A.states[i];
      g && console.debug(
        `[findAvailableSensors][pp] allergen: '${t}', cityKey: '${e}', rawKey: '${a}', sensorId: '${i}', exists: ${o}`
      ), o && C.push(i);
    }
  } else if (I === "dwd")
    ...
    for (const t of n.allergens || []) {
      const a = $(t);
      let i = e ? `sensor.polleninformation_${e}_${a}` : null, o = i && A.states[i];
      if (!o) {
      ...
      g && console.debug(
        `[findAvailableSensors][peu] allergen: '${t}', locationSlug: '${e}', allergenSlug: '${a}', sensorId: '${i}', exists: ${!!o}`
      ), o && C.push(i);
    }
  } else if (I === "silam") {
    const e = (n.location || "").toLowerCase();
    for (const t of n.allergens || []) {
      ...
      for (const i of Object.values(z.mapping)) {
        const o = Object.entries(i).reduce((d, [S, r]) => (d[r] = S, d), {});
        if (o[t]) {
          const d = o[t], S = `sensor.silam_pollen_${e}_${d}`;
          if (A.states[S]) {
            a = d, g && console.debug(
...
class tn extends iA {
  ...
  set hass(g) {
    ...
    let o;
    i === "dwd" ? o = T : i === "peu" ? o = V : i === "pp" ? o = L : i === "silam" ? o = K : console.error("Unknown integration:", i);
    ...
    if (this.config = r, this.tapAction = r.tap_action || this.tapAction || null, this.debug && (console.debug("[Card][Debug] Aktiv integration:", i), console.debug("[Card][Debug] Allergens i config:", r.allergens)), r.title === "false" || r.title === !1 || typeof r.title == "string" && r.title.trim() === "")
      ...
      if (i === "dwd")
        ...
        if (p) {
          ...
          u = D.location_title || ((Y = (R = D.friendly_name) == null ? void 0 : R.match(/\((.*?)\)/)) == null ? void 0 : Y[1]) || r.location;
        }
        Q = u || r.location || "";
      } else if (i === "silam") {
        const s = [
        ...
        if (E) {
          ...
          f = y.location_title || ((M = y.friendly_name) == null ? void 0 : M.replace(/^SILAM Pollen\s*-?\s*/i, "").replace(new RegExp("\\s+\\p{L}+$", "u"), "").trim()) || r.location, f = f.replace(/^[-\s]+/, "");
        }
        Q = f || r.location || "";
      } else
        Q = JA.find(
    ...
    const l = ng[r.integration] || RA;
    let c = null;
    if (r.integration === "silam" && r.mode === "hourly" && typeof l.fetchHourlyForecast == "function") {
      ...
      return c.then((Q) => {
        ...
        let D = Q.filter((y) => {
          if (r.integration === "silam" && u && (!r.mode || r.mode === "daily")) {
            const j = r.location || "", B = u[y.allergenReplaced] || y.allergenReplaced, J = `sensor.silam_pollen_${j}_${B}`;
    ...
    return w`
      ...
      <div class="card-content">
        <div class="flex-container">
          ${(this.sensors || []).map((g) => {
      var t, a, i, o, d, S, r, l, c;
      const I = ((t = g.day0) == null ? void 0 : t.state_text) ?? "", C = ((a = g.day0) == null ? void 0 : a.state) ?? "";
      let e = "";
      return (i = this.config) != null && i.show_text_allergen && (e += (o = this.config) != null && o.allergens_abbreviated ? g.allergenShort ?? "" : g.allergenCapitalized ?? ""), (d = this.config) != null && d.show_value_text && ((S = this.config) != null && S.show_value_numeric) ? (e && (e += ": "), e += `${I} (${C})`) : (r = this.config) != null && r.show_value_text ? (e && (e += ": "), e += I) : (l = this.config) != null && l.show_value_numeric && (e && (e += " "), e += `(${C})`), w`
              <div class="sensor">
                <img
                  class="box"
    ...
    return this.debug && console.debug("Display columns:", I), w`
      ...
      (C) => {
        ...
        return w`
          ...
          let o = "";
          return this.config.show_value_text && this.config.show_value_numeric ? o = `${a} (${i})` : this.config.show_value_text ? o = a : this.config.show_value_numeric && (o = String(i)), w`<td>${o}</td>`;
        })}
                    </tr>
                  ` : ""}
            `;
...
class an extends iA {
  ...
  _resetPhrases(A) {
    ...
    g.forEach((o) => {
      const d = $(o), S = CA[d] || d;
      I[o] = O(`editor.phrases_full.${S}`, A), C[o] = O(`editor.phrases_short.${S}`, A);
    });
  ...
  setConfig(A) {
    ...
    try {
      ...
      if (this._userConfig.hasOwnProperty("pollen_threshold") || (S.pollen_threshold = d.pollen_threshold, this.debug && console.debug(
        ...
        const r = q(this._hass, null), l = ((I = (g = this._hass) == null ? void 0 : g.locale) == null ? void 0 : I.language) || `${r}-${r.toUpperCase()}`;
  ...
  set hass(A) {
    ...
    if (this.debug) {
      ...
      const l = Object.values(z.mapping).flatMap(
  ...
  _updateConfig(A, g) {
    ...
    if (A === "integration") {
      ...
      C = { ...this._config, [A]: g }, this._config.integration === "silam" && A === "mode" && (g === "hourly" || g === "twice daily" ? C.days_to_show = 8 : g === "daily" && (C.days_to_show = 2));
