 ...
 */
const EA = window, JA = EA.ShadowRoot && (EA.ShadyCSS === void 0 || EA.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, OA = Symbol(), ZA = /* @__PURE__ */ new WeakMap();
let Ig = class {
  constructor(A, g, I) {
  ...
  get styleSheet() {
    ...
    if (JA && A === void 0) {
      ...
      I && (A = ZA.get(g)), A === void 0 && ((this.o = A = new CSSStyleSheet()).replaceSync(this.cssText), I && ZA.set(g, A));
    }
    return A;
  }
  toString() {
...
const sg = (n) => new Ig(typeof n == "string" ? n : n + "", void 0, OA), Cg = (n, ...A) => {
  const g = n.length === 1 ? n[0] : A.reduce((I, C, e) => I + ((t) => {
    if (t._$cssResult$ === !0) return t.cssText;
    if (typeof t == "number") return t;
    throw Error("Value passed to 'css' function must be a 'css' function result: " + t + ". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.");
  })(C) + n[e + 1], n[0]);
  return new Ig(g, n, OA);
}, Dg = (n, A) => {
  JA ? n.adoptedStyleSheets = A.map((g) => g instanceof CSSStyleSheet ? g : g.styleSheet) : A.forEach((g) => {
...
}, WA = JA ? (n) => n : (n) => n instanceof CSSStyleSheet ? ((A) => {
  let g = "";
 ...
 */
var mA;
const pA = window, FA = pA.trustedTypes, hg = FA ? FA.emptyScript : "", LA = pA.reactiveElementPolyfillSupport, vA = { toAttribute(n, A) {
  switch (A) {
    case Boolean:
      n = n ? hg : null;
      break;
  ...
  return g;
} }, ng = (n, A) => A !== n && (A == A || n == n), BA = { attribute: !0, type: String, converter: vA, reflect: !1, hasChanged: ng }, RA = "finalized";
let nA = class extends HTMLElement {
  ...
  static finalize() {
    if (this.hasOwnProperty(RA)) return !1;
    this[RA] = !0;
  ...
  createRenderRoot() {
    ...
    return Dg(g, this.constructor.elementStyles), g;
  }
  connectedCallback() {
    var A;
  ...
  _$EO(A, g, I = BA) {
    ...
    if (e !== void 0 && I.reflect === !0) {
      const t = (((C = I.converter) === null || C === void 0 ? void 0 : C.toAttribute) !== void 0 ? I.converter : vA).toAttribute(g, I.type);
  ...
  _$AK(A, g) {
    ...
    if (e !== void 0 && this._$El !== e) {
      const t = C.getPropertyOptions(e), i = typeof t.converter == "function" ? { fromAttribute: t.converter } : ((I = t.converter) === null || I === void 0 ? void 0 : I.fromAttribute) !== void 0 ? t.converter : vA;
      this._$El = e, this[e] = i.fromAttribute(g, t.type), this._$El = null;
    }
  }
  requestUpdate(A, g, I) {
    let C = !0;
    A !== void 0 && (((I = I || this.constructor.getPropertyOptions(A)).hasChanged || ng)(this[A], g) ? (this._$AL.has(A) || this._$AL.set(A, g), I.reflect === !0 && this._$El !== A && (this._$EC === void 0 && (this._$EC = /* @__PURE__ */ new Map()), this._$EC.set(A, I))) : C = !1), !this.isUpdatePending && C && (this._$E_ = this._$Ej());
  }
  async _$Ej() {
...
nA[RA] = !0, nA.elementProperties = /* @__PURE__ */ new Map(), nA.elementStyles = [], nA.shadowRootOptions = { mode: "open" }, LA == null || LA({ ReactiveElement: nA }), ((mA = pA.reactiveElementVersions) !== null && mA !== void 0 ? mA : pA.reactiveElementVersions = []).push("1.6.3");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
var UA;
const cA = window, rA = cA.trustedTypes, KA = rA ? rA.createPolicy("lit-html", { createHTML: (n) => n }) : void 0, jA = "$lit$", _ = `lit$${(Math.random() + "").slice(9)}$`, tg = "?" + _, dg = `<${tg}>`, IA = document, hA = () => IA.createComment(""), dA = (n) => n === null || typeof n != "object" && typeof n != "function", ig = Array.isArray, Qg = (n) => ig(n) || typeof (n == null ? void 0 : n[Symbol.iterator]) == "function", xA = `[ 	
\f\r]`, sA = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, VA = /-->/g, TA = />/g, gA = RegExp(`>|${xA}(?:([^\\s"'>=/]+)(${xA}*=${xA}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), zA = /'/g, NA = /"/g, rg = /^(?:script|style|textarea|title)$/i, Sg = (n) => (A, ...g) => ({ _$litType$: n, strings: A, values: g }), R = Sg(1), aA = Symbol.for("lit-noChange"), W = Symbol.for("lit-nothing"), XA = /* @__PURE__ */ new WeakMap(), eA = IA.createTreeWalker(IA, 129, null, !1);
function ag(n, A) {
  if (!Array.isArray(n) || !n.hasOwnProperty("raw")) throw Error("invalid template strings array");
  return KA !== void 0 ? KA.createHTML(A) : A;
}
const Eg = (n, A) => {
  ...
  for (let i = 0; i < g; i++) {
    const a = n[i];
    let l, h, r = -1, E = 0;
    for (; E < a.length && (t.lastIndex = E, h = t.exec(a), h !== null); ) E = t.lastIndex, t === sA ? h[1] === "!--" ? t = VA : h[1] !== void 0 ? t = TA : h[2] !== void 0 ? (rg.test(h[2]) && (C = RegExp("</" + h[2], "g")), t = gA) : h[3] !== void 0 && (t = gA) : t === gA ? h[0] === ">" ? (t = C ?? sA, r = -1) : h[1] === void 0 ? r = -2 : (r = t.lastIndex - h[2].length, l = h[1], t = h[3] === void 0 ? gA : h[3] === '"' ? NA : zA) : t === NA || t === zA ? t = gA : t === VA || t === TA ? t = sA : (t = gA, C = void 0);
    const o = t === gA && n[i + 1].startsWith("/>") ? " " : "";
    e += t === sA ? a + dg : r >= 0 ? (I.push(l), a.slice(0, r) + jA + a.slice(r) + _ + o) : a + _ + (r === -2 ? (I.push(void 0), i) : o);
  }
  return [ag(n, e + (n[g] || "<?>") + (A === 2 ? "</svg>" : "")), I];
};
class QA {
  constructor({ strings: A, _$litType$: g }, I) {
    ...
    this.parts = [];
    let e = 0, t = 0;
    const i = A.length - 1, a = this.parts, [l, h] = Eg(A, g);
    ...
    for (; (C = eA.nextNode()) !== null && a.length < i; ) {
      if (C.nodeType === 1) {
        if (C.hasAttributes()) {
          const r = [];
          for (const E of C.getAttributeNames()) if (E.endsWith(jA) || E.startsWith(_)) {
            const o = h[t++];
            if (r.push(E), o !== void 0) {
              const u = C.getAttribute(o.toLowerCase() + jA).split(_), w = /([.?@])?(.*)/.exec(o);
              a.push({ type: 1, index: e, name: w[2], strings: u, ctor: w[1] === "." ? cg : w[1] === "?" ? fg : w[1] === "@" ? mg : fA });
            } else a.push({ type: 6, index: e });
          }
          for (const E of r) C.removeAttribute(E);
        }
        if (rg.test(C.tagName)) {
          const r = C.textContent.split(_), E = r.length - 1;
          if (E > 0) {
            C.textContent = rA ? rA.emptyScript : "";
            for (let o = 0; o < E; o++) C.append(r[o], hA()), eA.nextNode(), a.push({ type: 2, index: ++e });
            C.append(r[E], hA());
          }
        }
      } else if (C.nodeType === 8) if (C.data === tg) a.push({ type: 2, index: e });
      else {
        let r = -1;
        for (; (r = C.data.indexOf(_, r + 1)) !== -1; ) a.push({ type: 7, index: e }), r += _.length - 1;
      }
      e++;
    }
  }
...
function lA(n, A, g = n, I) {
  var C, e, t, i;
  if (A === aA) return A;
  let a = I !== void 0 ? (C = g._$Co) === null || C === void 0 ? void 0 : C[I] : g._$Cl;
  const l = dA(A) ? void 0 : A._$litDirective$;
  return (a == null ? void 0 : a.constructor) !== l && ((e = a == null ? void 0 : a._$AO) === null || e === void 0 || e.call(a, !1), l === void 0 ? a = void 0 : (a = new l(n), a._$AT(n, g, I)), I !== void 0 ? ((t = (i = g)._$Co) !== null && t !== void 0 ? t : i._$Co = [])[I] = a : g._$Cl = a), a !== void 0 && (A = lA(n, a._$AS(n, A.values), a, I)), A;
}
class pg {
  constructor(A, g) {
  ...
  u(A) {
    ...
    eA.currentNode = e;
    let t = eA.nextNode(), i = 0, a = 0, l = C[0];
    for (; l !== void 0; ) {
      if (i === l.index) {
        let h;
        l.type === 2 ? h = new SA(t, t.nextSibling, this, A) : l.type === 1 ? h = new l.ctor(t, l.name, l.strings, this, A) : l.type === 6 && (h = new Bg(t, this, A)), this._$AV.push(h), l = C[++a];
      }
      i !== (l == null ? void 0 : l.index) && (t = eA.nextNode(), i++);
    }
...
class SA {
  ...
  _$AI(A, g = this) {
    A = lA(this, A, g), dA(A) ? A === W || A == null || A === "" ? (this._$AH !== W && this._$AR(), this._$AH = W) : A !== this._$AH && A !== aA && this._(A) : A._$litType$ !== void 0 ? this.g(A) : A.nodeType !== void 0 ? this.$(A) : Qg(A) ? this.T(A) : this._(A);
  }
  k(A) {
  ...
  g(A) {
    var g;
    const { values: I, _$litType$: C } = A, e = typeof C == "number" ? this._$AC(A) : (C.el === void 0 && (C.el = QA.createElement(ag(C.h, C.h[0]), this.options)), C);
    if (((g = this._$AH) === null || g === void 0 ? void 0 : g._$AD) === e) this._$AH.v(I);
    else {
      const t = new pg(e, this), i = t.u(this.options);
      t.v(I), this.$(i), this._$AH = t;
    }
  }
  _$AC(A) {
    let g = XA.get(A.strings);
    return g === void 0 && XA.set(A.strings, g = new QA(A)), g;
  }
  T(A) {
...
class fA {
  ...
  _$AI(A, g = this, I, C) {
    ...
    if (e === void 0) A = lA(this, A, g, 0), t = !dA(A) || A !== this._$AH && A !== aA, t && (this._$AH = A);
      ...
      const i = A;
      let a, l;
      for (A = e[0], a = 0; a < e.length - 1; a++) l = lA(this, i[I + a], g, a), l === aA && (l = this._$AH[a]), t || (t = !dA(l) || l !== this._$AH[a]), l === W ? A = W : A !== W && (A += (l ?? "") + e[a + 1]), this._$AH[a] = l;
    }
    t && !C && this.j(A);
  }
  j(A) {
...
const ug = rA ? rA.emptyScript : "";
class fg extends fA {
  constructor() {
    super(...arguments), this.type = 4;
  }
  j(A) {
    A && A !== W ? this.element.setAttribute(this.name, ug) : this.element.removeAttribute(this.name);
  }
}
class mg extends fA {
  constructor(A, g, I, C, e) {
...
const qA = cA.litHtmlPolyfillSupport;
qA == null || qA(QA, SA), ((UA = cA.litHtmlVersions) !== null && UA !== void 0 ? UA : cA.litHtmlVersions = []).push("2.8.0");
const Ug = (n, A, g) => {
  var I, C;
  const e = (I = g == null ? void 0 : g.renderBefore) !== null && I !== void 0 ? I : A;
  let t = e._$litPart$;
  if (t === void 0) {
    const i = (C = g == null ? void 0 : g.renderBefore) !== null && C !== void 0 ? C : null;
    e._$litPart$ = t = new SA(A.insertBefore(hA(), i), i, void 0, g ?? {});
  }
  return t._$AI(n), t;
};
/**
...
class iA extends nA {
  ...
  update(A) {
    const g = this.render();
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(A), this._$Do = Ug(g, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
    var A;
...
_A == null || _A({ LitElement: iA });
((yA = globalThis.litElementVersions) !== null && yA !== void 0 ? yA : globalThis.litElementVersions = []).push("3.3.3");
const kA = (n, A = "_") => {
  ...
  lime_6_png: Xe,
  // mold_spores
  "mold_spores_-1_png": nI,
  mold_spores_0_png: _e,
  mold_spores_1_png: $e,
  mold_spores_2_png: AI,
  mold_spores_3_png: gI,
  mold_spores_4_png: eI,
  mold_spores_5_png: II,
  mold_spores_6_png: CI,
  // mugwort
  "mugwort_-1_png": DI,
  mugwort_0_png: tI,
  mugwort_1_png: iI,
  ...
  "nettle_and_pellitory_-1_png": uI,
  nettle_and_pellitory_0_png: hI,
  nettle_and_pellitory_1_png: dI,
  nettle_and_pellitory_2_png: QI,
  nettle_and_pellitory_3_png: SI,
  nettle_and_pellitory_4_png: EI,
  nettle_and_pellitory_5_png: pI,
  nettle_and_pellitory_6_png: cI,
  // oak
  "oak_-1_png": vI,
  oak_0_png: fI,
  oak_1_png: mI,
  ...
  __proto__: null,
  default: OC
}, Symbol.toStringTag, { value: "Module" })), Ag = /* @__PURE__ */ Object.assign({ "./locales/cs.json": SC, "./locales/da.json": pC, "./locales/de.json": uC, "./locales/en.json": mC, "./locales/fi.json": UC, "./locales/it.json": wC, "./locales/nl.json": vC, "./locales/no.json": jC, "./locales/ru.json": HC, "./locales/sk.json": JC, "./locales/sv.json": YC }), oA = {};
for (const n in Ag) {
  const A = n.match(/\.\/locales\/([\w-]+)\.json$/);
  A && (oA[A[1]] = Ag[n].default);
}
const HA = "en";
function gg(n, A) {
...
function q(n, A) {
  var C;
  let g = A || ((C = n == null ? void 0 : n.locale) == null ? void 0 : C.language) || (n == null ? void 0 : n.language) || HA;
  if (oA[g])
    return g;
  const I = g.slice(0, 2).toLowerCase();
  return oA[I] ? I : HA;
}
const PC = Object.keys(oA);
function b(n, A) {
  const g = oA[A] || {};
  if (g[n] !== void 0)
    return g[n];
...
const MC = "state_tomorrow", GC = "state_in_2_days", ZC = "state_today_desc", WC = "state_tomorrow_desc", FC = "state_in_2_days_desc", V = {
  integration: "dwd",
  region_id: "",
  allergens: [
    "erle",
...
async function LC(n, A) {
  const g = !!A.debug, I = (f) => f.charAt(0).toUpperCase() + f.slice(1), C = q(n, A.date_locale), e = A.date_locale || V.date_locale, t = A.days_relative !== !1, i = !!A.days_abbreviated, a = !!A.days_uppercase, l = A.phrases || {}, h = l.full || {}, r = l.short || {}, E = l.levels, o = Array.isArray(E) && E.length === 7 ? E : Array.from({ length: 7 }, (f, s) => b(`card.levels.${s}`, C)), u = l.no_information || b("card.no_information", C), w = l.days || {}, H = A.days_to_show ?? V.days_to_show, U = A.pollen_threshold ?? V.pollen_threshold;
  ...
  for (const f of A.allergens)
    try {
      ...
      const c = CA[p] || p, d = h[f];
      if (d)
        s.allergenCapitalized = d;
      else {
        const O = `card.allergen.${CA[p] || p}`, Z = b(O, C);
        s.allergenCapitalized = Z !== O ? Z : I(f);
      }
      if (A.allergens_abbreviated) {
        const x = r[f];
        s.allergenShort = x || b(`editor.phrases_short.${c}`, C) || s.allergenCapitalized;
      } else
        s.allergenShort = s.allergenCapitalized;
      let Q = A.region_id ? `sensor.pollenflug_${p}_${A.region_id}` : null;
      if (!Q || !n.states[Q]) {
        const x = Object.keys(n.states).filter(
          (O) => O.startsWith(`sensor.pollenflug_${p}_`)
        );
        if (x.length === 1) Q = x[0];
        else continue;
      }
      const S = n.states[Q], v = j(S.state), B = j(S.attributes[MC]), k = j(S.attributes[GC]), G = [
        { date: P, level: v },
        { date: new Date(P.getTime() + 864e5), level: B },
        { date: new Date(P.getTime() + 2 * 864e5), level: k }
      ];
      for (; G.length < H; ) {
        const x = G.length;
        G.push({
          date: new Date(P.getTime() + x * 864e5),
          level: -1
        });
      }
      s.days = [], G.forEach((x, O) => {
        const Z = Math.round((x.date - P) / 864e5);
        let D;
        t ? w[Z] !== void 0 ? D = w[Z] : Z >= 0 && Z <= 2 ? D = b(`card.days.${Z}`, C) : D = x.date.toLocaleDateString(e, {
          day: "numeric",
          month: "short"
        }) : (D = x.date.toLocaleDateString(e, {
          weekday: i ? "short" : "long"
        }), D = D.charAt(0).toUpperCase() + D.slice(1)), a && (D = D.toUpperCase());
        const y = S.attributes[O === 0 ? ZC : O === 1 ? WC : FC] || "", M = x.level * 2, F = Math.min(Math.max(Math.round(M), 0), 6), N = F < 0 ? u : o[F] || y;
        s[`day${O}`] = {
      ...
      }), (G.slice(0, H).some((x) => x.level >= U) || U === 0) && m.push(s);
    } catch (s) {
      console.warn(`DWD adapter error for allergen ${f}:`, s);
    }
  return m.sort(
    {
      value_ascending: (f, s) => f.day0.state - s.day0.state,
      value_descending: (f, s) => s.day0.state - f.day0.state,
      name_descending: (f, s) => s.allergenCapitalized.localeCompare(f.allergenCapitalized)
    }[A.sort] || ((f, s) => s.day0.state - f.day0.state)
...
async function VC(n, A) {
  var p, c;
  const g = !!A.debug, I = q(n, A.date_locale), C = A.date_locale || ((p = n.locale) == null ? void 0 : p.language) || n.language || `${I}-${I.toUpperCase()}`, e = A.days_relative !== !1, t = !!A.days_abbreviated, i = !!A.days_uppercase, a = {
    full: {},
    short: {},
    levels: [],
    days: {},
    no_information: "",
    ...A.phrases || {}
  }, l = a.full, h = a.short, r = a.levels, E = 5;
  Array.isArray(r) && r.length === E || Array.from(
    { length: E },
    (d, Q) => b(`card.levels.${Q}`, I)
  );
  const o = a.no_information || b("card.no_information", I), u = a.days, w = A.integration === "dwd" ? 3 : A.integration === "peu" ? 4 : 6, H = (d) => {
    const Q = Number(d);
    return isNaN(Q) || Q < 0 ? -1 : Q > w ? w : Q;
  }, U = /* @__PURE__ */ new Date();
  U.setHours(0, 0, 0, 0);
  const j = A.days_to_show ?? T.days_to_show, P = A.pollen_threshold ?? T.pollen_threshold, m = Object.keys(n.states).filter(
    (d) => d.startsWith("sensor.polleninformation_")
  );
  let f = A.location;
  !f && m.length && (f = m[0].slice(25).split("_")[0]);
  const s = [];
  for (const d of A.allergens)
    try {
      ...
      Q.days = [];
      const S = d;
      if (Q.allergenReplaced = S, l[S])
        Q.allergenCapitalized = l[S];
      else {
        const D = CA[S] || S, y = b(`card.allergen.${D}`, I);
        Q.allergenCapitalized = y !== `card.allergen.${D}` ? y : S.charAt(0).toUpperCase() + S.slice(1);
      }
      if (A.allergens_abbreviated) {
        const D = h[S];
        Q.allergenShort = D || b(`editor.phrases_short.${S}`, I) || Q.allergenCapitalized;
      } else
        Q.allergenShort = Q.allergenCapitalized;
      let v = f ? `sensor.polleninformation_${f}_${S}` : null;
      if (!v || !n.states[v]) {
        const D = m.filter((y) => {
          const M = y.match(/^sensor\.polleninformation_(.+)_(.+)$/);
          if (!M) return !1;
          const F = M[1], N = M[2];
          return (!f || F === f) && N === S;
        });
      ...
      const B = n.states[v];
      if (!((c = B == null ? void 0 : B.attributes) != null && c.forecast)) throw "Missing forecast";
      const k = B.attributes.forecast, G = Array.isArray(k) ? k.reduce((D, y) => {
        const M = y.time || y.datetime;
        return D[M] = y, D;
      }, {}) : {}, x = Object.keys(G).sort(
        (D, y) => new Date(D) - new Date(y)
      ).filter((D) => new Date(D) >= U);
      let O = [];
      if (x.length >= j)
        O = x.slice(0, j);
      else {
        O = x.slice();
        let D = x.length > 0 ? new Date(x[x.length - 1]) : U;
        for (; O.length < j; ) {
          D = new Date(D.getTime() + 864e5);
          const y = D.getFullYear(), M = String(D.getMonth() + 1).padStart(2, "0"), F = String(D.getDate()).padStart(2, "0");
          O.push(`${y}-${M}-${F}T00:00:00`);
        }
      }
      O.forEach((D, y) => {
        const M = G[D] || {}, F = H(M.level), N = new Date(D), X = Math.round((N - U) / 864e5);
        let Y;
        e ? u[X] != null ? Y = u[X] : X >= 0 && X <= 2 ? Y = b(`card.days.${X}`, I) : Y = N.toLocaleDateString(C, {
          day: "numeric",
          month: "short"
        }) : (Y = N.toLocaleDateString(C, {
          weekday: t ? "short" : "long"
        }), Y = Y.charAt(0).toUpperCase() + Y.slice(1)), i && (Y = Y.toUpperCase());
        let AA;
        F < 2 ? AA = Math.floor(F * 6 / 4) : AA = Math.ceil(F * 6 / 4);
        const GA = {
          name: Q.allergenCapitalized,
          day: Y,
          state: F,
          state_text: AA < 0 ? o : b(`card.levels.${AA}`, I)
        };
        Q[`day${y}`] = GA, Q.days.push(GA);
      }), (Q.days.some((D) => D.state >= P) || P === 0) && s.push(Q);
    } catch (Q) {
      g && console.warn(`Fel vid allergen ${d}:`, Q);
    }
  return s.sort(
    {
      value_ascending: (d, Q) => d.day0.state - Q.day0.state,
      value_descending: (d, Q) => Q.day0.state - d.day0.state,
      name_ascending: (d, Q) => d.allergenCapitalized.localeCompare(Q.allergenCapitalized),
      name_descending: (d, Q) => Q.allergenCapitalized.localeCompare(d.allergenCapitalized)
    }[A.sort] || ((d, Q) => Q.day0.state - d.day0.state)
...
function PA(n, A) {
  return Array.isArray(n.levels) && n.levels.length === 7 ? n.levels : Array.from({ length: 7 }, (g, I) => b(`card.levels.${I}`, A));
}
function MA(n, A, g) {
  let I;
...
async function XC(n, A) {
  var P, m, f;
  const g = !!A.debug, I = q(n, A.date_locale), C = A.date_locale || ((P = n.locale) == null ? void 0 : P.language) || n.language || `${I}-${I.toUpperCase()}`, e = A.days_relative !== !1, t = !!A.days_abbreviated, i = !!A.days_uppercase, a = YA(A, I), l = PA(a, I), h = a.no_information, r = a.days, E = /* @__PURE__ */ new Date();
  E.setHours(0, 0, 0, 0);
  const o = A.days_to_show ?? K.days_to_show, u = A.pollen_threshold ?? K.pollen_threshold, w = (A.location || "").toLowerCase(), H = Object.keys(n.states).filter((s) => {
  ...
  for (const s of H) {
    ...
    const c = p[2];
    let d = !1;
    for (const [Q, S] of Object.entries(z.mapping))
      if (S[c]) {
        const v = S[c];
        U[v] = s, d = !0;
        break;
    ...
    !d && g && console.debug(
      `[SILAM][fetchForecast] Hittade ingen master-key för haSlug: '${c}'`
    );
  }
  const j = [];
  for (const s of A.allergens)
    try {
      ...
      const { allergenCapitalized: c, allergenShort: d } = MA(
        s,
        a,
        I
      );
      p.allergenCapitalized = c, p.allergenShort = A.allergens_abbreviated ? d : c;
      const Q = U[s];
      if (!Q || !n.states[Q]) {
        g && console.debug(`[SILAM] Ingen sensor för ${s}:`, Q);
        continue;
      }
      const S = n.states[Q], v = Number(S.state);
      let B = [];
      S.attributes && S.attributes.forecast && Array.isArray(S.attributes.forecast) && (B = S.attributes.forecast.map((J) => ({
        date: new Date(J.datetime || J.time),
        value: Number(J.value)
      })).filter(
        (J) => !isNaN(J.value) && J.date instanceof Date && !isNaN(J.date)
      ), B.sort((J, x) => J.date - x.date));
      let k = [];
      if (k.push(tA(s, v)), S.attributes && Array.isArray(S.attributes.forecast) && S.attributes.forecast.length > 0)
        for (let J = 1; J < o; ++J) {
          const x = new Date(E.getTime() + J * 864e5), O = S.attributes.forecast.find(
            (D) => Math.abs(
              new Date(D.datetime || D.time).getTime() - x.getTime()
            ) < 12 * 3600 * 1e3
          ), Z = O ? tA(s, Number(O.value)) : -1;
          k.push(Z);
        }
      else
        for (o > 1 && ((m = S.attributes) == null ? void 0 : m.tomorrow) !== void 0 ? k.push(
          tA(s, Number(S.attributes.tomorrow))
        ) : o > 1 && k.push(-1); k.length < o; )
          k.push(-1);
      k.length < o && ((f = S.attributes) == null ? void 0 : f.tomorrow) !== void 0 && (k[1] = tA(s, Number(S.attributes.tomorrow)) || -1);
      for (let J = 0; J < o; ++J) {
        const x = k[J], O = new Date(E.getTime() + J * 864e5), Z = J;
        let D;
        e ? r[Z] != null ? D = r[Z] : Z >= 0 && Z <= 2 ? D = b(`card.days.${Z}`, I) : D = O.toLocaleDateString(C, {
          day: "numeric",
          month: "short"
        }) : (D = O.toLocaleDateString(C, {
          weekday: t ? "short" : "long"
        }), D = D.charAt(0).toUpperCase() + D.slice(1)), i && (D = D.toUpperCase());
        const y = x < 0 ? 0 : Math.min(Math.round(x), 6), M = x < 0 ? h : l[y] || String(x);
        p[`day${J}`] = {
      ...
      (p.days.some((J) => J.state >= u) || u === 0) && j.push(p);
    } catch (p) {
...
async function qC(n, A) {
  var w, H;
  const g = !!A.debug, I = q(n, A.date_locale), C = A.date_locale || ((w = n.locale) == null ? void 0 : w.language) || n.language || `${I}-${I.toUpperCase()}`, e = A.pollen_threshold ?? K.pollen_threshold;
  if (g) {
  ...
  let t = (A.location || "").toLowerCase(), i = null;
  for (const U of Object.keys(n.states))
    if (U.startsWith("weather.silam_pollen_") && U.includes(t) && U.endsWith("_pollenprognos_beta")) {
      i = U;
      break;
    }
  if (g && console.debug(
  ...
  const a = n.states[i];
  if (!((H = a == null ? void 0 : a.attributes) != null && H.forecast) || !Array.isArray(a.attributes.forecast))
    return g && console.warn(
  ...
  const l = a.attributes.forecast;
  g && (console.debug(
    "[SILAM][fetchHourlyForecast] Forecast-array längd:",
    l.length
  ), l.length > 0 && console.debug(
    "[SILAM][fetchHourlyForecast] Första forecast-objektet:",
    l[0]
  ));
  const h = YA(A, I), r = PA(h, I), E = h.no_information, o = A.allergens || K.allergens;
  g && console.debug(
  ...
  for (const U of o)
    try {
      g && console.debug(
        `[SILAM][fetchHourlyForecast] Loop allergen: '${U}'`
      );
      const j = {};
      j.days = [], j.allergenReplaced = U;
      const { allergenCapitalized: P, allergenShort: m } = MA(
        U,
        h,
        I
      );
      j.allergenCapitalized = P, j.allergenShort = A.allergens_abbreviated ? m : P;
      for (let s = 0; s < l.length; ++s) {
        const p = l[s], c = `pollen_${U}`, d = Number(p[c]);
        g && console.debug(
          `[SILAM][fetchHourlyForecast] forecast[${s}] key: ${c} → värde:`,
          p[c],
          "(num)",
          d,
          "obj:",
        ...
        const Q = tA(U, d), S = Q < 0 ? E : r[Q] || String(Q);
        let B = new Date(p.datetime || p.time).toLocaleTimeString(C, {
          hour: "2-digit",
          minute: "2-digit"
        }) || "";
        j[`day${s}`] = {
      ...
      const f = j.days.some((s) => s.state >= e);
      g && console.debug(
        `[SILAM][fetchHourlyForecast] Resultat för allergen ${U}:`,
        j,
        "meets:",
        f
      ), (f || e === 0) && u.push(j);
    } catch (j) {
      g && console.warn(`[SILAM][hourly] Fel vid allergen ${U}:`, j);
    }
  return g && console.debug("[SILAM][fetchHourlyForecast] Klar. sensors:", u), u;
}
const _C = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  SILAM_THRESHOLDS: lg,
  fetchForecast: XC,
  fetchHourlyForecast: qC,
  getAllergenNames: MA,
  getLevelNames: PA,
  getPhrases: YA,
  grainsToLevel: tA,
...
async function An(n, A) {
  var s, p;
  const g = [], I = !!A.debug, C = (c) => c.charAt(0).toUpperCase() + c.slice(1), e = (c) => {
    const [d] = c.split("T"), [Q, S, v] = d.split("-").map(Number);
    return new Date(Q, S - 1, v);
  }, t = /* @__PURE__ */ new Date();
  t.setHours(0, 0, 0, 0);
  const i = q(n, A.date_locale), a = A.date_locale || ((s = n.locale) == null ? void 0 : s.language) || n.language || `${i}-${i.toUpperCase()}`, l = A.days_relative !== !1, h = !!A.days_abbreviated, r = !!A.days_uppercase, E = {
    full: {},
    short: {},
    levels: [],
    days: {},
    no_information: "",
    ...A.phrases || {}
  }, o = E.full, u = E.short, w = E.levels, H = Array.isArray(w) && w.length === 7 ? w : Array.from({ length: 7 }, (c, d) => b(`card.levels.${d}`, i)), U = E.no_information || b("card.no_information", i), j = E.days;
  I && console.debug("PP.fetchForecast — start", { city: A.city, lang: i });
  const P = (c) => {
    const d = Number(c);
    return isNaN(d) || d < 0 ? -1 : d > 6 ? 6 : d;
  }, m = A.days_to_show ?? L.days_to_show, f = A.pollen_threshold ?? L.pollen_threshold;
  for (const c of A.allergens)
    try {
      const d = {};
      d.days = [];
      const Q = $(c);
      if (d.allergenReplaced = Q, this.debug && console.log(
        "[PP] allergen",
        c,
        "fullPhrases keys",
        Object.keys(o)
      ), o[c])
        d.allergenCapitalized = o[c];
      else {
        const D = CA[Q] || Q, y = b(`card.allergen.${D}`, i);
        d.allergenCapitalized = y !== `card.allergen.${D}` ? y : C(c);
      }
      if (A.allergens_abbreviated) {
        const D = CA[Q] || Q, y = u[c];
        d.allergenShort = y || b(`editor.phrases_short.${D}`, i) || d.allergenCapitalized;
      } else
        d.allergenShort = d.allergenCapitalized;
      const S = $(A.city);
      let v = `sensor.pollen_${S}_${Q}`;
      if (!n.states[v]) {
        const D = Object.keys(n.states).filter(
          (y) => y.startsWith(`sensor.pollen_${S}_`) && y.includes(Q)
        );
        if (D.length === 1) v = D[0];
        else continue;
      }
      const B = n.states[v];
      if (!((p = B == null ? void 0 : B.attributes) != null && p.forecast)) throw "Missing forecast";
      const k = B.attributes.forecast, G = Array.isArray(k) ? k.reduce((D, y) => {
        const M = y.time || y.datetime;
        return D[M] = y, D;
      }, {}) : k, x = Object.keys(G).sort(
        (D, y) => e(D) - e(y)
      ).filter((D) => e(D) >= t);
      let O = [];
      if (x.length >= m)
        ...
        O = x.slice();
        let D = x.length > 0 ? e(x[x.length - 1]) : t;
        for (; O.length < m; ) {
          D = new Date(D.getTime() + 864e5);
          const y = D.getFullYear(), M = String(D.getMonth() + 1).padStart(2, "0"), F = String(D.getDate()).padStart(2, "0");
          O.push(`${y}-${M}-${F}T00:00:00`);
      ...
      O.forEach((D, y) => {
        const M = G[D] || {}, F = P(M.level), N = e(D), X = Math.round((N - t) / 864e5);
        let Y;
        l ? j[X] != null ? Y = j[X] : X >= 0 && X <= 2 ? Y = b(`card.days.${X}`, i) : Y = N.toLocaleDateString(a, {
          day: "numeric",
          month: "short"
        }) : (Y = N.toLocaleDateString(a, {
          weekday: h ? "short" : "long"
        }), Y = Y.charAt(0).toUpperCase() + Y.slice(1)), r && (Y = Y.toUpperCase());
        const AA = {
          name: d.allergenCapitalized,
          day: Y,
          state: F,
          state_text: F < 0 ? U : H[F]
        };
        d[`day${y}`] = AA, d.days.push(AA);
      }), (d.days.some((D) => D.state >= f) || f === 0) && g.push(d);
    } catch (d) {
      console.warn(`[PP] Fel vid allergen ${c}:`, d);
    }
  return g.sort(
    {
      value_ascending: (c, d) => c.day0.state - d.day0.state,
      value_descending: (c, d) => d.day0.state - c.day0.state,
      name_ascending: (c, d) => c.allergenCapitalized.localeCompare(d.allergenCapitalized),
      name_descending: (c, d) => d.allergenCapitalized.localeCompare(c.allergenCapitalized)
    }[A.sort] || ((c, d) => d.day0.state - c.day0.state)
...
function gn(n, A, g = !1) {
  ...
  if (I === "pp") {
    ...
    for (const t of n.allergens || []) {
      const i = $(t), a = `sensor.pollen_${e}_${i}`, l = !!A.states[a];
      g && console.debug(
        `[findAvailableSensors][pp] allergen: '${t}', cityKey: '${e}', rawKey: '${i}', sensorId: '${a}', exists: ${l}`
      ), l && C.push(a);
    }
  } else if (I === "dwd")
    for (const e of n.allergens || []) {
      const t = uA(e);
      let i = n.region_id ? `sensor.pollenflug_${t}_${n.region_id}` : null, a = i && A.states[i];
      if (!a) {
        const l = Object.keys(A.states).filter(
          (h) => h.startsWith(`sensor.pollenflug_${t}_`)
        );
        l.length === 1 && (i = l[0], a = !0);
      }
      g && console.debug(
        `[findAvailableSensors][dwd] allergen: '${e}', rawKey: '${t}', region_id: '${n.region_id}', sensorId: '${i}', exists: ${!!a}`
      ), a && C.push(i);
    }
  else if (I === "peu") {
    ...
    for (const t of n.allergens || []) {
      const i = $(t);
      let a = e ? `sensor.polleninformation_${e}_${i}` : null, l = a && A.states[a];
      if (!l) {
        const h = Object.keys(A.states).filter((r) => {
          const E = r.match(/^sensor\.polleninformation_(.+)_(.+)$/);
          if (!E) return !1;
          const o = E[1], u = E[2];
          return (!e || o === e) && u === i;
        });
        h.length === 1 && (a = h[0], l = !0);
      }
      g && console.debug(
        `[findAvailableSensors][peu] allergen: '${t}', locationSlug: '${e}', allergenSlug: '${i}', sensorId: '${a}', exists: ${!!l}`
      ), l && C.push(a);
    }
  } else if (I === "silam") {
    const e = (n.location || "").toLowerCase();
    for (const t of n.allergens || []) {
      let i = null;
      for (const a of Object.values(z.mapping)) {
        const l = Object.entries(a).reduce((h, [r, E]) => (h[E] = r, h), {});
        if (l[t]) {
          const h = l[t], r = `sensor.silam_pollen_${e}_${h}`;
          if (A.states[r]) {
            i = h, g && console.debug(
              `[findAvailableSensors][silam] allergen: '${t}', locationSlug: '${e}', hassSlug: '${i}', sensorId: '${r}', exists: true`,
              A.states[r]
            ), C.push(r);
            break;
          }
...
class In extends iA {
  ...
  get _lang() {
    var A;
    return q(this._hass, (A = this.config) == null ? void 0 : A.date_locale);
  }
  _t(A) {
    return b(A, this._lang);
  }
  _hasTapAction() {
  ...
  _getImageSrc(A, g) {
    const I = Number(g);
    let C = I, e = -1, t = 6;
    this.config.integration === "dwd" ? (C = I * 2, t = 6) : this.config.integration === "peu" && (C = Math.round(I * 6 / 4), t = 6, e = 0);
    let i = Math.round(C);
    (isNaN(i) || i < e) && (i = e), i > t && (i = t);
    const a = CA[A] || A;
    return $A[`${a}_${i}_png`] || $A[`${i}_png`];
  }
  constructor() {
  ...
  setConfig(A) {
    ...
    let g = this._userConfig.integration, I;
    g === "pp" ? I = L : g === "peu" ? I = T : g === "dwd" ? I = V : g === "silam" ? I = K : I = L;
    ...
    let e = {};
    for (const t of C)
      t in this._userConfig && (e[t] = this._userConfig[t]);
    this._userConfig = { ...I, ...e, integration: g }, this._initDone = !1, this._hass && (this.hass = this._hass);
  }
  set hass(A) {
    var u, w, H, U, j, P;
    this._hass = A;
    const g = !!this._integrationExplicit;
    this.debug && console.debug("[Card] set hass called; explicit:", g);
    const I = Object.keys(A.states).filter(
      (m) => m.startsWith("sensor.pollen_") && !m.startsWith("sensor.pollenflug_")
    ), C = Object.keys(A.states).filter(
      (m) => m.startsWith("sensor.pollenflug_")
    ), e = Object.keys(A.states).filter(
      (m) => m.startsWith("sensor.polleninformation_")
    ), t = Object.keys(A.states).filter(
      (m) => m.startsWith("sensor.silam_pollen_")
    );
    this.debug && (console.debug("Sensor states detected:"), console.debug("PP:", I), console.debug("DWD:", C), console.debug("PEU:", e), console.debug("SILAM:", t));
    let i = this._userConfig.integration;
    g || (I.length ? i = "pp" : e.length ? i = "peu" : C.length ? i = "dwd" : t.length && (i = "silam"));
    let a;
    i === "dwd" ? a = V : i === "peu" ? a = T : i === "pp" ? a = L : i === "silam" ? a = K : console.error("Unknown integration:", i);
    const { allergens: l, ...h } = this._userConfig, r = {
      ...a,
      ...h,
      integration: i
    };
    if (this._integrationExplicit && Array.isArray(l) && l.length > 0 ? (this.debug && console.debug(
      ...
      i
    ), i === "pp" ? r.allergens = L.allergens : i === "peu" ? r.allergens = T.allergens : i === "dwd" ? r.allergens = V.allergens : i === "silam" && (r.allergens = K.allergens)), !r.hasOwnProperty("date_locale")) {
      const m = q(A, null), f = ((w = (u = this._hass) == null ? void 0 : u.locale) == null ? void 0 : w.language) || ((H = this._hass) == null ? void 0 : H.language) || `${m}-${m.toUpperCase()}`;
      r.date_locale = f, this.debug && console.debug("[Card] auto-filling date_locale:", r.date_locale);
    }
    if (i === "dwd" && !r.region_id && C.length)
      r.region_id = Array.from(
        new Set(C.map((m) => m.split("_").pop()))
      ).sort((m, f) => Number(m) - Number(f))[0], this.debug && console.debug("[Card] Auto-set region_id:", r.region_id);
    else if (i === "pp" && !r.city && I.length)
      r.city = I[0].slice(14).replace(/_[^_]+$/, ""), this.debug && console.debug("[Card] Auto-set city:", r.city);
    else if (i === "peu" && !r.location && e.length) {
      const m = Array.from(
        new Set(
          e.map((f) => {
            var p;
            return (((p = A.states[f]) == null ? void 0 : p.attributes) || {}).location_slug || null;
          }).filter(Boolean)
        )
      );
      r.location = m[0] || null, this.debug && console.debug(
        "[Card][PEU] Auto-set location (location_slug):",
        r.location,
        m
      );
    } else if (i === "silam" && !r.location && t.length) {
      const m = Array.from(
        new Set(
          t.map((f) => {
            const s = f.match(/^sensor\.silam_pollen_(.*)_([^_]+)$/);
            return s ? s[1] : null;
          }).filter(Boolean)
        )
      );
    ...
    if (this.config = r, this.tapAction = r.tap_action || this.tapAction || null, this.debug && (console.debug("[Card][Debug] Aktiv integration:", i), console.debug("[Card][Debug] Allergens i config:", r.allergens)), r.title === "false" || r.title === !1 || typeof r.title == "string" && r.title.trim() === "")
      ...
      let m = "";
      if (i === "dwd")
        m = og[r.region_id] || r.region_id;
      else if (i === "peu") {
        const s = Object.values(A.states).filter(
          (c) => c.entity_id.startsWith("sensor.polleninformation_")
        ).find((c) => ((c.attributes || {}).location_slug || c.entity_id.replace("sensor.polleninformation_", "").replace(/_[^_]+$/, "")) === r.location);
        let p = "";
        if (s) {
          const c = s.attributes;
          p = c.location_title || ((j = (U = c.friendly_name) == null ? void 0 : U.match(/\((.*?)\)/)) == null ? void 0 : j[1]) || r.location;
        }
        m = p || r.location || "";
      } else if (i === "silam") {
        const f = [
        ...
        ), p = Object.values(A.states).filter((S) => {
          if (!S.entity_id.startsWith("sensor.silam_pollen_")) return !1;
          const v = S.entity_id.match(
            /^sensor\.silam_pollen_(.*)_([^_]+)$/
          );
          if (!v) return !1;
          const B = v[2];
          return s.has(B);
        }), c = kA(r.location || ""), d = p.find((S) => {
          const B = S.entity_id.replace("sensor.silam_pollen_", "").replace(/_[^_]+$/, "").replace(/^[-\s]+/, "");
          return kA(B) === c;
        });
        let Q = "";
        if (d) {
          const S = d.attributes;
          Q = S.location_title || ((P = S.friendly_name) == null ? void 0 : P.replace(/^SILAM Pollen\s*-?\s*/i, "").replace(new RegExp("\\s+\\p{L}+$", "u"), "").trim()) || r.location, Q = Q.replace(/^[-\s]+/, "");
        }
        m = Q || r.location || "";
      } else
        m = bA.find(
          (f) => f.toLowerCase().replace(/[åä]/g, "a").replace(/ö/g, "o").replace(/[-\s]/g, "_") === r.city
        ) || r.city;
      this.header = `${this._t("card.header_prefix")} ${m}`, this.debug && console.debug("[Card] header set to:", this.header);
    }
    const E = en[r.integration] || eg;
    let o;
    r.integration === "silam" && r.mode === "hourly" && typeof E.fetchHourlyForecast == "function" ? (console.debug("[Card] Using hourly forecast for SILAM"), o = E.fetchHourlyForecast(A, r)) : (console.debug("[Card] Using daily forecast for SILAM"), o = E.fetchForecast(A, r)), o.then((m) => {
      this.debug && (console.debug("[Card][Debug] Sensors före filtrering:", m), console.debug(
      ...
      const f = gn(r, A, this.debug), s = f.length;
      let p = {};
      if (r.integration === "silam") {
        const S = Object.keys(A.states).filter((v) => {
          const B = v.match(/^sensor\.silam_pollen_(.*)_([^_]+)$/);
        ...
        for (const v of S) {
          ...
          !G && this.debug && console.debug(
            `[Card][SILAM] Hittade ingen mapping för haSlug: '${k}'`
          );
        }
        this.debug && console.debug(
      ...
      let c = m.filter((S) => {
        if (r.integration === "silam" && p && (!r.mode || r.mode === "daily")) {
          const v = r.location || "", B = p[S.allergenReplaced] || S.allergenReplaced, k = `sensor.silam_pollen_${v}_${B}`;
          return this.debug && console.debug(
            `[Card][Debug][SILAM filter] allergenReplaced: '${S.allergenReplaced}', key: '${B}', id: '${k}', available: ${f.includes(k)}`
          ), f.includes(k);
        }
        return !0;
      });
      if (Array.isArray(r.allergens) && r.allergens.length > 0 && r.integration !== "silam") {
        let S, v;
        i === "dwd" ? (S = new Set(r.allergens.map((B) => uA(B))), v = (B) => uA(B.allergenReplaced || "")) : (this.debug && console.debug(
          "[Card][Debug] Använder normalisering för allergener:",
          r.allergens
        ), S = new Set(r.allergens.map((B) => $(B))), v = (B) => $(B.allergenReplaced || "")), c = c.filter((B) => {
          const k = v(B), G = S.has(k);
          return !G && this.debug && console.debug(
            `[Card][Debug] Sensor '${k}' är EJ tillåten (ej i allowed)`,
            B
          ), G;
        });
      }
      if (this._integrationExplicit && !!r.location && s === 0) {
        ...
        this._explicitLocationNoSensors = !1, this.sensors = c, this._availableSensorCount = f.length;
        let S = 0;
        r.show_empty_days ? S = r.days_to_show : c.length > 0 && c[0].days && (S = c[0].days.length), this.days_to_show = S, this.displayCols = Array.from({ length: S }, (v, B) => B), this.requestUpdate();
      }
    }).catch((m) => {
      console.error("[Card] Error fetching pollen forecast:", m), this.debug && console.debug("[Card] fetchForecast error:", m);
    });
  }
  _renderMinimalHtml() {
    return R`
      ...
      <div class="card-content">
        <div class="flex-container">
          ${(this.sensors || []).map((A) => {
      var e, t, i, a, l, h, r, E, o;
      const g = ((e = A.day0) == null ? void 0 : e.state_text) ?? "", I = ((t = A.day0) == null ? void 0 : t.state) ?? "";
      let C = "";
      return (i = this.config) != null && i.show_text_allergen && (C += (a = this.config) != null && a.allergens_abbreviated ? A.allergenShort ?? "" : A.allergenCapitalized ?? ""), (l = this.config) != null && l.show_value_text && ((h = this.config) != null && h.show_value_numeric) ? (C && (C += ": "), C += `${g} (${I})`) : (r = this.config) != null && r.show_value_text ? (C && (C += ": "), C += g) : (E = this.config) != null && E.show_value_numeric && (C && (C += " "), C += `(${I})`), R`
              <div class="sensor">
                <img
                  class="box"
            ...
            return R`
                    <td>
                      <div class="icon-wrapper">
                        <img
                          src="${this._getImageSrc("", (t = I.days[e]) == null ? void 0 : t.state)}"
                        />
                        ${this.config.show_value_numeric_in_circle ? R`<span class="circle-overlay">
                              ${((i = I.days[e]) == null ? void 0 : i.state) ?? ""}
                            </span>` : ""}
                      </div>
                    </td>
                  `;
              ...
              ${this.config.show_text_allergen || this.config.show_value_text || this.config.show_value_numeric ? R`
                    <tr class="allergen-text-row" valign="top">
                      ...
                      ${g.map((e) => {
          var l, h;
          const t = ((l = I.days[e]) == null ? void 0 : l.state_text) || "", i = (h = I.days[e]) == null ? void 0 : h.state;
          let a = "";
          return this.config.show_value_text && this.config.show_value_numeric ? a = `${t} (${i})` : this.config.show_value_text ? a = t : this.config.show_value_numeric && (a = String(i)), R`<td>${a}</td>`;
        })}
                    </tr>
                  ` : ""}
            `;
  ...
  render() {
    ...
    if (this.sensors.length)
      ...
      let h = "";
      this._availableSensorCount === 0 ? h = this._t("card.error_no_sensors") : h = this._t("card.error_filtered_sensors"), A = R`<div class="card-error">${h} (${l})</div>`;
    }
    const g = this.config.tap_action || null, I = (i = (t = this.config.background_color) == null ? void 0 : t.trim) != null && i.call(t) ? `background-color: ${this.config.background_color.trim()};` : "";
    this.debug && console.debug("[Card] Background style:", I);
    const C = g && g.type && g.type !== "none" ? "pointer" : "auto", e = `${I} cursor: ${C};`;
    return R`
      <ha-card
        style="${e}"
        @click="${g && g.type && g.type !== "none" ? this._handleTapAction : null}"
      >
        ${A}
      </ha-card>
    `;
  ...
  _handleTapAction(A) {
    ...
    (C = A.preventDefault) == null || C.call(A), (e = A.stopPropagation) == null || e.call(A);
    const g = this.tapAction.type || "more-info";
    ...
    switch (g) {
      ...
      case "call-service":
        if (this.tapAction.service && typeof this.tapAction.service == "string") {
          const [t, i] = this.tapAction.service.split(".");
  ...
  _fire(A, g, I) {
    ...
    return C.detail = g, this.dispatchEvent(C), C;
  }
  static get styles() {
    return Cg`
      .forecast {
...
customElements.define("pollenprognos-card", In);
const DA = (n, A) => {
  const g = { ...n };
  ...
  return g;
}, Cn = (n) => n === "dwd" ? V : n === "peu" ? T : n === "silam" ? K : L;
class nn extends iA {
  get debug() {
  ...
  _resetPhrases(A) {
    ...
    const g = this._config.integration === "dwd" ? V.allergens : this._config.integration === "peu" ? T.allergens : this._config.integration === "silam" ? K.allergens : L.allergens, I = {}, C = {};
    g.forEach((l) => {
      const h = $(l), r = CA[h] || h;
      I[l] = b(`editor.phrases_full.${r}`, A), C[l] = b(`editor.phrases_short.${r}`, A);
    });
    const e = this._config.integration === "dwd" ? 4 : this._config.integration === "peu" ? 5 : (this._config.integration === "silam", 7), t = Array.from(
      { length: e },
      (l, h) => b(`editor.phrases_levels.${h}`, A)
    ), i = {
      0: b("editor.phrases_days.0", A),
      1: b("editor.phrases_days.1", A),
      2: b("editor.phrases_days.2", A)
    }, a = b("editor.no_information", A);
  ...
  setConfig(A) {
    ...
    try {
      ...
      const C = A.integration === "dwd" ? V.allergens.length : A.integration === "peu" ? T.allergens.length : A.integration === "silam" ? K.allergens.length : L.allergens.length, e = { ...A };
      ...
      const t = (e.integration === "dwd" ? V : e.integration === "peu" ? T : e.integration === "silam" ? K : L).pollen_threshold;
      ...
      const h = Cn(l);
      let r = DA(h, this._userConfig);
      if (this._userConfig.hasOwnProperty("pollen_threshold") || (r.pollen_threshold = h.pollen_threshold, this.debug && console.debug(
        "[Editor] reset pollen_threshold to stub:",
        h.pollen_threshold
      )), r.allergens = Array.isArray(this._userConfig.allergens) ? this._userConfig.allergens : h.allergens, r.integration = l, r.type = "custom:pollenprognos-card", this._config = r, this._prevIntegration = l, this.debug && console.debug(
        ...
        const E = q(this._hass, null), o = ((I = (g = this._hass) == null ? void 0 : g.locale) == null ? void 0 : I.language) || `${E}-${E.toUpperCase()}`;
      ...
      if (this._initDone = !1, this._hass) {
        ...
        this.installedRegionIds = Array.from(
          new Set(
            E.filter((u) => u.startsWith("sensor.pollenflug_")).map((u) => u.split("_").pop())
          )
        ).sort((u, w) => Number(u) - Number(w));
        const o = new Set(
          E.filter(
            (u) => u.startsWith("sensor.pollen_") && !u.startsWith("sensor.pollenflug_")
          ).map(
            (u) => u.slice(14).replace(/_[^_]+$/, "")
          )
        );
        this.installedCities = bA.filter(
          (u) => o.has(
            u.toLowerCase().replace(/[åä]/g, "a").replace(/ö/g, "o").replace(/[-\s]/g, "_")
          )
        ).sort();
      }
  ...
  set hass(A) {
    ...
    let i = this._userConfig.integration;
    g || (I.length ? i = "pp" : e.length ? i = "peu" : C.length ? i = "dwd" : t.length && (i = "silam"), this._userConfig.integration = i);
    const a = i === "dwd" ? V : i === "peu" ? T : i === "silam" ? K : L;
    let l = DA(a, this._userConfig);
    ...
    ).sort((o, u) => o.localeCompare(u)), this.installedPeuLocations = Array.from(
      new Map(
        Object.values(A.states).filter((o) => o.entity_id.startsWith("sensor.polleninformation_")).map((o) => {
          var H, U;
          const u = o.attributes.location_slug || o.entity_id.replace("sensor.polleninformation_", "").replace(/_[^_]+$/, ""), w = o.attributes.location_title || ((U = (H = o.attributes.friendly_name) == null ? void 0 : H.match(/\((.*?)\)/)) == null ? void 0 : U[1]) || u;
          return [u, w];
        })
      )
    ...
    if (this.debug) {
      console.debug("[SilamAllergenMap.mapping]", z.mapping), console.debug("[pollenAllergens]", r);
      for (const [u, w] of Object.entries(z.mapping))
        for (const [H, U] of Object.entries(w))
          console.debug(`[Mapping] ${u}: ${H} → ${U}`);
      const o = Object.values(z.mapping).flatMap(
        (u) => Object.entries(u).filter(
          ([w, H]) => r.includes(H)
        ).map(([w]) => w)
      );
    ...
    this.installedSilamLocations = Array.from(
      new Map(
        Object.values(A.states).filter((o) => {
          ...
          const u = o.entity_id.match(
            /^sensor\.silam_pollen_(.*)_([^_]+)$/
          ), w = u ? u[1].replace(/^[-\s]+/, "") : "", H = kA(w);
          let U = o.attributes.location_title || (o.attributes.friendly_name ? o.attributes.friendly_name.replace(/^SILAM Pollen\s*-?\s*/i, "").replace(new RegExp("\\s+\\p{L}+$", "u"), "").trim() : "") || w;
          return U = U.replace(/^[-\s]+/, ""), U = U.charAt(0).toUpperCase() + U.slice(1), this.debug && console.debug(
            "[Map] entity_id:",
            o.entity_id,
            "| rawLocation:",
            w,
  ...
  _updateConfig(A, g) {
    ...
    if (A === "integration") {
      ...
      e !== t && (delete I[e === "dwd" ? "city" : "region_id"], delete I.allergens, delete I.pollen_threshold, this._allergensExplicit = !1), C = DA(e === "dwd" ? V : e === "peu" ? T : e === "silam" ? K : L, I), C.integration = e;
    } else
      C = { ...this._config, [A]: g };
      ...
      (e) => R`
              <ha-formfield .label=${e}>
                <ha-textfield
                  ...
                  @input=${(t) => {
        const i = { ...A.phrases.days, [e]: t.target.value };
...
customElements.define("pollenprognos-card-editor", nn);
