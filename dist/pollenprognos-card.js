...
let tg = class {
  constructor(A, g, I) {
    if (this._$cssResult$ = !0, I !== YA) throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");
...
const Sg = (C) => new tg(typeof C == "string" ? C : C + "", void 0, YA), ig = (C, ...A) => {
  const g = C.length === 1 ? C[0] : A.reduce((I, n, t) => I + ((e) => {
  ...
  PA ? C.adoptedStyleSheets = A.map((g) => g instanceof CSSStyleSheet ? g : g.styleSheet) : A.forEach((g) => {
    const I = document.createElement("style"), n = EA.litNonce;
    n !== void 0 && I.setAttribute("nonce", n), I.textContent = g.cssText, C.appendChild(I);
  });
...
let CA = class extends HTMLElement {
  ...
  static getPropertyDescriptor(A, g, I) {
    return { get() {
      ...
      const t = this[A];
      this[g] = n, this.requestUpdate(A, t, I);
  ...
  static finalizeStyles(A) {
    ...
    if (Array.isArray(A)) {
      ...
      for (const n of I) g.unshift(LA(n));
  ...
  _$EO(A, g, I = UA) {
    var n;
    const t = this.constructor._$Ep(A, I);
    if (t !== void 0 && I.reflect === !0) {
      const e = (((n = I.converter) === null || n === void 0 ? void 0 : n.toAttribute) !== void 0 ? I.converter : jA).toAttribute(g, I.type);
      this._$El = A, e == null ? this.removeAttribute(t) : this.setAttribute(t, e), this._$El = null;
    }
  }
  _$AK(A, g) {
    var I;
    ...
    if (t !== void 0 && this._$El !== t) {
      const e = n.getPropertyOptions(t), i = typeof e.converter == "function" ? { fromAttribute: e.converter } : ((I = e.converter) === null || I === void 0 ? void 0 : I.fromAttribute) !== void 0 ? e.converter : jA;
      this._$El = t, this[t] = i.fromAttribute(g, e.type), this._$El = null;
    }
  }
  requestUpdate(A, g, I) {
    let n = !0;
    A !== void 0 && (((I = I || this.constructor.getPropertyOptions(A)).hasChanged || rg)(this[A], g) ? (this._$AL.has(A) || this._$AL.set(A, g), I.reflect === !0 && this._$El !== A && (this._$EC === void 0 && (this._$EC = /* @__PURE__ */ new Map()), this._$EC.set(A, I))) : n = !1), !this.isUpdatePending && n && (this._$E_ = this._$Ej());
  }
  async _$Ej() {
...
const fg = (C, A) => {
  const g = C.length - 1, I = [];
  let n, t = A === 2 ? "<svg>" : "", e = sA;
  for (let i = 0; i < g; i++) {
    const r = C[i];
    let o, d, S = -1, a = 0;
    for (; a < r.length && (e.lastIndex = a, d = e.exec(r), d !== null); ) a = e.lastIndex, e === sA ? d[1] === "!--" ? e = VA : d[1] !== void 0 ? e = NA : d[2] !== void 0 ? (lg.test(d[2]) && (n = RegExp("</" + d[2], "g")), e = gA) : d[3] !== void 0 && (e = gA) : e === gA ? d[0] === ">" ? (e = n ?? sA, S = -1) : d[1] === void 0 ? S = -2 : (S = e.lastIndex - d[2].length, o = d[1], e = d[3] === void 0 ? gA : d[3] === '"' ? qA : XA) : e === qA || e === XA ? e = gA : e === VA || e === NA ? e = sA : (e = gA, n = void 0);
    const l = e === gA && C[i + 1].startsWith("/>") ? " " : "";
    t += e === sA ? r + pg : S >= 0 ? (I.push(o), r.slice(0, S) + HA + r.slice(S) + _ + l) : r + _ + (S === -2 ? (I.push(void 0), i) : l);
  }
  return [sg(C, t + (C[g] || "<?>") + (A === 2 ? "</svg>" : "")), I];
};
class QA {
  constructor({ strings: A, _$litType$: g }, I) {
    ...
    this.parts = [];
    let t = 0, e = 0;
    const i = A.length - 1, r = this.parts, [o, d] = fg(A, g);
    if (this.el = QA.createElement(o, I), eA.currentNode = this.el.content, g === 2) {
      const S = this.el.content, a = S.firstChild;
      a.remove(), S.append(...a.childNodes);
    }
    for (; (n = eA.nextNode()) !== null && r.length < i; ) {
      if (n.nodeType === 1) {
        if (n.hasAttributes()) {
          const S = [];
          for (const a of n.getAttributeNames()) if (a.endsWith(HA) || a.startsWith(_)) {
            ...
            if (S.push(a), l !== void 0) {
              ...
              r.push({ type: 1, index: t, name: x[2], strings: c, ctor: x[1] === "." ? Ug : x[1] === "?" ? yg : x[1] === "@" ? wg : mA });
            } else r.push({ type: 6, index: t });
          }
        ...
        if (lg.test(n.tagName)) {
          ...
          if (a > 0) {
            ...
            for (let l = 0; l < a; l++) n.append(S[l], DA()), eA.nextNode(), r.push({ type: 2, index: ++t });
            n.append(S[a], DA());
          }
        }
      } else if (n.nodeType === 8) if (n.data === ag) r.push({ type: 2, index: t });
      else {
        let S = -1;
        for (; (S = n.data.indexOf(_, S + 1)) !== -1; ) r.push({ type: 7, index: t }), S += _.length - 1;
      }
      t++;
    }
  }
...
function oA(C, A, g = C, I) {
  var n, t, e, i;
  if (A === aA) return A;
  let r = I !== void 0 ? (n = g._$Co) === null || n === void 0 ? void 0 : n[I] : g._$Cl;
  const o = dA(A) ? void 0 : A._$litDirective$;
  return (r == null ? void 0 : r.constructor) !== o && ((t = r == null ? void 0 : r._$AO) === null || t === void 0 || t.call(r, !1), o === void 0 ? r = void 0 : (r = new o(C), r._$AT(C, g, I)), I !== void 0 ? ((e = (i = g)._$Co) !== null && e !== void 0 ? e : i._$Co = [])[I] = r : g._$Cl = r), r !== void 0 && (A = oA(C, r._$AS(C, A.values), r, I)), A;
}
class Bg {
  constructor(A, g) {
  ...
  u(A) {
    var g;
    const { el: { content: I }, parts: n } = this._$AD, t = ((g = A == null ? void 0 : A.creationScope) !== null && g !== void 0 ? g : IA).importNode(I, !0);
    eA.currentNode = t;
    let e = eA.nextNode(), i = 0, r = 0, o = n[0];
    for (; o !== void 0; ) {
      if (i === o.index) {
        let d;
        o.type === 2 ? d = new SA(e, e.nextSibling, this, A) : o.type === 1 ? d = new o.ctor(e, o.name, o.strings, this, A) : o.type === 6 && (d = new vg(e, this, A)), this._$AV.push(d), o = n[++r];
      }
      i !== (o == null ? void 0 : o.index) && (e = eA.nextNode(), i++);
    }
...
class SA {
  constructor(A, g, I, n) {
    var t;
    this.type = 2, this._$AH = W, this._$AN = void 0, this._$AA = A, this._$AB = g, this._$AM = I, this.options = n, this._$Cp = (t = n == null ? void 0 : n.isConnected) === null || t === void 0 || t;
  }
  get _$AU() {
    var A, g;
  ...
  g(A) {
    var g;
    const { values: I, _$litType$: n } = A, t = typeof n == "number" ? this._$AC(A) : (n.el === void 0 && (n.el = QA.createElement(sg(n.h, n.h[0]), this.options)), n);
    if (((g = this._$AH) === null || g === void 0 ? void 0 : g._$AD) === t) this._$AH.v(I);
    else {
      const e = new Bg(t, this), i = e.u(this.options);
      e.v(I), this.$(i), this._$AH = e;
    }
  }
  _$AC(A) {
  ...
  T(A) {
    ...
    const g = this._$AH;
    let I, n = 0;
    for (const t of A) n === g.length ? g.push(I = new SA(this.k(DA()), this.k(DA()), this, this.options)) : I = g[n], I._$AI(t), n++;
...
class mA {
  constructor(A, g, I, n, t) {
    this.type = 1, this._$AH = W, this._$AN = void 0, this.element = A, this.name = g, this._$AM = n, this.options = t, I.length > 2 || I[0] !== "" || I[1] !== "" ? (this._$AH = Array(I.length - 1).fill(new String()), this.strings = I) : this._$AH = W;
  }
  get tagName() {
  ...
  _$AI(A, g = this, I, n) {
    ...
    let e = !1;
    if (t === void 0) A = oA(this, A, g, 0), e = !dA(A) || A !== this._$AH && A !== aA, e && (this._$AH = A);
    else {
      const i = A;
      let r, o;
      for (A = t[0], r = 0; r < t.length - 1; r++) o = oA(this, i[I + r], g, r), o === aA && (o = this._$AH[r]), e || (e = !dA(o) || o !== this._$AH[r]), o === W ? A = W : A !== W && (A += (o ?? "") + t[r + 1]), this._$AH[r] = o;
    }
    e && !n && this.j(A);
  }
  j(A) {
...
class wg extends mA {
  constructor(A, g, I, n, t) {
    super(A, g, I, n, t), this.type = 5;
  }
  _$AI(A, g = this) {
    var I;
    if ((A = (I = oA(this, A, g, 0)) !== null && I !== void 0 ? I : W) === aA) return;
    const n = this._$AH, t = A === W && n !== W || A.capture !== n.capture || A.once !== n.once || A.passive !== n.passive, e = A !== W && (n === W || t);
    t && this.element.removeEventListener(this.name, this, n), e && this.element.addEventListener(this.name, this, A), this._$AH = A;
  }
  handleEvent(A) {
    var g, I;
...
const Rg = (C, A, g) => {
  var I, n;
  const t = (I = g == null ? void 0 : g.renderBefore) !== null && I !== void 0 ? I : A;
  let e = t._$litPart$;
  if (e === void 0) {
    const i = (n = g == null ? void 0 : g.renderBefore) !== null && n !== void 0 ? n : null;
    t._$litPart$ = e = new SA(A.insertBefore(DA(), i), i, void 0, g ?? {});
  }
  return e._$AI(C), e;
};
/**
...
const bA = (C, A = "_") => {
  const g = "àáâäæãåāăąабçćčđďдèéêëēėęěеёэфğǵгḧхîïíīįìıİийкłлḿмñńǹňнôöòóœøōõőоṕпŕřрßśšşșсťțтûüùúūǘůűųувẃẍÿýыžźżз·", I = `aaaaaaaaaaabcccdddeeeeeeeeeeefggghhiiiiiiiiijkllmmnnnnnoooooooooopprrrsssssstttuuuuuuuuuuvwxyyyzzzz${A}`, n = new RegExp(g.split("").join("|"), "g"), t = {
    ж: "zh",
    х: "kh",
    ц: "ts",
    ч: "ch",
  ...
  let e;
  return C === "" ? e = "" : (e = C.toString().toLowerCase().replace(n, (i) => I.charAt(g.indexOf(i))).replace(/[а-я]/g, (i) => t[i] || "").replace(/(\d),(?=\d)/g, "$1").replace(/[^a-z0-9]+/g, A).replace(new RegExp(`(${A})\\1+`, "g"), "$1").replace(new RegExp(`^${A}+`), "").replace(new RegExp(`${A}+$`), ""), e === "" && (e = "unknown")), e;
...
const OA = "en";
function Ig(C, A) {
  return A.split(".").reduce((g, I) => g && typeof g == "object" ? g[I] : void 0, C);
}
function q(C, A) {
  var n;
...
async function Xn(C, A) {
  const g = !!A.debug, I = (Q) => Q.charAt(0).toUpperCase() + Q.slice(1), n = q(C, A.date_locale), t = A.date_locale || z.date_locale, e = A.days_relative !== !1, i = !!A.days_abbreviated, r = !!A.days_uppercase, o = A.phrases || {}, d = o.full || {}, S = o.short || {}, a = o.levels, l = Array.isArray(a) && a.length === 7 ? a : Array.from({ length: 7 }, (Q, s) => O(`card.levels.${s}`, n)), c = o.no_information || O("card.no_information", n), x = o.days || {}, b = A.days_to_show ?? z.days_to_show, m = A.pollen_threshold ?? z.pollen_threshold;
  ...
  for (const Q of A.allergens)
    try {
      ...
      s.days = [], J.forEach((U, H) => {
        ...
        let D;
        e ? x[Z] !== void 0 ? D = x[Z] : Z >= 0 && Z <= 2 ? D = O(`card.days.${Z}`, n) : D = U.date.toLocaleDateString(t, {
          day: "numeric",
          month: "short"
        }) : (D = U.date.toLocaleDateString(t, {
          weekday: i ? "short" : "long"
        }), D = D.charAt(0).toUpperCase() + D.slice(1)), r && (D = D.toUpperCase());
...
async function _n(C, A) {
  var p, u;
  const g = !!A.debug, I = q(C, A.date_locale), n = A.date_locale || ((p = C.locale) == null ? void 0 : p.language) || C.language || `${I}-${I.toUpperCase()}`, t = A.days_relative !== !1, e = !!A.days_abbreviated, i = !!A.days_uppercase, r = {
    full: {},
    short: {},
    levels: [],
    days: {},
    no_information: "",
    ...A.phrases || {}
  }, o = r.full, d = r.short, S = r.levels, a = 5;
  Array.isArray(S) && S.length === a || Array.from(
    { length: a },
    (h, E) => O(`card.levels.${E}`, I)
  );
  const l = r.no_information || O("card.no_information", I), c = r.days, x = A.integration === "dwd" ? 3 : A.integration === "peu" ? 4 : 6, b = (h) => {
    const E = Number(h);
  ...
  for (const h of A.allergens)
    try {
      ...
      if (E.allergenReplaced = f, o[f])
        ...
        const D = nA[f] || f, v = O(`card.allergen.${D}`, I);
        E.allergenCapitalized = v !== `card.allergen.${D}` ? v : f.charAt(0).toUpperCase() + f.slice(1);
      }
      if (A.allergens_abbreviated) {
        const D = d[f];
        E.allergenShort = D || O(`editor.phrases_short.${f}`, I) || E.allergenCapitalized;
      } else
      ...
      H.forEach((D, v) => {
        ...
        let P;
        t ? c[X] != null ? P = c[X] : X >= 0 && X <= 2 ? P = O(`card.days.${X}`, I) : P = N.toLocaleDateString(n, {
          day: "numeric",
          month: "short"
        ...
        const WA = {
          ...
          day: P,
          state: F,
          state_text: AA < 0 ? l : O(`card.levels.${AA}`, I)
        };
...
function GA(C, A) {
  return Array.isArray(C.levels) && C.levels.length === 7 ? C.levels : Array.from({ length: 7 }, (g, I) => O(`card.levels.${I}`, A));
}
function ZA(C, A, g) {
  let I;
  A.full[C] ? I = A.full[C] : V.names && V.names[C] && V.names[C][g] ? I = V.names[C][g] : I = C.charAt(0).toUpperCase() + C.slice(1);
  const n = A.short[C] || I;
  return { allergenCapitalized: I, allergenShort: n };
}
async function eC(C, A) {
  var Y, M, Q;
  const g = !!A.debug, I = q(C, A.date_locale), n = A.date_locale || ((Y = C.locale) == null ? void 0 : Y.language) || C.language || `${I}-${I.toUpperCase()}`, t = A.days_relative !== !1, e = !!A.days_abbreviated, i = !!A.days_uppercase, r = MA(A, I), o = GA(r, I), d = r.no_information, S = r.days, a = /* @__PURE__ */ new Date();
  a.setHours(0, 0, 0, 0);
  ...
  for (const s of A.allergens)
    try {
      ...
      for (let k = 0; k < l; ++k) {
        ...
        let D;
        t ? S[Z] != null ? D = S[Z] : Z >= 0 && Z <= 2 ? D = O(`card.days.${Z}`, I) : D = H.toLocaleDateString(n, {
          day: "numeric",
          month: "short"
...
async function IC(C, A, g = null) {
  ...
  const n = q(C, A.date_locale), t = A.date_locale || ((x = C.locale) == null ? void 0 : x.language) || C.language || `${n}-${n.toUpperCase()}`, e = A.pollen_threshold ?? K.pollen_threshold;
  if (I) {
  ...
  let i = (A.location || "").toLowerCase(), r = null;
  ...
  if (g && g.forecast && Array.isArray(g.forecast))
    ...
    const m = C.states[r];
    (b = m == null ? void 0 : m.attributes) != null && b.forecast && Array.isArray(m.attributes.forecast) && (o = m.attributes.forecast, I && console.debug(
  ...
  for (const m of l)
    try {
      ...
      const Q = R.days.some((s) => s.state >= e);
      I && console.debug(
      ...
      I && console.warn(`[SILAM][hourly] Fel vid allergen ${m}:`, R);
    }
...
async function tC(C, A) {
  var s, p;
  const g = [], I = !!A.debug, n = (u) => u.charAt(0).toUpperCase() + u.slice(1), t = (u) => {
    const [h] = u.split("T"), [E, f, y] = h.split("-").map(Number);
    return new Date(E, f - 1, y);
  }, e = /* @__PURE__ */ new Date();
  e.setHours(0, 0, 0, 0);
  const i = q(C, A.date_locale), r = A.date_locale || ((s = C.locale) == null ? void 0 : s.language) || C.language || `${i}-${i.toUpperCase()}`, o = A.days_relative !== !1, d = !!A.days_abbreviated, S = !!A.days_uppercase, a = {
    full: {},
    short: {},
    levels: [],
    days: {},
  ...
  for (const u of A.allergens)
    try {
      ...
      if (U.length >= M)
        ...
        H = U.slice();
        let D = U.length > 0 ? t(U[U.length - 1]) : e;
        for (; H.length < M; ) {
          D = new Date(D.getTime() + 864e5);
          const v = D.getFullYear(), G = String(D.getMonth() + 1).padStart(2, "0"), F = String(D.getDate()).padStart(2, "0");
          H.push(`${v}-${G}-${F}T00:00:00`);
      ...
      H.forEach((D, v) => {
        const G = J[D] || {}, F = Y(G.level), N = t(D), X = Math.round((N - e) / 864e5);
        let P;
        o ? R[X] != null ? P = R[X] : X >= 0 && X <= 2 ? P = O(`card.days.${X}`, i) : P = N.toLocaleDateString(r, {
          day: "numeric",
          month: "short"
        }) : (P = N.toLocaleDateString(r, {
...
function ng(C, A, g = !1) {
  ...
  if (I === "pp") {
    const t = $(C.city || "");
    for (const e of C.allergens || []) {
      const i = $(e), r = `sensor.pollen_${t}_${i}`, o = !!A.states[r];
      g && console.debug(
        `[findAvailableSensors][pp] allergen: '${e}', cityKey: '${t}', rawKey: '${i}', sensorId: '${r}', exists: ${o}`
      ), o && n.push(r);
    }
  } else if (I === "dwd")
    for (const t of C.allergens || []) {
      const e = uA(t);
      let i = C.region_id ? `sensor.pollenflug_${e}_${C.region_id}` : null, r = i && A.states[i];
      if (!r) {
        const o = Object.keys(A.states).filter(
          (d) => d.startsWith(`sensor.pollenflug_${e}_`)
        );
        o.length === 1 && (i = o[0], r = !0);
      }
      g && console.debug(
        `[findAvailableSensors][dwd] allergen: '${t}', rawKey: '${e}', region_id: '${C.region_id}', sensorId: '${i}', exists: ${!!r}`
      ), r && n.push(i);
    }
  else if (I === "peu") {
    ...
    for (const e of C.allergens || []) {
      const i = $(e);
      let r = t ? `sensor.polleninformation_${t}_${i}` : null, o = r && A.states[r];
      if (!o) {
        ...
        d.length === 1 && (r = d[0], o = !0);
      }
      g && console.debug(
        `[findAvailableSensors][peu] allergen: '${e}', locationSlug: '${t}', allergenSlug: '${i}', sensorId: '${r}', exists: ${!!o}`
      ), o && n.push(r);
    }
  } else if (I === "silam") {
    const t = (C.location || "").toLowerCase();
    for (const e of C.allergens || []) {
      let i = null;
      for (const r of Object.values(V.mapping)) {
        const o = Object.entries(r).reduce((d, [S, a]) => (d[a] = S, d), {});
        if (o[e]) {
          const d = o[e], S = `sensor.silam_pollen_${t}_${d}`;
          if (A.states[S]) {
            i = d, g && console.debug(
              `[findAvailableSensors][silam] allergen: '${e}', locationSlug: '${t}', hassSlug: '${i}', sensorId: '${S}', exists: true`,
              A.states[S]
            ), n.push(S);
            break;
          }
      ...
      !i && g && console.debug(
        `[findAvailableSensors][silam] allergen: '${e}', locationSlug: '${t}', ingen sensor hittades!`
      );
    }
  }
  if (g) {
...
class iC extends iA {
  ...
  _updateSensorsAndColumns(g, I, n) {
    this.sensors = g, this._availableSensorCount = I.length;
    let t = 0;
    n.show_empty_days ? t = n.days_to_show : g.length > 0 && g[0].days && (t = g[0].days.length), this.days_to_show = t, this.displayCols = Array.from({ length: t }, (e, i) => i), this.debug && (console.debug("Days to show:", this.days_to_show), console.debug("Display columns:", this.displayCols)), this.requestUpdate();
  }
  ...
  _getImageSrc(g, I) {
    const n = Number(I);
    let t = n, e = -1, i = 6;
    this.config.integration === "dwd" ? (t = n * 2, i = 6) : this.config.integration === "peu" && (t = Math.round(n * 6 / 4), i = 6, e = 0);
    let r = Math.round(t);
    (isNaN(r) || r < e) && (r = e), r > i && (r = i);
    const o = nA[g] || g;
    return gg[`${o}_${r}_png`] || gg[`${r}_png`];
  }
  ...
  setConfig(g) {
    ...
    let I = this._userConfig.integration, n;
    I === "pp" ? n = L : I === "peu" ? n = T : I === "dwd" ? n = z : I === "silam" ? n = K : n = L;
    ...
    let e = {};
    for (const i of t)
      i in this._userConfig && (e[i] = this._userConfig[i]);
    this._userConfig = { ...n, ...e, integration: I }, this._initDone = !1, this._hass && (this.hass = this._hass);
  }
  set hass(g) {
    var x, b, m, R, Y, M;
    this._hass = g;
    ...
    this.debug && (console.debug("Sensor states detected:"), console.debug("PP:", n), console.debug("DWD:", t), console.debug("PEU:", e), console.debug("SILAM:", i));
    let r = this._userConfig.integration;
    I || (n.length ? r = "pp" : e.length ? r = "peu" : t.length ? r = "dwd" : i.length && (r = "silam"));
    let o;
    r === "dwd" ? o = z : r === "peu" ? o = T : r === "pp" ? o = L : r === "silam" ? o = K : console.error("Unknown integration:", r);
    ...
    if (this._integrationExplicit && Array.isArray(d) && d.length > 0 ? (this.debug && console.debug(
      ...
      r
    ), r === "pp" ? a.allergens = L.allergens : r === "peu" ? a.allergens = T.allergens : r === "dwd" ? a.allergens = z.allergens : r === "silam" && (a.allergens = K.allergens)), !a.hasOwnProperty("date_locale")) {
    ...
    } else if (r === "silam" && !a.location && i.length) {
      const Q = Array.from(
        new Set(
          i.map((s) => {
            const p = s.match(/^sensor\.silam_pollen_(.*)_([^_]+)$/);
    ...
    if (this.config = a, this.tapAction = a.tap_action || this.tapAction || null, this.debug && (console.debug("[Card][Debug] Aktiv integration:", r), console.debug("[Card][Debug] Allergens i config:", a.allergens)), a.title === "false" || a.title === !1 || typeof a.title == "string" && a.title.trim() === "")
      this.header = "";
    ...
    if (c)
      return c.then((Q) => {
        ...
        if (Array.isArray(a.allergens) && a.allergens.length > 0 && a.integration !== "silam") {
          let y, j;
          r === "dwd" ? (y = new Set(a.allergens.map((B) => uA(B))), j = (B) => uA(B.allergenReplaced || "")) : (this.debug && console.debug(
    ...
    return w`
      ...
      <div class="card-content">
        <div class="flex-container">
          ${(this.sensors || []).map((g) => {
      var e, i, r, o, d, S, a, l, c;
      const I = ((e = g.day0) == null ? void 0 : e.state_text) ?? "", n = ((i = g.day0) == null ? void 0 : i.state) ?? "";
      let t = "";
      return (r = this.config) != null && r.show_text_allergen && (t += (o = this.config) != null && o.allergens_abbreviated ? g.allergenShort ?? "" : g.allergenCapitalized ?? ""), (d = this.config) != null && d.show_value_text && ((S = this.config) != null && S.show_value_numeric) ? (t && (t += ": "), t += `${I} (${n})`) : (a = this.config) != null && a.show_value_text ? (t && (t += ": "), t += I) : (l = this.config) != null && l.show_value_numeric && (t && (t += " "), t += `(${n})`), w`
              <div class="sensor">
                <img
                  class="box"
            ...
            return w`
                    <td>
                      <div class="icon-wrapper">
                        <img
                          src="${this._getImageSrc("", (i = n.days[e]) == null ? void 0 : i.state)}"
                        />
                        ${this.config.show_value_numeric_in_circle ? w`<span class="circle-overlay">
                              ${((r = n.days[e]) == null ? void 0 : r.state) ?? ""}
                            </span>` : ""}
                      </div>
                    </td>
                  `;
              ...
              ${this.config.show_text_allergen || this.config.show_value_text || this.config.show_value_numeric ? w`
                    <tr class="allergen-text-row" valign="top">
                      ...
                      ${I.map((e) => {
          var d, S;
          const i = ((d = n.days[e]) == null ? void 0 : d.state_text) || "", r = (S = n.days[e]) == null ? void 0 : S.state;
          let o = "";
          return this.config.show_value_text && this.config.show_value_numeric ? o = `${i} (${r})` : this.config.show_value_text ? o = i : this.config.show_value_numeric && (o = String(r)), w`<td>${o}</td>`;
        })}
                    </tr>
                  ` : ""}
            `;
  ...
  render() {
    ...
    const I = this.config.tap_action || null, n = (r = (i = this.config.background_color) == null ? void 0 : i.trim) != null && r.call(i) ? `background-color: ${this.config.background_color.trim()};` : "";
    this.debug && console.debug("[Card] Background style:", n);
    const t = I && I.type && I.type !== "none" ? "pointer" : "auto", e = `${n} cursor: ${t};`;
    return w`
      <ha-card
        style="${e}"
  ...
  _handleTapAction(g) {
    ...
    (t = g.preventDefault) == null || t.call(g), (e = g.stopPropagation) == null || e.call(g);
    ...
    switch (I) {
      ...
      case "call-service":
        if (this.tapAction.service && typeof this.tapAction.service == "string") {
          const [i, r] = this.tapAction.service.split(".");
  ...
  _fire(g, I, n) {
    ...
    return t.detail = I, this.dispatchEvent(t), t;
  }
  static get styles() {
    return ig`
      .forecast {
...
const hA = (C, A) => {
  ...
  for (const I of Object.keys(A)) {
    const n = A[I];
    n !== null && typeof n == "object" && !Array.isArray(n) && typeof C[I] == "object" && C[I] !== null ? g[I] = hA(C[I], n) : g[I] = n;
  }
  return g;
...
class aC extends iA {
  ...
  _resetPhrases(A) {
    ...
    const g = this._config.integration === "dwd" ? z.allergens : this._config.integration === "peu" ? T.allergens : this._config.integration === "silam" ? K.allergens : L.allergens, I = {}, n = {};
    g.forEach((o) => {
      const d = $(o), S = nA[d] || d;
      I[o] = O(`editor.phrases_full.${S}`, A), n[o] = O(`editor.phrases_short.${S}`, A);
    });
    const t = this._config.integration === "dwd" ? 4 : this._config.integration === "peu" ? 5 : (this._config.integration === "silam", 7), e = Array.from(
      { length: t },
  ...
  setConfig(A) {
    ...
    try {
      ...
      const e = (t.integration === "dwd" ? z : t.integration === "peu" ? T : t.integration === "silam" ? K : L).pollen_threshold;
      t.hasOwnProperty("pollen_threshold") && !this._thresholdExplicit && t.pollen_threshold === e && (this.debug && console.debug(
      ...
      const r = (t.integration === "dwd" ? z : t.integration === "peu" ? T : t.integration === "silam" ? K : L).date_locale;
      !this._localeExplicit && t.date_locale === r && (this.debug && console.debug("[Editor] dropped stub date_locale"), delete t.date_locale), this._userConfig = hA(this._userConfig, t), this._thresholdExplicit = this._userConfig.hasOwnProperty("pollen_threshold"), this._allergensExplicit = this._userConfig.hasOwnProperty("allergens"), this._integrationExplicit = this._userConfig.hasOwnProperty("integration"), this._daysExplicit = this._userConfig.hasOwnProperty("days_to_show"), this._localeExplicit = this._userConfig.hasOwnProperty("date_locale");
      ...
      if (this._userConfig.hasOwnProperty("pollen_threshold") || (S.pollen_threshold = d.pollen_threshold, this.debug && console.debug(
        ...
        const a = q(this._hass, null), l = ((I = (g = this._hass) == null ? void 0 : g.locale) == null ? void 0 : I.language) || `${a}-${a.toUpperCase()}`;
  ...
  set hass(A) {
    ...
    g || (I.length ? i = "pp" : t.length ? i = "peu" : n.length ? i = "dwd" : e.length && (i = "silam"), this._userConfig.integration = i), i === "silam" && !this._userConfig.mode && (this._userConfig.mode = "daily");
    const r = i === "dwd" ? z : i === "peu" ? T : i === "silam" ? K : L;
    let o = hA(r, this._userConfig);
    this._userConfig.hasOwnProperty("pollen_threshold") || (o.pollen_threshold = r.pollen_threshold, this.debug && console.debug(
      "[Editor][hass] reset pollen_threshold to stub:",
      r.pollen_threshold
    )), this._config = o, this.installedRegionIds = Array.from(
  ...
  _updateConfig(A, g) {
    ...
    let n;
    if (A === "integration") {
      const t = g, e = this._config.integration;
      t !== e && (delete I[t === "dwd" ? "city" : "region_id"], delete I.allergens, delete I.pollen_threshold, this._allergensExplicit = !1), n = hA(t === "dwd" ? z : t === "peu" ? T : t === "silam" ? K : L, I), n.integration = t;
    } else
  ...
  render() {
    const A = {
      ...
      ...this._config
    }, g = A.integration === "dwd" ? z.allergens : A.integration === "peu" ? T.allergens : A.integration === "silam" ? K.allergens : L.allergens, I = A.integration === "dwd" ? 4 : A.integration === "peu" ? 5 : 7, n = A.integration === "dwd" ? { min: 0, max: 3, step: 0.5 } : A.integration === "peu" ? { min: 0, max: 4, step: 1 } : { min: 0, max: 6, step: 1 }, t = [
    ...
    return w`
      ...
      (e) => w`
                <ha-formfield .label=${e}>
                  <ha-checkbox
                    ...
                    @change=${(i) => this._onAllergenToggle(e, i.target.checked)}
                  ></ha-checkbox>
                </ha-formfield>
              `
    )}
      ...
      (e) => w`
        ...
        const r = {
          ...A.phrases,
          full: { ...A.phrases.full, [e]: i.target.value }
        };
        this._updateConfig("phrases", r);
      }}
                ></ha-textfield>
              </ha-formfield>
            `
      ...
      (e) => w`
        ...
        const r = {
          ...A.phrases,
          short: { ...A.phrases.short, [e]: i.target.value }
        };
        this._updateConfig("phrases", r);
      }}
                ></ha-textfield>
        ...
        <details>
          ...
          ${Array.from({ length: I }, (e, i) => i).map(
      (e) => w`
              <ha-formfield .label=${e}>
                <ha-textfield
                  .value=${A.phrases.levels[e] || ""}
                  @input=${(i) => {
        const r = [...A.phrases.levels];
        r[e] = i.target.value;
        const o = { ...A.phrases, levels: r };
      ...
      (e) => w`
              <ha-formfield .label=${e}>
                <ha-textfield
                  ...
                  @input=${(i) => {
        const r = { ...A.phrases.days, [e]: i.target.value };
        this._updateConfig("phrases", { ...A.phrases, days: r });
      }}
                ></ha-textfield>
              </ha-formfield>
            `
