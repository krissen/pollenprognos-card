...
var Sg = (C, A, g) => A in C ? Qg(C, A, { enumerable: !0, configurable: !0, writable: !0, value: g }) : C[A] = g;
var mA = (C, A, g) => Sg(C, typeof A != "symbol" ? A + "" : A, g);
...
const cg = (C) => new tg(typeof C == "string" ? C : C + "", void 0, YA), ig = (C, ...A) => {
  const g = C.length === 1 ? C[0] : A.reduce((e, n, t) => e + ((r) => {
    if (r._$cssResult$ === !0) return r.cssText;
    if (typeof r == "number") return r;
    throw Error("Value passed to 'css' function must be a 'css' function result: " + r + ". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.");
  })(n) + C[t + 1], C[0]);
  return new tg(g, C, YA);
}, Eg = (C, A) => {
  PA ? C.adoptedStyleSheets = A.map((g) => g instanceof CSSStyleSheet ? g : g.styleSheet) : A.forEach((g) => {
    const e = document.createElement("style"), n = cA.litNonce;
    n !== void 0 && e.setAttribute("nonce", n), e.textContent = g.cssText, C.appendChild(e);
  });
}, LA = PA ? (C) => C : (C) => C instanceof CSSStyleSheet ? ((A) => {
  let g = "";
 ...
 */
var BA;
const EA = window, KA = EA.trustedTypes, pg = KA ? KA.emptyScript : "", zA = EA.reactiveElementPolyfillSupport, jA = { toAttribute(C, A) {
  switch (A) {
    case Boolean:
      C = C ? pg : null;
      break;
  ...
  return g;
} }, rg = (C, A) => A !== C && (A == A || C == C), UA = { attribute: !0, type: String, converter: jA, reflect: !1, hasChanged: rg }, kA = "finalized";
let CA = class extends HTMLElement {
  constructor() {
  ...
  static getPropertyDescriptor(A, g, e) {
    return { get() {
      ...
      const t = this[A];
      this[g] = n, this.requestUpdate(A, t, e);
  ...
  _$EO(A, g, e = UA) {
    var n;
    const t = this.constructor._$Ep(A, e);
    if (t !== void 0 && e.reflect === !0) {
      const r = (((n = e.converter) === null || n === void 0 ? void 0 : n.toAttribute) !== void 0 ? e.converter : jA).toAttribute(g, e.type);
      this._$El = A, r == null ? this.removeAttribute(t) : this.setAttribute(t, r), this._$El = null;
    }
  }
  _$AK(A, g) {
    var e;
    const n = this.constructor, t = n._$Ev.get(A);
    if (t !== void 0 && this._$El !== t) {
      const r = n.getPropertyOptions(t), I = typeof r.converter == "function" ? { fromAttribute: r.converter } : ((e = r.converter) === null || e === void 0 ? void 0 : e.fromAttribute) !== void 0 ? r.converter : jA;
      this._$El = t, this[t] = I.fromAttribute(g, r.type), this._$El = null;
    }
  }
  requestUpdate(A, g, e) {
    let n = !0;
    A !== void 0 && (((e = e || this.constructor.getPropertyOptions(A)).hasChanged || rg)(this[A], g) ? (this._$AL.has(A) || this._$AL.set(A, g), e.reflect === !0 && this._$El !== A && (this._$EC === void 0 && (this._$EC = /* @__PURE__ */ new Map()), this._$EC.set(A, e))) : n = !1), !this.isUpdatePending && n && (this._$E_ = this._$Ej());
  }
  async _$Ej() {
  ...
  performUpdate() {
    ...
    try {
      g = this.shouldUpdate(e), g ? (this.willUpdate(e), (A = this._$ES) === null || A === void 0 || A.forEach((n) => {
        var t;
        return (t = n.hostUpdate) === null || t === void 0 ? void 0 : t.call(n);
...
CA[kA] = !0, CA.elementProperties = /* @__PURE__ */ new Map(), CA.elementStyles = [], CA.shadowRootOptions = { mode: "open" }, zA == null || zA({ ReactiveElement: CA }), ((BA = EA.reactiveElementVersions) !== null && BA !== void 0 ? BA : EA.reactiveElementVersions = []).push("1.6.3");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
var xA;
const pA = window, rA = pA.trustedTypes, TA = rA ? rA.createPolicy("lit-html", { createHTML: (C) => C }) : void 0, HA = "$lit$", _ = `lit$${(Math.random() + "").slice(9)}$`, ag = "?" + _, ug = `<${ag}>`, IA = document, DA = () => IA.createComment(""), dA = (C) => C === null || typeof C != "object" && typeof C != "function", og = Array.isArray, fg = (C) => og(C) || typeof (C == null ? void 0 : C[Symbol.iterator]) == "function", yA = `[ 	
\f\r]`, sA = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, VA = /-->/g, NA = />/g, gA = RegExp(`>|${yA}(?:([^\\s"'>=/]+)(${yA}*=${yA}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), XA = /'/g, qA = /"/g, lg = /^(?:script|style|textarea|title)$/i, mg = (C) => (A, ...g) => ({ _$litType$: C, strings: A, values: g }), w = mg(1), aA = Symbol.for("lit-noChange"), F = Symbol.for("lit-nothing"), _A = /* @__PURE__ */ new WeakMap(), eA = IA.createTreeWalker(IA, 129, null, !1);
function sg(C, A) {
  if (!Array.isArray(C) || !C.hasOwnProperty("raw")) throw Error("invalid template strings array");
  return TA !== void 0 ? TA.createHTML(A) : A;
}
const Bg = (C, A) => {
  const g = C.length - 1, e = [];
  let n, t = A === 2 ? "<svg>" : "", r = sA;
  for (let I = 0; I < g; I++) {
    const i = C[I];
    let o, D, h = -1, a = 0;
    for (; a < i.length && (r.lastIndex = a, D = r.exec(i), D !== null); ) a = r.lastIndex, r === sA ? D[1] === "!--" ? r = VA : D[1] !== void 0 ? r = NA : D[2] !== void 0 ? (lg.test(D[2]) && (n = RegExp("</" + D[2], "g")), r = gA) : D[3] !== void 0 && (r = gA) : r === gA ? D[0] === ">" ? (r = n ?? sA, h = -1) : D[1] === void 0 ? h = -2 : (h = r.lastIndex - D[2].length, o = D[1], r = D[3] === void 0 ? gA : D[3] === '"' ? qA : XA) : r === qA || r === XA ? r = gA : r === VA || r === NA ? r = sA : (r = gA, n = void 0);
    const l = r === gA && C[I + 1].startsWith("/>") ? " " : "";
    t += r === sA ? i + ug : h >= 0 ? (e.push(o), i.slice(0, h) + HA + i.slice(h) + _ + l) : i + _ + (h === -2 ? (e.push(void 0), I) : l);
  }
  return [sg(C, t + (C[g] || "<?>") + (A === 2 ? "</svg>" : "")), e];
};
class QA {
  constructor({ strings: A, _$litType$: g }, e) {
    ...
    if (this.el = QA.createElement(o, e), eA.currentNode = this.el.content, g === 2) {
      const h = this.el.content, a = h.firstChild;
      a.remove(), h.append(...a.childNodes);
    }
    for (; (n = eA.nextNode()) !== null && i.length < I; ) {
      if (n.nodeType === 1) {
        if (n.hasAttributes()) {
          const h = [];
          for (const a of n.getAttributeNames()) if (a.endsWith(HA) || a.startsWith(_)) {
            const l = D[r++];
            if (h.push(a), l !== void 0) {
              const E = n.getAttribute(l.toLowerCase() + HA).split(_), x = /([.?@])?(.*)/.exec(l);
              i.push({ type: 1, index: t, name: x[2], strings: E, ctor: x[1] === "." ? xg : x[1] === "?" ? wg : x[1] === "@" ? vg : fA });
            } else i.push({ type: 6, index: t });
          }
          for (const a of h) n.removeAttribute(a);
        }
        if (lg.test(n.tagName)) {
          const h = n.textContent.split(_), a = h.length - 1;
          if (a > 0) {
            n.textContent = rA ? rA.emptyScript : "";
            for (let l = 0; l < a; l++) n.append(h[l], DA()), eA.nextNode(), i.push({ type: 2, index: ++t });
            n.append(h[a], DA());
          }
        }
      } else if (n.nodeType === 8) if (n.data === ag) i.push({ type: 2, index: t });
      else {
        let h = -1;
        for (; (h = n.data.indexOf(_, h + 1)) !== -1; ) i.push({ type: 7, index: t }), h += _.length - 1;
      }
      t++;
    }
  }
...
function oA(C, A, g = C, e) {
  var n, t, r, I;
  if (A === aA) return A;
  let i = e !== void 0 ? (n = g._$Co) === null || n === void 0 ? void 0 : n[e] : g._$Cl;
  const o = dA(A) ? void 0 : A._$litDirective$;
  return (i == null ? void 0 : i.constructor) !== o && ((t = i == null ? void 0 : i._$AO) === null || t === void 0 || t.call(i, !1), o === void 0 ? i = void 0 : (i = new o(C), i._$AT(C, g, e)), e !== void 0 ? ((r = (I = g)._$Co) !== null && r !== void 0 ? r : I._$Co = [])[e] = i : g._$Cl = i), i !== void 0 && (A = oA(C, i._$AS(C, A.values), i, e)), A;
}
class Ug {
  constructor(A, g) {
  ...
  u(A) {
    var g;
    const { el: { content: e }, parts: n } = this._$AD, t = ((g = A == null ? void 0 : A.creationScope) !== null && g !== void 0 ? g : IA).importNode(e, !0);
    eA.currentNode = t;
    let r = eA.nextNode(), I = 0, i = 0, o = n[0];
    for (; o !== void 0; ) {
      if (I === o.index) {
        let D;
        o.type === 2 ? D = new SA(r, r.nextSibling, this, A) : o.type === 1 ? D = new o.ctor(r, o.name, o.strings, this, A) : o.type === 6 && (D = new Rg(r, this, A)), this._$AV.push(D), o = n[++i];
      }
      I !== (o == null ? void 0 : o.index) && (r = eA.nextNode(), I++);
    }
    return eA.currentNode = IA, t;
  }
  v(A) {
    let g = 0;
...
class SA {
  constructor(A, g, e, n) {
    var t;
    this.type = 2, this._$AH = F, this._$AN = void 0, this._$AA = A, this._$AB = g, this._$AM = e, this.options = n, this._$Cp = (t = n == null ? void 0 : n.isConnected) === null || t === void 0 || t;
  }
  get _$AU() {
    var A, g;
  ...
  _$AI(A, g = this) {
    A = oA(this, A, g), dA(A) ? A === F || A == null || A === "" ? (this._$AH !== F && this._$AR(), this._$AH = F) : A !== this._$AH && A !== aA && this._(A) : A._$litType$ !== void 0 ? this.g(A) : A.nodeType !== void 0 ? this.$(A) : fg(A) ? this.T(A) : this._(A);
  }
  k(A) {
  ...
  g(A) {
    var g;
    const { values: e, _$litType$: n } = A, t = typeof n == "number" ? this._$AC(A) : (n.el === void 0 && (n.el = QA.createElement(sg(n.h, n.h[0]), this.options)), n);
    if (((g = this._$AH) === null || g === void 0 ? void 0 : g._$AD) === t) this._$AH.v(e);
    else {
      const r = new Ug(t, this), I = r.u(this.options);
      r.v(e), this.$(I), this._$AH = r;
    }
  }
  _$AC(A) {
  ...
  T(A) {
    ...
    const g = this._$AH;
    let e, n = 0;
    for (const t of A) n === g.length ? g.push(e = new SA(this.k(DA()), this.k(DA()), this, this.options)) : e = g[n], e._$AI(t), n++;
...
class fA {
  constructor(A, g, e, n, t) {
    this.type = 1, this._$AH = F, this._$AN = void 0, this.element = A, this.name = g, this._$AM = n, this.options = t, e.length > 2 || e[0] !== "" || e[1] !== "" ? (this._$AH = Array(e.length - 1).fill(new String()), this.strings = e) : this._$AH = F;
  }
  get tagName() {
  ...
  _$AI(A, g = this, e, n) {
    ...
    let r = !1;
    if (t === void 0) A = oA(this, A, g, 0), r = !dA(A) || A !== this._$AH && A !== aA, r && (this._$AH = A);
    else {
      const I = A;
      let i, o;
      for (A = t[0], i = 0; i < t.length - 1; i++) o = oA(this, I[e + i], g, i), o === aA && (o = this._$AH[i]), r || (r = !dA(o) || o !== this._$AH[i]), o === F ? A = F : A !== F && (A += (o ?? "") + t[i + 1]), this._$AH[i] = o;
    }
    r && !n && this.j(A);
  }
  j(A) {
...
class vg extends fA {
  constructor(A, g, e, n, t) {
    super(A, g, e, n, t), this.type = 5;
  }
  _$AI(A, g = this) {
    var e;
    if ((A = (e = oA(this, A, g, 0)) !== null && e !== void 0 ? e : F) === aA) return;
    const n = this._$AH, t = A === F && n !== F || A.capture !== n.capture || A.once !== n.once || A.passive !== n.passive, r = A !== F && (n === F || t);
    t && this.element.removeEventListener(this.name, this, n), r && this.element.addEventListener(this.name, this, A), this._$AH = A;
  }
  handleEvent(A) {
    var g, e;
...
const jg = (C, A, g) => {
  var e, n;
  const t = (e = g == null ? void 0 : g.renderBefore) !== null && e !== void 0 ? e : A;
  let r = t._$litPart$;
  if (r === void 0) {
    const I = (n = g == null ? void 0 : g.renderBefore) !== null && n !== void 0 ? n : null;
    t._$litPart$ = r = new SA(A.insertBefore(DA(), I), I, void 0, g ?? {});
  }
  return r._$AI(C), r;
};
/**
...
const bA = (C, A = "_") => {
  const g = "àáâäæãåāăąабçćčđďдèéêëēėęěеёэфğǵгḧхîïíīįìıİийкłлḿмñńǹňнôöòóœøōõőоṕпŕřрßśšşșсťțтûüùúūǘůűųувẃẍÿýыžźżз·", e = `aaaaaaaaaaabcccdddeeeeeeeeeeefggghhiiiiiiiiijkllmmnnnnnoooooooooopprrrsssssstttuuuuuuuuuuvwxyyyzzzz${A}`, n = new RegExp(g.split("").join("|"), "g"), t = {
    ж: "zh",
    х: "kh",
    ц: "ts",
    ч: "ch",
  ...
  mold_spores_2_png: tI,
  mold_spores_3_png: iI,
  mold_spores_4_png: rI,
  mold_spores_5_png: aI,
...
for (const C in eg) {
  const A = C.match(/\.\/locales\/([\w-]+)\.json$/);
  A && (lA[A[1]] = eg[C].default);
}
const OA = "en";
function Ig(C, A) {
  return A.split(".").reduce((g, e) => g && typeof g == "object" ? g[e] : void 0, C);
}
function q(C, A) {
  var n;
  let g = A || ((n = C == null ? void 0 : C.locale) == null ? void 0 : n.language) || (C == null ? void 0 : C.language) || OA;
  if (lA[g])
    return g;
...
function $(C) {
  return C.normalize("NFD").replace(/[\u0300-\u036f]/g, "").toLowerCase().replace(/[^a-z0-9]+/g, "_").replace(/^_+|_+$/g, "");
}
function uA(C) {
  return C.toLowerCase().replace(/ä/g, "ae").replace(/ö/g, "oe").replace(/ü/g, "ue").replace(/ß/g, "ss").replace(/[^a-z0-9]+/g, "_").replace(/^_+|_+$/g, "");
}
const zn = "state_tomorrow", Tn = "state_in_2_days", Vn = "state_today_desc", Nn = "state_tomorrow_desc", Xn = "state_in_2_days_desc", T = {
  integration: "dwd",
  region_id: "",
  allergens: [
    "erle",
...
async function qn(C, A) {
  const g = !!A.debug, e = (S) => S.charAt(0).toUpperCase() + S.slice(1), n = q(C, A.date_locale), t = A.date_locale || T.date_locale, r = A.days_relative !== !1, I = !!A.days_abbreviated, i = !!A.days_uppercase, o = A.phrases || {}, D = o.full || {}, h = o.short || {}, a = o.levels, l = Array.isArray(a) && a.length === 7 ? a : Array.from({ length: 7 }, (S, s) => O(`card.levels.${s}`, n)), E = o.no_information || O("card.no_information", n), x = o.days || {}, b = A.days_to_show ?? T.days_to_show, B = A.pollen_threshold ?? T.pollen_threshold;
  ...
  for (const S of A.allergens)
    try {
      ...
      if (!c || !C.states[c]) {
        const U = Object.keys(C.states).filter(
          (H) => H.startsWith(`sensor.pollenflug_${p}_`)
        );
        if (U.length === 1) c = U[0];
        else continue;
      }
      const m = C.states[c], y = j(m.state), v = j(m.attributes[zn]), f = j(m.attributes[Tn]), J = [
        { date: Y, level: y },
      ...
      s.days = [], J.forEach((U, H) => {
        ...
        let Q;
        r ? x[W] !== void 0 ? Q = x[W] : W >= 0 && W <= 2 ? Q = O(`card.days.${W}`, n) : Q = U.date.toLocaleDateString(t, {
          day: "numeric",
          month: "short"
        }) : (Q = U.date.toLocaleDateString(t, {
...
async function $n(C, A) {
  var p, u;
  const g = !!A.debug, e = q(C, A.date_locale), n = A.date_locale || ((p = C.locale) == null ? void 0 : p.language) || C.language || `${e}-${e.toUpperCase()}`, t = A.days_relative !== !1, r = !!A.days_abbreviated, I = !!A.days_uppercase, i = {
    full: {},
    short: {},
    levels: [],
    days: {},
    no_information: "",
    ...A.phrases || {}
  }, o = i.full, D = i.short, h = i.levels, a = 5;
  Array.isArray(h) && h.length === a || Array.from(
    { length: a },
  ...
  B.setHours(0, 0, 0, 0);
  const j = A.days_to_show ?? V.days_to_show, Y = A.pollen_threshold ?? V.pollen_threshold, M = Object.keys(C.states).filter(
  ...
  for (const d of A.allergens)
    try {
      ...
      H.forEach((Q, R) => {
        ...
        let P;
        t ? E[X] != null ? P = E[X] : X >= 0 && X <= 2 ? P = O(`card.days.${X}`, e) : P = N.toLocaleDateString(n, {
          day: "numeric",
          month: "short"
...
function hg(C, A, g) {
  ...
  const t = ((i = G.weather_suffixes) == null ? void 0 : i[g]) || ((o = G.weather_suffixes) == null ? void 0 : o[g == null ? void 0 : g.split("-")[0]]) || [];
  for (const h of t) {
    n.add(h);
    const a = `weather.silam_pollen_${e}_${h}`;
    if (a in C.states) return a;
  }
  ...
  return Object.keys(C.states).find((h) => h.startsWith(I)) || null;
}
const z = {
  integration: "silam",
  location: "",
...
function GA(C, A) {
  return Array.isArray(C.levels) && C.levels.length === 7 ? C.levels : Array.from({ length: 7 }, (g, e) => O(`card.levels.${e}`, A));
}
function ZA(C, A, g) {
  let e;
  A.full[C] ? e = A.full[C] : G.names && G.names[C] && G.names[C][g] ? e = G.names[C][g] : e = C.charAt(0).toUpperCase() + C.slice(1);
  const n = A.short[C] || e;
  return { allergenCapitalized: e, allergenShort: n };
}
async function nC(C, A) {
  var Y, M, S;
  const g = !!A.debug, e = q(C, A.date_locale), n = A.date_locale || ((Y = C.locale) == null ? void 0 : Y.language) || C.language || `${e}-${e.toUpperCase()}`, t = A.days_relative !== !1, r = !!A.days_abbreviated, I = !!A.days_uppercase, i = MA(A, e), o = GA(i, e), D = i.no_information, h = i.days, a = /* @__PURE__ */ new Date();
  a.setHours(0, 0, 0, 0);
  const l = A.days_to_show ?? z.days_to_show, E = A.pollen_threshold ?? z.pollen_threshold, x = (A.location || "").toLowerCase(), b = Object.keys(C.states).filter((s) => {
  ...
  for (const s of A.allergens)
    try {
      ...
      const m = C.states[c], y = Number(m.state);
      let v = [];
      ...
      let f = [];
      if (f.push(tA(s, y)), m.attributes && Array.isArray(m.attributes.forecast) && m.attributes.forecast.length > 0)
        for (let k = 1; k < l; ++k) {
          const U = new Date(a.getTime() + k * 864e5), H = m.attributes.forecast.find(
            (Q) => Math.abs(
              new Date(Q.datetime || Q.time).getTime() - U.getTime()
            ) < 12 * 3600 * 1e3
          ), W = H ? tA(s, Number(H.value)) : -1;
          f.push(W);
        }
      else
        for (l > 1 && ((M = m.attributes) == null ? void 0 : M.tomorrow) !== void 0 ? f.push(
          ...
          f.push(-1);
      f.length < l && ((S = m.attributes) == null ? void 0 : S.tomorrow) !== void 0 && (f[1] = tA(s, Number(m.attributes.tomorrow)) || -1);
      for (let k = 0; k < l; ++k) {
        const U = f[k], H = new Date(a.getTime() + k * 864e5), W = k;
        let Q;
        t ? h[W] != null ? Q = h[W] : W >= 0 && W <= 2 ? Q = O(`card.days.${W}`, e) : Q = H.toLocaleDateString(n, {
          day: "numeric",
          month: "short"
...
async function CC(C, A, g = null) {
  ...
  const n = q(C, A.date_locale), t = A.date_locale || ((x = C.locale) == null ? void 0 : x.language) || C.language || `${n}-${n.toUpperCase()}`, r = A.pollen_threshold ?? z.pollen_threshold;
  if (e) {
    const B = Object.keys(C.states).filter(
  ...
  const D = MA(A, n), h = GA(D, n), a = D.no_information, l = A.allergens || z.allergens;
  e && console.debug(
  ...
  for (const B of l)
    try {
      ...
      for (let s = 0; s < o.length; ++s) {
        const p = o[s], u = `pollen_${B}`, d = Number(p[u]), c = tA(B, d), m = c < 0 ? a : h[c] || String(c), y = new Date(p.datetime || p.time);
        let v, f;
      ...
      const S = j.days.some((s) => s.state >= r);
      e && console.debug(
...
async function rC(C, A) {
  ...
  r.setHours(0, 0, 0, 0);
  const I = q(C, A.date_locale), i = A.date_locale || ((s = C.locale) == null ? void 0 : s.language) || C.language || `${I}-${I.toUpperCase()}`, o = A.days_relative !== !1, D = !!A.days_abbreviated, h = !!A.days_uppercase, a = {
    full: {},
    short: {},
    levels: [],
    days: {},
    no_information: "",
    ...A.phrases || {}
  }, l = a.full, E = a.short, x = a.levels, b = Array.isArray(x) && x.length === 7 ? x : Array.from({ length: 7 }, (u, d) => O(`card.levels.${d}`, I)), B = a.no_information || O("card.no_information", I), j = a.days;
  ...
  for (const u of A.allergens)
    try {
      ...
      if (!C.states[y]) {
        const Q = Object.keys(C.states).filter(
      ...
      if (U.length >= M)
        ...
        H = U.slice();
        let Q = U.length > 0 ? t(U[U.length - 1]) : r;
        for (; H.length < M; ) {
          Q = new Date(Q.getTime() + 864e5);
          const R = Q.getFullYear(), Z = String(Q.getMonth() + 1).padStart(2, "0"), L = String(Q.getDate()).padStart(2, "0");
          H.push(`${R}-${Z}-${L}T00:00:00`);
      ...
      H.forEach((Q, R) => {
        const Z = J[Q] || {}, L = Y(Z.level), N = t(Q), X = Math.round((N - r) / 864e5);
        let P;
...
function ng(C, A, g = !1) {
  const e = C.integration;
  let n = [];
  if (e === "pp") {
    const t = $(C.city || "");
    for (const r of C.allergens || []) {
      const I = $(r), i = `sensor.pollen_${t}_${I}`, o = !!A.states[i];
      g && console.debug(
        `[findAvailableSensors][pp] allergen: '${r}', cityKey: '${t}', rawKey: '${I}', sensorId: '${i}', exists: ${o}`
      ), o && n.push(i);
    }
  } else if (e === "dwd")
    for (const t of C.allergens || []) {
      const r = uA(t);
      let I = C.region_id ? `sensor.pollenflug_${r}_${C.region_id}` : null, i = I && A.states[I];
      if (!i) {
        const o = Object.keys(A.states).filter(
          (D) => D.startsWith(`sensor.pollenflug_${r}_`)
        );
        o.length === 1 && (I = o[0], i = !0);
      }
      g && console.debug(
        `[findAvailableSensors][dwd] allergen: '${t}', rawKey: '${r}', region_id: '${C.region_id}', sensorId: '${I}', exists: ${!!i}`
      ), i && n.push(I);
    }
  else if (e === "peu") {
    const t = (C.location || "").toLowerCase();
    for (const r of C.allergens || []) {
      const I = $(r);
      let i = t ? `sensor.polleninformation_${t}_${I}` : null, o = i && A.states[i];
      if (!o) {
        const D = Object.keys(A.states).filter((h) => {
          const a = h.match(/^sensor\.polleninformation_(.+)_(.+)$/);
          if (!a) return !1;
          const l = a[1], E = a[2];
          return (!t || l === t) && E === I;
        });
      ...
      g && console.debug(
        `[findAvailableSensors][peu] allergen: '${r}', locationSlug: '${t}', allergenSlug: '${I}', sensorId: '${i}', exists: ${!!o}`
      ), o && n.push(i);
    }
  } else if (e === "silam") {
    const t = (C.location || "").toLowerCase();
    for (const r of C.allergens || []) {
      ...
      for (const i of Object.values(G.mapping)) {
        const o = Object.entries(i).reduce((D, [h, a]) => (D[a] = h, D), {});
        if (o[r]) {
          const D = o[r], h = `sensor.silam_pollen_${t}_${D}`;
          if (A.states[h]) {
            I = D, g && console.debug(
              `[findAvailableSensors][silam] allergen: '${r}', locationSlug: '${t}', hassSlug: '${I}', sensorId: '${h}', exists: true`,
              A.states[h]
            ), n.push(h);
            break;
          }
      ...
      !I && g && console.debug(
        `[findAvailableSensors][silam] allergen: '${r}', locationSlug: '${t}', ingen sensor hittades!`
      );
    }
  }
  if (g) {
...
class aC extends iA {
  ...
  _updateSensorsAndColumns(g, e, n) {
    ...
    let t = 0;
    n.show_empty_days ? t = n.days_to_show : g.length > 0 && g[0].days && (t = g[0].days.length), this.days_to_show = t, this.displayCols = Array.from({ length: t }, (r, I) => I), this.debug && (console.debug("Days to show:", this.days_to_show), console.debug("Display columns:", this.displayCols)), this.requestUpdate();
  }
  _subscribeForecastIfNeeded() {
    var g, e, n, t;
    if (!(!this.config || !this._hass) && (this._forecastUnsub && (Promise.resolve(this._forecastUnsub).then((r) => {
      typeof r == "function" && r();
      ...
      const r = this.config.location.toLowerCase(), I = ((e = (g = this.config) == null ? void 0 : g.date_locale) == null ? void 0 : e.split("-")[0]) || "en", i = ((n = G.weather_suffixes) == null ? void 0 : n[I]) || ((t = G.weather_suffixes) == null ? void 0 : t.en) || [];
      if (this.debug) {
        const h = Object.keys(this._hass.states).filter(
          (a) => a.startsWith("weather.silam_pollen_")
        );
        console.debug(
          "[Card][Debug] Alla weather-entities i hass.states:",
          h
        ), console.debug("[Card][Debug] locationSlug:", r), console.debug("[Card][Debug] Suffixes:", i);
      }
      const o = hg(this._hass, r, I);
      let D = "hourly";
  ...
  _getImageSrc(g, e) {
    const n = Number(e);
    let t = n, r = -1, I = 6;
    this.config.integration === "dwd" ? (t = n * 2, I = 6) : this.config.integration === "peu" && (t = Math.round(n * 6 / 4), I = 6, r = 0);
    let i = Math.round(t);
    (isNaN(i) || i < r) && (i = r), i > I && (i = I);
    const o = nA[g] || g;
  ...
  setConfig(g) {
    ...
    e === "pp" ? n = K : e === "peu" ? n = V : e === "dwd" ? n = T : e === "silam" ? n = z : n = K;
    const t = Object.keys(n).concat([
      "allergens",
      "city",
      "location",
      "region_id",
    ...
    let r = {};
    for (const I of t)
      I in this._userConfig && (r[I] = this._userConfig[I]);
  ...
  set hass(g) {
    ...
    ), r = Object.keys(g.states).filter(
      (S) => S.startsWith("sensor.polleninformation_")
    ), I = Object.keys(g.states).filter(
      (S) => S.startsWith("sensor.silam_pollen_")
    );
    this.debug && (console.debug("Sensor states detected:"), console.debug("PP:", n), console.debug("DWD:", t), console.debug("PEU:", r), console.debug("SILAM:", I));
    let i = this._userConfig.integration;
    e || (n.length ? i = "pp" : r.length ? i = "peu" : t.length ? i = "dwd" : I.length && (i = "silam"));
    let o;
    i === "dwd" ? o = T : i === "peu" ? o = V : i === "pp" ? o = K : i === "silam" ? o = z : console.error("Unknown integration:", i);
    const { allergens: D, ...h } = this._userConfig, a = {
      ...o,
      ...h,
      integration: i
    };
    if (this._integrationExplicit && Array.isArray(D) && D.length > 0 ? (this.debug && console.debug(
      ...
      D
    ), a.allergens = D) : (this.debug && console.debug(
      "[Card] Using stub allergens for integration:",
      i
    ), i === "pp" ? a.allergens = K.allergens : i === "peu" ? a.allergens = V.allergens : i === "dwd" ? a.allergens = T.allergens : i === "silam" && (a.allergens = z.allergens)), !a.hasOwnProperty("date_locale")) {
      ...
      a.date_locale = s, this.debug && console.debug("[Card] auto-filling date_locale:", a.date_locale);
    }
    if (i === "dwd" && !a.region_id && t.length)
      a.region_id = Array.from(
        new Set(t.map((S) => S.split("_").pop()))
      ).sort((S, s) => Number(S) - Number(s))[0], this.debug && console.debug("[Card] Auto-set region_id:", a.region_id);
    else if (i === "pp" && !a.city && n.length)
      a.city = n[0].slice(14).replace(/_[^_]+$/, ""), this.debug && console.debug("[Card] Auto-set city:", a.city);
    else if (i === "peu" && !a.location && r.length) {
      const S = Array.from(
        new Set(
          r.map((s) => {
            var u;
      ...
      a.location = S[0] || null, this.debug && console.debug(
        "[Card][PEU] Auto-set location (location_slug):",
        a.location,
        S
      );
    } else if (i === "silam" && !a.location && I.length) {
      const S = Array.from(
        new Set(
          I.map((s) => {
            const p = s.match(/^sensor\.silam_pollen_(.*)_([^_]+)$/);
    ...
    if (this.config = a, this.tapAction = a.tap_action || this.tapAction || null, this.debug && (console.debug("[Card][Debug] Aktiv integration:", i), console.debug("[Card][Debug] Allergens i config:", a.allergens)), a.title === "false" || a.title === !1 || typeof a.title == "string" && a.title.trim() === "")
      this.header = "";
    else if (typeof a.title == "string" && a.title.trim() !== "" && a.title !== "true")
      this.header = a.title;
    else {
      let S = "";
      if (i === "dwd")
        S = dg[a.region_id] || a.region_id;
      else if (i === "peu") {
        const p = Object.values(g.states).filter(
          (d) => d.entity_id.startsWith("sensor.polleninformation_")
        ).find((d) => ((d.attributes || {}).location_slug || d.entity_id.replace("sensor.polleninformation_", "").replace(/_[^_]+$/, "")) === a.location);
        let u = "";
        if (p) {
          const d = p.attributes;
          u = d.location_title || ((Y = (j = d.friendly_name) == null ? void 0 : j.match(/\((.*?)\)/)) == null ? void 0 : Y[1]) || a.location;
        }
        S = u || a.location || "";
      } else if (i === "silam") {
        const s = [
        ...
        if (c) {
          ...
          m = y.location_title || ((M = y.friendly_name) == null ? void 0 : M.replace(/^SILAM Pollen\s*-?\s*/i, "").replace(new RegExp("\\s+\\p{L}+$", "u"), "").trim()) || a.location, m = m.replace(/^[-\s]+/, "");
        }
        S = m || a.location || "";
      } else
        S = JA.find(
    ...
    if (E)
      return E.then((S) => {
        ...
        ), console.debug("[Card] Användaren har valt city:", a.city), console.debug(
          "[Card] Användaren har valt allergener:",
          a.allergens
        ), console.debug("[Card] Användaren har valt plats:", a.location));
        ...
        if (Array.isArray(a.allergens) && a.allergens.length > 0 && a.integration !== "silam") {
          ...
          i === "dwd" ? (y = new Set(a.allergens.map((f) => uA(f))), v = (f) => uA(f.allergenReplaced || "")) : (this.debug && console.debug(
            ...
            a.allergens
          ), y = new Set(a.allergens.map((f) => $(f))), v = (f) => $(f.allergenReplaced || "")), d = d.filter((f) => {
        ...
        if (this._integrationExplicit && !!a.location && p === 0) {
          this._explicitLocationNoSensors = !0, this._updateSensorsAndColumns([], [], a), this.debug && console.warn(
            `[Card] Ingen sensor hittad för explicit vald plats: '${a.location}'`
          );
          return;
        } else
          this._explicitLocationNoSensors = !1, this._updateSensorsAndColumns(d, s, a);
      }).catch((S) => {
    ...
    return w`
      ...
      <div class="card-content">
        <div class="flex-container">
          ${(this.sensors || []).map((g) => {
      var r, I, i, o, D, h, a, l, E;
      const e = ((r = g.day0) == null ? void 0 : r.state_text) ?? "", n = ((I = g.day0) == null ? void 0 : I.state) ?? "";
      let t = "";
      return (i = this.config) != null && i.show_text_allergen && (t += (o = this.config) != null && o.allergens_abbreviated ? g.allergenShort ?? "" : g.allergenCapitalized ?? ""), (D = this.config) != null && D.show_value_text && ((h = this.config) != null && h.show_value_numeric) ? (t && (t += ": "), t += `${e} (${n})`) : (a = this.config) != null && a.show_value_text ? (t && (t += ": "), t += e) : (l = this.config) != null && l.show_value_numeric && (t && (t += " "), t += `(${n})`), w`
              <div class="sensor">
                <img
                  class="box"
        ...
        (E = g.day0) == null ? void 0 : E.state
                ...
                />
                ${t ? w`<span class="short-text">${t}</span>` : ""}
              </div>
            `;
    })}
        </div>
              ...
              <tr class="allergen-icon-row" valign="top">
                <td>
                  <img
                    ...
                    src="${this._getImageSrc(
          n.allergenReplaced,
          (t = n.days[0]) == null ? void 0 : t.state
        )}"
                  />
                </td>
                ${e.map(
            ...
            return w`
                    <td>
                      <div class="icon-wrapper">
                        <img
                          src="${this._getImageSrc("", (I = n.days[r]) == null ? void 0 : I.state)}"
                        />
                        ${this.config.show_value_numeric_in_circle ? w`<span class="circle-overlay">
                              ${((i = n.days[r]) == null ? void 0 : i.state) ?? ""}
                            </span>` : ""}
                      </div>
                    </td>
                  `;
              ...
              ${this.config.show_text_allergen || this.config.show_value_text || this.config.show_value_numeric ? w`
                    <tr class="allergen-text-row" valign="top">
                      ...
                      ${e.map((r) => {
          var D, h;
          const I = ((D = n.days[r]) == null ? void 0 : D.state_text) || "", i = (h = n.days[r]) == null ? void 0 : h.state;
          let o = "";
  ...
  render() {
    ...
    const t = e && e.type && e.type !== "none" ? "pointer" : "auto", r = `${n} cursor: ${t};`;
    return w`
      <ha-card
        style="${r}"
  ...
  _handleTapAction(g) {
    ...
    (t = g.preventDefault) == null || t.call(g), (r = g.stopPropagation) == null || r.call(g);
  ...
  _fire(g, e, n) {
    ...
    return t.detail = e, this.dispatchEvent(t), t;
  }
  static get styles() {
    return ig`
      .forecast {
...
customElements.define("pollenprognos-card", aC);
const hA = (C, A) => {
  const g = { ...C };
  for (const e of Object.keys(A)) {
    const n = A[e];
    n !== null && typeof n == "object" && !Array.isArray(n) && typeof C[e] == "object" && C[e] !== null ? g[e] = hA(C[e], n) : g[e] = n;
  }
  return g;
}, oC = (C) => C === "dwd" ? T : C === "peu" ? V : C === "silam" ? z : K;
class lC extends iA {
  get debug() {
  ...
  _hasSilamWeatherEntity(A) {
    ...
    const g = ((I = (r = this._config) == null ? void 0 : r.date_locale) == null ? void 0 : I.split("-")[0]) || "en", e = ((i = G.weather_suffixes) == null ? void 0 : i[g]) || ((o = G.weather_suffixes) == null ? void 0 : o.en) || [], n = A.toLowerCase();
    for (const D of e)
      if (`weather.silam_pollen_${n}_${D}` in this._hass.states) return !0;
    const t = `weather.silam_pollen_${n}_`;
    return Object.keys(this._hass.states).some((D) => D.startsWith(t));
  }
  _resetAll() {
  ...
  _resetPhrases(A) {
    ...
    const g = this._config.integration === "dwd" ? T.allergens : this._config.integration === "peu" ? V.allergens : this._config.integration === "silam" ? z.allergens : K.allergens, e = {}, n = {};
    g.forEach((o) => {
      const D = $(o), h = nA[D] || D;
      e[o] = O(`editor.phrases_full.${h}`, A), n[o] = O(`editor.phrases_short.${h}`, A);
    });
    const t = this._config.integration === "dwd" ? 4 : this._config.integration === "peu" ? 5 : (this._config.integration === "silam", 7), r = Array.from(
      { length: t },
  ...
  setConfig(A) {
    ...
    try {
      ...
      const n = A.integration === "dwd" ? T.allergens.length : A.integration === "peu" ? V.allergens.length : A.integration === "silam" ? z.allergens.length : K.allergens.length, t = { ...A };
      ...
      const r = (t.integration === "dwd" ? T : t.integration === "peu" ? V : t.integration === "silam" ? z : K).pollen_threshold;
      t.hasOwnProperty("pollen_threshold") && !this._thresholdExplicit && t.pollen_threshold === r && (this.debug && console.debug(
        "[Editor] dropping incoming stub-threshold (matches stub):",
        r
      ), delete t.pollen_threshold);
      const I = A.integration;
      this._prevIntegration !== void 0 && I !== this._prevIntegration && (delete this._userConfig.allergens, this._allergensExplicit = !1, this.debug && console.debug("[Editor] integration changed → wipe allergens")), !this._integrationExplicit && t.integration === K.integration && (this.debug && console.debug("[Editor] dropped stub integration"), delete t.integration), !this._daysExplicit && t.days_to_show === K.days_to_show && (this.debug && console.debug("[Editor] dropped stub days_to_show"), delete t.days_to_show);
      const i = (t.integration === "dwd" ? T : t.integration === "peu" ? V : t.integration === "silam" ? z : K).date_locale;
      !this._localeExplicit && t.date_locale === i && (this.debug && console.debug("[Editor] dropped stub date_locale"), delete t.date_locale), this._userConfig = hA(this._userConfig, t), this._thresholdExplicit = this._userConfig.hasOwnProperty("pollen_threshold"), this._allergensExplicit = this._userConfig.hasOwnProperty("allergens"), this._integrationExplicit = this._userConfig.hasOwnProperty("integration"), this._daysExplicit = this._userConfig.hasOwnProperty("days_to_show"), this._localeExplicit = this._userConfig.hasOwnProperty("date_locale");
      ...
      if (!this._integrationExplicit && this._hass) {
        const a = Object.keys(this._hass.states);
        a.some((l) => l.startsWith("sensor.pollen_")) ? o = "pp" : a.some((l) => l.startsWith("sensor.polleninformation_")) ? o = "peu" : a.some((l) => l.startsWith("sensor.pollenflug_")) ? o = "dwd" : a.some((l) => l.startsWith("sensor.silam_pollen_")) && (o = "silam"), this._userConfig.integration = o, this.debug && console.debug("[Editor] auto-detected integration:", o);
      }
      ...
      if (this._userConfig.hasOwnProperty("pollen_threshold") || (h.pollen_threshold = D.pollen_threshold, this.debug && console.debug(
        ...
        const a = q(this._hass, null), l = ((e = (g = this._hass) == null ? void 0 : g.locale) == null ? void 0 : e.language) || `${a}-${a.toUpperCase()}`;
      ...
      if (this._initDone = !1, this._hass) {
        ...
        this.installedRegionIds = Array.from(
          new Set(
            a.filter((E) => E.startsWith("sensor.pollenflug_")).map((E) => E.split("_").pop())
          )
  ...
  set hass(A) {
    ...
    ), r = Object.keys(A.states).filter(
      (l) => l.startsWith("sensor.silam_pollen_")
    );
    let I = this._userConfig.integration;
    g || (e.length ? I = "pp" : t.length ? I = "peu" : n.length ? I = "dwd" : r.length && (I = "silam"), this._userConfig.integration = I), I === "silam" && !this._userConfig.mode && (this._userConfig.mode = "daily");
    const i = I === "dwd" ? T : I === "peu" ? V : I === "silam" ? z : K;
  ...
  _updateConfig(A, g) {
    ...
    if (A === "integration") {
      ...
      t !== r && (delete e[t === "dwd" ? "city" : "region_id"], delete e.allergens, delete e.pollen_threshold, this._allergensExplicit = !1), n = hA(t === "dwd" ? T : t === "peu" ? V : t === "silam" ? z : K, e), n.integration = t;
    } else
      n = { ...this._config, [A]: g }, this._config.integration === "silam" && A === "mode" && (g === "hourly" || g === "twice_daily" ? n.days_to_show = 8 : g === "daily" && (n.days_to_show = 2)), this._config.integration === "silam" && A === "location" && (this._hasSilamWeatherEntity(g) || (n.mode = "daily", n.days_to_show = 2));
  ...
  render() {
    const A = {
      ...
      ...this._config
    }, g = A.integration === "dwd" ? T.allergens : A.integration === "peu" ? V.allergens : A.integration === "silam" ? z.allergens : K.allergens, e = A.integration === "dwd" ? 4 : A.integration === "peu" ? 5 : 7, n = A.integration === "dwd" ? { min: 0, max: 3, step: 0.5 } : A.integration === "peu" ? { min: 0, max: 4, step: 1 } : { min: 0, max: 6, step: 1 }, r = [
      "value_ascending",
      "value_descending",
      "name_ascending",
      "name_descending"
...
customElements.define("pollenprognos-card-editor", lC);
