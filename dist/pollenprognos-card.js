 ...
 */
const QA = window, jA = QA.ShadowRoot && (QA.ShadyCSS === void 0 || QA.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, RA = Symbol(), vA = /* @__PURE__ */ new WeakMap();
let qA = class {
  constructor(A, g, C) {
    if (this._$cssResult$ = !0, C !== RA) throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");
...
const Cg = (e) => new qA(typeof e == "string" ? e : e + "", void 0, RA), zA = (e, ...A) => {
  ...
  return new qA(g, e, RA);
}, ng = (e, A) => {
  jA ? e.adoptedStyleSheets = A.map((g) => g instanceof CSSStyleSheet ? g : g.styleSheet) : A.forEach((g) => {
    const C = document.createElement("style"), n = QA.litNonce;
    n !== void 0 && C.setAttribute("nonce", n), C.textContent = g.cssText, e.appendChild(C);
  });
}, kA = jA ? (e) => e : (e) => e instanceof CSSStyleSheet ? ((A) => {
  let g = "";
 ...
 */
var SA;
const sA = window, PA = sA.trustedTypes, Dg = PA ? PA.emptyScript : "", OA = sA.reactiveElementPolyfillSupport, BA = { toAttribute(e, A) {
  switch (A) {
    case Boolean:
      e = e ? Dg : null;
      break;
  ...
  return g;
} }, NA = (e, A) => A !== e && (A == A || e == e), fA = { attribute: !0, type: String, converter: BA, reflect: !1, hasChanged: NA }, uA = "finalized";
let gA = class extends HTMLElement {
  ...
  static getPropertyOptions(A) {
    return this.elementProperties.get(A) || fA;
  }
  static finalize() {
    if (this.hasOwnProperty(uA)) return !1;
    this[uA] = !0;
  ...
  _$EO(A, g, C = fA) {
    ...
    if (I !== void 0 && C.reflect === !0) {
      const D = (((n = C.converter) === null || n === void 0 ? void 0 : n.toAttribute) !== void 0 ? C.converter : BA).toAttribute(g, C.type);
  ...
  _$AK(A, g) {
    ...
    if (I !== void 0 && this._$El !== I) {
      const D = n.getPropertyOptions(I), t = typeof D.converter == "function" ? { fromAttribute: D.converter } : ((C = D.converter) === null || C === void 0 ? void 0 : C.fromAttribute) !== void 0 ? D.converter : BA;
...
gA[uA] = !0, gA.elementProperties = /* @__PURE__ */ new Map(), gA.elementStyles = [], gA.shadowRootOptions = { mode: "open" }, OA == null || OA({ ReactiveElement: gA }), ((SA = sA.reactiveElementVersions) !== null && SA !== void 0 ? SA : sA.reactiveElementVersions = []).push("1.6.3");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
var dA;
const rA = window, CA = rA.trustedTypes, YA = CA ? CA.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, pA = "$lit$", X = `lit$${(Math.random() + "").slice(9)}$`, _A = "?" + X, eg = `<${_A}>`, _ = document, iA = () => _.createComment(""), lA = (e) => e === null || typeof e != "object" && typeof e != "function", $A = Array.isArray, hg = (e) => $A(e) || typeof (e == null ? void 0 : e[Symbol.iterator]) == "function", UA = `[ 	
\f\r]`, hA = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, WA = /-->/g, bA = />/g, z = RegExp(`>|${UA}(?:([^\\s"'>=/]+)(${UA}*=${UA}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), MA = /'/g, ZA = /"/g, Ag = /^(?:script|style|textarea|title)$/i, tg = (e) => (A, ...g) => ({ _$litType$: e, strings: A, values: g }), U = tg(1), nA = Symbol.for("lit-noChange"), k = Symbol.for("lit-nothing"), GA = /* @__PURE__ */ new WeakMap(), N = _.createTreeWalker(_, 129, null, !1);
function gg(e, A) {
...
const ig = (e, A) => {
  ...
  for (let t = 0; t < g; t++) {
    const i = e[t];
    let l, h, s = -1, r = 0;
    for (; r < i.length && (D.lastIndex = r, h = D.exec(i), h !== null); ) r = D.lastIndex, D === hA ? h[1] === "!--" ? D = WA : h[1] !== void 0 ? D = bA : h[2] !== void 0 ? (Ag.test(h[2]) && (n = RegExp("</" + h[2], "g")), D = z) : h[3] !== void 0 && (D = z) : D === z ? h[0] === ">" ? (D = n ?? hA, s = -1) : h[1] === void 0 ? s = -2 : (s = D.lastIndex - h[2].length, l = h[1], D = h[3] === void 0 ? z : h[3] === '"' ? ZA : MA) : D === ZA || D === MA ? D = z : D === WA || D === bA ? D = hA : (D = z, n = void 0);
    const m = D === z && e[t + 1].startsWith("/>") ? " " : "";
    I += D === hA ? i + eg : s >= 0 ? (C.push(l), i.slice(0, s) + pA + i.slice(s) + X + m) : i + X + (s === -2 ? (C.push(void 0), t) : m);
  }
  ...
  constructor({ strings: A, _$litType$: g }, C) {
    ...
    for (; (n = N.nextNode()) !== null && i.length < t; ) {
      if (n.nodeType === 1) {
        if (n.hasAttributes()) {
          const s = [];
          for (const r of n.getAttributeNames()) if (r.endsWith(pA) || r.startsWith(X)) {
            const m = h[D++];
            if (s.push(r), m !== void 0) {
              const c = n.getAttribute(m.toLowerCase() + pA).split(X), J = /([.?@])?(.*)/.exec(m);
              i.push({ type: 1, index: I, name: J[2], strings: c, ctor: J[1] === "." ? og : J[1] === "?" ? Qg : J[1] === "@" ? sg : EA });
            } else i.push({ type: 6, index: I });
          }
          for (const r of s) n.removeAttribute(r);
        }
        if (Ag.test(n.tagName)) {
          const s = n.textContent.split(X), r = s.length - 1;
          if (r > 0) {
            n.textContent = CA ? CA.emptyScript : "";
            for (let m = 0; m < r; m++) n.append(s[m], iA()), N.nextNode(), i.push({ type: 2, index: ++I });
            n.append(s[r], iA());
          }
        }
        ...
        let s = -1;
        for (; (s = n.data.indexOf(X, s + 1)) !== -1; ) i.push({ type: 7, index: I }), s += X.length - 1;
      }
      I++;
    }
  }
...
class aA {
  constructor(A, g, C, n) {
    var I;
    this.type = 2, this._$AH = k, this._$AN = void 0, this._$AA = A, this._$AB = g, this._$AM = C, this.options = n, this._$Cp = (I = n == null ? void 0 : n.isConnected) === null || I === void 0 || I;
  }
  get _$AU() {
    var A, g;
  ...
  _$AI(A, g = this) {
    A = DA(this, A, g), lA(A) ? A === k || A == null || A === "" ? (this._$AH !== k && this._$AR(), this._$AH = k) : A !== this._$AH && A !== nA && this._(A) : A._$litType$ !== void 0 ? this.g(A) : A.nodeType !== void 0 ? this.$(A) : hg(A) ? this.T(A) : this._(A);
  }
  k(A) {
  ...
  _(A) {
    this._$AH !== k && lA(this._$AH) ? this._$AA.nextSibling.data = A : this.$(_.createTextNode(A)), this._$AH = A;
  }
  g(A) {
    var g;
...
class EA {
  constructor(A, g, C, n, I) {
    this.type = 1, this._$AH = k, this._$AN = void 0, this.element = A, this.name = g, this._$AM = n, this.options = I, C.length > 2 || C[0] !== "" || C[1] !== "" ? (this._$AH = Array(C.length - 1).fill(new String()), this.strings = C) : this._$AH = k;
  }
  get tagName() {
  ...
  _$AI(A, g = this, C, n) {
    ...
    if (I === void 0) A = DA(this, A, g, 0), D = !lA(A) || A !== this._$AH && A !== nA, D && (this._$AH = A);
      ...
      const t = A;
      let i, l;
      for (A = I[0], i = 0; i < I.length - 1; i++) l = DA(this, t[C + i], g, i), l === nA && (l = this._$AH[i]), D || (D = !lA(l) || l !== this._$AH[i]), l === k ? A = k : A !== k && (A += (l ?? "") + I[i + 1]), this._$AH[i] = l;
    }
    D && !n && this.j(A);
  }
  j(A) {
    A === k ? this.element.removeAttribute(this.name) : this.element.setAttribute(this.name, A ?? "");
  }
}
class og extends EA {
  constructor() {
  ...
  j(A) {
    this.element[this.name] = A === k ? void 0 : A;
  }
}
...
class Qg extends EA {
  ...
  j(A) {
    A && A !== k ? this.element.setAttribute(this.name, ag) : this.element.removeAttribute(this.name);
  }
}
class sg extends EA {
  constructor(A, g, C, n, I) {
  ...
  _$AI(A, g = this) {
    var C;
    if ((A = (C = DA(this, A, g, 0)) !== null && C !== void 0 ? C : k) === nA) return;
    const n = this._$AH, I = A === k && n !== k || A.capture !== n.capture || A.once !== n.once || A.passive !== n.passive, D = A !== k && (n === k || I);
...
const FA = rA.litHtmlPolyfillSupport;
FA == null || FA(oA, aA), ((dA = rA.litHtmlVersions) !== null && dA !== void 0 ? dA : rA.litHtmlVersions = []).push("2.8.0");
const Eg = (e, A, g) => {
  var C, n;
...
IA.finalized = !0, IA._$litElement$ = !0, (mA = globalThis.litElementHydrateSupport) === null || mA === void 0 || mA.call(globalThis, { LitElement: IA });
const KA = globalThis.litElementPolyfillSupport;
KA == null || KA({ LitElement: IA });
((xA = globalThis.litElementVersions) !== null && xA !== void 0 ? xA : globalThis.litElementVersions = []).push("3.3.3");
...
function $(e, A) {
  var n;
  let g = A || ((n = e == null ? void 0 : e.locale) == null ? void 0 : n.language) || (e == null ? void 0 : e.language) || cA;
  if (eA[g])
    return g;
...
const dC = "state_tomorrow", UC = "state_in_2_days", mC = "state_today_desc", xC = "state_tomorrow_desc", BC = "state_in_2_days_desc", Y = {
  integration: "dwd",
  region_id: "",
  allergens: [
    "erle",
...
async function uC(e, A) {
  const g = !!A.debug, C = (S) => S.charAt(0).toUpperCase() + S.slice(1), n = $(e, A.date_locale), I = A.date_locale || Y.date_locale, D = A.days_relative !== !1, t = !!A.days_abbreviated, i = !!A.days_uppercase, l = A.phrases || {}, h = l.full || {}, s = l.short || {}, r = l.levels, m = Array.isArray(r) && r.length === 7 ? r : Array.from({ length: 7 }, (S, E) => p(`card.levels.${E}`, n)), c = l.no_information || p("card.no_information", n), J = l.days || {}, L = A.days_to_show ?? Y.days_to_show, f = A.pollen_threshold ?? Y.pollen_threshold;
  ...
  for (const S of A.allergens)
    try {
      const E = {}, P = fC(S);
      E.allergenReplaced = P;
      const x = AA[P] || P, a = h[S];
      if (a)
        E.allergenCapitalized = a;
      else {
        const j = `card.allergen.${AA[P] || P}`, K = p(j, n);
        E.allergenCapitalized = K !== j ? K : C(S);
      }
      if (A.allergens_abbreviated) {
        const B = s[S];
        E.allergenShort = B || p(`editor.phrases_short.${x}`, n) || E.allergenCapitalized;
      } else
        E.allergenShort = E.allergenCapitalized;
      let Q = A.region_id ? `sensor.pollenflug_${P}_${A.region_id}` : null;
      if (!Q || !e.states[Q]) {
        const B = Object.keys(e.states).filter(
          (j) => j.startsWith(`sensor.pollenflug_${P}_`)
        );
        if (B.length === 1) Q = B[0];
        else continue;
      }
      const H = e.states[Q], M = u(H.state), Z = u(H.attributes[dC]), V = u(H.attributes[UC]), G = [
        { date: v, level: M },
        { date: new Date(v.getTime() + 864e5), level: Z },
        { date: new Date(v.getTime() + 2 * 864e5), level: V }
      ];
      for (; G.length < L; ) {
        const B = G.length;
        G.push({
          date: new Date(v.getTime() + B * 864e5),
          level: -1
        });
      }
      E.days = [], G.forEach((B, j) => {
        const K = Math.round((B.date - v) / 864e5);
        let o;
        D ? J[K] !== void 0 ? o = J[K] : K >= 0 && K <= 2 ? o = p(`card.days.${K}`, n) : o = B.date.toLocaleDateString(I, {
          day: "numeric",
          month: "short"
        }) : (o = B.date.toLocaleDateString(I, {
          weekday: t ? "short" : "long"
        }), o = o.charAt(0).toUpperCase() + o.slice(1)), i && (o = o.toUpperCase());
        const d = H.attributes[j === 0 ? mC : j === 1 ? xC : BC] || "", b = B.level * 2, O = Math.min(Math.max(Math.round(b), 0), 6), T = O < 0 ? c : m[O] || d;
        E[`day${j}`] = {
      ...
      }), (G.slice(0, L).some((B) => B.level >= f) || f === 0) && y.push(E);
    } catch (E) {
      console.warn(`DWD adapter error for allergen ${S}:`, E);
    }
  return y.sort(
    {
      value_ascending: (S, E) => S.day0.state - E.day0.state,
      value_descending: (S, E) => E.day0.state - S.day0.state,
      name_descending: (S, E) => E.allergenCapitalized.localeCompare(S.allergenCapitalized)
    }[A.sort] || ((S, E) => E.day0.state - S.day0.state)
  ), g && console.debug("DWD adapter complete sensors:", y), y;
}
...
async function cC(e, A) {
  var P, x;
  const g = !!A.debug, C = $(e, A.date_locale), n = A.date_locale || ((P = e.locale) == null ? void 0 : P.language) || e.language || `${C}-${C.toUpperCase()}`, I = A.days_relative !== !1, D = !!A.days_abbreviated, t = !!A.days_uppercase, i = {
    full: {},
    short: {},
    levels: [],
    days: {},
    no_information: "",
    ...A.phrases || {}
  }, l = i.full, h = i.short, s = i.levels, r = 5;
  Array.isArray(s) && s.length === r || Array.from(
    { length: r },
    (a, Q) => p(`card.levels.${Q}`, C)
  );
  const m = i.no_information || p("card.no_information", C), c = i.days, J = A.integration === "dwd" ? 3 : A.integration === "peu" ? 4 : 6, L = (a) => {
    const Q = Number(a);
    return isNaN(Q) || Q < 0 ? -1 : Q > J ? J : Q;
  }, f = /* @__PURE__ */ new Date();
  f.setHours(0, 0, 0, 0);
  const u = A.days_to_show ?? W.days_to_show, v = A.pollen_threshold ?? W.pollen_threshold, y = Object.keys(e.states).filter(
    (a) => a.startsWith("sensor.polleninformation_")
  );
  let S = A.location;
  !S && y.length && (S = y[0].slice(25).split("_")[0]);
  const E = [];
  for (const a of A.allergens)
    try {
      const Q = {};
      Q.days = [];
      const H = a;
      if (Q.allergenReplaced = H, l[H])
        Q.allergenCapitalized = l[H];
      else {
        const o = AA[H] || H, d = p(`card.allergen.${o}`, C);
        Q.allergenCapitalized = d !== `card.allergen.${o}` ? d : H.charAt(0).toUpperCase() + H.slice(1);
      }
      if (A.allergens_abbreviated) {
        const o = h[H];
        Q.allergenShort = o || p(`editor.phrases_short.${H}`, C) || Q.allergenCapitalized;
      } else
        Q.allergenShort = Q.allergenCapitalized;
      let M = S ? `sensor.polleninformation_${S}_${H}` : null;
      if (!M || !e.states[M]) {
        const o = y.filter((d) => d.endsWith(`_${H}`));
        if (o.length === 1) M = o[0];
        else continue;
      }
      const Z = e.states[M];
      if (!((x = Z == null ? void 0 : Z.attributes) != null && x.forecast)) throw "Missing forecast";
      const V = Z.attributes.forecast, G = Array.isArray(V) ? V.reduce((o, d) => {
        const b = d.time || d.datetime;
        return o[b] = d, o;
      }, {}) : {}, B = Object.keys(G).sort(
        (o, d) => new Date(o) - new Date(d)
      ).filter((o) => new Date(o) >= f);
      let j = [];
      if (B.length >= u)
        j = B.slice(0, u);
      else {
        j = B.slice();
        let o = B.length > 0 ? new Date(B[B.length - 1]) : f;
        for (; j.length < u; ) {
          o = new Date(o.getTime() + 864e5);
          const d = o.getFullYear(), b = String(o.getMonth() + 1).padStart(2, "0"), O = String(o.getDate()).padStart(2, "0");
          j.push(`${d}-${b}-${O}T00:00:00`);
        }
      }
      j.forEach((o, d) => {
        const b = G[o] || {}, O = L(b.level), T = new Date(o), F = Math.round((T - f) / 864e5);
        let R;
        I ? c[F] != null ? R = c[F] : F >= 0 && F <= 2 ? R = p(`card.days.${F}`, C) : R = T.toLocaleDateString(n, {
          day: "numeric",
          month: "short"
        }) : (R = T.toLocaleDateString(n, {
          weekday: D ? "short" : "long"
        }), R = R.charAt(0).toUpperCase() + R.slice(1)), t && (R = R.toUpperCase());
        let q;
        O < 2 ? q = Math.floor(O * 6 / 4) : q = Math.ceil(O * 6 / 4);
        const JA = {
          name: Q.allergenCapitalized,
          day: R,
          state: O,
          state_text: q < 0 ? m : p(`card.levels.${q}`, C)
        };
        Q[`day${d}`] = JA, Q.days.push(JA);
      }), (Q.days.some((o) => o.state >= v) || v === 0) && E.push(Q);
    } catch (Q) {
      g && console.warn(`Fel vid allergen ${a}:`, Q);
    }
  return E.sort(
    {
      value_ascending: (a, Q) => a.day0.state - Q.day0.state,
      value_descending: (a, Q) => Q.day0.state - a.day0.state,
      name_ascending: (a, Q) => a.allergenCapitalized.localeCompare(Q.allergenCapitalized),
      name_descending: (a, Q) => Q.allergenCapitalized.localeCompare(a.allergenCapitalized)
    }[A.sort] || ((a, Q) => Q.day0.state - a.day0.state)
  ), g && console.debug("PEU.fetchForecast — done", E), E;
}
...
async function jC(e, A) {
  var E, P;
  const g = [], C = !!A.debug, n = (x) => x.charAt(0).toUpperCase() + x.slice(1), I = (x) => {
    const [a] = x.split("T"), [Q, H, M] = a.split("-").map(Number);
    return new Date(Q, H - 1, M);
  }, D = /* @__PURE__ */ new Date();
  D.setHours(0, 0, 0, 0);
  const t = $(e, A.date_locale), i = A.date_locale || ((E = e.locale) == null ? void 0 : E.language) || e.language || `${t}-${t.toUpperCase()}`, l = A.days_relative !== !1, h = !!A.days_abbreviated, s = !!A.days_uppercase, r = {
    full: {},
    short: {},
    levels: [],
    days: {},
    no_information: "",
    ...A.phrases || {}
  }, m = r.full, c = r.short, J = r.levels, L = Array.isArray(J) && J.length === 7 ? J : Array.from({ length: 7 }, (x, a) => p(`card.levels.${a}`, t)), f = r.no_information || p("card.no_information", t), u = r.days;
  C && console.debug("PP.fetchForecast — start", { city: A.city, lang: t });
  const v = (x) => {
    const a = Number(x);
    return isNaN(a) || a < 0 ? -1 : a > 6 ? 6 : a;
  }, y = A.days_to_show ?? w.days_to_show, S = A.pollen_threshold ?? w.pollen_threshold;
  for (const x of A.allergens)
    try {
      const a = {};
      a.days = [];
      const Q = yA(x);
      if (a.allergenReplaced = Q, m[x])
        a.allergenCapitalized = m[x];
      else {
        const o = AA[Q] || Q, d = p(`card.allergen.${o}`, t);
        a.allergenCapitalized = d !== `card.allergen.${o}` ? d : n(x);
      }
      if (A.allergens_abbreviated) {
        const o = AA[Q] || Q, d = c[x];
        a.allergenShort = d || p(`editor.phrases_short.${o}`, t) || a.allergenCapitalized;
      } else
        a.allergenShort = a.allergenCapitalized;
      const H = yA(A.city);
      let M = `sensor.pollen_${H}_${Q}`;
      if (!e.states[M]) {
        const o = Object.keys(e.states).filter(
          (d) => d.startsWith(`sensor.pollen_${H}_`) && d.includes(Q)
        );
        if (o.length === 1) M = o[0];
        else continue;
      }
      const Z = e.states[M];
      if (!((P = Z == null ? void 0 : Z.attributes) != null && P.forecast)) throw "Missing forecast";
      const V = Z.attributes.forecast, G = Array.isArray(V) ? V.reduce((o, d) => {
        const b = d.time || d.datetime;
        return o[b] = d, o;
      }, {}) : V, B = Object.keys(G).sort(
        (o, d) => I(o) - I(d)
      ).filter((o) => I(o) >= D);
      let j = [];
      if (B.length >= y)
        ...
        j = B.slice();
        let o = B.length > 0 ? I(B[B.length - 1]) : D;
        for (; j.length < y; ) {
          o = new Date(o.getTime() + 864e5);
          const d = o.getFullYear(), b = String(o.getMonth() + 1).padStart(2, "0"), O = String(o.getDate()).padStart(2, "0");
          j.push(`${d}-${b}-${O}T00:00:00`);
      ...
      j.forEach((o, d) => {
        const b = G[o] || {}, O = v(b.level), T = I(o), F = Math.round((T - D) / 864e5);
        let R;
        l ? u[F] != null ? R = u[F] : F >= 0 && F <= 2 ? R = p(`card.days.${F}`, t) : R = T.toLocaleDateString(i, {
          day: "numeric",
          month: "short"
        }) : (R = T.toLocaleDateString(i, {
          weekday: h ? "short" : "long"
        }), R = R.charAt(0).toUpperCase() + R.slice(1)), s && (R = R.toUpperCase());
        const q = {
          name: a.allergenCapitalized,
          day: R,
          state: O,
          state_text: O < 0 ? f : L[O]
        };
        a[`day${d}`] = q, a.days.push(q);
      }), (a.days.some((o) => o.state >= S) || S === 0) && g.push(a);
    } catch (a) {
      console.warn(`Fel vid allergen ${x}:`, a);
    }
  return g.sort(
    {
      value_ascending: (x, a) => x.day0.state - a.day0.state,
      value_descending: (x, a) => a.day0.state - x.day0.state,
      name_ascending: (x, a) => x.allergenCapitalized.localeCompare(a.allergenCapitalized),
      name_descending: (x, a) => a.allergenCapitalized.localeCompare(x.allergenCapitalized)
    }[A.sort] || ((x, a) => a.day0.state - x.day0.state)
...
class wC extends IA {
  ...
  _getImageSrc(A, g) {
    const C = Number(g);
    let n = C, I = -1, D = 6;
    this.config.integration === "dwd" ? (n = C * 2, D = 6) : this.config.integration === "peu" && (n = Math.round(C * 6 / 4), D = 6, I = 0);
    let t = Math.round(n);
  ...
  setConfig(A) {
    ...
    g === "pp" ? C = w : g === "peu" ? C = W : g === "dwd" ? C = Y : C = w;
  ...
  set hass(A) {
    ...
    const C = Object.keys(A.states).filter(
      (f) => f.startsWith("sensor.pollen_") && !f.startsWith("sensor.pollenflug_")
    ), n = Object.keys(A.states).filter(
      (f) => f.startsWith("sensor.pollenflug_")
    ...
    let t;
    D === "dwd" ? t = Y : D === "peu" ? t = W : t = w;
    const { allergens: i, ...l } = this._userConfig, h = {
      ...t,
      ...l,
      integration: D
    };
    if (Array.isArray(i) && i.length > 0 ? h.allergens = i : D === "pp" ? h.allergens = w.allergens : D === "peu" ? h.allergens = W.allergens : D === "dwd" && (h.allergens = Y.allergens), !h.hasOwnProperty("date_locale")) {
      const f = $(A, null), u = ((m = (r = this._hass) == null ? void 0 : r.locale) == null ? void 0 : m.language) || ((c = this._hass) == null ? void 0 : c.language) || `${f}-${f.toUpperCase()}`;
    ...
    if (D === "dwd" && !h.region_id && n.length)
      h.region_id = Array.from(
        new Set(n.map((f) => f.split("_").pop()))
      ).sort((f, u) => Number(f) - Number(u))[0], this.debug && console.debug("[Card] Auto-set region_id:", h.region_id);
      ...
      h.location = f[0], this.debug && console.debug(
    ...
    if (this.config = h, this.tapAction = h.tap_action || this.tapAction || null, this.debug && (console.debug("[Card][Debug] Aktiv integration:", D), console.debug("[Card][Debug] Allergens i config:", h.allergens)), typeof h.title == "string")
      ...
      let f = "";
      if (D === "dwd")
        f = Ig[h.region_id] || h.region_id;
      else if (D === "peu") {
        const u = I.find(
          (y) => y.split("_")[1] === h.location
        );
        let v = "";
        if (u && A.states[u]) {
          const y = A.states[u].attributes;
          v = y.location_title || ((L = (J = y.friendly_name) == null ? void 0 : J.match(/\((.*?)\)/)) == null ? void 0 : L[1]) || h.location;
        }
        f = v || h.location || "";
      } else
        f = HA.find(
      ...
      this.header = `${this._t("card.header_prefix")} ${f}`, this.debug && console.debug("[Card] header set to:", this.header);
    }
    (RC[h.integration] || XA).fetchForecast(A, h).then((f) => {
      var v;
      this.debug && (console.debug("[Card][Debug] Sensors före filtrering:", f), console.debug(
      ...
      if (Array.isArray(h.allergens) && h.allergens.length > 0) {
        ...
        D === "dwd" ? y = new Set(
          ...
          let E = "";
          D === "dwd" || D === "peu" ? E = (S.allergenReplaced || "").toLowerCase() : E = (S.allergenCapitalized || S.allergenShort || S.allergenReplaced || S.allergen || "").toLowerCase().replace(/\s+/g, "_");
          const P = y.has(E);
          return !P && this.debug && console.debug(
            `[Card][Debug] Sensor '${E}' är EJ tillåten (ej i allowed)`,
            S
          ), P;
        });
      }
      ...
      console.error("Error fetching pollen forecast:", f), this.debug && console.debug("[Card] fetchForecast error:", f);
    });
  }
  _renderMinimalHtml() {
    return U`
      <ha-card>
        ${this.header ? U`<h1 class="header">${this.header}</h1>` : ""}
        <div class="flex-container">
          ${this.sensors.map((A) => {
      const g = A.day0.state_text || "", C = A.day0.state;
      let n = "";
      return this.config.show_text_allergen && (n += this.config.allergens_abbreviated ? A.allergenShort : A.allergenCapitalized), this.config.show_value_text && this.config.show_value_numeric ? (n && (n += ": "), n += `${g} (${C})`) : this.config.show_value_text ? (n && (n += ": "), n += g) : this.config.show_value_numeric && (n && (n += " "), n += `(${C})`), U`
              <div class="sensor">
                <img
                  class="box"
        ...
        A.day0.state
                ...
                />
                ${n ? U`<span class="short-text">${n}</span>` : ""}
              </div>
            `;
    })}
        </div>
    ...
    return U`
      ...
      (C) => {
        ...
        return U`
            ...
            return U`
                    <td>
                      <div class="icon-wrapper">
                        ...
                        />
                        ${this.config.show_value_numeric_in_circle ? U`<span class="circle-overlay">
              ...
              ${this.config.show_text_allergen || this.config.show_value_text || this.config.show_value_numeric ? U`
          ...
          let i = "";
          return this.config.show_value_text && this.config.show_value_numeric ? i = `${D} (${t})` : this.config.show_value_text ? i = D : this.config.show_value_numeric && (i = String(t)), U`<td>${i}</td>`;
        })}
                    </tr>
                  ` : ""}
            `;
...
class vC extends IA {
  ...
  _resetPhrases(A) {
    ...
    const g = this._config.integration === "dwd" ? Y.allergens : this._config.integration === "peu" ? W.allergens : w.allergens, C = {}, n = {};
    g.forEach((l) => {
      const h = yA(l), s = AA[h] || h;
      C[l] = p(`editor.phrases_full.${s}`, A), n[l] = p(`editor.phrases_short.${s}`, A);
    });
  ...
  setConfig(A) {
    ...
    try {
      ...
      const n = A.integration === "dwd" ? Y.allergens.length : A.integration === "peu" ? W.allergens.length : w.allergens.length, I = { ...A };
      ...
      const D = (I.integration === "dwd" ? Y : I.integration === "peu" ? W : w).pollen_threshold;
      ...
      const i = (I.integration === "dwd" ? Y : I.integration === "peu" ? W : w).date_locale;
      ...
      if (!this._integrationExplicit && this._hass) {
        ...
        r.some((m) => m.startsWith("sensor.pollen_")) ? l = "pp" : r.some((m) => m.startsWith("sensor.polleninformation_")) ? l = "peu" : r.some((m) => m.startsWith("sensor.pollenflug_")) && (l = "dwd"), this._userConfig.integration = l, this.debug && console.debug("[Editor] auto-detected integration:", l);
      }
      const h = JC(l);
      let s = tA(h, this._userConfig);
      if (this._userConfig.hasOwnProperty("pollen_threshold") || (s.pollen_threshold = h.pollen_threshold, this.debug && console.debug(
        ...
        h.pollen_threshold
      )), s.allergens = Array.isArray(this._userConfig.allergens) ? this._userConfig.allergens : h.allergens, s.integration = l, s.type = "custom:pollenprognos-card", this._config = s, this._prevIntegration = l, this.debug && console.debug(
        ...
        const r = $(this._hass, null), m = ((C = (g = this._hass) == null ? void 0 : g.locale) == null ? void 0 : C.language) || `${r}-${r.toUpperCase()}`;
        this._config.date_locale = m, this.debug && console.debug(
  ...
  set hass(A) {
    ...
    ).sort((h, s) => h.localeCompare(s)), this.installedPeuLocations = Array.from(
      new Map(
        Object.values(A.states).filter((h) => h.entity_id.startsWith("sensor.polleninformation_")).map((h) => {
          ...
          return [
            ...
            h.attributes.location_title || ((r = (s = h.attributes.friendly_name) == null ? void 0 : s.match(/\((.*?)\)/)) == null ? void 0 : r[1]) || h.entity_id.split("_")[1]
          ];
        })
      )
  ...
  _updateConfig(A, g) {
    ...
    if (A === "integration") {
      ...
      I !== D && (delete C[I === "dwd" ? "city" : "region_id"], delete C.allergens, delete C.pollen_threshold, this._allergensExplicit = !1), n = tA(I === "dwd" ? Y : I === "peu" ? W : w, C), n.integration = I;
  ...
  render() {
    const A = {
      ...
      ...this._config
    }, g = A.integration === "dwd" ? Y.allergens : A.integration === "peu" ? W.allergens : w.allergens, C = A.integration === "dwd" ? 4 : A.integration === "peu" ? 5 : 7, n = A.integration === "dwd" ? { min: 0, max: 3, step: 0.5 } : A.integration === "peu" ? { min: 0, max: 4, step: 1 } : { min: 0, max: 6, step: 1 };
    return U`
