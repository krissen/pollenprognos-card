...
var cg = (t, A, g) => A in t ? Qg(t, A, { enumerable: !0, configurable: !0, writable: !0, value: g }) : t[A] = g;
var mA = (t, A, g) => cg(t, typeof A != "symbol" ? A + "" : A, g);
 ...
 */
const SA = window, PA = SA.ShadowRoot && (SA.ShadyCSS === void 0 || SA.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, YA = Symbol(), FA = /* @__PURE__ */ new WeakMap();
let Cg = class {
  constructor(A, g, e) {
    if (this._$cssResult$ = !0, e !== YA) throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");
  ...
  get styleSheet() {
    ...
    const g = this.t;
    if (PA && A === void 0) {
      const e = g !== void 0 && g.length === 1;
      e && (A = FA.get(g)), A === void 0 && ((this.o = A = new CSSStyleSheet()).replaceSync(this.cssText), e && FA.set(g, A));
    }
    return A;
  }
  toString() {
...
const Sg = (t) => new Cg(typeof t == "string" ? t : t + "", void 0, YA), ig = (t, ...A) => {
  const g = t.length === 1 ? t[0] : A.reduce((e, n, C) => e + ((a) => {
    if (a._$cssResult$ === !0) return a.cssText;
    if (typeof a == "number") return a;
    throw Error("Value passed to 'css' function must be a 'css' function result: " + a + ". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.");
  })(n) + t[C + 1], t[0]);
  return new Cg(g, t, YA);
}, Eg = (t, A) => {
  PA ? t.adoptedStyleSheets = A.map((g) => g instanceof CSSStyleSheet ? g : g.styleSheet) : A.forEach((g) => {
    const e = document.createElement("style"), n = SA.litNonce;
    n !== void 0 && e.setAttribute("nonce", n), e.textContent = g.cssText, t.appendChild(e);
  });
}, LA = PA ? (t) => t : (t) => t instanceof CSSStyleSheet ? ((A) => {
  let g = "";
  for (const e of A.cssRules) g += e.cssText;
  return Sg(g);
})(t) : t;
/**
 * @license
 ...
 */
var BA;
const EA = window, KA = EA.trustedTypes, pg = KA ? KA.emptyScript : "", TA = EA.reactiveElementPolyfillSupport, jA = { toAttribute(t, A) {
  switch (A) {
    case Boolean:
      t = t ? pg : null;
      break;
  ...
  return g;
} }, ag = (t, A) => A !== t && (A == A || t == t), UA = { attribute: !0, type: String, converter: jA, reflect: !1, hasChanged: ag }, kA = "finalized";
let nA = class extends HTMLElement {
  ...
  static get observedAttributes() {
    this.finalize();
    const A = [];
    return this.elementProperties.forEach((g, e) => {
      const n = this._$Ep(e, g);
      n !== void 0 && (this._$Ev.set(n, e), A.push(n));
    }), A;
  }
  static createProperty(A, g = UA) {
    if (g.state && (g.attribute = !1), this.finalize(), this.elementProperties.set(A, g), !g.noAccessor && !this.prototype.hasOwnProperty(A)) {
      const e = typeof A == "symbol" ? Symbol() : "__" + A, n = this.getPropertyDescriptor(A, e, g);
      n !== void 0 && Object.defineProperty(this.prototype, A, n);
    }
  }
  static getPropertyDescriptor(A, g, e) {
    return { get() {
      return this[g];
    }, set(n) {
      const C = this[A];
      this[g] = n, this.requestUpdate(A, C, e);
  ...
  static finalize() {
    ...
    if (A.finalize(), A.h !== void 0 && (this.h = [...A.h]), this.elementProperties = new Map(A.elementProperties), this._$Ev = /* @__PURE__ */ new Map(), this.hasOwnProperty("properties")) {
      const g = this.properties, e = [...Object.getOwnPropertyNames(g), ...Object.getOwnPropertySymbols(g)];
      for (const n of e) this.createProperty(n, g[n]);
    }
  ...
  static finalizeStyles(A) {
    ...
    if (Array.isArray(A)) {
      ...
      for (const n of e) g.unshift(LA(n));
  ...
  addController(A) {
    var g, e;
    ((g = this._$ES) !== null && g !== void 0 ? g : this._$ES = []).push(A), this.renderRoot !== void 0 && this.isConnected && ((e = A.hostConnected) === null || e === void 0 || e.call(A));
  }
  removeController(A) {
    var g;
  ...
  connectedCallback() {
    ...
    this.renderRoot === void 0 && (this.renderRoot = this.createRenderRoot()), this.enableUpdating(!0), (A = this._$ES) === null || A === void 0 || A.forEach((g) => {
      var e;
      return (e = g.hostConnected) === null || e === void 0 ? void 0 : e.call(g);
    });
  }
  enableUpdating(A) {
  }
  disconnectedCallback() {
    ...
    (A = this._$ES) === null || A === void 0 || A.forEach((g) => {
      var e;
      return (e = g.hostDisconnected) === null || e === void 0 ? void 0 : e.call(g);
    });
  }
  attributeChangedCallback(A, g, e) {
    this._$AK(A, e);
  }
  _$EO(A, g, e = UA) {
    var n;
    const C = this.constructor._$Ep(A, e);
    if (C !== void 0 && e.reflect === !0) {
      const a = (((n = e.converter) === null || n === void 0 ? void 0 : n.toAttribute) !== void 0 ? e.converter : jA).toAttribute(g, e.type);
      this._$El = A, a == null ? this.removeAttribute(C) : this.setAttribute(C, a), this._$El = null;
    }
  }
  _$AK(A, g) {
    var e;
    const n = this.constructor, C = n._$Ev.get(A);
    if (C !== void 0 && this._$El !== C) {
      const a = n.getPropertyOptions(C), I = typeof a.converter == "function" ? { fromAttribute: a.converter } : ((e = a.converter) === null || e === void 0 ? void 0 : e.fromAttribute) !== void 0 ? a.converter : jA;
      this._$El = C, this[C] = I.fromAttribute(g, a.type), this._$El = null;
    }
  }
  requestUpdate(A, g, e) {
    let n = !0;
    A !== void 0 && (((e = e || this.constructor.getPropertyOptions(A)).hasChanged || ag)(this[A], g) ? (this._$AL.has(A) || this._$AL.set(A, g), e.reflect === !0 && this._$El !== A && (this._$EC === void 0 && (this._$EC = /* @__PURE__ */ new Map()), this._$EC.set(A, e))) : n = !1), !this.isUpdatePending && n && (this._$E_ = this._$Ej());
  }
  async _$Ej() {
  ...
  performUpdate() {
    ...
    this.hasUpdated, this._$Ei && (this._$Ei.forEach((n, C) => this[C] = n), this._$Ei = void 0);
    let g = !1;
    const e = this._$AL;
    try {
      g = this.shouldUpdate(e), g ? (this.willUpdate(e), (A = this._$ES) === null || A === void 0 || A.forEach((n) => {
        var C;
        return (C = n.hostUpdate) === null || C === void 0 ? void 0 : C.call(n);
      }), this.update(e)) : this._$Ek();
    } catch (n) {
      throw g = !1, this._$Ek(), n;
    }
    g && this._$AE(e);
  }
  willUpdate(A) {
  ...
  _$AE(A) {
    var g;
    (g = this._$ES) === null || g === void 0 || g.forEach((e) => {
      var n;
  ...
  update(A) {
    this._$EC !== void 0 && (this._$EC.forEach((g, e) => this._$EO(e, this[e], g)), this._$EC = void 0), this._$Ek();
  }
  updated(A) {
  }
  firstUpdated(A) {
...
nA[kA] = !0, nA.elementProperties = /* @__PURE__ */ new Map(), nA.elementStyles = [], nA.shadowRootOptions = { mode: "open" }, TA == null || TA({ ReactiveElement: nA }), ((BA = EA.reactiveElementVersions) !== null && BA !== void 0 ? BA : EA.reactiveElementVersions = []).push("1.6.3");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
var xA;
const pA = window, iA = pA.trustedTypes, VA = iA ? iA.createPolicy("lit-html", { createHTML: (t) => t }) : void 0, HA = "$lit$", _ = `lit$${(Math.random() + "").slice(9)}$`, rg = "?" + _, ug = `<${rg}>`, eA = document, hA = () => eA.createComment(""), DA = (t) => t === null || typeof t != "object" && typeof t != "function", og = Array.isArray, fg = (t) => og(t) || typeof (t == null ? void 0 : t[Symbol.iterator]) == "function", yA = `[ 	
\f\r]`, lA = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, zA = /-->/g, NA = />/g, AA = RegExp(`>|${yA}(?:([^\\s"'>=/]+)(${yA}*=${yA}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), XA = /'/g, qA = /"/g, lg = /^(?:script|style|textarea|title)$/i, mg = (t) => (A, ...g) => ({ _$litType$: t, strings: A, values: g }), w = mg(1), aA = Symbol.for("lit-noChange"), W = Symbol.for("lit-nothing"), _A = /* @__PURE__ */ new WeakMap(), gA = eA.createTreeWalker(eA, 129, null, !1);
function sg(t, A) {
  if (!Array.isArray(t) || !t.hasOwnProperty("raw")) throw Error("invalid template strings array");
  return VA !== void 0 ? VA.createHTML(A) : A;
}
const Bg = (t, A) => {
  const g = t.length - 1, e = [];
  let n, C = A === 2 ? "<svg>" : "", a = lA;
  for (let I = 0; I < g; I++) {
    const i = t[I];
    let o, h, s = -1, r = 0;
    for (; r < i.length && (a.lastIndex = r, h = a.exec(i), h !== null); ) r = a.lastIndex, a === lA ? h[1] === "!--" ? a = zA : h[1] !== void 0 ? a = NA : h[2] !== void 0 ? (lg.test(h[2]) && (n = RegExp("</" + h[2], "g")), a = AA) : h[3] !== void 0 && (a = AA) : a === AA ? h[0] === ">" ? (a = n ?? lA, s = -1) : h[1] === void 0 ? s = -2 : (s = a.lastIndex - h[2].length, o = h[1], a = h[3] === void 0 ? AA : h[3] === '"' ? qA : XA) : a === qA || a === XA ? a = AA : a === zA || a === NA ? a = lA : (a = AA, n = void 0);
    const l = a === AA && t[I + 1].startsWith("/>") ? " " : "";
    C += a === lA ? i + ug : s >= 0 ? (e.push(o), i.slice(0, s) + HA + i.slice(s) + _ + l) : i + _ + (s === -2 ? (e.push(void 0), I) : l);
  }
  return [sg(t, C + (t[g] || "<?>") + (A === 2 ? "</svg>" : "")), e];
};
class dA {
  constructor({ strings: A, _$litType$: g }, e) {
    let n;
    this.parts = [];
    let C = 0, a = 0;
    const I = A.length - 1, i = this.parts, [o, h] = Bg(A, g);
    if (this.el = dA.createElement(o, e), gA.currentNode = this.el.content, g === 2) {
      const s = this.el.content, r = s.firstChild;
      r.remove(), s.append(...r.childNodes);
    }
    for (; (n = gA.nextNode()) !== null && i.length < I; ) {
      if (n.nodeType === 1) {
        if (n.hasAttributes()) {
          const s = [];
          for (const r of n.getAttributeNames()) if (r.endsWith(HA) || r.startsWith(_)) {
            const l = h[a++];
            if (s.push(r), l !== void 0) {
              const p = n.getAttribute(l.toLowerCase() + HA).split(_), y = /([.?@])?(.*)/.exec(l);
              i.push({ type: 1, index: C, name: y[2], strings: p, ctor: y[1] === "." ? xg : y[1] === "?" ? wg : y[1] === "@" ? vg : fA });
            } else i.push({ type: 6, index: C });
          }
          for (const r of s) n.removeAttribute(r);
        }
        if (lg.test(n.tagName)) {
          const s = n.textContent.split(_), r = s.length - 1;
          if (r > 0) {
            n.textContent = iA ? iA.emptyScript : "";
            for (let l = 0; l < r; l++) n.append(s[l], hA()), gA.nextNode(), i.push({ type: 2, index: ++C });
            n.append(s[r], hA());
          }
        }
      } else if (n.nodeType === 8) if (n.data === rg) i.push({ type: 2, index: C });
      else {
        let s = -1;
        for (; (s = n.data.indexOf(_, s + 1)) !== -1; ) i.push({ type: 7, index: C }), s += _.length - 1;
      }
      C++;
    }
  }
  static createElement(A, g) {
    const e = eA.createElement("template");
    return e.innerHTML = A, e;
  }
}
function rA(t, A, g = t, e) {
  var n, C, a, I;
  if (A === aA) return A;
  let i = e !== void 0 ? (n = g._$Co) === null || n === void 0 ? void 0 : n[e] : g._$Cl;
  const o = DA(A) ? void 0 : A._$litDirective$;
  return (i == null ? void 0 : i.constructor) !== o && ((C = i == null ? void 0 : i._$AO) === null || C === void 0 || C.call(i, !1), o === void 0 ? i = void 0 : (i = new o(t), i._$AT(t, g, e)), e !== void 0 ? ((a = (I = g)._$Co) !== null && a !== void 0 ? a : I._$Co = [])[e] = i : g._$Cl = i), i !== void 0 && (A = rA(t, i._$AS(t, A.values), i, e)), A;
}
class Ug {
  constructor(A, g) {
  ...
  u(A) {
    var g;
    const { el: { content: e }, parts: n } = this._$AD, C = ((g = A == null ? void 0 : A.creationScope) !== null && g !== void 0 ? g : eA).importNode(e, !0);
    gA.currentNode = C;
    let a = gA.nextNode(), I = 0, i = 0, o = n[0];
    for (; o !== void 0; ) {
      if (I === o.index) {
        let h;
        o.type === 2 ? h = new QA(a, a.nextSibling, this, A) : o.type === 1 ? h = new o.ctor(a, o.name, o.strings, this, A) : o.type === 6 && (h = new Rg(a, this, A)), this._$AV.push(h), o = n[++i];
      }
      I !== (o == null ? void 0 : o.index) && (a = gA.nextNode(), I++);
    }
    return gA.currentNode = eA, C;
  }
  v(A) {
    let g = 0;
    for (const e of this._$AV) e !== void 0 && (e.strings !== void 0 ? (e._$AI(A, e, g), g += e.strings.length - 2) : e._$AI(A[g])), g++;
  }
}
class QA {
  constructor(A, g, e, n) {
    var C;
    this.type = 2, this._$AH = W, this._$AN = void 0, this._$AA = A, this._$AB = g, this._$AM = e, this.options = n, this._$Cp = (C = n == null ? void 0 : n.isConnected) === null || C === void 0 || C;
  }
  get _$AU() {
    var A, g;
  ...
  _$AI(A, g = this) {
    A = rA(this, A, g), DA(A) ? A === W || A == null || A === "" ? (this._$AH !== W && this._$AR(), this._$AH = W) : A !== this._$AH && A !== aA && this._(A) : A._$litType$ !== void 0 ? this.g(A) : A.nodeType !== void 0 ? this.$(A) : fg(A) ? this.T(A) : this._(A);
  }
  k(A) {
  ...
  _(A) {
    this._$AH !== W && DA(this._$AH) ? this._$AA.nextSibling.data = A : this.$(eA.createTextNode(A)), this._$AH = A;
  }
  g(A) {
    var g;
    const { values: e, _$litType$: n } = A, C = typeof n == "number" ? this._$AC(A) : (n.el === void 0 && (n.el = dA.createElement(sg(n.h, n.h[0]), this.options)), n);
    if (((g = this._$AH) === null || g === void 0 ? void 0 : g._$AD) === C) this._$AH.v(e);
    else {
      const a = new Ug(C, this), I = a.u(this.options);
      a.v(e), this.$(I), this._$AH = a;
    }
  }
  _$AC(A) {
    let g = _A.get(A.strings);
    return g === void 0 && _A.set(A.strings, g = new dA(A)), g;
  }
  T(A) {
    og(this._$AH) || (this._$AH = [], this._$AR());
    const g = this._$AH;
    let e, n = 0;
    for (const C of A) n === g.length ? g.push(e = new QA(this.k(hA()), this.k(hA()), this, this.options)) : e = g[n], e._$AI(C), n++;
    n < g.length && (this._$AR(e && e._$AB.nextSibling, n), g.length = n);
  }
  _$AR(A = this._$AA.nextSibling, g) {
    var e;
    for ((e = this._$AP) === null || e === void 0 || e.call(this, !1, !0, g); A && A !== this._$AB; ) {
...
class fA {
  constructor(A, g, e, n, C) {
    this.type = 1, this._$AH = W, this._$AN = void 0, this.element = A, this.name = g, this._$AM = n, this.options = C, e.length > 2 || e[0] !== "" || e[1] !== "" ? (this._$AH = Array(e.length - 1).fill(new String()), this.strings = e) : this._$AH = W;
  }
  get tagName() {
  ...
  _$AI(A, g = this, e, n) {
    ...
    let a = !1;
    if (C === void 0) A = rA(this, A, g, 0), a = !DA(A) || A !== this._$AH && A !== aA, a && (this._$AH = A);
    else {
      const I = A;
      let i, o;
      for (A = C[0], i = 0; i < C.length - 1; i++) o = rA(this, I[e + i], g, i), o === aA && (o = this._$AH[i]), a || (a = !DA(o) || o !== this._$AH[i]), o === W ? A = W : A !== W && (A += (o ?? "") + C[i + 1]), this._$AH[i] = o;
    }
    a && !n && this.j(A);
  }
  j(A) {
...
const yg = iA ? iA.emptyScript : "";
class wg extends fA {
  constructor() {
    super(...arguments), this.type = 4;
  }
  j(A) {
    A && A !== W ? this.element.setAttribute(this.name, yg) : this.element.removeAttribute(this.name);
  }
}
class vg extends fA {
  constructor(A, g, e, n, C) {
    super(A, g, e, n, C), this.type = 5;
  }
  _$AI(A, g = this) {
    var e;
    if ((A = (e = rA(this, A, g, 0)) !== null && e !== void 0 ? e : W) === aA) return;
    const n = this._$AH, C = A === W && n !== W || A.capture !== n.capture || A.once !== n.once || A.passive !== n.passive, a = A !== W && (n === W || C);
    C && this.element.removeEventListener(this.name, this, n), a && this.element.addEventListener(this.name, this, A), this._$AH = A;
  }
  handleEvent(A) {
    var g, e;
    typeof this._$AH == "function" ? this._$AH.call((e = (g = this.options) === null || g === void 0 ? void 0 : g.host) !== null && e !== void 0 ? e : this.element, A) : this._$AH.handleEvent(A);
  }
}
class Rg {
  constructor(A, g, e) {
    this.element = A, this.type = 6, this._$AN = void 0, this._$AM = g, this.options = e;
  }
  get _$AU() {
    return this._$AM._$AU;
  }
...
$A == null || $A(dA, QA), ((xA = pA.litHtmlVersions) !== null && xA !== void 0 ? xA : pA.litHtmlVersions = []).push("2.8.0");
const jg = (t, A, g) => {
  var e, n;
  const C = (e = g == null ? void 0 : g.renderBefore) !== null && e !== void 0 ? e : A;
  let a = C._$litPart$;
  if (a === void 0) {
    const I = (n = g == null ? void 0 : g.renderBefore) !== null && n !== void 0 ? n : null;
    C._$litPart$ = a = new QA(A.insertBefore(hA(), I), I, void 0, g ?? {});
  }
  return a._$AI(t), a;
};
/**
...
class CA extends nA {
  ...
  createRenderRoot() {
    ...
    return (A = (g = this.renderOptions).renderBefore) !== null && A !== void 0 || (g.renderBefore = e.firstChild), e;
  }
  update(A) {
    const g = this.render();
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(A), this._$Do = jg(g, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
    var A;
...
CA.finalized = !0, CA._$litElement$ = !0, (wA = globalThis.litElementHydrateSupport) === null || wA === void 0 || wA.call(globalThis, { LitElement: CA });
const Ag = globalThis.litElementPolyfillSupport;
Ag == null || Ag({ LitElement: CA });
((vA = globalThis.litElementVersions) !== null && vA !== void 0 ? vA : globalThis.litElementVersions = []).push("3.3.3");
const bA = (t, A = "_") => {
  const g = "àáâäæãåāăąабçćčđďдèéêëēėęěеёэфğǵгḧхîïíīįìıİийкłлḿмñńǹňнôöòóœøōõőоṕпŕřрßśšşșсťțтûüùúūǘůűųувẃẍÿýыžźżз·", e = `aaaaaaaaaaabcccdddeeeeeeeeeeefggghhiiiiiiiiijkllmmnnnnnoooooooooopprrrsssssstttuuuuuuuuuuvwxyyyzzzz${A}`, n = new RegExp(g.split("").join("|"), "g"), C = {
    ж: "zh",
    х: "kh",
    ц: "ts",
    ч: "ch",
  ...
  mold_spores_0_png: nI,
  mold_spores_1_png: tI,
  mold_spores_2_png: CI,
  mold_spores_3_png: iI,
  mold_spores_4_png: aI,
  mold_spores_5_png: rI,
  mold_spores_6_png: oI,
  // mugwort
  "mugwort_-1_png": EI,
  mugwort_0_png: sI,
  mugwort_1_png: hI,
  ...
  "nettle_and_pellitory_-1_png": yI,
  nettle_and_pellitory_0_png: pI,
  nettle_and_pellitory_1_png: uI,
  nettle_and_pellitory_2_png: fI,
  nettle_and_pellitory_3_png: mI,
  nettle_and_pellitory_4_png: BI,
  nettle_and_pellitory_5_png: UI,
  nettle_and_pellitory_6_png: xI,
  // oak
  "oak_-1_png": OI,
  oak_0_png: wI,
  oak_1_png: vI,
  ...
  __proto__: null,
  default: Fn
}, Symbol.toStringTag, { value: "Module" })), eg = /* @__PURE__ */ Object.assign({ "./locales/cs.json": Bn, "./locales/da.json": xn, "./locales/de.json": wn, "./locales/en.json": Rn, "./locales/fi.json": kn, "./locales/it.json": bn, "./locales/nl.json": Jn, "./locales/no.json": Yn, "./locales/ru.json": Gn, "./locales/sk.json": Wn, "./locales/sv.json": Ln }), oA = {};
for (const t in eg) {
  const A = t.match(/\.\/locales\/([\w-]+)\.json$/);
  A && (oA[A[1]] = eg[t].default);
}
const OA = "en";
function Ig(t, A) {
  return A.split(".").reduce((g, e) => g && typeof g == "object" ? g[e] : void 0, t);
}
function q(t, A) {
  var n;
  let g = A || ((n = t == null ? void 0 : t.locale) == null ? void 0 : n.language) || (t == null ? void 0 : t.language) || OA;
  if (oA[g])
    return g;
  const e = g.slice(0, 2).toLowerCase();
  return oA[e] ? e : OA;
}
const Kn = Object.keys(oA);
function b(t, A) {
  const g = oA[A] || {};
  if (g[t] !== void 0)
    return g[t];
...
const Tn = "state_tomorrow", Vn = "state_in_2_days", zn = "state_today_desc", Nn = "state_tomorrow_desc", Xn = "state_in_2_days_desc", V = {
  integration: "dwd",
  region_id: "",
  allergens: [
    "erle",
...
async function qn(t, A) {
  const g = !!A.debug, e = (Q) => Q.charAt(0).toUpperCase() + Q.slice(1), n = q(t, A.date_locale), C = A.date_locale || V.date_locale, a = A.days_relative !== !1, I = !!A.days_abbreviated, i = !!A.days_uppercase, o = A.phrases || {}, h = o.full || {}, s = o.short || {}, r = o.levels, l = Array.isArray(r) && r.length === 7 ? r : Array.from({ length: 7 }, (Q, D) => b(`card.levels.${D}`, n)), p = o.no_information || b("card.no_information", n), y = o.days || {}, H = A.days_to_show ?? V.days_to_show, B = A.pollen_threshold ?? V.pollen_threshold;
  ...
  for (const Q of A.allergens)
    try {
      const D = {}, d = uA(Q);
      D.allergenReplaced = d;
      const S = IA[d] || d, u = h[Q];
      if (u)
        D.allergenCapitalized = u;
      else {
        const J = `card.allergen.${IA[d] || d}`, x = b(J, n);
        D.allergenCapitalized = x !== J ? x : e(Q);
      }
      if (A.allergens_abbreviated) {
        const U = s[Q];
        D.allergenShort = U || b(`editor.phrases_short.${S}`, n) || D.allergenCapitalized;
      } else
        D.allergenShort = D.allergenCapitalized;
      let E = A.region_id ? `sensor.pollenflug_${d}_${A.region_id}` : null;
      if (!E || !t.states[E]) {
        const U = Object.keys(t.states).filter(
          (J) => J.startsWith(`sensor.pollenflug_${d}_`)
        );
        if (U.length === 1) E = U[0];
        else continue;
      }
      const f = t.states[E], v = k(f.state), j = k(f.attributes[Tn]), m = k(f.attributes[Vn]), O = [
        { date: Y, level: v },
        { date: new Date(Y.getTime() + 864e5), level: j },
        { date: new Date(Y.getTime() + 2 * 864e5), level: m }
      ];
      for (; O.length < H; ) {
        const U = O.length;
        O.push({
          date: new Date(Y.getTime() + U * 864e5),
          level: -1
        });
      }
      D.days = [], O.forEach((U, J) => {
        if (U.level !== null && U.level >= 0) {
          const x = Math.round((U.date - Y) / 864e5);
          let c;
          a ? y[x] !== void 0 ? c = y[x] : x >= 0 && x <= 2 ? c = b(`card.days.${x}`, n) : c = U.date.toLocaleDateString(C, {
            day: "numeric",
            month: "short"
          }) : (c = U.date.toLocaleDateString(C, {
            weekday: I ? "short" : "long"
          }), c = c.charAt(0).toUpperCase() + c.slice(1)), i && (c = c.toUpperCase());
          const P = f.attributes[J === 0 ? zn : J === 1 ? Nn : Xn] || "", Z = U.level * 2, F = Math.min(Math.max(Math.round(Z), 0), 6), N = F < 0 ? p : l[F] || P;
          D[`day${J}`] = {
      ...
      }), (O.slice(0, H).some((U) => U.level >= B) || B === 0) && G.push(D);
    } catch (D) {
      console.warn(`DWD adapter error for allergen ${Q}:`, D);
    }
  return G.sort(
    {
      value_ascending: (Q, D) => Q.day0.state - D.day0.state,
      value_descending: (Q, D) => D.day0.state - Q.day0.state,
      name_descending: (Q, D) => D.allergenCapitalized.localeCompare(Q.allergenCapitalized)
    }[A.sort] || ((Q, D) => D.day0.state - Q.day0.state)
  ), g && console.debug("DWD adapter complete sensors:", G), G;
}
...
async function $n(t, A) {
  var d, S;
  const g = !!A.debug, e = q(t, A.date_locale), n = A.date_locale || ((d = t.locale) == null ? void 0 : d.language) || t.language || `${e}-${e.toUpperCase()}`, C = A.days_relative !== !1, a = !!A.days_abbreviated, I = !!A.days_uppercase, i = {
    full: {},
    short: {},
    levels: [],
    days: {},
    no_information: "",
    ...A.phrases || {}
  }, o = i.full, h = i.short, s = i.levels, r = 5;
  Array.isArray(s) && s.length === r || Array.from(
    { length: r },
    (u, E) => b(`card.levels.${E}`, e)
  );
  const l = i.no_information || b("card.no_information", e), p = i.days, y = A.integration === "dwd" ? 3 : A.integration === "peu" ? 4 : 6, H = (u) => {
    const E = Number(u);
    return isNaN(E) || E < 0 ? -1 : E > y ? y : E;
  }, B = /* @__PURE__ */ new Date();
  B.setHours(0, 0, 0, 0);
  const k = A.days_to_show ?? z.days_to_show, Y = A.pollen_threshold ?? z.pollen_threshold, G = Object.keys(t.states).filter(
    (u) => u.startsWith("sensor.polleninformation_")
  );
  let Q = A.location;
  !Q && G.length && (Q = G[0].slice(25).split("_")[0]);
  const D = [];
  for (const u of A.allergens)
    try {
      ...
      if (E.allergenReplaced = f, o[f])
        ...
        const c = IA[f] || f, P = b(`card.allergen.${c}`, e);
        E.allergenCapitalized = P !== `card.allergen.${c}` ? P : f.charAt(0).toUpperCase() + f.slice(1);
      }
      if (A.allergens_abbreviated) {
        const c = h[f];
        E.allergenShort = c || b(`editor.phrases_short.${f}`, e) || E.allergenCapitalized;
      } else
        E.allergenShort = E.allergenCapitalized;
      let v = Q ? `sensor.polleninformation_${Q}_${f}` : null;
      if (!v || !t.states[v]) {
        const c = G.filter((P) => {
          const Z = P.match(/^sensor\.polleninformation_(.+)_(.+)$/);
          if (!Z) return !1;
          const F = Z[1], N = Z[2];
          return (!Q || F === Q) && N === f;
        });
      ...
      const j = t.states[v];
      if (!((S = j == null ? void 0 : j.attributes) != null && S.forecast)) throw "Missing forecast";
      const m = j.attributes.forecast, O = Array.isArray(m) ? m.reduce((c, P) => {
        const Z = P.time || P.datetime;
        return c[Z] = P, c;
      }, {}) : {}, U = Object.keys(O).sort(
        (c, P) => new Date(c) - new Date(P)
      ).filter((c) => new Date(c) >= B);
      let J = [];
      if (U.length >= k)
        J = U.slice(0, k);
      else {
        J = U.slice();
        let c = U.length > 0 ? new Date(U[U.length - 1]) : B;
        for (; J.length < k; ) {
          c = new Date(c.getTime() + 864e5);
          const P = c.getFullYear(), Z = String(c.getMonth() + 1).padStart(2, "0"), F = String(c.getDate()).padStart(2, "0");
          J.push(`${P}-${Z}-${F}T00:00:00`);
        }
      }
      J.forEach((c, P) => {
        const Z = O[c] || {}, F = H(Z.level);
        if (F !== null && F >= 0) {
          const N = new Date(c), K = Math.round((N - B) / 864e5);
          let X;
          C ? p[K] != null ? X = p[K] : K >= 0 && K <= 2 ? X = b(`card.days.${K}`, e) : X = N.toLocaleDateString(n, {
            day: "numeric",
            month: "short"
          }) : (X = N.toLocaleDateString(n, {
            weekday: a ? "short" : "long"
          }), X = X.charAt(0).toUpperCase() + X.slice(1)), I && (X = X.toUpperCase());
          let cA;
          F < 2 ? cA = Math.floor(F * 6 / 4) : cA = Math.ceil(F * 6 / 4);
          const WA = {
            name: E.allergenCapitalized,
            day: X,
            state: F,
            state_text: cA < 0 ? l : b(`card.levels.${cA}`, e)
          };
          E[`day${P}`] = WA, E.days.push(WA);
        }
      }), (E.days.some((c) => c.state >= Y) || Y === 0) && D.push(E);
    } catch (E) {
      g && console.warn(`Fel vid allergen ${u}:`, E);
    }
  return D.sort(
    {
      value_ascending: (u, E) => u.day0.state - E.day0.state,
      value_descending: (u, E) => E.day0.state - u.day0.state,
      name_ascending: (u, E) => u.allergenCapitalized.localeCompare(E.allergenCapitalized),
      name_descending: (u, E) => E.allergenCapitalized.localeCompare(u.allergenCapitalized)
    }[A.sort] || ((u, E) => E.day0.state - u.day0.state)
  ), g && console.debug("PEU.fetchForecast — done", D), D;
}
const At = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  fetchForecast: $n,
  stubConfigPEU: z
}, Symbol.toStringTag, { value: "Module" })), gt = { nl: { els: "alder", berk: "birch", gras: "grass", hazelaar: "hazel", bijvoet: "mugwort", olijf: "olive", ambrosia: "ragweed" }, de: { erle: "alder", birke: "birch", gras: "grass", hasel: "hazel", beifu: "mugwort", ambrosia: "ragweed" }, ru: { "": "ragweed" }, fi: { leppa: "alder", koivu: "birch", heina: "grass", pahkinaleppa: "hazel", siankarsamo: "mugwort", oliivi: "olive", ambrosia: "ragweed" }, sk: { jelsa: "alder", breza: "birch", trava: "grass", lieska: "hazel", palina: "mugwort", olivovnik: "olive", ambrozia: "ragweed" }, en: { alder: "alder", birch: "birch", grass: "grass", hazel: "hazel", mugwort: "mugwort", olive: "olive", ragweed: "ragweed" }, it: { ontano: "alder", betulla: "birch", erba: "grass", nocciolo: "hazel", artemisia: "mugwort", oliva: "olive", ambrosia: "ragweed" }, cs: { olse: "alder", briza: "birch", trava: "grass", liska: "hazel", pelynek: "mugwort", olivovnik: "olive", ambrozie: "ragweed" }, no: { al: "alder", bjrk: "birch", gress: "grass", hassel: "hazel", malurt: "mugwort", oliven: "olive", ambrosia: "ragweed" }, da: { al: "alder", birk: "birch", grs: "grass", hassel: "hazel", malurt: "mugwort", oliven: "olive", ambrosia: "ragweed" }, sv: { al: "alder", bjork: "birch", gras: "grass", hassel: "hazel", malort: "mugwort", oliv: "olive", ambrosia: "ragweed" } }, et = { alder: { nl: "Els", de: "Erle", ru: "Ольха", fi: "Leppä", sk: "Jelša", en: "Alder", it: "Ontano", cs: "Olše", no: "Al", da: "Al", sv: "Al" }, birch: { nl: "Berk", de: "Birke", ru: "Берёза", fi: "Koivu", sk: "Breza", en: "Birch", it: "Betulla", cs: "Bříza", no: "Bjørk", da: "Birk", sv: "Björk" }, grass: { nl: "Gras", de: "Gras", ru: "Трава", fi: "Heinä", sk: "Tráva", en: "Grass", it: "Erba", cs: "Tráva", no: "Gress", da: "Græs", sv: "Gräs" }, hazel: { nl: "Hazelaar", de: "Hasel", ru: "Лещина", fi: "Pähkinäleppä", sk: "Lieska", en: "Hazel", it: "Nocciolo", cs: "Líska", no: "Hassel", da: "Hassel", sv: "Hassel" }, mugwort: { nl: "Bijvoet", de: "Beifuß", ru: "Полынь", fi: "Siankärsämö", sk: "Palina", en: "Mugwort", it: "Artemisia", cs: "Pelyněk", no: "Malurt", da: "Malurt", sv: "Malört" }, olive: { nl: "Olijf", de: "Olive", ru: "Олива", fi: "Oliivi", sk: "Olivovník", en: "Olive", it: "Oliva", cs: "Olivovník", no: "Oliven", da: "Oliven", sv: "Oliv" }, ragweed: { nl: "Ambrosia", de: "Ambrosia", ru: "Амброзия", fi: "Ambrosia", sk: "Ambrózia", en: "Ragweed", it: "Ambrosia", cs: "Ambrózie", no: "Ambrosia", da: "Ambrosia", sv: "Ambrosia" } }, It = { nl: ["forecast"], de: ["pollen_vorhersage_beta"], ru: ["beta"], fi: ["siitepolyennuste_beta"], sk: ["predpoved"], en: ["forecast"], it: ["previsione_del_polline_beta"], cs: ["predpoved"], no: ["pollenprognose_beta"], da: ["pollenprognose_beta"], sv: ["pollenprognos_beta"] }, M = {
  mapping: gt,
  names: et,
  weather_suffixes: It
};
function hg(t, A, g) {
  ...
  const C = ((i = M.weather_suffixes) == null ? void 0 : i[g]) || ((o = M.weather_suffixes) == null ? void 0 : o[g == null ? void 0 : g.split("-")[0]]) || [];
  for (const s of C) {
    n.add(s);
    const r = `weather.silam_pollen_${e}_${s}`;
    if (r in t.states) return r;
  }
  for (const s of ((h = M.weather_suffixes) == null ? void 0 : h.en) || []) {
    if (n.has(s)) continue;
    n.add(s);
    const r = `weather.silam_pollen_${e}_${s}`;
    if (r in t.states) return r;
  ...
  const a = Array.from(
    new Set(Object.values(M.weather_suffixes).flat())
  );
  for (const s of a) {
    if (n.has(s)) continue;
    const r = `weather.silam_pollen_${e}_${s}`;
  ...
  const I = `weather.silam_pollen_${e}_`;
  return Object.keys(t.states).find((s) => s.startsWith(I)) || null;
}
const T = {
  integration: "silam",
  location: "",
...
function MA(t, A) {
  ...
  return g.no_information = g.no_information || b("card.no_information", A), g;
}
function GA(t, A) {
  return Array.isArray(t.levels) && t.levels.length === 7 ? t.levels : Array.from({ length: 7 }, (g, e) => b(`card.levels.${e}`, A));
}
function ZA(t, A, g) {
  let e;
  A.full[t] ? e = A.full[t] : M.names && M.names[t] && M.names[t][g] ? e = M.names[t][g] : e = t.charAt(0).toUpperCase() + t.slice(1);
  const n = A.short[t] || e;
  return { allergenCapitalized: e, allergenShort: n };
}
async function nt(t, A) {
  var Y, G, Q;
  const g = !!A.debug, e = q(t, A.date_locale), n = A.date_locale || ((Y = t.locale) == null ? void 0 : Y.language) || t.language || `${e}-${e.toUpperCase()}`, C = A.days_relative !== !1, a = !!A.days_abbreviated, I = !!A.days_uppercase, i = MA(A, e), o = GA(i, e), h = i.no_information, s = i.days, r = /* @__PURE__ */ new Date();
  r.setHours(0, 0, 0, 0);
  const l = A.days_to_show ?? T.days_to_show, p = A.pollen_threshold ?? T.pollen_threshold, y = (A.location || "").toLowerCase(), H = Object.keys(t.states).filter((D) => {
    const d = D.match(/^sensor\.silam_pollen_(.*)_([^_]+)$/);
    return d && d[1] === y;
  }), B = {};
  for (const D of H) {
    const d = D.match(/^sensor\.silam_pollen_(.*)_([^_]+)$/);
    ...
    const S = d[2];
    let u = !1;
    for (const [E, f] of Object.entries(M.mapping))
      if (f[S]) {
        const v = f[S];
        B[v] = D, u = !0;
        break;
    ...
    !u && g && console.debug(
      `[SILAM][fetchForecast] Hittade ingen master-key för haSlug: '${S}'`
    );
  }
  const k = [];
  for (const D of A.allergens)
    try {
      const d = {};
      d.days = [], d.allergenReplaced = D;
      const { allergenCapitalized: S, allergenShort: u } = ZA(
        D,
        i,
        e
      );
      d.allergenCapitalized = S, d.allergenShort = A.allergens_abbreviated ? u : S;
      const E = B[D];
      if (!E || !t.states[E]) {
        g && console.debug(`[SILAM] Ingen sensor för ${D}:`, E);
        continue;
      }
      const f = t.states[E], v = Number(f.state);
      let j = [];
      f.attributes && f.attributes.forecast && Array.isArray(f.attributes.forecast) && (j = f.attributes.forecast.map((R) => ({
        date: new Date(R.datetime || R.time),
        value: Number(R.value)
      })).filter(
        (R) => !isNaN(R.value) && R.date instanceof Date && !isNaN(R.date)
      ), j.sort((R, U) => R.date - U.date));
      let m = [];
      if (m.push(tA(D, v)), f.attributes && Array.isArray(f.attributes.forecast) && f.attributes.forecast.length > 0)
        for (let R = 1; R < l; ++R) {
          const U = new Date(r.getTime() + R * 864e5), J = f.attributes.forecast.find(
            (c) => Math.abs(
              new Date(c.datetime || c.time).getTime() - U.getTime()
            ) < 12 * 3600 * 1e3
          ), x = J ? tA(D, Number(J.value)) : -1;
          m.push(x);
        }
      else
        for (l > 1 && ((G = f.attributes) == null ? void 0 : G.tomorrow) !== void 0 ? m.push(
          tA(D, Number(f.attributes.tomorrow))
        ) : l > 1 && m.push(-1); m.length < l; )
          m.push(-1);
      m.length < l && ((Q = f.attributes) == null ? void 0 : Q.tomorrow) !== void 0 && (m[1] = tA(D, Number(f.attributes.tomorrow)) || -1);
      for (let R = 0; R < l; ++R) {
        const U = m[R];
        if (U !== null && U >= 0) {
          const J = new Date(r.getTime() + R * 864e5), x = R;
          let c;
          C ? s[x] != null ? c = s[x] : x >= 0 && x <= 2 ? c = b(`card.days.${x}`, e) : c = J.toLocaleDateString(n, {
            day: "numeric",
            month: "short"
          }) : (c = J.toLocaleDateString(n, {
            weekday: a ? "short" : "long"
          }), c = c.charAt(0).toUpperCase() + c.slice(1)), I && (c = c.toUpperCase());
          const P = U < 0 ? 0 : Math.min(Math.round(U), 6), Z = U < 0 ? h : o[P] || String(U);
          d[`day${R}`] = {
            name: d.allergenCapitalized,
            day: c,
            state: U,
      ...
      (d.days.some((R) => R.state >= p) || p === 0) && k.push(d);
    } catch (d) {
      g && console.warn(`[SILAM] Fel vid allergen ${D}:`, d);
    }
  return k.sort(
    {
      value_ascending: (D, d) => D.day0.state - d.day0.state,
      value_descending: (D, d) => d.day0.state - D.day0.state,
      name_ascending: (D, d) => D.allergenCapitalized.localeCompare(d.allergenCapitalized),
      name_descending: (D, d) => d.allergenCapitalized.localeCompare(D.allergenCapitalized)
    }[A.sort] || ((D, d) => d.day0.state - D.day0.state)
  ), g && console.debug("[SILAM] fetchForecast klar:", k), k;
}
async function tt(t, A, g = null) {
  var y, H;
  const e = !!A.debug;
  g ? e && console.debug(
    "[SILAM][fetchHourlyForecast] forecastEvent MOTTAGET!",
    g
  ) : e && console.debug("[SILAM][fetchHourlyForecast] forecastEvent ÄR NULL!");
  const n = q(t, A.date_locale), C = A.date_locale || ((y = t.locale) == null ? void 0 : y.language) || t.language || `${n}-${n.toUpperCase()}`, a = A.pollen_threshold ?? T.pollen_threshold;
  if (e) {
    const B = Object.keys(t.states).filter(
      (k) => k.startsWith("weather.silam_pollen_")
    );
    console.debug(
  ...
  if (g && g.forecast && Array.isArray(g.forecast))
    ...
    const B = t.states[i];
    (H = B == null ? void 0 : B.attributes) != null && H.forecast && Array.isArray(B.attributes.forecast) && (o = B.attributes.forecast, e && console.debug(
  ...
  const h = MA(A, n), s = GA(h, n), r = h.no_information, l = A.allergens || T.allergens;
  e && console.debug(
  ...
  for (const B of l)
    try {
      const k = {};
      k.days = [], k.allergenReplaced = B;
      const { allergenCapitalized: Y, allergenShort: G } = ZA(
        B,
        h,
        n
      );
      k.allergenCapitalized = Y, k.allergenShort = A.allergens_abbreviated ? G : Y;
      for (let D = 0; D < o.length; ++D) {
        const d = o[D], S = `pollen_${B}`, u = Number(d[S]), E = tA(B, u);
        if (E !== null && E >= 0) {
          const f = E < 0 ? r : s[E] || String(E), v = new Date(d.datetime || d.time);
          let j, m;
          if (A.mode === "twice_daily") {
            const O = v.toLocaleDateString(C, { weekday: "short" });
            j = O.charAt(0).toUpperCase() + O.slice(1), m = D % 2 === 0 ? "mdi:weather-sunset-up" : "mdi:weather-sunset-down", A.days_uppercase && (j = j.toUpperCase());
          } else
            j = v.toLocaleTimeString(C, {
              hour: "2-digit",
              minute: "2-digit"
            }) || "", m = null;
          k[`day${D}`] = {
      ...
      const Q = k.days.some((D) => D.state >= a);
      e && console.debug(
        `[SILAM][fetchHourlyForecast] Resultat för allergen ${B}:`,
        k,
        "meets:",
        Q
      ), (Q || a === 0) && p.push(k);
    } catch (k) {
      e && console.warn(`[SILAM][hourly] Fel vid allergen ${B}:`, k);
    }
  return e && console.debug("[SILAM][fetchHourlyForecast] Klar. sensors:", p), p;
}
const Ct = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  SILAM_THRESHOLDS: Dg,
  fetchForecast: nt,
  fetchHourlyForecast: tt,
  getAllergenNames: ZA,
  getLevelNames: GA,
  getPhrases: MA,
  grainsToLevel: tA,
...
async function at(t, A) {
  var Q, D;
  const g = [], e = !!A.debug, n = (d) => d.charAt(0).toUpperCase() + d.slice(1), C = (d) => {
    const [S] = d.split("T"), [u, E, f] = S.split("-").map(Number);
    return new Date(u, E - 1, f);
  }, a = /* @__PURE__ */ new Date();
  a.setHours(0, 0, 0, 0);
  const I = q(t, A.date_locale), i = A.date_locale || ((Q = t.locale) == null ? void 0 : Q.language) || t.language || `${I}-${I.toUpperCase()}`, o = A.days_relative !== !1, h = !!A.days_abbreviated, s = !!A.days_uppercase, r = {
    full: {},
    short: {},
    levels: [],
    days: {},
    no_information: "",
    ...A.phrases || {}
  }, l = r.full, p = r.short, y = r.levels, H = Array.isArray(y) && y.length === 7 ? y : Array.from({ length: 7 }, (d, S) => b(`card.levels.${S}`, I));
  r.no_information || b("card.no_information", I);
  const B = r.days;
  e && console.debug("PP.fetchForecast — start", { city: A.city, lang: I });
  const k = (d) => {
    const S = Number(d);
    return isNaN(S) || S < 0 ? null : S > 6 ? 6 : S;
  }, Y = A.days_to_show ?? L.days_to_show, G = A.pollen_threshold ?? L.pollen_threshold;
  for (const d of A.allergens)
    try {
      const S = {};
      S.days = [];
      const u = $(d);
      if (S.allergenReplaced = u, this.debug && console.log(
        "[PP] allergen",
        d,
        "fullPhrases keys",
        Object.keys(l)
      ), l[d])
        S.allergenCapitalized = l[d];
      else {
        const x = IA[u] || u, c = b(`card.allergen.${x}`, I);
        S.allergenCapitalized = c !== `card.allergen.${x}` ? c : n(d);
      }
      if (A.allergens_abbreviated) {
        const x = IA[u] || u, c = p[d];
        S.allergenShort = c || b(`editor.phrases_short.${x}`, I) || S.allergenCapitalized;
      } else
        S.allergenShort = S.allergenCapitalized;
      const E = $(A.city);
      let f = `sensor.pollen_${E}_${u}`;
      if (!t.states[f]) {
        const x = Object.keys(t.states).filter(
          (c) => c.startsWith(`sensor.pollen_${E}_`) && c.includes(u)
        );
        if (x.length === 1) f = x[0];
        else continue;
      }
      const v = t.states[f];
      if (!((D = v == null ? void 0 : v.attributes) != null && D.forecast)) throw "Missing forecast";
      const j = v.attributes.forecast, m = Array.isArray(j) ? j.reduce((x, c) => {
        const P = c.time || c.datetime;
        return x[P] = c, x;
      }, {}) : j, R = Object.keys(m).sort(
        (x, c) => C(x) - C(c)
      ).filter((x) => C(x) >= a);
      let U = [];
      if (R.length >= Y)
        ...
        U = R.slice();
        let x = R.length > 0 ? C(R[R.length - 1]) : a;
        for (; U.length < Y; ) {
          x = new Date(x.getTime() + 864e5);
          const c = x.getFullYear(), P = String(x.getMonth() + 1).padStart(2, "0"), Z = String(x.getDate()).padStart(2, "0");
          U.push(`${c}-${P}-${Z}T00:00:00`);
        }
      }
      U.forEach((x, c) => {
        const P = m[x] || {}, Z = k(P.level), F = C(x), N = Math.round((F - a) / 864e5);
        let K;
        if (o ? B[N] != null ? K = B[N] : N >= 0 && N <= 2 ? K = b(`card.days.${N}`, I) : K = F.toLocaleDateString(i, {
          day: "numeric",
          month: "short"
        }) : (K = F.toLocaleDateString(i, {
          weekday: h ? "short" : "long"
        }), K = K.charAt(0).toUpperCase() + K.slice(1)), s && (K = K.toUpperCase()), Z !== null) {
          const X = {
          ...
          S[`day${c}`] = X, S.days.push(X);
        }
      }), (S.days.some((x) => x.state >= G) || G === 0) && g.push(S);
    } catch (S) {
      console.warn(`[PP] Fel vid allergen ${d}:`, S);
    }
  return g.sort(
    {
      value_ascending: (d, S) => d.day0.state - S.day0.state,
      value_descending: (d, S) => S.day0.state - d.day0.state,
      name_ascending: (d, S) => d.allergenCapitalized.localeCompare(S.allergenCapitalized),
      name_descending: (d, S) => S.allergenCapitalized.localeCompare(d.allergenCapitalized)
    }[A.sort] || ((d, S) => S.day0.state - d.day0.state)
  ), e && console.debug("PP.fetchForecast — done", g), g;
}
function ng(t, A, g = !1) {
  ...
  if (e === "pp") {
    ...
    for (const a of t.allergens || []) {
      const I = $(a), i = `sensor.pollen_${C}_${I}`, o = !!A.states[i];
      g && console.debug(
        `[findAvailableSensors][pp] allergen: '${a}', cityKey: '${C}', rawKey: '${I}', sensorId: '${i}', exists: ${o}`
      ), o && n.push(i);
    }
  } else if (e === "dwd")
    for (const C of t.allergens || []) {
      const a = uA(C);
      let I = t.region_id ? `sensor.pollenflug_${a}_${t.region_id}` : null, i = I && A.states[I];
      if (!i) {
        const o = Object.keys(A.states).filter(
          (h) => h.startsWith(`sensor.pollenflug_${a}_`)
        );
        o.length === 1 && (I = o[0], i = !0);
      }
      g && console.debug(
        `[findAvailableSensors][dwd] allergen: '${C}', rawKey: '${a}', region_id: '${t.region_id}', sensorId: '${I}', exists: ${!!i}`
      ), i && n.push(I);
    }
  else if (e === "peu") {
    const C = (t.location || "").toLowerCase();
    for (const a of t.allergens || []) {
      const I = $(a);
      let i = C ? `sensor.polleninformation_${C}_${I}` : null, o = i && A.states[i];
      if (!o) {
        const h = Object.keys(A.states).filter((s) => {
          const r = s.match(/^sensor\.polleninformation_(.+)_(.+)$/);
          if (!r) return !1;
          const l = r[1], p = r[2];
          return (!C || l === C) && p === I;
        });
        h.length === 1 && (i = h[0], o = !0);
      }
      g && console.debug(
        `[findAvailableSensors][peu] allergen: '${a}', locationSlug: '${C}', allergenSlug: '${I}', sensorId: '${i}', exists: ${!!o}`
      ), o && n.push(i);
    }
  } else if (e === "silam") {
    const C = (t.location || "").toLowerCase();
    for (const a of t.allergens || []) {
      let I = null;
      for (const i of Object.values(M.mapping)) {
        const o = Object.entries(i).reduce((h, [s, r]) => (h[r] = s, h), {});
        if (o[a]) {
          const h = o[a], s = `sensor.silam_pollen_${C}_${h}`;
          if (A.states[s]) {
            I = h, g && console.debug(
              `[findAvailableSensors][silam] allergen: '${a}', locationSlug: '${C}', hassSlug: '${I}', sensorId: '${s}', exists: true`,
              A.states[s]
            ), n.push(s);
            break;
          }
      ...
      !I && g && console.debug(
        `[findAvailableSensors][silam] allergen: '${a}', locationSlug: '${C}', ingen sensor hittades!`
      );
    }
  }
  if (g) {
...
class rt extends CA {
  ...
  _updateSensorsAndColumns(g, e, n) {
    this.sensors = g, this._availableSensorCount = e.length;
    let C = 0;
    n.show_empty_days ? C = n.days_to_show : g.length > 0 && g[0].days && (C = Math.min(g[0].days.length, n.days_to_show)), this.days_to_show = C, this.displayCols = Array.from({ length: C }, (a, I) => I), this.debug && (console.debug("Days to show:", this.days_to_show), console.debug("Display columns:", this.displayCols)), this.requestUpdate();
  }
  _subscribeForecastIfNeeded() {
    ...
    if (!(!this.config || !this._hass) && (this._forecastUnsub && (Promise.resolve(this._forecastUnsub).then((a) => {
      ...
      const a = this.config.location.toLowerCase(), I = ((e = (g = this.config) == null ? void 0 : g.date_locale) == null ? void 0 : e.split("-")[0]) || "en", i = ((n = M.weather_suffixes) == null ? void 0 : n[I]) || ((C = M.weather_suffixes) == null ? void 0 : C.en) || [];
      if (this.debug) {
        const s = Object.keys(this._hass.states).filter(
          (r) => r.startsWith("weather.silam_pollen_")
        );
        console.debug(
          "[Card][Debug] Alla weather-entities i hass.states:",
          s
        ), console.debug("[Card][Debug] locationSlug:", a), console.debug("[Card][Debug] Suffixes:", i);
      }
      const o = hg(this._hass, a, I);
      let h = "hourly";
      this.config && this.config.mode === "twice_daily" && (h = "twice_daily"), o ? (this._forecastUnsub = this._hass.connection.subscribeMessage(
        (s) => {
          this.debug && console.debug(
            "[Card][subscribeForecast] forecastEvent RECEIVED:",
            s
          ), this._forecastEvent = s, this._updateSensorsAfterForecastEvent();
        },
        {
      ...
      ), this.debug && console.debug("[Card][subscribeForecast] Subscribed for", o)) : this.debug && console.debug(
  ...
  _updateSensorsAfterForecastEvent() {
    if (this.config && this.config.integration === "silam" && (this.config.mode === "hourly" || this.config.mode === "twice_daily") && this._forecastEvent) {
      const g = tg[this.config.integration] || RA;
  ...
  _getImageSrc(g, e) {
    const n = Number(e);
    let C = n, a = -1, I = 6;
    this.config.integration === "dwd" ? (C = n * 2, I = 6) : this.config.integration === "peu" && (C = Math.round(n * 6 / 4), I = 6, a = 0);
    let i = Math.round(C);
    (isNaN(i) || i < a) && (i = a), i > I && (i = I);
    const o = IA[g] || g;
    return gg[`${o}_${i}_png`] || gg[`${i}_png`];
  }
  ...
  setConfig(g) {
    ...
    let e = this._userConfig.integration, n;
    e === "pp" ? n = L : e === "peu" ? n = z : e === "dwd" ? n = V : e === "silam" ? n = T : n = L;
    const C = Object.keys(n).concat([
      "allergens",
      "city",
      "location",
      "region_id",
    ...
    let a = {};
    for (const I of C)
      I in this._userConfig && (a[I] = this._userConfig[I]);
    this._userConfig = { ...n, ...a, integration: e }, this._initDone = !1, this._hass && (this.hass = this._hass);
  }
  set hass(g) {
    var y, H, B, k, Y, G;
    this._hass = g;
    ...
    const n = Object.keys(g.states).filter(
      (Q) => Q.startsWith("sensor.pollen_") && !Q.startsWith("sensor.pollenflug_")
    ), C = Object.keys(g.states).filter(
      (Q) => Q.startsWith("sensor.pollenflug_")
    ), a = Object.keys(g.states).filter(
      (Q) => Q.startsWith("sensor.polleninformation_")
    ), I = Object.keys(g.states).filter(
      (Q) => Q.startsWith("sensor.silam_pollen_")
    );
    this.debug && (console.debug("Sensor states detected:"), console.debug("PP:", n), console.debug("DWD:", C), console.debug("PEU:", a), console.debug("SILAM:", I));
    let i = this._userConfig.integration;
    e || (n.length ? i = "pp" : a.length ? i = "peu" : C.length ? i = "dwd" : I.length && (i = "silam"));
    let o;
    i === "dwd" ? o = V : i === "peu" ? o = z : i === "pp" ? o = L : i === "silam" ? o = T : console.error("Unknown integration:", i);
    const { allergens: h, ...s } = this._userConfig, r = {
      ...o,
      ...s,
      integration: i
    };
    if (this._integrationExplicit && Array.isArray(h) && h.length > 0 ? (this.debug && console.debug(
      ...
      h
    ), r.allergens = h) : (this.debug && console.debug(
      "[Card] Using stub allergens for integration:",
      i
    ), i === "pp" ? r.allergens = L.allergens : i === "peu" ? r.allergens = z.allergens : i === "dwd" ? r.allergens = V.allergens : i === "silam" && (r.allergens = T.allergens)), !r.hasOwnProperty("date_locale")) {
      const Q = q(g, null), D = ((H = (y = this._hass) == null ? void 0 : y.locale) == null ? void 0 : H.language) || ((B = this._hass) == null ? void 0 : B.language) || `${Q}-${Q.toUpperCase()}`;
      r.date_locale = D, this.debug && console.debug("[Card] auto-filling date_locale:", r.date_locale);
    }
    if (i === "dwd" && !r.region_id && C.length)
      r.region_id = Array.from(
        new Set(C.map((Q) => Q.split("_").pop()))
      ).sort((Q, D) => Number(Q) - Number(D))[0], this.debug && console.debug("[Card] Auto-set region_id:", r.region_id);
    else if (i === "pp" && !r.city && n.length)
      r.city = n[0].slice(14).replace(/_[^_]+$/, ""), this.debug && console.debug("[Card] Auto-set city:", r.city);
    else if (i === "peu" && !r.location && a.length) {
      const Q = Array.from(
        new Set(
          a.map((D) => {
            var S;
            return (((S = g.states[D]) == null ? void 0 : S.attributes) || {}).location_slug || null;
          }).filter(Boolean)
        )
      );
    ...
    } else if (i === "silam" && !r.location && I.length) {
      const Q = Array.from(
        new Set(
          I.map((D) => {
            const d = D.match(/^sensor\.silam_pollen_(.*)_([^_]+)$/);
    ...
    if (this.config = r, this.tapAction = r.tap_action || this.tapAction || null, this.debug && (console.debug("[Card][Debug] Aktiv integration:", i), console.debug("[Card][Debug] Allergens i config:", r.allergens)), r.title === "false" || r.title === !1 || typeof r.title == "string" && r.title.trim() === "")
      ...
      let Q = "";
      if (i === "dwd")
        Q = dg[r.region_id] || r.region_id;
      else if (i === "peu") {
        const d = Object.values(g.states).filter(
          (u) => u.entity_id.startsWith("sensor.polleninformation_")
        ).find((u) => ((u.attributes || {}).location_slug || u.entity_id.replace("sensor.polleninformation_", "").replace(/_[^_]+$/, "")) === r.location);
        let S = "";
        if (d) {
          const u = d.attributes;
          S = u.location_title || ((Y = (k = u.friendly_name) == null ? void 0 : k.match(/\((.*?)\)/)) == null ? void 0 : Y[1]) || r.location;
        }
        Q = S || r.location || "";
      } else if (i === "silam") {
        const D = [
          ...
          Object.values(M.mapping).flatMap(
            (v) => Object.entries(v).filter(
              ([j, m]) => D.includes(m)
            ).map(([j]) => j)
          )
        ), S = Object.values(g.states).filter((v) => {
          if (!v.entity_id.startsWith("sensor.silam_pollen_")) return !1;
          const j = v.entity_id.match(
            /^sensor\.silam_pollen_(.*)_([^_]+)$/
          );
          if (!j) return !1;
          const m = j[2];
          return d.has(m);
        }), u = bA(r.location || ""), E = S.find((v) => {
          const m = v.entity_id.replace("sensor.silam_pollen_", "").replace(/_[^_]+$/, "").replace(/^[-\s]+/, "");
          return bA(m) === u;
        });
        let f = "";
        if (E) {
          const v = E.attributes;
          f = v.location_title || ((G = v.friendly_name) == null ? void 0 : G.replace(/^SILAM Pollen\s*-?\s*/i, "").replace(new RegExp("\\s+\\p{L}+$", "u"), "").trim()) || r.location, f = f.replace(/^[-\s]+/, "");
        }
        Q = f || r.location || "";
      } else
        Q = JA.find(
          (D) => D.toLowerCase().replace(/[åä]/g, "a").replace(/ö/g, "o").replace(/[-\s]/g, "_") === r.city
        ) || r.city;
      this.header = `${this._t("card.header_prefix")} ${Q}`, this.debug && console.debug("[Card] header set to:", this.header);
    }
    const l = tg[r.integration] || RA;
    let p = null;
    if (r.integration === "silam" && (r.mode === "hourly" || r.mode === "twice_daily") && typeof l.fetchHourlyForecast == "function") {
      ...
      p = l.fetchHourlyForecast(
        g,
        r,
        this._forecastEvent
      );
    } else
      p = l.fetchForecast(g, r);
    if (p)
      return p.then((Q) => {
        ...
        const D = ng(r, g, this.debug), d = D.length;
        let S = {};
        if (r.integration === "silam") {
          const v = Object.keys(g.states).filter((j) => {
            const m = j.match(/^sensor\.silam_pollen_(.*)_([^_]+)$/);
            return m && m[1] === (r.location || "");
          });
          for (const j of v) {
            const m = j.match(/^sensor\.silam_pollen_(.*)_([^_]+)$/);
            if (!m) continue;
        ...
        let u = Q.filter((v) => {
          if (r.integration === "silam" && S && (!r.mode || r.mode === "daily")) {
            const j = r.location || "", m = S[v.allergenReplaced] || v.allergenReplaced, O = `sensor.silam_pollen_${j}_${m}`;
            return this.debug && console.debug(
              `[Card][Debug][SILAM filter] allergenReplaced: '${v.allergenReplaced}', key: '${m}', id: '${O}', available: ${D.includes(O)}`
            ), D.includes(O);
          }
          return !0;
        });
        if (Array.isArray(r.allergens) && r.allergens.length > 0 && r.integration !== "silam") {
          let v, j;
          i === "dwd" ? (v = new Set(r.allergens.map((m) => uA(m))), j = (m) => uA(m.allergenReplaced || "")) : (this.debug && console.debug(
            "[Card][Debug] Använder normalisering för allergener:",
            r.allergens
          ), v = new Set(r.allergens.map((m) => $(m))), j = (m) => $(m.allergenReplaced || "")), u = u.filter((m) => {
            const O = j(m), R = v.has(O);
            return !R && this.debug && console.debug(
              `[Card][Debug] Sensor '${O}' är EJ tillåten (ej i allowed)`,
              m
            ), R;
          });
        }
        if (this._integrationExplicit && !!r.location && d === 0) {
          ...
          this._explicitLocationNoSensors = !1, this._updateSensorsAndColumns(u, D, r);
      }).catch((Q) => {
    ...
    return w`
      ...
      <div class="card-content">
        <div class="flex-container">
          ${(this.sensors || []).map((g) => {
      var a, I, i, o, h, s, r, l, p;
      const e = ((a = g.day0) == null ? void 0 : a.state_text) ?? "", n = ((I = g.day0) == null ? void 0 : I.state) ?? "";
      let C = "";
      return (i = this.config) != null && i.show_text_allergen && (C += (o = this.config) != null && o.allergens_abbreviated ? g.allergenShort ?? "" : g.allergenCapitalized ?? ""), (h = this.config) != null && h.show_value_text && ((s = this.config) != null && s.show_value_numeric) ? (C && (C += ": "), C += `${e} (${n})`) : (r = this.config) != null && r.show_value_text ? (C && (C += ": "), C += e) : (l = this.config) != null && l.show_value_numeric && (C && (C += " "), C += `(${n})`), w`
              <div class="sensor">
                <img
                  class="box"
                  src="${this._getImageSrc(
        g.allergenReplaced,
        (p = g.day0) == null ? void 0 : p.state
      )}"
                />
                ${C ? w`<span class="short-text">${C}</span>` : ""}
              </div>
            `;
    })}
        </div>
  ...
  _renderNormalHtml() {
    const g = !!this.config.days_boldfaced, e = this.displayCols;
    return this.debug && console.debug("Display columns:", e), w`
      ${this.header ? w`<div class="card-header">${this.header}</div>` : ""}
      <div class="card-content">
        <div class="forecast-content">
          <table class="forecast"">
            <colgroup>
              ${[0, ...e].map(
      () => w`<col style="width: ${100 / (e.length + 1)}%;" />`
    )}
            </colgroup>
            <thead>
              <tr>
        ...
        return w`
                    ...
                    >
                      ...
                      >
                        ...
                        ${this.config.mode === "twice_daily" && ((a = this.sensors[0].days[n]) != null && a.icon) ? w`<ha-icon
                ...
                <tr class="allergen-icon-row" valign="top">
                  <td>
                    <img
                      ...
                      src="${this._getImageSrc(
          n.allergenReplaced,
          (C = n.days[0]) == null ? void 0 : C.state
        )}"
                    />
                  </td>
                  ${e.map(
                      ...
                      <td>
                        <div class="icon-wrapper">
                          <img
                            src="${this._getImageSrc(
              "",
              (I = n.days[a]) == null ? void 0 : I.state
            )}"
                          />
                ...
                ${this.config.show_text_allergen || this.config.show_value_text || this.config.show_value_numeric ? w`
                      <tr class="allergen-text-row">
                        ...
                        ${e.map((a) => {
          var h, s;
          const I = ((h = n.days[a]) == null ? void 0 : h.state_text) || "", i = (s = n.days[a]) == null ? void 0 : s.state;
          let o = "";
          return this.config.show_value_text && this.config.show_value_numeric ? o = `${I} (${i})` : this.config.show_value_text ? o = I : this.config.show_value_numeric && (o = String(i)), w`<td>${o}</td>`;
        })}
                      </tr>
                    ` : ""}
              `;
  ...
  render() {
    ...
    if (this.sensors.length)
      ...
      const o = `card.integration.${this.config.integration}`, h = this._t(o);
      let s = "";
      this._availableSensorCount === 0 ? s = this._t("card.error_no_sensors") : s = this._t("card.error_filtered_sensors"), g = w`<div class="card-error">${s} (${h})</div>`;
    }
    const e = this.config.tap_action || null, n = (i = (I = this.config.background_color) == null ? void 0 : I.trim) != null && i.call(I) ? `background-color: ${this.config.background_color.trim()};` : "";
    this.debug && console.debug("[Card] Background style:", n);
    const C = e && e.type && e.type !== "none" ? "pointer" : "auto", a = `${n} cursor: ${C};`;
    return w`
      <ha-card
        style="${a}"
        @click="${e && e.type && e.type !== "none" ? this._handleTapAction : null}"
      >
        ${g}
      </ha-card>
    `;
  ...
  _handleTapAction(g) {
    ...
    (C = g.preventDefault) == null || C.call(g), (a = g.stopPropagation) == null || a.call(g);
    const e = this.tapAction.type || "more-info";
    let n = this.tapAction.entity || "camera.pollen";
    switch (e) {
      case "more-info":
        this._fire("hass-more-info", { entityId: n });
        break;
      case "navigate":
      ...
      case "call-service":
        if (this.tapAction.service && typeof this.tapAction.service == "string") {
          const [I, i] = this.tapAction.service.split(".");
  ...
  _fire(g, e, n) {
    ...
    return C.detail = e, this.dispatchEvent(C), C;
  }
  static get styles() {
    return ig`
      /* normalhtml */
...
customElements.define("pollenprognos-card", rt);
const sA = (t, A) => {
  const g = { ...t };
  for (const e of Object.keys(A)) {
    const n = A[e];
    n !== null && typeof n == "object" && !Array.isArray(n) && typeof t[e] == "object" && t[e] !== null ? g[e] = sA(t[e], n) : g[e] = n;
  }
  return g;
}, ot = (t) => t === "dwd" ? V : t === "peu" ? z : t === "silam" ? T : L;
class lt extends CA {
  get debug() {
    return !!this._config.debug;
  }
  _hasSilamWeatherEntity(A) {
    var a, I, i, o;
    if (!this._hass) return !1;
    if (!A) {
      const h = Object.keys(this._hass.states).filter((s) => s.startsWith("weather.silam_pollen_")).map(
        (s) => s.replace(/^weather\.silam_pollen_/, "").replace(/_.+$/, "")
      ).filter((s, r, l) => l.indexOf(s) === r).sort();
      return this.debug && console.debug(
        "[Editor] _hasSilamWeatherEntity: found locations:",
        h
      ), h.length > 0 ? (this.debug && console.debug(
    ...
    const g = ((I = (a = this._config) == null ? void 0 : a.date_locale) == null ? void 0 : I.split("-")[0]) || "en", e = ((i = M.weather_suffixes) == null ? void 0 : i[g]) || ((o = M.weather_suffixes) == null ? void 0 : o.en) || [], n = A.toLowerCase();
    for (const h of e)
      if (`weather.silam_pollen_${n}_${h}` in this._hass.states) return !0;
    const C = `weather.silam_pollen_${n}_`;
    return Object.keys(this._hass.states).some((h) => h.startsWith(C));
  }
  _resetAll() {
  ...
  _resetPhrases(A) {
    ...
    const g = this._config.integration === "dwd" ? V.allergens : this._config.integration === "peu" ? z.allergens : this._config.integration === "silam" ? T.allergens : L.allergens, e = {}, n = {};
    g.forEach((o) => {
      const h = $(o), s = IA[h] || h;
      e[o] = b(`editor.phrases_full.${s}`, A), n[o] = b(`editor.phrases_short.${s}`, A);
    });
    const C = this._config.integration === "dwd" ? 4 : this._config.integration === "peu" ? 5 : (this._config.integration === "silam", 7), a = Array.from(
      { length: C },
      (o, h) => b(`editor.phrases_levels.${h}`, A)
    ), I = {
      0: b("editor.phrases_days.0", A),
      1: b("editor.phrases_days.1", A),
      2: b("editor.phrases_days.2", A)
    }, i = b("editor.no_information", A);
  ...
  setConfig(A) {
    var g, e;
    try {
      this.debug && console.debug("[Editor] ▶️ setConfig INCOMING:", A), A.phrases && (this._userConfig.phrases = A.phrases);
      const n = A.integration === "dwd" ? V.allergens.length : A.integration === "peu" ? z.allergens.length : A.integration === "silam" ? T.allergens.length : L.allergens.length, C = { ...A };
      Array.isArray(A.allergens) && A.allergens.length < n && (this._userConfig.allergens = [...A.allergens], this._allergensExplicit = !0, this.debug && console.debug(
        "[Editor] saved user-chosen allergens:",
        this._userConfig.allergens
      ));
      const a = (C.integration === "dwd" ? V : C.integration === "peu" ? z : C.integration === "silam" ? T : L).pollen_threshold;
      C.hasOwnProperty("pollen_threshold") && !this._thresholdExplicit && C.pollen_threshold === a && (this.debug && console.debug(
        "[Editor] dropping incoming stub-threshold (matches stub):",
        a
      ), delete C.pollen_threshold);
      const I = A.integration;
      this._prevIntegration !== void 0 && I !== this._prevIntegration && (delete this._userConfig.allergens, this._allergensExplicit = !1, this.debug && console.debug("[Editor] integration changed → wipe allergens")), !this._integrationExplicit && C.integration === L.integration && (this.debug && console.debug("[Editor] dropped stub integration"), delete C.integration), !this._daysExplicit && C.days_to_show === L.days_to_show && (this.debug && console.debug("[Editor] dropped stub days_to_show"), delete C.days_to_show);
      const i = (C.integration === "dwd" ? V : C.integration === "peu" ? z : C.integration === "silam" ? T : L).date_locale;
      !this._localeExplicit && C.date_locale === i && (this.debug && console.debug("[Editor] dropped stub date_locale"), delete C.date_locale), this._userConfig = sA(this._userConfig, C), this._thresholdExplicit = this._userConfig.hasOwnProperty("pollen_threshold"), this._allergensExplicit = this._userConfig.hasOwnProperty("allergens"), this._integrationExplicit = this._userConfig.hasOwnProperty("integration"), this._daysExplicit = this._userConfig.hasOwnProperty("days_to_show"), this._localeExplicit = this._userConfig.hasOwnProperty("date_locale");
      let o = this._userConfig.integration !== void 0 ? this._userConfig.integration : this._config.integration;
      if (!this._integrationExplicit && this._hass) {
        const r = Object.keys(this._hass.states);
        r.some((l) => l.startsWith("sensor.pollen_")) ? o = "pp" : r.some((l) => l.startsWith("sensor.polleninformation_")) ? o = "peu" : r.some((l) => l.startsWith("sensor.pollenflug_")) ? o = "dwd" : r.some((l) => l.startsWith("sensor.silam_pollen_")) && (o = "silam"), this._userConfig.integration = o, this.debug && console.debug("[Editor] auto-detected integration:", o);
      }
      o === "silam" && !this._userConfig.mode && (this._userConfig.mode = "daily");
      const h = ot(o);
      let s = sA(h, this._userConfig);
      if (this._userConfig.hasOwnProperty("pollen_threshold") || (s.pollen_threshold = h.pollen_threshold, this.debug && console.debug(
        "[Editor] reset pollen_threshold to stub:",
        h.pollen_threshold
      )), s.allergens = Array.isArray(this._userConfig.allergens) ? this._userConfig.allergens : h.allergens, s.integration = o, s.type = "custom:pollenprognos-card", this._config = s, this._prevIntegration = o, this.debug && console.debug(
        ...
        const r = q(this._hass, null), l = ((e = (g = this._hass) == null ? void 0 : g.locale) == null ? void 0 : e.language) || `${r}-${r.toUpperCase()}`;
        this._config.date_locale = l, this.debug && console.debug(
      ...
      if (this._initDone = !1, this._hass) {
        ...
        this.installedRegionIds = Array.from(
          new Set(
            r.filter((p) => p.startsWith("sensor.pollenflug_")).map((p) => p.split("_").pop())
          )
        ).sort((p, y) => Number(p) - Number(y));
        const l = new Set(
          r.filter(
            (p) => p.startsWith("sensor.pollen_") && !p.startsWith("sensor.pollenflug_")
          ).map(
            (p) => p.slice(14).replace(/_[^_]+$/, "")
          )
        );
        this.installedCities = JA.filter(
          (p) => l.has(
            p.toLowerCase().replace(/[åä]/g, "a").replace(/ö/g, "o").replace(/[-\s]/g, "_")
          )
        ).sort();
      }
      this._integrationExplicit || (o === "dwd" && !this._userConfig.region_id && this.installedRegionIds.length && (this._config.region_id = this.installedRegionIds[0]), o === "pp" && !this._userConfig.city && this.installedCities.length && (this._config.city = this.installedCities[0]), o === "silam" && !this._userConfig.location && this.installedLocations.length && (this._config.location = this.installedLocations[0])), this.debug && console.debug("[Editor] färdig _config innan dispatch:", this._config), this._config.tap_action ? (this._tapType = this._config.tap_action.type || "more-info", this._tapEntity = this._config.tap_action.entity || "", this._tapNavigation = this._config.tap_action.navigation_path || "", this._tapService = this._config.tap_action.service || "", this._tapServiceData = JSON.stringify(
      ...
      ), this.requestUpdate(), this._prevIntegration = I, this._initDone = !0;
    } catch (n) {
      throw console.error("pollenprognos-card-editor: Fel i setConfig:", n, A), n;
    }
  }
  set hass(A) {
    this._hass = A;
    const g = this._integrationExplicit, e = Object.keys(A.states).filter(
      (l) => l.startsWith("sensor.pollen_") && !l.startsWith("sensor.pollenflug_")
    ), n = Object.keys(A.states).filter(
      (l) => l.startsWith("sensor.pollenflug_")
    ), C = Object.keys(A.states).filter(
      (l) => l.startsWith("sensor.polleninformation_")
    ), a = Object.keys(A.states).filter(
      (l) => l.startsWith("sensor.silam_pollen_")
    );
    let I = this._userConfig.integration;
    g || (e.length ? I = "pp" : C.length ? I = "peu" : n.length ? I = "dwd" : a.length && (I = "silam"), this._userConfig.integration = I), I === "silam" && !this._userConfig.mode && (this._userConfig.mode = "daily");
    const i = I === "dwd" ? V : I === "peu" ? z : I === "silam" ? T : L;
    let o = sA(i, this._userConfig);
    this._userConfig.hasOwnProperty("pollen_threshold") || (o.pollen_threshold = i.pollen_threshold, this.debug && console.debug(
      "[Editor][hass] reset pollen_threshold to stub:",
      i.pollen_threshold
    )), o.sort = o.sort || "value_ascending", this._config = o, this.installedRegionIds = Array.from(
      new Set(n.map((l) => l.split("_").pop()))
    ).sort((l, p) => Number(l) - Number(p));
    const h = Array.from(
      new Set(
        e.map(
          (l) => l.slice(14).replace(/_[^_]+$/, "")
        )
      )
    );
    this.installedCities = JA.filter(
      (l) => h.includes(
        l.toLowerCase().replace(/[åä]/g, "a").replace(/ö/g, "o").replace(/[-\s]/g, "_")
      )
    ).sort((l, p) => l.localeCompare(p)), this.installedPeuLocations = Array.from(
      new Map(
        Object.values(A.states).filter((l) => l.entity_id.startsWith("sensor.polleninformation_")).map((l) => {
          var H, B;
          const p = l.attributes.location_slug || l.entity_id.replace("sensor.polleninformation_", "").replace(/_[^_]+$/, ""), y = l.attributes.location_title || ((B = (H = l.attributes.friendly_name) == null ? void 0 : H.match(/\((.*?)\)/)) == null ? void 0 : B[1]) || p;
          return [p, y];
        })
      )
    ...
    if (this.debug) {
      console.debug("[SilamAllergenMap.mapping]", M.mapping), console.debug("[pollenAllergens]", s);
      for (const [p, y] of Object.entries(M.mapping))
        for (const [H, B] of Object.entries(y))
          console.debug(`[Mapping] ${p}: ${H} → ${B}`);
      const l = Object.values(M.mapping).flatMap(
        (p) => Object.entries(p).filter(
          ([y, H]) => s.includes(H)
        ).map(([y]) => y)
      );
      console.debug("[SilamValidAllergenSlugs]", l);
    }
    const r = new Set(
      Object.values(M.mapping).flatMap(
        (l) => Object.entries(l).filter(
          ([p, y]) => s.includes(y)
        ).map(([p]) => p)
      )
    );
    this.installedSilamLocations = Array.from(
      new Map(
        Object.values(A.states).filter((l) => {
          if (!l.entity_id.startsWith("sensor.silam_pollen_")) return !1;
          const p = l.entity_id.match(
            /^sensor\.silam_pollen_(.*)_([^_]+)$/
          );
          if (!p)
            return this.debug && console.debug("[Filter] Skip (no match):", l.entity_id), !1;
          const y = p[1], H = p[2];
          return this.debug && console.debug(
            "[Filter] entity_id:",
            l.entity_id,
          ...
          const p = l.entity_id.match(
            /^sensor\.silam_pollen_(.*)_([^_]+)$/
          ), y = p ? p[1].replace(/^[-\s]+/, "") : "", H = bA(y);
          let B = l.attributes.location_title || (l.attributes.friendly_name ? l.attributes.friendly_name.replace(/^SILAM Pollen\s*-?\s*/i, "").replace(new RegExp("\\s+\\p{L}+$", "u"), "").trim() : "") || y;
          return B = B.replace(/^[-\s]+/, ""), B = B.charAt(0).toUpperCase() + B.slice(1), this.debug && console.debug(
            "[Map] entity_id:",
            l.entity_id,
            "| rawLocation:",
            y,
    ...
    ), this._initDone || (I === "dwd" && !this._userConfig.region_id && this.installedRegionIds.length && (this._config.region_id = this.installedRegionIds[0]), I === "pp" && !this._userConfig.city && this.installedCities.length && (this._config.city = this.installedCities[0]), I === "silam" && !this._userConfig.location && this.installedSilamLocations.length && (this._config.location = this.installedSilamLocations[0][0])), this._initDone = !0, this.dispatchEvent(
      new CustomEvent("config-changed", {
        detail: { config: this._config },
        bubbles: !0,
        composed: !0
  ...
  _onAllergenToggle(A, g) {
    const e = new Set(this._config.allergens);
    g ? e.add(A) : e.delete(A), this._updateConfig("allergens", [...e]);
  }
  _updateConfig(A, g) {
    if (this.debug && console.debug("[Editor] _updateConfig – prop:", A, "value:", g), A === "date_locale") {
      const C = this._config.sort, a = this._config.mode;
      this._config = {
        ...this._config,
        date_locale: g,
        sort: "",
    ...
    const e = { ...this._userConfig };
    let n;
    if (A === "integration") {
      const C = g, a = this._config.integration;
      C !== a && (delete e.city, delete e.region_id, delete e.location, delete e.mode, delete e.allergens, delete e.days_to_show, delete e.pollen_threshold, this._allergensExplicit = !1), n = sA(C === "dwd" ? V : C === "peu" ? z : C === "silam" ? T : L, e), n.integration = C;
    } else
      n = { ...this._config, [A]: g }, this._config.integration === "silam" && A === "mode" && (g === "hourly" || g === "twice_daily" ? (n.days_to_show = 8, n.show_empty_days = !1) : g === "daily" && (n.days_to_show = 2)), this._config.integration === "silam" && A === "location" && (this._hasSilamWeatherEntity(g) || (n.mode = "daily", n.days_to_show = 2));
  ...
  render() {
    const A = {
      ...
      ...this._config
    }, g = A.integration === "dwd" ? V.allergens : A.integration === "peu" ? z.allergens : A.integration === "silam" ? T.allergens : L.allergens, e = A.integration === "dwd" ? 4 : A.integration === "peu" ? 5 : 7, n = A.integration === "dwd" ? { min: 0, max: 3, step: 0.5 } : A.integration === "peu" ? { min: 0, max: 4, step: 1 } : { min: 0, max: 6, step: 1 }, a = [
      "value_ascending",
      "value_descending",
      "name_ascending",
      "name_descending"
      ...
      value: I,
      label: this._t(`sort_${I}`)
    }));
    return this.debug && (console.debug("Aktuellt språk (lang):", this._lang), console.debug("Sort label test:", this._t("sort_value_ascending"))), w`
      <div class="card-config">
        ...
        <ha-formfield label="${this._t("integration")}">
          <ha-select
            .value=${A.integration}
            @selected=${(I) => this._updateConfig("integration", I.target.value)}
        ...
        ${A.integration === "pp" ? w`
              <ha-formfield label="${this._t("city")}">
                <ha-select
                  .value=${A.city || ""}
                  @selected=${(I) => this._updateConfig("city", I.target.value)}
                  @closed=${(I) => I.stopPropagation()}
                >
                  ${this.installedCities.map(
      (I) => w`<mwc-list-item .value=${I}
                        >${I}</mwc-list-item
                      >`
    )}
                </ha-select>
            ...
            ` : A.integration === "peu" ? w`
                <ha-formfield label="${this._t("location")}">
                  <ha-select
                    .value=${A.location || ""}
                    @selected=${(I) => this._updateConfig("location", I.target.value)}
                    @closed=${(I) => I.stopPropagation()}
                  >
                    ${this.installedPeuLocations.map(
      ([I, i]) => w`<mwc-list-item .value=${I}
                          >${i}</mwc-list-item
                        >`
    )}
                  </ha-select>
      ...
      ([I, i]) => w`<mwc-list-item .value=${I}
                ...
                ` : w`
                  <ha-formfield label="${this._t("region_id")}">
                    <ha-select
                      .value=${A.region_id || ""}
                      @selected=${(I) => this._updateConfig("region_id", I.target.value)}
                      @closed=${(I) => I.stopPropagation()}
                    >
      ...
      i.trim() === "" ? this._updateConfig("title", !0) : this._updateConfig("title", i);
    }}
          ></ha-textfield>
        </ha-formfield>
        <!-- Bakgrundsfärg -->
        <ha-formfield label="${this._t("background_color")}">
          <div style="display:flex; gap:8px; align-items:center;">
            <ha-textfield
              ...
              @input=${(I) => this._updateConfig("background_color", I.target.value)}
              style="width: 120px;"
            ></ha-textfield>
            <input
              type="color"
        ...
        <!-- Layout-switchar -->
        ${A.integration === "silam" && this._hasSilamWeatherEntity(A.location) ? w`
              <ha-formfield label="${this._t("mode")}">
                <ha-select
                  .value=${A.mode || "daily"}
                  @selected=${(I) => this._updateConfig("mode", I.target.value)}
                  @closed=${(I) => I.stopPropagation()}
                >
      ...
      I.target.checked
        ...
        <div class="slider-row">
          <div class="slider-text">
            ${A.integration === "silam" && A.mode === "twice_daily" ? this._t("to_show_columns") : A.integration === "silam" && A.mode === "hourly" ? this._t("to_show_hours") : this._t("to_show_days")}
          </div>
        ...
        <ha-formfield label="${this._t("sort")}">
          ...
          >
            ${a.map(
      ({ value: I, label: i }) => w`<mwc-list-item .value=${I}>${i}</mwc-list-item>`
    )}
          </ha-select>
        </ha-formfield>
        ...
        <ha-formfield label="${this._t("locale")}">
          <ha-textfield
            .value=${A.date_locale}
            @input=${(I) => this._updateConfig("date_locale", I.target.value)}
          ></ha-textfield>
        </ha-formfield>
      ...
      (I) => w`
                <ha-formfield .label=${I}>
                  <ha-checkbox
                    .checked=${A.allergens.includes(I)}
                    @change=${(i) => this._onAllergenToggle(I, i.target.checked)}
                  ></ha-checkbox>
                </ha-formfield>
              `
    )}
        ...
        <div class="preset-buttons">
          <ha-formfield label="${this._t("phrases_translate_all")}">
            <ha-select
              ...
              @selected=${(I) => this._selectedPhraseLang = I.target.value}
              @closed=${(I) => I.stopPropagation()}
            >
              ${Kn.map(
      (I) => w`
      ...
      (I) => w`
              <ha-formfield .label=${I}>
                <ha-textfield
                  .value=${A.phrases.full[I] || ""}
                  @input=${(i) => {
        const o = {
          ...A.phrases,
          full: { ...A.phrases.full, [I]: i.target.value }
        };
        this._updateConfig("phrases", o);
      }}
                ></ha-textfield>
              </ha-formfield>
            `
      ...
      (I) => w`
              <ha-formfield .label=${I}>
                <ha-textfield
                  .value=${A.phrases.short[I] || ""}
                  @input=${(i) => {
        const o = {
          ...A.phrases,
          short: { ...A.phrases.short, [I]: i.target.value }
        };
        this._updateConfig("phrases", o);
      }}
                ></ha-textfield>
        ...
        <details>
          ...
          ${Array.from({ length: e }, (I, i) => i).map(
      (I) => w`
              <ha-formfield .label=${I}>
                <ha-textfield
                  .value=${A.phrases.levels[I] || ""}
                  @input=${(i) => {
        const o = [...A.phrases.levels];
        o[I] = i.target.value;
        const h = { ...A.phrases, levels: o };
      ...
      (I) => w`
              <ha-formfield .label=${I}>
                <ha-textfield
                  .value=${A.phrases.days[I] || ""}
                  @input=${(i) => {
        const o = { ...A.phrases.days, [I]: i.target.value };
        this._updateConfig("phrases", { ...A.phrases, days: o });
      }}
                ></ha-textfield>
              </ha-formfield>
            `
        ...
        <ha-formfield label="${this._t("no_information")}">
          <ha-textfield
            ...
            @input=${(I) => this._updateConfig("phrases", {
      ...A.phrases,
      no_information: I.target.value
    })}
          ></ha-textfield>
        </ha-formfield>
        ...
        <ha-formfield label="${this._t("tap_action_enable")}">
          <ha-switch
            ...
            @change=${(I) => {
      I.target.checked ? (this._tapType = "more-info", this._updateConfig("tap_action", {
        ...
        ${this._tapType !== "none" ? w`
              <div style="margin-top: 10px;">
                ...
                <ha-select
                  .value=${this._tapType}
                  @selected=${(I) => {
      this._tapType = I.target.value;
      let i = { type: this._tapType };
      if (this._tapType === "more-info" && (i.entity = this._tapEntity), this._tapType === "navigate" && (i.navigation_path = this._tapNavigation), this._tapType === "call-service") {
        i.service = this._tapService;
        try {
          i.service_data = JSON.parse(
      ...
      this._updateConfig("tap_action", i), this.requestUpdate();
    }}
                  @closed=${(I) => I.stopPropagation()}
                >
              ...
              ${this._tapType === "more-info" ? w`
                    <ha-formfield label="Entity">
                      <ha-textfield
                        ...
                        @input=${(I) => {
      this._tapEntity = I.target.value, this._updateConfig("tap_action", {
        type: "more-info",
              ...
              ${this._tapType === "navigate" ? w`
                    <ha-formfield label="Navigation path">
                      <ha-textfield
                        ...
                        @input=${(I) => {
      this._tapNavigation = I.target.value, this._updateConfig("tap_action", {
        type: "navigate",
              ...
              ${this._tapType === "call-service" ? w`
                    <ha-formfield label="Service (e.g. light.turn_on)">
                      <ha-textfield
                        ...
                        @input=${(I) => {
      this._tapService = I.target.value;
      let i = {};
      try {
        i = JSON.parse(this._tapServiceData || "{}");
      } catch {
      }
        ...
        service_data: i
                    ...
                    <ha-formfield label="Service data (JSON)">
                      <ha-textfield
                        ...
                        @input=${(I) => {
      this._tapServiceData = I.target.value;
      let i = {};
      try {
        i = JSON.parse(this._tapServiceData || "{}");
      } catch {
      ...
      this._updateConfig("tap_action", {
        ...
        <ha-formfield label="${this._t("debug")}">
          <ha-switch
            .checked=${A.debug}
            @change=${(I) => this._updateConfig("debug", I.target.checked)}
          ></ha-switch>
        </ha-formfield>
      </div>
    `;
...
customElements.define("pollenprognos-card-editor", lt);
