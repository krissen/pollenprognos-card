...
const cg = (C) => new tg(typeof C == "string" ? C : C + "", void 0, YA), ig = (C, ...A) => {
  const g = C.length === 1 ? C[0] : A.reduce((e, n, t) => e + ((a) => {
...
const EA = window, KA = EA.trustedTypes, pg = KA ? KA.emptyScript : "", zA = EA.reactiveElementPolyfillSupport, jA = { toAttribute(C, A) {
  ...
  return g;
} }, ag = (C, A) => A !== C && (A == A || C == C), UA = { attribute: !0, type: String, converter: jA, reflect: !1, hasChanged: ag }, kA = "finalized";
let CA = class extends HTMLElement {
  ...
  _$EO(A, g, e = UA) {
    ...
    if (t !== void 0 && e.reflect === !0) {
      ...
      this._$El = A, a == null ? this.removeAttribute(t) : this.setAttribute(t, a), this._$El = null;
    }
  }
  _$AK(A, g) {
    var e;
    ...
    if (t !== void 0 && this._$El !== t) {
      const a = n.getPropertyOptions(t), I = typeof a.converter == "function" ? { fromAttribute: a.converter } : ((e = a.converter) === null || e === void 0 ? void 0 : e.fromAttribute) !== void 0 ? a.converter : jA;
      this._$El = t, this[t] = I.fromAttribute(g, a.type), this._$El = null;
    }
  }
  requestUpdate(A, g, e) {
    let n = !0;
 ...
 */
var xA;
const pA = window, aA = pA.trustedTypes, TA = aA ? aA.createPolicy("lit-html", { createHTML: (C) => C }) : void 0, HA = "$lit$", _ = `lit$${(Math.random() + "").slice(9)}$`, rg = "?" + _, ug = `<${rg}>`, IA = document, DA = () => IA.createComment(""), dA = (C) => C === null || typeof C != "object" && typeof C != "function", og = Array.isArray, fg = (C) => og(C) || typeof (C == null ? void 0 : C[Symbol.iterator]) == "function", yA = `[ 	
\f\r]`, sA = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, VA = /-->/g, NA = />/g, gA = RegExp(`>|${yA}(?:([^\\s"'>=/]+)(${yA}*=${yA}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), XA = /'/g, qA = /"/g, lg = /^(?:script|style|textarea|title)$/i, mg = (C) => (A, ...g) => ({ _$litType$: C, strings: A, values: g }), w = mg(1), rA = Symbol.for("lit-noChange"), F = Symbol.for("lit-nothing"), _A = /* @__PURE__ */ new WeakMap(), eA = IA.createTreeWalker(IA, 129, null, !1);
function sg(C, A) {
...
const Bg = (C, A) => {
  ...
  for (let I = 0; I < g; I++) {
    ...
    const l = a === gA && C[I + 1].startsWith("/>") ? " " : "";
    t += a === sA ? i + ug : h >= 0 ? (e.push(o), i.slice(0, h) + HA + i.slice(h) + _ + l) : i + _ + (h === -2 ? (e.push(void 0), I) : l);
  }
      ...
      if (n.nodeType === 1) {
        ...
        if (lg.test(n.tagName)) {
          ...
          if (r > 0) {
            ...
            for (let l = 0; l < r; l++) n.append(h[l], DA()), eA.nextNode(), i.push({ type: 2, index: ++t });
            n.append(h[r], DA());
          }
        }
      } else if (n.nodeType === 8) if (n.data === rg) i.push({ type: 2, index: t });
      else {
        let h = -1;
...
function oA(C, A, g = C, e) {
  ...
  return (i == null ? void 0 : i.constructor) !== o && ((t = i == null ? void 0 : i._$AO) === null || t === void 0 || t.call(i, !1), o === void 0 ? i = void 0 : (i = new o(C), i._$AT(C, g, e)), e !== void 0 ? ((a = (I = g)._$Co) !== null && a !== void 0 ? a : I._$Co = [])[e] = i : g._$Cl = i), i !== void 0 && (A = oA(C, i._$AS(C, A.values), i, e)), A;
}
class Ug {
  constructor(A, g) {
...
class SA {
  ...
  g(A) {
    ...
    if (((g = this._$AH) === null || g === void 0 ? void 0 : g._$AD) === t) this._$AH.v(e);
      ...
      const a = new Ug(t, this), I = a.u(this.options);
...
class fA {
  ...
  _$AI(A, g = this, e, n) {
    ...
    let a = !1;
    if (t === void 0) A = oA(this, A, g, 0), a = !dA(A) || A !== this._$AH && A !== rA, a && (this._$AH = A);
    else {
      const I = A;
      let i, o;
      for (A = t[0], i = 0; i < t.length - 1; i++) o = oA(this, I[e + i], g, i), o === rA && (o = this._$AH[i]), a || (a = !dA(o) || o !== this._$AH[i]), o === F ? A = F : A !== F && (A += (o ?? "") + t[i + 1]), this._$AH[i] = o;
    }
    a && !n && this.j(A);
  }
  j(A) {
...
class vg extends fA {
  ...
  _$AI(A, g = this) {
    ...
    const n = this._$AH, t = A === F && n !== F || A.capture !== n.capture || A.once !== n.once || A.passive !== n.passive, a = A !== F && (n === F || t);
    t && this.element.removeEventListener(this.name, this, n), a && this.element.addEventListener(this.name, this, A), this._$AH = A;
  }
  handleEvent(A) {
    var g, e;
...
const jg = (C, A, g) => {
  ...
  if (a === void 0) {
    ...
    t._$litPart$ = a = new SA(A.insertBefore(DA(), I), I, void 0, g ?? {});
  }
  return a._$AI(C), a;
};
/**
...
const bA = (C, A = "_") => {
  ...
  let a;
  return C === "" ? a = "" : (a = C.toString().toLowerCase().replace(n, (I) => e.charAt(g.indexOf(I))).replace(/[а-я]/g, (I) => t[I] || "").replace(/(\d),(?=\d)/g, "$1").replace(/[^a-z0-9]+/g, A).replace(new RegExp(`(${A})\\1+`, "g"), "$1").replace(new RegExp(`^${A}+`), "").replace(new RegExp(`${A}+$`), ""), a === "" && (a = "unknown")), a;
...
async function qn(C, A) {
  const g = !!A.debug, e = (S) => S.charAt(0).toUpperCase() + S.slice(1), n = q(C, A.date_locale), t = A.date_locale || T.date_locale, a = A.days_relative !== !1, I = !!A.days_abbreviated, i = !!A.days_uppercase, o = A.phrases || {}, D = o.full || {}, h = o.short || {}, r = o.levels, l = Array.isArray(r) && r.length === 7 ? r : Array.from({ length: 7 }, (S, s) => O(`card.levels.${s}`, n)), E = o.no_information || O("card.no_information", n), x = o.days || {}, b = A.days_to_show ?? T.days_to_show, B = A.pollen_threshold ?? T.pollen_threshold;
  ...
  for (const S of A.allergens)
    try {
      ...
      s.days = [], J.forEach((U, H) => {
        ...
        let Q;
        a ? x[W] !== void 0 ? Q = x[W] : W >= 0 && W <= 2 ? Q = O(`card.days.${W}`, n) : Q = U.date.toLocaleDateString(t, {
          day: "numeric",
          month: "short"
...
async function $n(C, A) {
  var p, u;
  const g = !!A.debug, e = q(C, A.date_locale), n = A.date_locale || ((p = C.locale) == null ? void 0 : p.language) || C.language || `${e}-${e.toUpperCase()}`, t = A.days_relative !== !1, a = !!A.days_abbreviated, I = !!A.days_uppercase, i = {
    full: {},
    short: {},
    levels: [],
    days: {},
...
async function nC(C, A) {
  var Y, M, S;
  const g = !!A.debug, e = q(C, A.date_locale), n = A.date_locale || ((Y = C.locale) == null ? void 0 : Y.language) || C.language || `${e}-${e.toUpperCase()}`, t = A.days_relative !== !1, a = !!A.days_abbreviated, I = !!A.days_uppercase, i = MA(A, e), o = GA(i, e), D = i.no_information, h = i.days, r = /* @__PURE__ */ new Date();
  r.setHours(0, 0, 0, 0);
...
async function CC(C, A, g = null) {
  ...
  const n = q(C, A.date_locale), t = A.date_locale || ((x = C.locale) == null ? void 0 : x.language) || C.language || `${n}-${n.toUpperCase()}`, a = A.pollen_threshold ?? z.pollen_threshold;
  if (e) {
  ...
  const D = MA(A, n), h = GA(D, n), r = D.no_information, l = A.allergens || z.allergens;
  e && console.debug(
  ...
  for (const B of l)
    try {
      ...
      for (let s = 0; s < o.length; ++s) {
        const p = o[s], u = `pollen_${B}`, d = Number(p[u]), c = tA(B, d), m = c < 0 ? r : h[c] || String(c), y = new Date(p.datetime || p.time);
        let v, f;
...
async function aC(C, A) {
  ...
  a.setHours(0, 0, 0, 0);
  const I = q(C, A.date_locale), i = A.date_locale || ((s = C.locale) == null ? void 0 : s.language) || C.language || `${I}-${I.toUpperCase()}`, o = A.days_relative !== !1, D = !!A.days_abbreviated, h = !!A.days_uppercase, r = {
    full: {},
    short: {},
    levels: [],
    days: {},
  ...
  for (const u of A.allergens)
    try {
      ...
      if (U.length >= M)
        ...
        H = U.slice();
        let Q = U.length > 0 ? t(U[U.length - 1]) : a;
        for (; H.length < M; ) {
          Q = new Date(Q.getTime() + 864e5);
          const R = Q.getFullYear(), Z = String(Q.getMonth() + 1).padStart(2, "0"), L = String(Q.getDate()).padStart(2, "0");
          H.push(`${R}-${Z}-${L}T00:00:00`);
      ...
      H.forEach((Q, R) => {
        const Z = J[Q] || {}, L = Y(Z.level), N = t(Q), X = Math.round((N - a) / 864e5);
        let P;
...
function ng(C, A, g = !1) {
  ...
  if (e === "pp") {
    ...
    for (const a of C.allergens || []) {
      const I = $(a), i = `sensor.pollen_${t}_${I}`, o = !!A.states[i];
      g && console.debug(
        `[findAvailableSensors][pp] allergen: '${a}', cityKey: '${t}', rawKey: '${I}', sensorId: '${i}', exists: ${o}`
      ), o && n.push(i);
    }
  } else if (e === "dwd")
    for (const t of C.allergens || []) {
      const a = uA(t);
      let I = C.region_id ? `sensor.pollenflug_${a}_${C.region_id}` : null, i = I && A.states[I];
      if (!i) {
      ...
      g && console.debug(
        `[findAvailableSensors][dwd] allergen: '${t}', rawKey: '${a}', region_id: '${C.region_id}', sensorId: '${I}', exists: ${!!i}`
      ), i && n.push(I);
    }
  else if (e === "peu") {
    ...
    for (const a of C.allergens || []) {
      ...
      g && console.debug(
        `[findAvailableSensors][peu] allergen: '${a}', locationSlug: '${t}', allergenSlug: '${I}', sensorId: '${i}', exists: ${!!o}`
      ), o && n.push(i);
    }
  } else if (e === "silam") {
    const t = (C.location || "").toLowerCase();
    for (const a of C.allergens || []) {
      ...
      for (const i of Object.values(G.mapping)) {
        ...
        if (o[a]) {
          const D = o[a], h = `sensor.silam_pollen_${t}_${D}`;
          if (A.states[h]) {
            I = D, g && console.debug(
              `[findAvailableSensors][silam] allergen: '${a}', locationSlug: '${t}', hassSlug: '${I}', sensorId: '${h}', exists: true`,
              A.states[h]
            ), n.push(h);
            break;
          }
      ...
      !I && g && console.debug(
        `[findAvailableSensors][silam] allergen: '${a}', locationSlug: '${t}', ingen sensor hittades!`
      );
    }
  }
  if (g) {
...
class rC extends iA {
  ...
  _updateSensorsAndColumns(g, e, n) {
    ...
    let t = 0;
    n.show_empty_days ? t = n.days_to_show : g.length > 0 && g[0].days && (t = g[0].days.length), this.days_to_show = t, this.displayCols = Array.from({ length: t }, (a, I) => I), this.debug && (console.debug("Days to show:", this.days_to_show), console.debug("Display columns:", this.displayCols)), this.requestUpdate();
  }
  _subscribeForecastIfNeeded() {
    ...
    if (!(!this.config || !this._hass) && (this._forecastUnsub && (Promise.resolve(this._forecastUnsub).then((a) => {
      ...
      const a = this.config.location.toLowerCase(), I = ((e = (g = this.config) == null ? void 0 : g.date_locale) == null ? void 0 : e.split("-")[0]) || "en", i = ((n = G.weather_suffixes) == null ? void 0 : n[I]) || ((t = G.weather_suffixes) == null ? void 0 : t.en) || [];
      if (this.debug) {
  ...
  _getImageSrc(g, e) {
    const n = Number(e);
    let t = n, a = -1, I = 6;
    this.config.integration === "dwd" ? (t = n * 2, I = 6) : this.config.integration === "peu" && (t = Math.round(n * 6 / 4), I = 6, a = 0);
    let i = Math.round(t);
  ...
  set hass(g) {
    ...
    this.debug && (console.debug("Sensor states detected:"), console.debug("PP:", n), console.debug("DWD:", t), console.debug("PEU:", a), console.debug("SILAM:", I));
    let i = this._userConfig.integration;
    e || (n.length ? i = "pp" : a.length ? i = "peu" : t.length ? i = "dwd" : I.length && (i = "silam"));
    let o;
    ...
    if (this._integrationExplicit && Array.isArray(D) && D.length > 0 ? (this.debug && console.debug(
      ...
      i
    ), i === "pp" ? r.allergens = K.allergens : i === "peu" ? r.allergens = V.allergens : i === "dwd" ? r.allergens = T.allergens : i === "silam" && (r.allergens = z.allergens)), !r.hasOwnProperty("date_locale")) {
  ...
  render() {
    ...
    const t = e && e.type && e.type !== "none" ? "pointer" : "auto", a = `${n} cursor: ${t};`;
    return w`
      <ha-card
        style="${a}"
  ...
  _handleTapAction(g) {
    ...
    (t = g.preventDefault) == null || t.call(g), (a = g.stopPropagation) == null || a.call(g);
...
customElements.define("pollenprognos-card", rC);
const hA = (C, A) => {
  const g = { ...C };
...
class lC extends iA {
  ...
  _resetPhrases(A) {
    ...
    const t = this._config.integration === "dwd" ? 4 : this._config.integration === "peu" ? 5 : (this._config.integration === "silam", 7), a = Array.from(
      { length: t },
  ...
  setConfig(A) {
    ...
    try {
      ...
      const a = (t.integration === "dwd" ? T : t.integration === "peu" ? V : t.integration === "silam" ? z : K).pollen_threshold;
      t.hasOwnProperty("pollen_threshold") && !this._thresholdExplicit && t.pollen_threshold === a && (this.debug && console.debug(
  ...
  set hass(A) {
    ...
    let I = this._userConfig.integration;
    g || (e.length ? I = "pp" : t.length ? I = "peu" : n.length ? I = "dwd" : a.length && (I = "silam"), this._userConfig.integration = I), I === "silam" && !this._userConfig.mode && (this._userConfig.mode = "daily");
  ...
  _updateConfig(A, g) {
    ...
    let n;
    if (A === "integration") {
      const t = g, a = this._config.integration;
      t !== a && (delete e[t === "dwd" ? "city" : "region_id"], delete e.allergens, delete e.days_to_show, delete e.pollen_threshold, this._allergensExplicit = !1), n = hA(t === "dwd" ? T : t === "peu" ? V : t === "silam" ? z : K, e), n.integration = t;
    } else
  ...
  render() {
    const A = {
      ...
      ...this._config
    }, g = A.integration === "dwd" ? T.allergens : A.integration === "peu" ? V.allergens : A.integration === "silam" ? z.allergens : K.allergens, e = A.integration === "dwd" ? 4 : A.integration === "peu" ? 5 : 7, n = A.integration === "dwd" ? { min: 0, max: 3, step: 0.5 } : A.integration === "peu" ? { min: 0, max: 4, step: 1 } : { min: 0, max: 6, step: 1 }, a = [
      "value_ascending",
      "value_descending",
      "name_ascending",
      "name_descending"
