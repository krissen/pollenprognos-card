...
var Sg = (t, A, g) => A in t ? Qg(t, A, { enumerable: !0, configurable: !0, writable: !0, value: g }) : t[A] = g;
var mA = (t, A, g) => Sg(t, typeof A != "symbol" ? A + "" : A, g);
 ...
 */
const cA = window, PA = cA.ShadowRoot && (cA.ShadyCSS === void 0 || cA.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, YA = Symbol(), FA = /* @__PURE__ */ new WeakMap();
let Cg = class {
  constructor(A, g, e) {
...
const cg = (t) => new Cg(typeof t == "string" ? t : t + "", void 0, YA), ig = (t, ...A) => {
  ...
  PA ? t.adoptedStyleSheets = A.map((g) => g instanceof CSSStyleSheet ? g : g.styleSheet) : A.forEach((g) => {
    const e = document.createElement("style"), n = cA.litNonce;
 ...
 */
var xA;
const pA = window, aA = pA.trustedTypes, zA = aA ? aA.createPolicy("lit-html", { createHTML: (t) => t }) : void 0, HA = "$lit$", _ = `lit$${(Math.random() + "").slice(9)}$`, rg = "?" + _, ug = `<${rg}>`, IA = document, DA = () => IA.createComment(""), dA = (t) => t === null || typeof t != "object" && typeof t != "function", og = Array.isArray, fg = (t) => og(t) || typeof (t == null ? void 0 : t[Symbol.iterator]) == "function", yA = `[ 	
\f\r]`, sA = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, VA = /-->/g, NA = />/g, gA = RegExp(`>|${yA}(?:([^\\s"'>=/]+)(${yA}*=${yA}*(?:[^ 	
...
const Bg = (t, A) => {
  ...
  for (let I = 0; I < g; I++) {
    const i = t[I];
    let o, D, h = -1, r = 0;
    for (; r < i.length && (a.lastIndex = r, D = a.exec(i), D !== null); ) r = a.lastIndex, a === sA ? D[1] === "!--" ? a = VA : D[1] !== void 0 ? a = NA : D[2] !== void 0 ? (lg.test(D[2]) && (n = RegExp("</" + D[2], "g")), a = gA) : D[3] !== void 0 && (a = gA) : a === gA ? D[0] === ">" ? (a = n ?? sA, h = -1) : D[1] === void 0 ? h = -2 : (h = a.lastIndex - D[2].length, o = D[1], a = D[3] === void 0 ? gA : D[3] === '"' ? qA : XA) : a === qA || a === XA ? a = gA : a === VA || a === NA ? a = sA : (a = gA, n = void 0);
...
class Ug {
  ...
  u(A) {
    ...
    for (; o !== void 0; ) {
      if (I === o.index) {
        let D;
        o.type === 2 ? D = new SA(a, a.nextSibling, this, A) : o.type === 1 ? D = new o.ctor(a, o.name, o.strings, this, A) : o.type === 6 && (D = new Rg(a, this, A)), this._$AV.push(D), o = n[++i];
      }
...
class SA {
  ...
  T(A) {
    ...
    const g = this._$AH;
    let e, n = 0;
    for (const C of A) n === g.length ? g.push(e = new SA(this.k(DA()), this.k(DA()), this, this.options)) : e = g[n], e._$AI(C), n++;
...
const jg = (t, A, g) => {
  ...
  if (a === void 0) {
    ...
    C._$litPart$ = a = new SA(A.insertBefore(DA(), I), I, void 0, g ?? {});
  }
  return a._$AI(t), a;
};
/**
...
const Tn = "state_tomorrow", zn = "state_in_2_days", Vn = "state_today_desc", Nn = "state_tomorrow_desc", Xn = "state_in_2_days_desc", z = {
  integration: "dwd",
  region_id: "",
  allergens: [
    "erle",
...
async function qn(t, A) {
  const g = !!A.debug, e = (S) => S.charAt(0).toUpperCase() + S.slice(1), n = q(t, A.date_locale), C = A.date_locale || z.date_locale, a = A.days_relative !== !1, I = !!A.days_abbreviated, i = !!A.days_uppercase, o = A.phrases || {}, D = o.full || {}, h = o.short || {}, r = o.levels, l = Array.isArray(r) && r.length === 7 ? r : Array.from({ length: 7 }, (S, s) => O(`card.levels.${s}`, n)), E = o.no_information || O("card.no_information", n), x = o.days || {}, b = A.days_to_show ?? z.days_to_show, B = A.pollen_threshold ?? z.pollen_threshold;
  ...
  for (const S of A.allergens)
    try {
      ...
      let c = A.region_id ? `sensor.pollenflug_${p}_${A.region_id}` : null;
      if (!c || !t.states[c]) {
      ...
      const m = t.states[c], y = j(m.state), v = j(m.attributes[Tn]), f = j(m.attributes[zn]), J = [
        { date: Y, level: y },
      ...
      s.days = [], J.forEach((U, H) => {
        ...
        const R = m.attributes[H === 0 ? Vn : H === 1 ? Nn : Xn] || "", Z = U.level * 2, L = Math.min(Math.max(Math.round(Z), 0), 6), N = L < 0 ? E : l[L] || R;
        s[`day${H}`] = {
      ...
      console.warn(`DWD adapter error for allergen ${S}:`, s);
    }
  return M.sort(
    {
      value_ascending: (S, s) => S.day0.state - s.day0.state,
      value_descending: (S, s) => s.day0.state - S.day0.state,
      name_descending: (S, s) => s.allergenCapitalized.localeCompare(S.allergenCapitalized)
    }[A.sort] || ((S, s) => s.day0.state - S.day0.state)
...
async function $n(t, A) {
  ...
  Array.isArray(h) && h.length === r || Array.from(
    { length: r },
    (d, c) => O(`card.levels.${c}`, e)
  );
  const l = i.no_information || O("card.no_information", e), E = i.days, x = A.integration === "dwd" ? 3 : A.integration === "peu" ? 4 : 6, b = (d) => {
    const c = Number(d);
    return isNaN(c) || c < 0 ? -1 : c > x ? x : c;
  }, B = /* @__PURE__ */ new Date();
  B.setHours(0, 0, 0, 0);
  const j = A.days_to_show ?? V.days_to_show, Y = A.pollen_threshold ?? V.pollen_threshold, M = Object.keys(t.states).filter(
    (d) => d.startsWith("sensor.polleninformation_")
  );
  let S = A.location;
  !S && M.length && (S = M[0].slice(25).split("_")[0]);
  const s = [];
  for (const d of A.allergens)
    try {
      ...
      c.days = [];
      const m = d;
      if (c.allergenReplaced = m, o[m])
        c.allergenCapitalized = o[m];
      else {
        const Q = nA[m] || m, R = O(`card.allergen.${Q}`, e);
        c.allergenCapitalized = R !== `card.allergen.${Q}` ? R : m.charAt(0).toUpperCase() + m.slice(1);
      }
      if (A.allergens_abbreviated) {
        const Q = D[m];
        c.allergenShort = Q || O(`editor.phrases_short.${m}`, e) || c.allergenCapitalized;
      } else
        c.allergenShort = c.allergenCapitalized;
      let y = S ? `sensor.polleninformation_${S}_${m}` : null;
      if (!y || !t.states[y]) {
        const Q = M.filter((R) => {
      ...
      H.forEach((Q, R) => {
        ...
        c[`day${R}`] = WA, c.days.push(WA);
      }), (c.days.some((Q) => Q.state >= Y) || Y === 0) && s.push(c);
    } catch (c) {
      g && console.warn(`Fel vid allergen ${d}:`, c);
    }
  return s.sort(
    {
      value_ascending: (d, c) => d.day0.state - c.day0.state,
      value_descending: (d, c) => c.day0.state - d.day0.state,
      name_ascending: (d, c) => d.allergenCapitalized.localeCompare(c.allergenCapitalized),
      name_descending: (d, c) => c.allergenCapitalized.localeCompare(d.allergenCapitalized)
    }[A.sort] || ((d, c) => c.day0.state - d.day0.state)
...
async function nt(t, A) {
  ...
  for (const s of b) {
    ...
    const u = p[2];
    let d = !1;
    for (const [c, m] of Object.entries(G.mapping))
      if (m[u]) {
        const y = m[u];
        B[y] = s, d = !0;
        break;
  ...
  for (const s of A.allergens)
    try {
      ...
      const c = B[s];
      if (!c || !t.states[c]) {
        g && console.debug(`[SILAM] Ingen sensor för ${s}:`, c);
        continue;
      }
      const m = t.states[c], y = Number(m.state);
      let v = [];
      ...
      if (f.push(CA(s, y)), m.attributes && Array.isArray(m.attributes.forecast) && m.attributes.forecast.length > 0)
        ...
        for (l > 1 && ((M = m.attributes) == null ? void 0 : M.tomorrow) !== void 0 ? f.push(
          ...
          f.push(-1);
      f.length < l && ((S = m.attributes) == null ? void 0 : S.tomorrow) !== void 0 && (f[1] = CA(s, Number(m.attributes.tomorrow)) || -1);
      for (let k = 0; k < l; ++k) {
  ...
  for (const B of l)
    try {
      ...
      for (let s = 0; s < o.length; ++s) {
        const p = o[s], u = `pollen_${B}`, d = Number(p[u]), c = CA(B, d), m = c < 0 ? r : h[c] || String(c), y = new Date(p.datetime || p.time);
        let v, f;
      ...
      const S = j.days.some((s) => s.state >= a);
      e && console.debug(
...
async function at(t, A) {
  ...
  const g = [], e = !!A.debug, n = (u) => u.charAt(0).toUpperCase() + u.slice(1), C = (u) => {
    const [d] = u.split("T"), [c, m, y] = d.split("-").map(Number);
    return new Date(c, m - 1, y);
  }, a = /* @__PURE__ */ new Date();
  a.setHours(0, 0, 0, 0);
  ...
  }, M = A.days_to_show ?? K.days_to_show, S = A.pollen_threshold ?? K.pollen_threshold;
  for (const u of A.allergens)
    try {
      const d = {};
      d.days = [];
      const c = $(u);
      if (d.allergenReplaced = c, this.debug && console.log(
        "[PP] allergen",
        u,
        "fullPhrases keys",
        Object.keys(l)
      ...
      }), (d.days.some((Q) => Q.state >= S) || S === 0) && g.push(d);
    } catch (d) {
...
class rt extends iA {
  ...
  setConfig(g) {
    ...
    e === "pp" ? n = K : e === "peu" ? n = V : e === "dwd" ? n = z : e === "silam" ? n = T : n = K;
  ...
  set hass(g) {
    ...
    const n = Object.keys(g.states).filter(
      (S) => S.startsWith("sensor.pollen_") && !S.startsWith("sensor.pollenflug_")
    ), C = Object.keys(g.states).filter(
      (S) => S.startsWith("sensor.pollenflug_")
    ), a = Object.keys(g.states).filter(
      (S) => S.startsWith("sensor.polleninformation_")
    ), I = Object.keys(g.states).filter(
      (S) => S.startsWith("sensor.silam_pollen_")
    );
    ...
    let o;
    i === "dwd" ? o = z : i === "peu" ? o = V : i === "pp" ? o = K : i === "silam" ? o = T : console.error("Unknown integration:", i);
    ...
    if (this._integrationExplicit && Array.isArray(D) && D.length > 0 ? (this.debug && console.debug(
      ...
      i
    ), i === "pp" ? r.allergens = K.allergens : i === "peu" ? r.allergens = V.allergens : i === "dwd" ? r.allergens = z.allergens : i === "silam" && (r.allergens = T.allergens)), !r.hasOwnProperty("date_locale")) {
      const S = q(g, null), s = ((b = (x = this._hass) == null ? void 0 : x.locale) == null ? void 0 : b.language) || ((B = this._hass) == null ? void 0 : B.language) || `${S}-${S.toUpperCase()}`;
    ...
    if (i === "dwd" && !r.region_id && C.length)
      r.region_id = Array.from(
        new Set(C.map((S) => S.split("_").pop()))
      ).sort((S, s) => Number(S) - Number(s))[0], this.debug && console.debug("[Card] Auto-set region_id:", r.region_id);
      ...
      r.location = S[0] || null, this.debug && console.debug(
    ...
    if (this.config = r, this.tapAction = r.tap_action || this.tapAction || null, this.debug && (console.debug("[Card][Debug] Aktiv integration:", i), console.debug("[Card][Debug] Allergens i config:", r.allergens)), r.title === "false" || r.title === !1 || typeof r.title == "string" && r.title.trim() === "")
      ...
      this.header = `${this._t("card.header_prefix")} ${S}`, this.debug && console.debug("[Card] header set to:", this.header);
    }
    ...
    if (E)
      return E.then((S) => {
        ...
        console.error("[Card] Error fetching pollen forecast:", S), this.debug && console.debug("[Card] fetchForecast error:", S);
      });
  }
  _renderMinimalHtml() {
    return w`
            ...
            return w`
                    <td>
                      <div class="icon-wrapper">
                        <img
                          src="${this._getImageSrc("", (I = n.days[a]) == null ? void 0 : I.state)}"
                        />
...
const hA = (t, A) => {
  ...
  return g;
}, ot = (t) => t === "dwd" ? z : t === "peu" ? V : t === "silam" ? T : K;
class lt extends iA {
  get debug() {
  ...
  _resetPhrases(A) {
    ...
    const g = this._config.integration === "dwd" ? z.allergens : this._config.integration === "peu" ? V.allergens : this._config.integration === "silam" ? T.allergens : K.allergens, e = {}, n = {};
    g.forEach((o) => {
      const D = $(o), h = nA[D] || D;
  ...
  setConfig(A) {
    ...
    try {
      ...
      const n = A.integration === "dwd" ? z.allergens.length : A.integration === "peu" ? V.allergens.length : A.integration === "silam" ? T.allergens.length : K.allergens.length, C = { ...A };
      ...
      const a = (C.integration === "dwd" ? z : C.integration === "peu" ? V : C.integration === "silam" ? T : K).pollen_threshold;
      ...
      const i = (C.integration === "dwd" ? z : C.integration === "peu" ? V : C.integration === "silam" ? T : K).date_locale;
  ...
  set hass(A) {
    ...
    const i = I === "dwd" ? z : I === "peu" ? V : I === "silam" ? T : K;
  ...
  _updateConfig(A, g) {
    ...
    if (A === "integration") {
      ...
      C !== a && (delete e[C === "dwd" ? "city" : "region_id"], delete e.allergens, delete e.days_to_show, delete e.pollen_threshold, this._allergensExplicit = !1), n = hA(C === "dwd" ? z : C === "peu" ? V : C === "silam" ? T : K, e), n.integration = C;
    } else
  ...
  render() {
    const A = {
      ...
      ...this._config
    }, g = A.integration === "dwd" ? z.allergens : A.integration === "peu" ? V.allergens : A.integration === "silam" ? T.allergens : K.allergens, e = A.integration === "dwd" ? 4 : A.integration === "peu" ? 5 : 7, n = A.integration === "dwd" ? { min: 0, max: 3, step: 0.5 } : A.integration === "peu" ? { min: 0, max: 4, step: 1 } : { min: 0, max: 6, step: 1 }, a = [
      "value_ascending",
      "value_descending",
      "name_ascending",
      "name_descending"
