...
var Qg = (C, A, g) => A in C ? dg(C, A, { enumerable: !0, configurable: !0, writable: !0, value: g }) : C[A] = g;
var fA = (C, A, g) => Qg(C, typeof A != "symbol" ? A + "" : A, g);
 ...
 */
const EA = window, PA = EA.ShadowRoot && (EA.ShadyCSS === void 0 || EA.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, YA = Symbol(), FA = /* @__PURE__ */ new WeakMap();
let tg = class {
  constructor(A, g, e) {
...
const Sg = (C) => new tg(typeof C == "string" ? C : C + "", void 0, YA), ig = (C, ...A) => {
  ...
  PA ? C.adoptedStyleSheets = A.map((g) => g instanceof CSSStyleSheet ? g : g.styleSheet) : A.forEach((g) => {
    const e = document.createElement("style"), n = EA.litNonce;
 ...
 */
var BA;
const cA = window, KA = cA.trustedTypes, cg = KA ? KA.emptyScript : "", zA = cA.reactiveElementPolyfillSupport, jA = { toAttribute(C, A) {
  switch (A) {
    case Boolean:
      C = C ? cg : null;
      break;
...
CA[kA] = !0, CA.elementProperties = /* @__PURE__ */ new Map(), CA.elementStyles = [], CA.shadowRootOptions = { mode: "open" }, zA == null || zA({ ReactiveElement: CA }), ((BA = cA.reactiveElementVersions) !== null && BA !== void 0 ? BA : cA.reactiveElementVersions = []).push("1.6.3");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
var xA;
const pA = window, rA = pA.trustedTypes, TA = rA ? rA.createPolicy("lit-html", { createHTML: (C) => C }) : void 0, HA = "$lit$", _ = `lit$${(Math.random() + "").slice(9)}$`, ag = "?" + _, pg = `<${ag}>`, IA = document, DA = () => IA.createComment(""), dA = (C) => C === null || typeof C != "object" && typeof C != "function", og = Array.isArray, ug = (C) => og(C) || typeof (C == null ? void 0 : C[Symbol.iterator]) == "function", yA = `[ 	
\f\r]`, sA = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, VA = /-->/g, NA = />/g, gA = RegExp(`>|${yA}(?:([^\\s"'>=/]+)(${yA}*=${yA}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), XA = /'/g, qA = /"/g, lg = /^(?:script|style|textarea|title)$/i, mg = (C) => (A, ...g) => ({ _$litType$: C, strings: A, values: g }), w = mg(1), aA = Symbol.for("lit-noChange"), W = Symbol.for("lit-nothing"), _A = /* @__PURE__ */ new WeakMap(), eA = IA.createTreeWalker(IA, 129, null, !1);
function sg(C, A) {
...
const fg = (C, A) => {
  ...
  for (let I = 0; I < g; I++) {
    const i = C[I];
    let o, d, S = -1, a = 0;
    for (; a < i.length && (r.lastIndex = a, d = r.exec(i), d !== null); ) a = r.lastIndex, r === sA ? d[1] === "!--" ? r = VA : d[1] !== void 0 ? r = NA : d[2] !== void 0 ? (lg.test(d[2]) && (n = RegExp("</" + d[2], "g")), r = gA) : d[3] !== void 0 && (r = gA) : r === gA ? d[0] === ">" ? (r = n ?? sA, S = -1) : d[1] === void 0 ? S = -2 : (S = r.lastIndex - d[2].length, o = d[1], r = d[3] === void 0 ? gA : d[3] === '"' ? qA : XA) : r === qA || r === XA ? r = gA : r === VA || r === NA ? r = sA : (r = gA, n = void 0);
    const l = r === gA && C[I + 1].startsWith("/>") ? " " : "";
    t += r === sA ? i + pg : S >= 0 ? (e.push(o), i.slice(0, S) + HA + i.slice(S) + _ + l) : i + _ + (S === -2 ? (e.push(void 0), I) : l);
  }
...
class QA {
  constructor({ strings: A, _$litType$: g }, e) {
    ...
    this.parts = [];
    let t = 0, r = 0;
    const I = A.length - 1, i = this.parts, [o, d] = fg(A, g);
    if (this.el = QA.createElement(o, e), eA.currentNode = this.el.content, g === 2) {
      const S = this.el.content, a = S.firstChild;
      a.remove(), S.append(...a.childNodes);
    }
      ...
      if (n.nodeType === 1) {
        if (n.hasAttributes()) {
          ...
          for (const a of n.getAttributeNames()) if (a.endsWith(HA) || a.startsWith(_)) {
            const l = d[r++];
            if (S.push(a), l !== void 0) {
              const c = n.getAttribute(l.toLowerCase() + HA).split(_), x = /([.?@])?(.*)/.exec(l);
              i.push({ type: 1, index: t, name: x[2], strings: c, ctor: x[1] === "." ? Ug : x[1] === "?" ? yg : x[1] === "@" ? wg : mA });
            } else i.push({ type: 6, index: t });
          }
          for (const a of S) n.removeAttribute(a);
        }
        if (lg.test(n.tagName)) {
          const S = n.textContent.split(_), a = S.length - 1;
          if (a > 0) {
            n.textContent = rA ? rA.emptyScript : "";
            for (let l = 0; l < a; l++) n.append(S[l], DA()), eA.nextNode(), i.push({ type: 2, index: ++t });
            n.append(S[a], DA());
          }
        }
        ...
        let S = -1;
        for (; (S = n.data.indexOf(_, S + 1)) !== -1; ) i.push({ type: 7, index: t }), S += _.length - 1;
      }
      t++;
    }
  }
...
class Bg {
  ...
  u(A) {
    ...
    for (; o !== void 0; ) {
      if (I === o.index) {
        let d;
        o.type === 2 ? d = new SA(r, r.nextSibling, this, A) : o.type === 1 ? d = new o.ctor(r, o.name, o.strings, this, A) : o.type === 6 && (d = new vg(r, this, A)), this._$AV.push(d), o = n[++i];
      }
...
class SA {
  constructor(A, g, e, n) {
    var t;
    this.type = 2, this._$AH = W, this._$AN = void 0, this._$AA = A, this._$AB = g, this._$AM = e, this.options = n, this._$Cp = (t = n == null ? void 0 : n.isConnected) === null || t === void 0 || t;
  }
  get _$AU() {
    var A, g;
  ...
  _$AI(A, g = this) {
    A = oA(this, A, g), dA(A) ? A === W || A == null || A === "" ? (this._$AH !== W && this._$AR(), this._$AH = W) : A !== this._$AH && A !== aA && this._(A) : A._$litType$ !== void 0 ? this.g(A) : A.nodeType !== void 0 ? this.$(A) : ug(A) ? this.T(A) : this._(A);
  }
  k(A) {
  ...
  g(A) {
    ...
    if (((g = this._$AH) === null || g === void 0 ? void 0 : g._$AD) === t) this._$AH.v(e);
      ...
      const r = new Bg(t, this), I = r.u(this.options);
...
class mA {
  constructor(A, g, e, n, t) {
    this.type = 1, this._$AH = W, this._$AN = void 0, this.element = A, this.name = g, this._$AM = n, this.options = t, e.length > 2 || e[0] !== "" || e[1] !== "" ? (this._$AH = Array(e.length - 1).fill(new String()), this.strings = e) : this._$AH = W;
  }
  get tagName() {
  ...
  _$AI(A, g = this, e, n) {
    ...
    if (t === void 0) A = oA(this, A, g, 0), r = !dA(A) || A !== this._$AH && A !== aA, r && (this._$AH = A);
      ...
      const I = A;
      let i, o;
      for (A = t[0], i = 0; i < t.length - 1; i++) o = oA(this, I[e + i], g, i), o === aA && (o = this._$AH[i]), r || (r = !dA(o) || o !== this._$AH[i]), o === W ? A = W : A !== W && (A += (o ?? "") + t[i + 1]), this._$AH[i] = o;
    }
    r && !n && this.j(A);
  }
  j(A) {
...
class wg extends mA {
  ...
  _$AI(A, g = this) {
    var e;
    if ((A = (e = oA(this, A, g, 0)) !== null && e !== void 0 ? e : W) === aA) return;
    const n = this._$AH, t = A === W && n !== W || A.capture !== n.capture || A.once !== n.once || A.passive !== n.passive, r = A !== W && (n === W || t);
...
const bA = (C, A = "_") => {
  ...
  lime_6_png: gI,
  // mold_spores
  "mold_spores_-1_png": oI,
  mold_spores_0_png: II,
  mold_spores_1_png: nI,
  ...
  __proto__: null,
  default: Wn
}, Symbol.toStringTag, { value: "Module" })), eg = /* @__PURE__ */ Object.assign({ "./locales/cs.json": fn, "./locales/da.json": Un, "./locales/de.json": yn, "./locales/en.json": vn, "./locales/fi.json": jn, "./locales/it.json": Hn, "./locales/nl.json": On, "./locales/no.json": Pn, "./locales/ru.json": Mn, "./locales/sk.json": Zn, "./locales/sv.json": Fn }), lA = {};
for (const C in eg) {
...
const Kn = "state_tomorrow", zn = "state_in_2_days", Tn = "state_today_desc", Vn = "state_tomorrow_desc", Nn = "state_in_2_days_desc", z = {
  integration: "dwd",
  region_id: "",
  allergens: [
    "erle",
...
async function Xn(C, A) {
  ...
  for (const Q of A.allergens)
    try {
      ...
      const u = nA[p] || p, h = d[Q];
      if (h)
        s.allergenCapitalized = h;
      else {
        const H = `card.allergen.${nA[p] || p}`, Z = O(H, n);
        s.allergenCapitalized = Z !== H ? Z : e(Q);
      }
      ...
      s.days = [], J.forEach((U, H) => {
        const Z = Math.round((U.date - Y) / 864e5);
        let D;
        r ? x[Z] !== void 0 ? D = x[Z] : Z >= 0 && Z <= 2 ? D = O(`card.days.${Z}`, n) : D = U.date.toLocaleDateString(t, {
          day: "numeric",
          month: "short"
      ...
      }), (J.slice(0, b).some((U) => U.level >= m) || m === 0) && M.push(s);
    } catch (s) {
...
async function _n(C, A) {
  ...
  const g = !!A.debug, e = q(C, A.date_locale), n = A.date_locale || ((p = C.locale) == null ? void 0 : p.language) || C.language || `${e}-${e.toUpperCase()}`, t = A.days_relative !== !1, r = !!A.days_abbreviated, I = !!A.days_uppercase, i = {
    ...
    no_information: "",
    ...A.phrases || {}
  }, o = i.full, d = i.short, S = i.levels, a = 5;
  Array.isArray(S) && S.length === a || Array.from(
    { length: a },
    (h, E) => O(`card.levels.${E}`, e)
  );
  const l = i.no_information || O("card.no_information", e), c = i.days, x = A.integration === "dwd" ? 3 : A.integration === "peu" ? 4 : 6, b = (h) => {
    const E = Number(h);
  ...
  return s.sort(
    {
      value_ascending: (h, E) => h.day0.state - E.day0.state,
      value_descending: (h, E) => E.day0.state - h.day0.state,
      name_ascending: (h, E) => h.allergenCapitalized.localeCompare(E.allergenCapitalized),
      name_descending: (h, E) => E.allergenCapitalized.localeCompare(h.allergenCapitalized)
    }[A.sort] || ((h, E) => E.day0.state - h.day0.state)
...
function ZA(C, A, g) {
  let e;
  A.full[C] ? e = A.full[C] : V.names && V.names[C] && V.names[C][g] ? e = V.names[C][g] : e = C.charAt(0).toUpperCase() + C.slice(1);
  const n = A.short[C] || e;
  return { allergenCapitalized: e, allergenShort: n };
}
async function eC(C, A) {
  var Y, M, Q;
  const g = !!A.debug, e = q(C, A.date_locale), n = A.date_locale || ((Y = C.locale) == null ? void 0 : Y.language) || C.language || `${e}-${e.toUpperCase()}`, t = A.days_relative !== !1, r = !!A.days_abbreviated, I = !!A.days_uppercase, i = MA(A, e), o = GA(i, e), d = i.no_information, S = i.days, a = /* @__PURE__ */ new Date();
  a.setHours(0, 0, 0, 0);
  const l = A.days_to_show ?? K.days_to_show, c = A.pollen_threshold ?? K.pollen_threshold, x = (A.location || "").toLowerCase(), b = Object.keys(C.states).filter((s) => {
  ...
  for (const s of A.allergens)
    try {
      ...
      const { allergenCapitalized: u, allergenShort: h } = ZA(
        s,
        i,
        e
      );
      p.allergenCapitalized = u, p.allergenShort = A.allergens_abbreviated ? h : u;
      const E = m[s];
      if (!E || !C.states[E]) {
...
async function IC(C, A, g = null) {
  ...
  let I = (A.location || "").toLowerCase(), i = null;
  for (const m of Object.keys(C.states))
    if (m.startsWith("weather.silam_pollen_") && m.includes(I) && m.endsWith("forecast")) {
      i = m;
      break;
    }
  if (e && console.debug(
  ...
  if (g && g.forecast && Array.isArray(g.forecast))
    ...
    const m = C.states[i];
    (b = m == null ? void 0 : m.attributes) != null && b.forecast && Array.isArray(m.attributes.forecast) && (o = m.attributes.forecast, e && console.debug(
  ...
  const d = MA(A, n), S = GA(d, n), a = d.no_information, l = A.allergens || K.allergens;
  e && console.debug(
...
async function tC(C, A) {
  ...
  for (const u of A.allergens)
    try {
      ...
      h.days = [];
      const E = $(u);
      if (h.allergenReplaced = E, this.debug && console.log(
        "[PP] allergen",
        u,
        "fullPhrases keys",
        Object.keys(l)
      ...
      H.forEach((D, v) => {
        ...
        }), P = P.charAt(0).toUpperCase() + P.slice(1)), S && (P = P.toUpperCase());
        const AA = {
  ...
  return g.sort(
    {
      value_ascending: (u, h) => u.day0.state - h.day0.state,
      value_descending: (u, h) => h.day0.state - u.day0.state,
      name_ascending: (u, h) => u.allergenCapitalized.localeCompare(h.allergenCapitalized),
      name_descending: (u, h) => h.allergenCapitalized.localeCompare(u.allergenCapitalized)
    }[A.sort] || ((u, h) => h.day0.state - u.day0.state)
...
function ng(C, A, g = !1) {
  ...
  if (e === "pp") {
    ...
    for (const r of C.allergens || []) {
      ...
      if (!o) {
        const d = Object.keys(A.states).filter((S) => {
          const a = S.match(/^sensor\.polleninformation_(.+)_(.+)$/);
          if (!a) return !1;
          const l = a[1], c = a[2];
          return (!t || l === t) && c === I;
        });
    ...
    for (const r of C.allergens || []) {
      let I = null;
      for (const i of Object.values(V.mapping)) {
        const o = Object.entries(i).reduce((d, [S, a]) => (d[a] = S, d), {});
        if (o[r]) {
          const d = o[r], S = `sensor.silam_pollen_${t}_${d}`;
          if (A.states[S]) {
            I = d, g && console.debug(
              `[findAvailableSensors][silam] allergen: '${r}', locationSlug: '${t}', hassSlug: '${I}', sensorId: '${S}', exists: true`,
              A.states[S]
            ), n.push(S);
            break;
          }
...
class iC extends iA {
  constructor() {
    super();
    fA(this, "_forecastUnsub", null);
    // Unsubscribe-funktion
    fA(this, "_forecastEvent", null);
  ...
  setConfig(g) {
    ...
    e === "pp" ? n = L : e === "peu" ? n = T : e === "dwd" ? n = z : e === "silam" ? n = K : n = L;
  ...
  set hass(g) {
    ...
    let o;
    i === "dwd" ? o = z : i === "peu" ? o = T : i === "pp" ? o = L : i === "silam" ? o = K : console.error("Unknown integration:", i);
    const { allergens: d, ...S } = this._userConfig, a = {
      ...o,
      ...S,
      integration: i
    };
    if (this._integrationExplicit && Array.isArray(d) && d.length > 0 ? (this.debug && console.debug(
      ...
      i
    ), i === "pp" ? a.allergens = L.allergens : i === "peu" ? a.allergens = T.allergens : i === "dwd" ? a.allergens = z.allergens : i === "silam" && (a.allergens = K.allergens)), !a.hasOwnProperty("date_locale")) {
      const Q = q(g, null), s = ((b = (x = this._hass) == null ? void 0 : x.locale) == null ? void 0 : b.language) || ((m = this._hass) == null ? void 0 : m.language) || `${Q}-${Q.toUpperCase()}`;
    ...
    if (i === "dwd" && !a.region_id && t.length)
      a.region_id = Array.from(
        new Set(t.map((Q) => Q.split("_").pop()))
      ).sort((Q, s) => Number(Q) - Number(s))[0], this.debug && console.debug("[Card] Auto-set region_id:", a.region_id);
      ...
      a.location = Q[0] || null, this.debug && console.debug(
    ...
    if (this.config = a, this.tapAction = a.tap_action || this.tapAction || null, this.debug && (console.debug("[Card][Debug] Aktiv integration:", i), console.debug("[Card][Debug] Allergens i config:", a.allergens)), a.title === "false" || a.title === !1 || typeof a.title == "string" && a.title.trim() === "")
      ...
      let Q = "";
      if (i === "dwd")
        Q = Dg[a.region_id] || a.region_id;
      else if (i === "peu") {
        const p = Object.values(g.states).filter(
          (h) => h.entity_id.startsWith("sensor.polleninformation_")
        ).find((h) => ((h.attributes || {}).location_slug || h.entity_id.replace("sensor.polleninformation_", "").replace(/_[^_]+$/, "")) === a.location);
        let u = "";
        if (p) {
    ...
    if (a.integration === "silam" && a.mode === "hourly" && typeof l.fetchHourlyForecast == "function") {
      ...
      c = l.fetchHourlyForecast(
        g,
        a,
        this._forecastEvent
      );
    } else
      c = l.fetchForecast(g, a);
    if (c)
      return c.then((Q) => {
        ...
        if (this._integrationExplicit && !!a.location && p === 0) {
          ...
          this._explicitLocationNoSensors = !1, this._updateSensorsAndColumns(h, s, a);
      }).catch((Q) => {
            ...
            return w`
              ...
              ${this.config.show_text_allergen || this.config.show_value_text || this.config.show_value_numeric ? w`
                    <tr class="allergen-text-row" valign="top">
                      ...
                      ${e.map((r) => {
          var d, S;
          const I = ((d = n.days[r]) == null ? void 0 : d.state_text) || "", i = (S = n.days[r]) == null ? void 0 : S.state;
          let o = "";
...
customElements.define("pollenprognos-card", iC);
const hA = (C, A) => {
  const g = { ...C };
  ...
  return g;
}, rC = (C) => C === "dwd" ? z : C === "peu" ? T : C === "silam" ? K : L;
class aC extends iA {
  get debug() {
  ...
  _resetPhrases(A) {
    ...
    const g = this._config.integration === "dwd" ? z.allergens : this._config.integration === "peu" ? T.allergens : this._config.integration === "silam" ? K.allergens : L.allergens, e = {}, n = {};
    g.forEach((o) => {
      const d = $(o), S = nA[d] || d;
      e[o] = O(`editor.phrases_full.${S}`, A), n[o] = O(`editor.phrases_short.${S}`, A);
    });
  ...
  setConfig(A) {
    ...
    try {
      ...
      const n = A.integration === "dwd" ? z.allergens.length : A.integration === "peu" ? T.allergens.length : A.integration === "silam" ? K.allergens.length : L.allergens.length, t = { ...A };
      ...
      const r = (t.integration === "dwd" ? z : t.integration === "peu" ? T : t.integration === "silam" ? K : L).pollen_threshold;
      ...
      this._prevIntegration !== void 0 && I !== this._prevIntegration && (delete this._userConfig.allergens, this._allergensExplicit = !1, this.debug && console.debug("[Editor] integration changed → wipe allergens")), !this._integrationExplicit && t.integration === L.integration && (this.debug && console.debug("[Editor] dropped stub integration"), delete t.integration), !this._daysExplicit && t.days_to_show === L.days_to_show && (this.debug && console.debug("[Editor] dropped stub days_to_show"), delete t.days_to_show);
      const i = (t.integration === "dwd" ? z : t.integration === "peu" ? T : t.integration === "silam" ? K : L).date_locale;
      ...
      if (this._userConfig.hasOwnProperty("pollen_threshold") || (S.pollen_threshold = d.pollen_threshold, this.debug && console.debug(
        ...
        d.pollen_threshold
      )), S.allergens = Array.isArray(this._userConfig.allergens) ? this._userConfig.allergens : d.allergens, S.integration = o, S.type = "custom:pollenprognos-card", this._config = S, this._prevIntegration = o, this.debug && console.debug(
  ...
  set hass(A) {
    ...
    const i = I === "dwd" ? z : I === "peu" ? T : I === "silam" ? K : L;
    ...
    ).sort((l, c) => l.localeCompare(c)), this.installedPeuLocations = Array.from(
      new Map(
        Object.values(A.states).filter((l) => l.entity_id.startsWith("sensor.polleninformation_")).map((l) => {
          var b, m;
          const c = l.attributes.location_slug || l.entity_id.replace("sensor.polleninformation_", "").replace(/_[^_]+$/, ""), x = l.attributes.location_title || ((m = (b = l.attributes.friendly_name) == null ? void 0 : b.match(/\((.*?)\)/)) == null ? void 0 : m[1]) || c;
          return [c, x];
        })
      )
    ...
    if (this.debug) {
      console.debug("[SilamAllergenMap.mapping]", V.mapping), console.debug("[pollenAllergens]", S);
      for (const [c, x] of Object.entries(V.mapping))
        for (const [b, m] of Object.entries(x))
          console.debug(`[Mapping] ${c}: ${b} → ${m}`);
      const l = Object.values(V.mapping).flatMap(
    ...
    this.installedSilamLocations = Array.from(
      new Map(
        Object.values(A.states).filter((l) => {
          ...
          let m = l.attributes.location_title || (l.attributes.friendly_name ? l.attributes.friendly_name.replace(/^SILAM Pollen\s*-?\s*/i, "").replace(new RegExp("\\s+\\p{L}+$", "u"), "").trim() : "") || x;
  ...
  render() {
    const A = {
      ...
      ...this._config
    }, g = A.integration === "dwd" ? z.allergens : A.integration === "peu" ? T.allergens : A.integration === "silam" ? K.allergens : L.allergens, e = A.integration === "dwd" ? 4 : A.integration === "peu" ? 5 : 7, n = A.integration === "dwd" ? { min: 0, max: 3, step: 0.5 } : A.integration === "peu" ? { min: 0, max: 4, step: 1 } : { min: 0, max: 6, step: 1 }, r = [
      "value_ascending",
      "value_descending",
      "name_ascending",
      "name_descending"
...
customElements.define("pollenprognos-card-editor", aC);
