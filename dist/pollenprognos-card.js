 ...
 */
var BA;
const cA = window, KA = cA.trustedTypes, cg = KA ? KA.emptyScript : "", VA = cA.reactiveElementPolyfillSupport, jA = { toAttribute(n, A) {
  switch (A) {
    case Boolean:
      n = n ? cg : null;
      break;
...
const LC = "state_tomorrow", KC = "state_in_2_days", VC = "state_today_desc", TC = "state_tomorrow_desc", zC = "state_in_2_days_desc", V = {
  integration: "dwd",
  region_id: "",
  allergens: [
    "erle",
